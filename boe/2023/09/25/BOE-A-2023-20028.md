---
identificador: "BOE-A-2023-20028"
titulo: "Resolución de 15 de septiembre de 2023, de la Presidencia de la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P., por la que se publica el Convenio con Protein Alternatives, SL, para la realización conjunta del proyecto de I+D+i \"Traduciendo la biología tumoral en medicina personalizada: Desarrollo de un test pronóstico y predictivo para pacientes en estadio II de cáncer de colon\"."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "229"
pagina_inicial: 129660
pagina_final: 129675
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2023-20028"
url_pdf: "https://www.boe.es/boe/dias/2023/09/25/pdfs/BOE-A-2023-20028.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2023-20028"
url_eli: ""
fetched_at: "2026-04-10T22:15:05Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 15 de septiembre de 2023, de la Presidencia de la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P., por la que se publica el Convenio con Protein Alternatives, SL, para la realización conjunta del proyecto de I+D+i "Traduciendo la biología tumoral en medicina personalizada: Desarrollo de un test pronóstico y predictivo para pacientes en estadio II de cáncer de colon".

Suscrito el convenio el 14 de septiembre de 2023, y en cumplimiento de lo dispuesto en el apartado 8 del artí*c*ulo 48 de la Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público, procede la publicación en el «Boletín Oficial del Estado» de dicho convenio, que figura como anexo de esta resolución.

Madrid, 15 de septiembre de 2023.–La Presidenta de Agencia Estatal del Consejo Superior de Investigaciones Científicas, M.P., Eloísa del Pino Matute.

## ANEXO. Convenio entre la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P. (CSIC), y Protein Alternatives, SL (PROALT), para la realización conjunta del proyecto de I+D+i «Traduciendo la biología tumoral en medicina personalizada: Desarrollo de un test pronóstico y predictivo para pacientes en estadio II de cáncer de colon»

INTERVIENEN

De una parte, don Carlos Closa Montero, en su condición de vicepresidente de Organización y Relaciones Institucionales de la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P. (CSIC), nombrado por Acuerdo del Consejo Rector del CSIC, en su reunión de 30 de noviembre de 2022 (BOE de 23 de diciembre de 2022. Res. Presidencia CSIC de 14 de diciembre de 2022, por la que se resuelve convocatoria de libre designación), actuando en nombre y representación de esta institución en virtud de las competencias que tiene delegadas por resolución de 21 de enero de 2021 de la Presidencia del CSIC (BOE de 28 de enero siguiente). Organismo con sede central en Madrid (C. P. 28006), domicilio institucional en calle de Serrano, 117, y NIF Q-2818002-D.

Y de otra, don Juan Ignacio Imbaud Martínez, en nombre y representación de Protein Alternatives, SL (en adelante, PROALT), con NIF B-84697077, domiciliada en ronda de Poniente, 16, piso 1.º AF, 28760 Tres Cantos (Madrid), que actúa como representante legal de la institución en calidad de Apoderado, en virtud de la Escritura pública autorizada ante el Notario de Madrid don Pedro Antonio Mateos Salgado, el día 15 de febrero de 2019, con el número 1.252 de su protocolo.

El CSIC y PROALT en adelante denominadas conjuntamente «las partes» o «entidades participantes», declaran hallarse debidamente facultadas y con la capacidad necesaria para obligarse en los términos del presente convenio, a cuyo efecto
...
2.  Que PROALT es una empresa que desarrolla su actividad en el sector de la biotecnología que diseña y desarrolla ensayos diagnósticos innovadores para la detección precoz del cáncer y anticuerpos terapéuticos únicos frente a nuevas dianas para el tratamiento eficiente de cánceres metastásicos y tiene los recursos y la capacidad técnica, financiera y comercial para desarrollar el proyecto de I+D en los términos detallados en el proyecto objeto de esta colaboración.

En este sentido, entre las funciones de PROALT se encuentra el diseño y optimización del algoritmo de puntuación de riesgo para la correcta estratificación de los pacientes de cáncer de colon, así como la comercialización de este algoritmo que incluyen un análisis de mercado exhaustivo y la realización de un plan de negocio para la comercialización de dicho algoritmo.

La compañía PROALT cuenta con gran experiencia y conocimientos en el campo de la biomedicina y, concretamente, en los diagnósticos innovadores para la detección precoz del cáncer, los test de pronóstico del cáncer y los anticuerpos terapéuticos.
...
4.  Que la Agencia Estatal de Investigación (AEI) dentro de la actuación ayudas públicas a proyectos de prueba de concepto, del Plan Estatal de Investigación Científica, Técnica y de Innovación para el período 2021-2023, en el marco del Plan de Recuperación, Transformación y Resiliencia, ha concedido al CSIC, como beneficiaria de la ayuda y coordinadora del Proyecto, una ayuda para la realización del Proyecto «Traduciendo la biología tumoral en medicina personalizada: Desarrollo de un test pronóstico y predictivo para pacientes en estadio II de cáncer de colon», financiada con cargo al Plan de Recuperación, Transformación y Resiliencia a través del Mecanismo de Recuperación y Resiliencia, según se prevé en la convocatoria correspondiente a 2022, aprobada por Orden CIN/417/2022, de 4 de mayo (BOE de 12 de mayo de 2022). El CSIC y PROALT están interesados en colaborar mutuamente para llevar a cabo el citado Proyecto, de acuerdo con lo establecido en la cláusula cuarta y en las restantes disposiciones de este convenio.
...
El objeto del presente convenio es establecer la colaboración científico-técnica entre el CSIC, a través del CIB Margarita Salas, y PROALT, en la realización conjunta del Proyecto de I+D+i «Traduciendo la biología tumoral en medicina personalizada: Desarrollo de un test pronóstico y predictivo para pacientes en estadio II de cáncer de colon», en adelante «el Proyecto», consistente en las investigaciones necesarias para demostrar la capacidad de la «SEC6» (combinación de seis genes/proteínas IGFBP3, CD109, LTBP1, PSAP, BMP1 y NPC2) para predecir el riesgo de recidiva en pacientes de cáncer de colon usando muestras clínicas parafinadas, así como proteger la propiedad intelectual e industrial y promover la transferencia tecnológica a las empresas interesadas, en los términos establecidos por las partes en este convenio y en el Plan de Trabajo que éstas acuerden y al que se hace referencia en la cláusula segunda.
...
El Proyecto cuenta con la financiación indicada en el expositivo cuarto por lo que, en su ejecución, justificación y difusión, las partes deberán cumplir con lo establecido en las bases reguladoras, convocatoria y/o concesión de la ayuda / agente financiador para la transferencia de los fondos.
...
Las tareas consistirán en que el CSIC y PROALT desarrollarán las actividades detalladas en la memoria objeto de la subvención, en concreto las siguientes:

Por parte de PROALT:

– Colaboración para la presentación de los informes a tiempo (tarea 1.3).

– Optimización del algoritmo de puntuación de riesgo para la correcta estratificación de los pacientes de cáncer de colon (tarea 2.3).

– Comercialización de este algoritmo (tarea 3) mediante la realización de un exhaustivo análisis de mercado (tarea 3.1), la realización del plan de negocio para su comercialización (tarea 3.2) y contacto con los posibles beneficiarios y clientes (tarea 3.3).

Por parte del CSIC:

– Administración del Proyecto (tarea 1) mediante la:

a) Coordinación y gestión del Proyecto (tarea 1.1).

b) Gestión de la propiedad intelectual e industrial (tarea 1.2).

c) Supervisión constante del Proyecto y asegurarse de la presentación de los informes a tiempo (tarea 1.3).

– Demostración de la viabilidad (tarea 2):

a) Recolección de muestras de pacientes (tarea 2.1)

b) Realización de qPCR (tarea 2.2)

c) Puesta a punto del algoritmo (tarea 2.3)

d) Analizar la efectividad y eficiencia del algoritmo (tarea 2.4)

e) Validación pronóstica del algoritmo por inmunohistoquímica (tarea 2.5).

– Comercialización (tarea 3 en todos sus puntos)

a) Estudio de mercado (tarea 3.1).

b) Plan de negocio (tarea 3.2).

c) Contacto con los posibles beneficiarios y clientes (tarea 3.3).

d) Demostración del prototipo (tarea 3.4).

e) Estrategia de negociación y licencia (tarea 3.5).
...
En concreto el CSIC desarrollará el Proyecto a través del grupo de «Mecanismos de metástasis tumoral» y PROALT a través del personal dirigido por su Dirección de laboratorio.
...
– Ejecutar el Proyecto conforme a lo que establezcan las bases reguladoras/convocatoria/resolución definitiva de concesión y lo que haya establecido el agente financiador para la transferencia de los fondos, ejerciendo el CSIC de entidad beneficiaria de la ayuda y coordinadora del Proyecto, asumiendo las obligaciones de coordinación y seguimiento de PROALT así como su representación ante el agente financiador a efectos de cobro y distribución de la ayuda, su justificación y/o reintegro, en función de lo que establezcan las bases reguladoras, convocatoria y/o resolución definitiva de concesión de la ayuda y el agente financiador para la transferencia de los fondos, así como el presente convenio.
...
● y por parte de la PROALT, será el/la director/a de laboratorio responsable del Proyecto.
...
1. El Proyecto consta de un presupuesto concedido de ciento dieciséis mil euros (116.000,00 €), comprometiéndose el CSIC, en su condición de entidad beneficiaria de la ayuda y coordinadora del Proyecto, a la distribución y transferencia inmediata de los fondos necesarios para la ejecución del Proyecto a PROALT una vez recibidas las anualidades correspondientes por parte del agente financiador, en los términos establecidos en las bases reguladoras/convocatoria/resolución de concesión de la ayuda y sin perjuicio de lo previsto en el artículo 59 del Real Decreto-ley 36/2020, de 30 de diciembre, por el que se aprueban medidas urgentes para la modernización de la Administración Pública y para la ejecución del Plan de Recuperación, Transformación y Resiliencia. El CSIC no realizará ninguna aportación propia, limitándose a transferir los fondos recibidos del agente financiador.
...
| --- | --- | --- | --- |
| Año 2023 | Año 2024 |  |  |
| CSIC. | 61.000 | 30.000 | 91.000 |
| PROALT. | 25.000 | 0 | 25.000 |
| Total. |  |  | 116.000 |
| Grupo PROALT: el grupo de PROALT liderado por la persona responsable del Proyecto indicada en la cláusula 2.2. realizará las tareas 1.3, 2.3, 3.1, 3.2 y 3.3 conforme a lo establecido en la cláusula 2.1. El presupuesto consiste en 25.000 euros con la siguiente distribución: gastos de personal 25.000,00 euros (contrato de un año, nivel MECES 3).
 Grupo CSIC: el grupo del CIB Margarita Salas, liderado por la persona responsable del Proyecto indicada en la cláusula 2.2. realizará las tareas 1.1-1.3, 2.1-2.5 y 3.1-3.5 conforme a lo establecido en la cláusula 2.1. El presupuesto consiste en 91.000,00 euros con la siguiente distribución: gastos de personal 33.400,00 euros (contrato un año, nivel M3), gastos en fungible y utilización de instalaciones y equipos propios 57.600,00 euros. A esto se suman 17.400,00 euros de costes indirectos. Las mencionadas cantidades relativas al CSIC se imputarán a la aplicación presupuestaria 77900/0000/9411 de los ejercicios 2023 y 2024 de los presupuestos de dicho organismo. |  |  |  |

2. Las cantidades indicadas se harán efectivas mediante transferencia bancaria realizada por la entidad beneficiaria de la ayuda y coordinadora del Proyecto en la cuenta abierta a nombre de PROALT que ésta indique y certifique (indicando en el concepto de la transferencia el acrónimo o código identificativo del Proyecto), y previa conformidad del ordenante del pago con el cumplimiento hasta ese momento del Plan de Trabajo y el calendario de pagos establecido.

El importe a abonar por CSIC a PROALT no incluirá IVA, pues la cantidad no es en concepto de contraprestación directa y equivalente a las actividades que se realizarán, sino que éstas carecen de onerosidad al tener como finalidad coadyuvar a la consecución del objeto común y a los fines del presente convenio establecidos en la cláusula primera. En este sentido, la ausencia de onerosidad del objeto, fines y actuaciones es clara y patente a la luz de los preceptos contenidos en el artículo 4.1 (sujeción de las entregas de bienes y prestaciones al impuesto) de la Ley 37/1992, de 28 de diciembre, del Impuesto sobre el Valor Añadido.
...
Las contrataciones de personal habrán de ajustarse a la normativa vigente sobre contratación que resulte de aplicación a PROALT y al CSIC y con las limitaciones que, en su caso, se establezcan en las correspondientes leyes de presupuestos que sean aplicables, teniéndose en cuenta que los costes máximos de contratación imputables a la subvención se ajustarán a los importes contenidos en las instrucciones dictadas al efecto, que se publicarán en la página web del AEI. Las contrataciones de personal serán exclusivamente para la realización de las actuaciones recogidas en el convenio, sin que en ningún caso pueda derivarse de ello la consolidación de los contratados como personal propio de ninguna de las partes una vez finalizado el periodo de vigencia del Proyecto y, por tanto, del convenio, de acuerdo con la normativa aplicable en la materia.
...
Por parte del CSIC el órgano directivo será la Vicepresidencia de Investigación Científica y Técnica (VICYT) y por parte de la PROALT será la Dirección de laboratorio y Apoderado.

Y en prueba de conformidad, las partes suscriben el presente convenio, el 14 de septiembre de 2023.–El Vicepresidente de Organización y Relaciones Institucionales de la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P. (CSIC), Carlos Closa Montero.–El Apoderado de Protein Alternatives, SL (PROALT), Juan Ignacio Imbaud Martínez.
