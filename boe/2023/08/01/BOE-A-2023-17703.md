---
identificador: "BOE-A-2023-17703"
...
pagina_final: 113935
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2023-17703"
url_pdf: "https://www.boe.es/boe/dias/2023/08/01/pdfs/BOE-A-2023-17703.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2023-17703"
url_eli: ""
fetched_at: "2026-04-10T20:14:26Z"
...
La presente convocatoria tiene por objeto la selección de personal, mediante el sistema de concurso-oposición, para cubrir una plaza de la escala técnica básica de laboratorios (Departamento de Traducción) de la Universitat Jaume I de Castelló, grupo C, subgrupo C1.
...
«Participar en las pruebas selectivas de ingreso en la escala técnica básica de laboratorios (Departamento de Traducción) de la Universitat Jaume I de Castelló, código asunto: 20795.»
...
Los miembros de una familia numerosa de categoría general o de una familia monoparental de categoría general disfrutarán de una bonificación del cincuenta por ciento de la cuota íntegra, es decir, el importe será de 7,50 euros.
...
https://e-ujier.uji.es/pls/www/pagaments.ini?p_id=14&p_importe=15,00&p_referencia=20795
...
https://e-ujier.uji.es/pls/www/pagaments.ini?p_id=14&p_importe=7,50&p_referencia=20795
...
6.2 Terminado el plazo de presentación de solicitudes, previa verificación de que se ha realizado el pago de los derechos de examen, el órgano convocante dictará resolución, que se publicará en el TAO-UJI, y que contendrá la relación provisional de personas admitidas y excluidas a la realización de las pruebas.
...
En caso de persistir el empate, si este fuera entre personas de distinto sexo, se dirimirá a favor de del sexo infrarrepresentado dentro del colectivo de personas que formen parte de la escala técnica básica de laboratorios (Departamento de Traducción) de la Universitat Jaume I en la fecha de publicación de la presente convocatoria.
...
Transcurrido el plazo de presentación de la documentación se dictará una resolución, que se publicará en el Diari Oficial de la Generalitat Valenciana, procediendo al nombramiento como personal funcionario de carrera de la escala técnica básica de laboratorios (Departamento de Traducción) de la Universitat Jaume I, grupo C, subgrupo C1, del personal aprobado a que hace referencia la base 9.3, previa la adjudicación del puesto de trabajo de acuerdo con la puntuación obtenida.
...
a) Definición y topologías.

b) Redes Ethernet y wifi (IEEE 802.3 y IEEE 802.11): conceptos básicos.

c) Medios físicos de transmisión de datos en Ethernet: tipos de cable y normativas.

13. Servicios y protocolos de red:

a) Protocolos TCP/IP. Capas del modelo TCP/IP.

b) DHCP y DNS.

c) Arranque por red (PXE).

d) Protocolos para correo electrónico (POP, IMAP y SMTP).

e) La World Wide Web: origen y evolución; los protocolos HTTP/HTTPS.

14. Equipos de comunicación:

a) Tipos, características y funcionamiento.

b) Enrutamiento y cortafuegos.

c) Redes wifi y seguridad.
...
b) Entorno de trabajo: MS Windows: Windows 10, 11 y Windows Server.

c) Unix/linux.

d) Máquinas virtuales.

e) Servidores de archivos: uso de recursos compartidos.

f) Impresión remota: hardware y software.

g) Servidores de licencias.

h) Directorio activo de Microsoft.

i) Gestión de permisos basados en credenciales corporativas.

16. Informática personal:

a) Ofimática y herramientas colaborativas.

b) Procesadores de textos. Hojas de cálculo. Gestores de bases de datos.

c) Paquetes integrados (MS Office 365 y G Suite for Education [Google Apps]).

17. Copias de seguridad: necesidad. Planificación. Organización. Soportes.

18. Administración de múltiplos entornos remotos: actualización del software en un entorno distribuido.

19. Protección y seguridad: virus, troyanos, criptovirus, hacking, intrusismo, exfiltración de datos, Dos y DDoS.

20. Identidad digital:

a) Certificados digitales.

b) Identidad y protección de archivos (cifrado).

c) Firma digital de documentos.

21. Lenguajes de marcación de textos: HTML y sus extensiones.
...
a) Instalación y configuraciones básicas.
...
e) eXist XML. Database Server.

24. Aplicaciones de software para la gestión de:
...
25. Aplicaciones de software para la traducción: bases de datos terminológicas y sistemas de traducción asistida

26. Gestión de recursos multimedia:

a) Edición de sonido y video. Funcionamiento de programa Audacity.

i. Conversión entre formatos.

ii. Limpieza de archivos de audio.

b) Formatos de sonido. Diferencias entre MP3 y WAV.

c) Hardware multimedia:

i. Tipos de micrófonos.

ii. Tipos de altavoces.

iii. Tipos de cableado y conectores en sonido.

d) Resolución problemas de equipamiento multimedia.

27. Tipos de cableado. Elementos principales de cableado estructurado.

28. Reparación, montaje y mantenimiento de hardware y software.

29. Gestión de compras. Estudio de proveedoras y presupuestos.

30. Legislación básica de protección de datos: ENTE y RGPD.
...
– 0,235 puntos por mes completo de servicios prestados en la escala técnica básica de laboratorios (Departamento de Traducción) de la Universitat Jaume I o en las escalas equivalentes de las universidades públicas.

– 0,195 puntos por mes completo de servicios prestados en cuerpos o escalas análogas a la escala técnica básica de laboratorios (Departamento de Traducción) en administraciones públicas diferentes a las universidades públicas.
