---
identificador: "BOE-A-2023-22548"
titulo: "Resolución de 25 de octubre de 2023, del Instituto de Mayores y Servicios Sociales, por la que se publica el Convenio con la Comunidad Autónoma de Andalucía, para el desarrollo del Marco de Cooperación Interadministrativa previsto en la Ley 39/2006, de 14 de diciembre, de Promoción de la Autonomía Personal y Atención a las Personas en situación de dependencia y para el establecimiento y financiación del nivel de protección acordado para el ejercicio 2023."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 147519
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2023-22548"
url_pdf: "https://www.boe.es/boe/dias/2023/11/03/pdfs/BOE-A-2023-22548.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2023-22548"
url_eli: ""
fetched_at: "2026-04-11T00:17:49Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 25 de octubre de 2023, del Instituto de Mayores y Servicios Sociales, por la que se publica el Convenio con la Comunidad Autónoma de Andalucía, para el desarrollo del Marco de Cooperación Interadministrativa previsto en la Ley 39/2006, de 14 de diciembre, de Promoción de la Autonomía Personal y Atención a las Personas en situación de dependencia y para el establecimiento y financiación del nivel de protección acordado para el ejercicio 2023.
...
Madrid, 25 de octubre de 2023.–El Director General del Instituto de Mayores y Servicios Sociales, Luis Alberto Barriga Martín.
...
Que, por su parte, la Comunidad Autónoma de Andalucía ha dispuesto, en sus presupuestos correspondientes al año 2023, créditos para la atención a las personas en situación de dependencia en aplicación de lo previsto en el artículo 32 de la Ley 39/2006, de 14 de diciembre.
...
La Comunidad Autónoma de Andalucía aportará, para la financiación del presente convenio, con cargo a sus propios presupuestos, un crédito inicial de ciento setenta y dos millones ciento cuarenta y un mil quinientos treinta y nueve euros con ochenta y un céntimos (172.141.539,81€), con cargo al programa presupuestario 31R: Atención a la dependencia, envejecimiento activo y discapacidad de la sección 1800: Consejería de Inclusión Social, Juventud, familias e Igualdad, y de la sección 1851: Agencia de Servicios Sociales y Dependencia de Andalucía.
...
Y, en prueba de conformidad y para la debida constancia de todo lo convenido, las partes firman el presente convenio digitalmente, tomándose como fecha de formalización del presente documento la fecha del último firmante (24 de octubre de 223).–Por el Instituto de Mayores y Servicios Sociales, el Director General, Luis Alberto Barriga Martín.–Por la Comunidad Autónoma de Andalucía, la Consejera de Inclusión Social, Juventud, Familias e Igualdad, María Dolores López Gabarro.

## ANEXO I. Al Convenio entre la Administración General del Estado y la Comunidad Autónoma Andalucía, para el desarrollo del Marco de Cooperación Interadministrativa previsto en la Ley 39/2006, de 14 de diciembre de Promoción de la Autonomía Personal y Atención a las Personas en situacion de dependencia y para el establecimiento y financiacion del nivel de protección acordado para el ejercicio 2023
...
| Descripción de la medida. | Incremento neto de personas beneficiarias en 2023. |
| --- | --- |
| Línea de base a 1 de enero de 2023. | Personas beneficiarias: 270.632. |
| Impacto esperado sobre la lista de espera para 2023 (desde 1 de enero hasta 31 de diciembre). | Personas beneficiarias: 276.632. Teniendo en cuenta el objetivo de incremento neto de al menos 6.000 personas beneficiarias a final de año. |
| Indicadores de verificación de cumplimiento. | – Incremento neto de al menos 6.000 personas beneficiarias respecto al cierre del año anterior (31/12/2022).
 – Incorporación como altas al sistema de aproximadamente 43.000 personas beneficiarias. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 27.500.000 €. |
| Observaciones. | Son costes estimados. |

| Descripción de la medida. | Mantenimiento del incremento de personas beneficiarias desde 2021. |
| --- | --- |
| Línea de base a 1 de enero de 2023. | Mantenimiento incremento 2021-2023:42.077 personas beneficiarias (31/12/2020:228.555, 31/12/2022: 270.632). |
| Impacto esperado sobre la lista de espera para 2023 (desde 1 de enero hasta 31 de diciembre). | Personas beneficiarias: 276.632. Teniendo en cuenta el objetivo de incremento neto de al menos 6.000 personas beneficiarias a final de año. |
| Indicadores de verificación de cumplimiento. | Mantenimiento como altas al sistema de aproximadamente 43.000 personas beneficiarias. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 214.343.180 €. |
| Observaciones. | Son costes estimados. |

| Descripción de la medida. | Tramitación normativa de proyecto de Decreto que regule el nuevo procedimiento de reconocimiento de la situación de dependencia y del derecho a las prestaciones, así como de la gestión de los procedimientos de revisión con el objeto de simplificar los trámites. |
| --- | --- |
| Línea de base a 1 de enero de 2023. | Procedimiento actual del reconocimiento de situación de dependencia y reconocimiento de servicios y prestaciones en dos fases (Grado – PIA). |
| Impacto esperado sobre la lista de espera para 2023 (desde 1 de enero hasta 31 de diciembre). | Unificar el procedimiento de reconocimiento de situación de dependencia y reconocimiento de servicios y prestaciones en una única fase, simplificar la gestión de revisión de la prestación lo que impactará reduciendo los tiempos de tramitación. |
| Indicadores de verificación de cumplimiento. | Avanzado estado de tramitación, se han recibido los correspondientes informes preceptivos. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | Sin impacto económico. |
| Observaciones. |  |

| Descripción de la medida. | Atendiendo a la modificación del actual decreto regulador del procedimiento de dependencia, es necesaria la adaptación de los sistemas de información vigentes a los nuevos desarrollos normativos. |
| --- | --- |
| Línea de base a 1 de enero de 2023. | Fase I: Actualización de la Ventanilla Electrónica de Dependencia (VED) y del Módulo de Solicitudes a la modificación del actual decreto regulador del procedimiento de dependencia. |
| Impacto esperado sobre la lista de espera para 2023 (desde 1 de enero hasta 31 de diciembre). | Esta fase I permitiría la tramitación completa del procedimiento inicial cuando se trate de una prestación de servicio. |
| Indicadores de verificación de cumplimiento. | Adaptación de sistemas a la normativa publicada. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 534.234 €. |
| Observaciones. | Son costes estimados. |

| Descripción de la medida. | Incrementar el volumen de expedientes gestionados. |
| --- | --- |
| Línea de base a 1 de enero de 2023. | Expedientes pendientes de programa individual de atención: 36.606. |
| Impacto esperado sobre la lista de espera para 2023 (desde 1 de enero hasta 31 de diciembre). | Reducir la lista de espera. |
| Indicadores de verificación de cumplimiento. | Aprobación por parte del Consejo de Gobierno y distribución a las Entidades Locales. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 11.000.941 €. |
| Observaciones. | Son costes estimados. |
...
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 5.682.957€, |
| Observaciones. | Son costes estimados. |

| Descripción de la medida. | Incrementar plazas y reducir lista de demanda de centros residenciales y centros de días. |
| --- | --- |
| Situación a 1 de enero de 2023. | Mejorar la oferta pública de plazas así como la adecuación de la oferta a las necesidades territoriales. |
| Impacto esperado para 2023 (hasta 31 de diciembre de 2023). | Mejora en la calidad de los servicios y reducir lista de demanda en el acceso al servicio de atención residencial y centro de día. |
| Indicadores de verificación de cumplimiento. | N.º de plazas a incrementar según tipología:
 1500 plazas para el servicio de atención residencial mayores.
 300 plazas para el servicio de atención residencial para personas con discapacidad.
 140 plazas para el servicio de centro de día para personas con discapacidad.
 30 plazas centros de día discapacidad con terapia ocupacional. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 2.500.000 €. |
| Observaciones. | Son costes estimados. |
...
| Descripción de la medida. | Modificación de las cuantías máximas y mínimas de las prestaciones económicas a todas las personas beneficiarias y nuevas incorporaciones y adaptación de los sistemas de información correspondientes. |
| --- | --- |
| Situación a 1 de enero de 2023. | Lo establecido en el Real Decreto 1051/2013, de 27 de diciembre, por el que se regulan las prestaciones del Sistema para la Autonomía y Atención a la Dependencia. |
| Impacto esperado para 2023 (hasta 31 de diciembre de 2023). | Mejora en la calidad de los servicios. |
| Indicadores de verificación de cumplimiento. | Adaptación de las medidas y de los sistemas correspondientes. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 15.000.000 €. |
| Observaciones. | Son costes estimados. |

| Descripción de la medida. | Aplicación de la nueva intensidad horaria a las nuevas incorporaciones al SAAD a partir de la entrada en vigor del Real Decreto 675/2023 de 18 de julio), así como la adaptación de los sistemas de información afectados. |
| --- | --- |
| Situación a 1 de enero de 2023. | Lo establecido en el Real Decreto 1051/2013, de 27 de diciembre, por el que se regulan las prestaciones del Sistema para la Autonomía y Atención a la Dependencia. |
| Impacto esperado para 2023 (hasta 31 de diciembre de 2023). | Mejora en la calidad de los servicios |
| Indicadores de verificación de cumplimiento. | Aplicación de las medidas y de los sistemas correspondientes |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 5.000.000 € |
| Observaciones. | Son costes estimados |
...
| Descripción de la medida. | Mejora de las condiciones de financiación de servicios a través de centros concertados de atención residencial y de centros de día. Incremento del 4,5% en el sector de personas mayores y en el sector de personas con discapacidad |
| --- | --- |
| Situación a 1 de enero de 2023. | Lo establecido en la Resolución de 1 de junio de 2022, de la Agencia de Servicios Sociales y Dependencia de Andalucía, por la que se revisan los costes máximos de las plazas objeto de concertación con centros de atención a personas mayores y personas con discapacidad en situación de dependencia. |
| Impacto esperado para 2023 (hasta 31 de diciembre de 2023). | Mejora en la calidad de los servicios y las condiciones laborales de las personas trabajadoras del SAAD. |
| Indicadores de verificación de cumplimiento. | Resolución de revisión costes máximo plazas publicadas en BOJA |
| Determinación de costes previstos en 2022 derivados directamente de la medida/actuación. | 31.530.632€ |
| Observaciones. |  |
...
Y para que así conste, se expide el presente certificado en ................., ......... de ....... de 2024.
