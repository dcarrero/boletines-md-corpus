---
identificador: "BOE-A-2023-1596"
titulo: "Resolución de 10 de enero de 2023, del Consejo de Seguridad Nuclear, por la que se publica el Convenio de colaboración con IDOM Consulting, Engineering and Architecture, SAU, para participar en el Programa Internacional \"Code Applications and Maintenance Program\"."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 7657
pagina_final: 7666
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2023-1596"
url_pdf: "https://www.boe.es/boe/dias/2023/01/19/pdfs/BOE-A-2023-1596.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2023-1596"
url_eli: ""
fetched_at: "2026-04-10T09:10:41Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 10 de enero de 2023, del Consejo de Seguridad Nuclear, por la que se publica el Convenio de colaboración con IDOM Consulting, Engineering and Architecture, SAU, para participar en el Programa Internacional "Code Applications and Maintenance Program".

El Presidente del Consejo de Seguridad Nuclear y el Director del Área Técnica de Servicios Nucleares de la Compañía IDOM Consulting, Engineering and Architecture, SAU, han suscrito, con fecha 9 de enero de 2023, un Convenio para participar en el Programa Internacional «Code Applications and Maintenance Program (CAMP)».

Para general conocimiento, y en cumplimiento de lo establecido en el artículo 48.8 de la Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público, dispongo la publicación en el «Boletín Oficial del Estado» del referido Convenio, como anejo a la presente resolución.

Madrid, 10 de enero de 2023.–El Presidente del Consejo de Seguridad Nuclear, Juan Carlos Lentijo Lentijo.

## ANEJO. Convenio de colaboración entre el Consejo de Seguridad Nuclear y la Compañía Idom Consulting, Engineering and Architecture, SAU, para participar en el Programa Internacional «Code Applications and Maintenance Program (CAMP)»
...
De otra parte, don Óscar Larrosa Peruga, en nombre y representación como Director del Área Técnica de Servicios Nucleares de IDOM Consulting, Engineering and Architecture, SAU (en adelante IDOM), con sede en avenida Zarandoa, 23, 48015 Bilbao, Bizkaia.
...
Que la empresa IDOM dispone de una amplia experiencia en la utilización de códigos termohidráulicos en el campo de la seguridad nuclear, entre otros, por lo que tiene interés en el acceso a los códigos desarrollados por la USNRC.

## Quinto.

Que el CSN e IDOM (en adelante las partes) han colaborado en el pasado para el desarrollo de diversos proyectos de investigación, dedicados a la protección del público y del medio ambiente. En particular, la empresa IDOM ha colaborado durante los períodos 2016 a 2017 y 2018 a 2022 en el programa CAMP de la USNRC, dentro del proyecto nacional asociado CAMP-España.

## Sexto.

Que, a la vista de los excelentes resultados obtenidos hasta ahora, las partes consideran conveniente continuar realizando actividades conjuntas de colaboración en el programa CAMP, lo que resulta beneficioso para el cumplimiento de los objetivos establecidos para el mismo, y en particular, para reforzar y complementar la participación española en el programa.
...
El objetivo general de este convenio es la realización del proyecto titulado «Colaboración CSN-IDOM para la participación en el Programa Internacional Code Applications and Maintenance Program (CAMP) de la USNRC».
...
– Facilitar la participación de expertos representantes de IDOM en los grupos y reuniones que se constituyan o celebren dentro del programa CAMP, incluidas las reuniones del Comité Técnico del programa CAMP que se describe en el acuerdo bilateral que se incluye como anexo 3.

– Proporcionar a IDOM acceso al código TRACE (incluido el código PARCS), el código RELAP5 y la interfase gráfica SNAP, y toda la documentación asociada a los mismos, así como cualquier actualización de los códigos o de la documentación que la USNRC realice durante la vigencia de este convenio.

Son obligaciones de IDOM dentro de este convenio:
...
La contribución económica de IDOM a la financiación del convenio se establece en un total de diez mil euros (10.000 €).

Esta cantidad se pagará al CSN en cuatro plazos de 2.500 euros cada uno, el primero de ellos a la firma del convenio, y los siguientes en los meses de septiembre de los años 2023, 2024 y 2025.
...
Por IDOM: Don Patricio Andrés Alberto.

## Sexta. Organización.

A la fecha de la firma de este convenio, IDOM se incorpora también a la estructura nacional de participación en el programa CAMP de la NRC denominada CAMP-España. Esta estructura tiene un órgano de gestión denominado Comité de Coordinación del proyecto que reúne dos veces al año a representantes de cada una de las organizaciones nacionales que colaboran con el CSN en el programa CAMP.
...
IDOM nombrará a un representante en el citado Comité de Coordinación de CAMP-España.
...
IDOM entregará al CSN un informe de los resultados obtenidos hasta el momento de la interrupción, pudiendo utilizar libremente dichos resultados, siempre que se salvaguarden las condiciones estipuladas en las cláusulas séptima y octava.

Habiendo leído el presente por sí mismos y hallándose conformes, lo firman en Madrid a 9 de enero de 2023.–Por el Consejo de Seguridad Nuclear, el Presidente, Juan Carlos Lentijo Lentijo.–Por IDOM Consulting, Engineering and Architecture, SAU, el Director del Área de Servicios Nucleares, Óscar Larrosa Peruga.

## ANEXO 1. Memoria técnica del «Convenio de Colaboración entre el Consejo de Seguridad Nuclear y la Compañía Idom Consulting, Engineering and Architecture, SAU, para participar en el Programa Internacional CAMP»
...
La empresa IDOM Consulting, Engineering and Architecture, SAU, (IDOM) ha estado involucrada en CAMP-España durante los períodos 2016 a 2017 y 2018 a 2022.

Se ha recibido en el área MOSI (STN) del CSN, como coordinadores nacionales en el programa CAMP de la USNRC y del nacional asociado CAMP-España, solicitud de renovación del acuerdo vigente CSN-IDOM para la colaboración en el programa CAMP-España.
...
3. Programa coordinado para la participación de IDOM Ingeniería y Consultoría SAU, en el Programa Internacional CAMP

IDOM Ingeniería y Consultoría, SAU, (IDOM) ha manifestado su interés en dar continuidad a su participación en la estructura de CAMP-España con un grado de dedicación y esfuerzos técnicos y económicos equivalentes a los establecidos en el convenio anterior.

Por todo ello, y con todos los antecedentes descritos, se propone la formalización del convenio de colaboración con la empresa IDOM con el objetivo fundamental de colaborar con el CSN en el programa internacional CAMP. Dicha propuesta está en línea con el firmado con otras compañías de ingeniería españolas con igual propósito.

El equipo de IDOM participante en esta propuesta es un grupo con amplia experiencia en proyectos similares, y con estructura y capacidad de gestión para la realización de las actividades y tareas previstas, con los objetivos que se detallan en los puntos siguientes.

3.1 Objetivos principales.

Los objetivos generales ligados a los de los programas internacionales son:

1. Dar cobertura al acceso de IDOM a las nuevas versiones de los códigos TRACE y RELAP5, y de sus códigos auxiliares PARCS y SNAP.
...
IDOM nombrará a un representante en este Comité de Coordinación de CAMP-España.
...
## ANEXO 2. Memoria económica del «Convenio de colaboración entre el Consejo de Seguridad Nuclear y la Compañía Idom Consulting, Engineering and Architecture, SAU, para participar en el Programa Internacional CAMP»
...
– Responsable: Patricio Andrés Alberto.

– Equipo Investigación:

Gilberto Villescas Díaz.

Carlos Diego Quispe Bocal.

Jorge Fradera Fernández.

Rafael Bocanegra Melián.

Gerald Cano de la Casa.

El equipo de IDOM participante en esta propuesta es un grupo con amplia experiencia en proyectos similares anteriores, y con estructura y capacidad de gestión para la realización de las actividades y tareas previstas.

2. Vigencia y programa de pagos

La duración del convenio se extiende hasta la fecha de vencimiento del acuerdo CAMP actual entre el CSN y la USNRC.
...
Este acuerdo conlleva, entre otros, el compromiso por parte de IDOM del pago anual al CSN de dos mil quinientos euros (2.500,00 €), lo que supone un total de diez mil euros (10.000,00 €) por los años 2022 a 2026 de vigencia, en concepto de ayuda al pago de la cuota que el CSN abona a la USNRC por participar en CAMP.
