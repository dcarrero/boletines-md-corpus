---
identificador: "BOE-A-2020-17326"
titulo: "Resolución de 22 de diciembre de 2020, de la Subsecretaría, por la que se publica el Convenio entre la Universidad Nacional de Educación a Distancia y el Instituto Nacional de Administración Pública, para la realización de los procesos selectivos para ingreso por el sistema general de acceso libre y promoción interna, en el Cuerpo Superior de Sistemas y Tecnologías de la Información de la Administración del Estado, y para acceso por promoción interna, para personal funcionario y personal laboral fijo, y para la estabilización del empleo temporal, en la Escala Técnica de Gestión de Organismos Autónomos."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 125835
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2020-17326"
url_pdf: "https://www.boe.es/boe/dias/2020/12/30/pdfs/BOE-A-2020-17326.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2020-17326"
url_eli: ""
fetched_at: "2026-04-16T04:48:11Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 22 de diciembre de 2020, de la Subsecretaría, por la que se publica el Convenio entre la Universidad Nacional de Educación a Distancia y el Instituto Nacional de Administración Pública, para la realización de los procesos selectivos para ingreso por el sistema general de acceso libre y promoción interna, en el Cuerpo Superior de Sistemas y Tecnologías de la Información de la Administración del Estado, y para acceso por promoción interna, para personal funcionario y personal laboral fijo, y para la estabilización del empleo temporal, en la Escala Técnica de Gestión de Organismos Autónomos.

El Rector de la Universidad Nacional de Educación a Distancia y el Director del Instituto Nacional de Administración Pública, han suscrito un Convenio para la realización de los procesos selectivos para ingreso libre y acceso por promoción interna en el Cuerpo Superior de Sistemas y Tecnologías de la Información de la Administración del Estado; y para acceso por promoción interna, para personal funcionario y personal laboral fijo, y para la estabilización del empleo temporal, en la Escala Técnica de Gestión de Organismos Autónomos.
...
## ANEJO. Convenio entre la Universidad Nacional de Educación a Distancia y el Instituto Nacional de Administración Pública para la realización de los procesos selectivos para ingreso libre y acceso por promoción interna en el Cuerpo Superior de Sistemas y Tecnologías de la Información de la Administración del Estado; y para acceso por promoción interna, para personal funcionario y personal laboral fijo, y para la estabilización del empleo temporal, en la Escala Técnica de Gestión de Organismos Autónomos
...
El presente Convenio se aplica a los siguientes procesos selectivos:

– Proceso selectivo convocado mediante Resolución de 29 de julio de 2020, de la Secretaría General de Función Pública, por la que se convocan procesos selectivos para acceso por promoción interna, para personal funcionario y personal laboral fijo, y para la estabilización del empleo temporal, en la Escala Técnica de Gestión de Organismos Autónomos.

El presente Convenio incluye la celebración del primer ejercicio, que tiene un tiempo máximo para la realización de una hora, sin perjuicio del tiempo adicional que pueda corresponder a las personas con discapacidad.

– Proceso selectivo convocado mediante Resolución de 30 de julio de 2020, de la Secretaría General de Función Pública, por la que se convoca el proceso selectivo para ingreso, por el sistema general de acceso libre y promoción interna, en el Cuerpo Superior de Sistemas y Tecnologías de la Información de la Administración del Estado.

El presente Convenio incluye la celebración de los tres primeros ejercicios, cuya descripción es la siguiente:

– Primer ejercicio: tiene un tiempo máximo para la realización de 120 minutos, sin perjuicio del tiempo adicional que pueda corresponder a las personas con discapacidad. Los enunciados y hojas de respuesta de este primer ejercicio serán proporcionados por el Tribunal calificador.

– Segundo ejercicio: la prueba consistiría en un ejercicio de un máximo de 200 preguntas y de 120 minutos de duración, sin perjuicio del tiempo adicional que pueda corresponder a las personas con discapacidad, y constará de las siguientes partes:

a) Parte de *listening*: la duración total de esta parte será de 45 minutos.

b) Parte de *reading*: La duración de esta parte será de 75 minutos.

Los enunciados y hojas de respuesta de este segundo ejercicio serán proporcionados por el Tribunal calificador.

– Tercer ejercicio: consistirá en la resolución por escrito, durante un período máximo de cuatro horas de un supuesto práctico, sin perjuicio del tiempo adicional que pueda corresponder a las personas con discapacidad.

El ejercicio deberá ser leído íntegramente por el aspirante en sesión pública ante el Tribunal.

Para el desarrollo de este ejercicio se utilizará la valija virtual de la UNED para la impresión, escaneo y, en su caso, las lecturas en sesión pública a través del servicio de videoconferencia.
...
Los Tribunales calificadores de los procesos selectivos comunicarán con antelación suficiente las fechas, sedes y aulas concretas de celebración de los ejercicios, así como el número de aspirantes convocados en cada una de ellas.
...
El importe total del Convenio en ningún caso podrá exceder de doscientos catorce mil ciento cincuenta euros (214.150,00 €), sin perjuicio de lo establecido en la cláusula Novena de este Convenio.
...
| --- | --- |
| 2020 | 75.800,00 euros. |
| 2021 | 138.350,00 euros. |
| Total. | 214.150,00 euros. |

La distribución por anualidades se detalla en anexo a este Convenio.
...
## ANEXO. Distribución presupuestaria por anualidades

|  | 2020 | 2021 |  |
| --- | --- | --- | --- |
|  | Primer ejercicio TIC + ETGOA
 –
 Euros | Segundo ejercicio TIC
 –
 Euros | Tercer ejercicio TIC
 –
 Euros |
| Tecnología. | 18.500,00 | 2.000,00 | 2.000,00 |
| Centros de examen. | 63.550,00 | 63.550,00 | 63.550,00 |
| AVIP (lecturas, servicio cloud y soporte videoconferencias). | – | – | 6.500,00 |
| Subtotal Tecnología. | 18.500,00 | 2.000,00 | 8.500,00 |
| Personal colaborador adicional. | 3.000,00 | 1.500,00 | 4.500,00 |
| Bonificación Tecnología (50 %). | –9.250,00 | –1.000,00 | –4.250,00 |
| Total por ejercicio. | 75.800,00 | 66.050,00 | 72.300,00 |
| Total por anualidades. | 75.800,00 | 138.350,00 |  |
| Total general. | 214.150,00 |  |  |
