...
pagina_final: 120885
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2020-17040"
url_pdf: "https://www.boe.es/boe/dias/2020/12/26/pdfs/BOE-A-2020-17040.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2020-17040"
url_eli: "https://www.boe.es/eli/es/res/2020/12/16/(3)"
fetched_at: "2026-04-16T04:29:43Z"
...
3.4.1 Facturación de potencia. Se tomará como la potencia contratada en cada periodo horario,Pc~p,~ la correspondiente al punto de conexión conforme al punto 3.1.

3.4.2 Facturación de energía. Se tomará como energía a facturar en cada periodo horario, E~p,~ el balance horario de la instalación de generación en cada periodo p, que se calculará como:

[imagen]

Donde:

E~p~: Energía consumida en el período horario p, expresada en kWh. En el caso que E~p~sea menor de cero se tomará el valor cero.

AE~i,h~: Energía activa entrante en la hora h a través del punto frontera i de la instalación de producción.

AS~i,h~: Energía activa saliente en la hora h a través del punto frontera i de la instalación de producción.
...
Los valores horarios de AE~i,h~ y AS~i,h~ serán los mismos que se utilicen para la liquidación de energía en el mercado de producción de energía eléctrica.

3.4.3 Facturación por potencia demandada. A los efectos de facturación por potencia demandada, se tomará como Pd~j~, la siguiente potencia demandada:

[imagen]

Donde:

Pd~j~: Potencia demandada en cada uno de los cuartos de hora j del período horario p en que se haya sobrepasado Pc~p~, expresada en kW. En el caso de que el equipo de medida no disponga de capacidad de registro cuartohoraria en todas las conexiones, se considerará la misma potencia demandada en todos los cuartos de hora.

AE~i,j~: Energía activa entrante en el cuarto de hora j a través del punto frontera i de la instalación de producción multiplicado por 4.

AS~i,j~: Energía activa saliente en el cuarto de hora j a través del punto frontera i de la instalación de producción multiplicado por 4.
