...
pagina_inicial: 3985
pagina_final: 3993
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2020-614"
url_pdf: "https://www.boe.es/boe/dias/2020/01/16/pdfs/BOE-A-2020-614.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2020-614"
url_eli: "https://www.boe.es/eli/es/cir/2020/01/09/1"
fetched_at: "2026-04-15T09:37:24Z"
...
En particular, en cuando a los principios de necesidad y eficiencia, esta circular está justificada por una razón de interés general, se basa en una identificación clara de los fines perseguidos y es el instrumento más adecuado para garantizar su consecución.
...
[imagen]: Retribución total del gestor técnico del sistema en el año *n*.

[imagen]: Base de retribución del gestor técnico del sistema en el año *n*. Será aquella del periodo regulatorio *p* al que el año *n* pertenezca.

[imagen]: Retribución por incentivos del gestor técnico del sistema en el año *n*.
...
[imagen]: Base de retribución del gestor técnico del sistema del periodo regulatorio *p.*

[imagen]: Término de retribución por OPEX incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio *p*.

[imagen]: Margen sobre el término de retribución por OPEX incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio *p.*

[imagen]: Término de amortización estándar incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio*p.*

[imagen]: Término de retribución financiera estándar incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio *p.*
...
1. El margen sobre el término de retribución por OPEX [imagen] incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio *p,* se calculará a partir de la siguiente fórmula:
...
1. El término de retribución financiera estándar [imagen] incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio *p* se calculará a partir de la fórmula siguiente:

[imagen]

Donde:

[imagen]: Inmovilizado neto estándar incluido en la base de retribución del gestor técnico del sistema del periodo regulatorio *p.*

*Tasa de retribución*[imagen]: Tasa de retribución financiera, en porcentaje (%) con 2 decimales. Tomará el valor de la tasa de retribución financiera de las actividades de transporte y regasificación de gas natural que se establezca en los años que se correspondan con el periodo regulatorio *p,* en la Circular 2/2019, de 12 de noviembre*,*de la Comisión Nacional de los Mercados y la Competencia, por la que se establece la metodología de cálculo de la tasa de retribución financiera de las actividades de transporte y distribución de energía eléctrica, y regasificación, transporte y distribución de gas natural.
...
6. En el supuesto excepcional de que el operador del sistema incurra en costes durante el periodo regulatorio *p* por nuevas obligaciones regulatorias imprevistas, que superen el saldo de la cuenta regulatoria del periodo *p*, estos costes podrán incorporarse a la cuenta regulatoria del periodo siguiente *(p+1),* siempre que estén debidamente justificados.
...
Para este período regulatorio, los valores de los parámetros de la base de retribución del operador del sistema serán los siguientes:

1. [imagen]: 25.007 miles €.

2*. [imagen]*: 14.904 miles €.

3*. [imagen]*: 745 miles €.

4*. [imagen]:*8.650 miles €.

5*. [imagen]*: 708 miles €.

6*. [imagen]*: 13.008 miles €.
