...
pagina_final: 93065
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2020-13115"
url_pdf: "https://www.boe.es/boe/dias/2020/10/29/pdfs/BOE-A-2020-13115.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2020-13115"
url_eli: "https://www.boe.es/eli/es/rd/2020/10/27/929"
fetched_at: "2026-04-16T00:09:24Z"
...
i) Velocidad máxima permitida del tren a la altura del paso a nivel o intersección (V~m~), en km/h.

j) Número de vías existentes en el paso a nivel o intersección (n).

k) Visibilidad técnica (D~tv~, D~tp~) y real (D~rv~, D~rp~) asociadas a cada uso específico, según se define en el Anexo VII. En pasos a nivel o intersecciones con más de un uso específico se podrá suponer que D~rp~ = D~rv~.
...
a) Cuando el nivel global de seguridad del subsistema de que se trate pueda verse afectado por las obras previstas;
...
b) el nivel global de seguridad del vehículo de que se trate pudiera verse afectado por los trabajos previstos, o
...
| Uso específico | Velocidad máxima del tren en el paso a nivel (km/h) | Ubicación | A x T | A | Visibilidad real (D~rv~) | Clase de protección mínima(^4^) (^5^) |
| --- | --- | --- | --- | --- | --- | --- |
| Vehículos | ≤ 40 |  |  |  | ≥ D~tv.~
 (Suficiente) | P |
|  | < D~tv.~
 (Insuficiente) | A2 (^1^) |  |  |  |  |
| 40 < V~m~ < 160 | Plena Vía | < 1000 |  | ≥ D~tv.~
 (Suficiente) | P |  |
|  | < D~tv.~
 (Insuficiente) | A2 (^1^) |  |  |  |  |
| 1000 ≤ AxT < 1500 | < 100 |  |  |  |  |  |
...
| Uso específico | Velocidad máxima del tren en el paso a nivel (km/h) | Ubicación | Visibilidad real (D~rp~) | P x T | P | Clase de protección mínima(^4^) (^5^) |
| --- | --- | --- | --- | --- | --- | --- |
| Peatones, con o sin ganado (^2^) | ≤ 40 |  | ≥ D~tp.~
 (Suficiente) |  |  | P |
| < D~tp.~
 (Insuficiente) |  |  | A2 |  |  |  |
| 40 < V~m~ < 160 | Plena Vía | ≥ D~tp.~
 (Suficiente) | < 1000 | < 100 | P |  |
| ≥ 100 | P (^3^) |  |  |  |  |  |
| ≥ 1000 | < 100 | P |  |  |  |  |
| ≥ 100 | A2 |  |  |  |  |  |
| < D~tp.~
...
| Señalización horizontal y vertical definida en la normativa estatal de carreteras (*) para los pasos a nivel sin barreras.
 ...
 En pasos situados en núcleos urbanos, la señalización a colocar se adaptará a las características urbanas de las calles o viales y, en general, se colocará sobre cualquier itinerario que confluya en el entorno del paso a nivel. | P y A2 |
| Señalización horizontal y vertical definida en la normativa estatal de carreteras (*) para los pasos a nivel con barreras.
 En pasos situados en núcleos urbanos, la señalización a colocar se adaptará a las características urbanas de las calles o viales y, en general, se colocará sobre cualquier itinerario que confluya en el entorno del paso a nivel. | A3 y A4 |
...
| Señal acústica, integrada en la señalización luminosa del margen derecho de la carretera o camino. Comienza a sonar simultáneamente con la activación de aquella y cesa al concluir:
 ...
 En casos debidamente justificados por las condiciones del entorno, podrá reducirse el nivel acústico de dicha señal. | A2, A3 y A4 |
| Semibarreras o barreras móviles, para cortar el acceso de los vehículos desde la carretera a las vías del ferrocarril. Las semibarreras podrán ser simples (de entrada) o dobles (de entrada y de salida), en función de que corten la mitad derecha de la calzada o su totalidad.
 ...
 Los pasos con clase de protección A4 dispondrán siempre de barreras completas o semibarreras dobles. | A3 y A4 |
...
| Señal P-11 (Situación de un paso a nivel sin barreras) o P-11a (Situación de un paso a nivel sin barreras de más de una vía férrea), definidas en el art. 149.5 del RGC ^1^, dependiendo de que exista una o más vías férreas.
 Se colocará en el margen derecho de la carretera y, en su caso, adosada al mástil de la señalización luminosa. | P, A2 |
| Señal R-100 (Circulación prohibida).
 Esta señal se colocará únicamente cuando sea posible el acceso de vehículos a motor al paso a nivel. (El acceso no debería ser posible con elementos de ralentizado) | P, A2 |
| Cartel con la leyenda «ATENCIÓN AL TREN. PASO EXCLUSIVO DE PEATONES».
 Se colocará sobre el mismo poste de la señal P-11 o P-11a. | P (solo peatones) |
| Cartel con la leyenda «ATENCIÓN AL TREN. PASO EXCLUSIVO DE PEATONES Y GANADO».
 Se colocará sobre el mismo poste de la señal P-11 o P-11a. | P (peatones y ganado) |
| Cartel con la leyenda «ATENCIÓN AL SEMÁFORO. PASO EXCLUSIVO DE PEATONES».
 Se colocará sobre el mismo poste de la señal P-11 o P-11a. | A2 |
...
| Señal luminosa representando un pictograma de silueta humana en posición de espera, en rojo fijo, y la leyenda «ATENCIÓN NO PASE», en rojo a destellos.
 ...
 La falta de indicación de una de las señales peatonales instaladas, llevará a la SPN a su indicación más restrictiva («Paso a nivel sin protección»). | A2 |
...
Con la aproximación anterior de, la *D*~tp~ estimada sería:
...
| Cruce Nuevo o Existente | Velocidad máxima del tren en el cruce (km/h) | Visibilidad real (D~rp~) | T’ (^1^) | Clase de protección mínima |
| --- | --- | --- | --- | --- |
| Nuevo | ≤ 40 | ≥ D~tp.~
 (Visibilidad suficiente) |  | Clase 2 |
| Existente | < 160 | < 8 | Clase 1 |  |
| ≥ 8 | Clase 2 |  |  |  |
| Nuevo | ≤ 40 | < D~tp~.
 (Visibilidad insuficiente) |  | Cruce a distinto nivel |
...
| Equipamiento en los andenes de ambos lados del cruce | Clase
 de
 protección |
| --- | --- |
