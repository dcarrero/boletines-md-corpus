---
identificador: "BOE-A-2025-21156"
titulo: "Resolución de 2 de octubre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Gestión de Informática."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 137446
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-21156"
url_pdf: "https://www.boe.es/boe/dias/2025/10/21/pdfs/BOE-A-2025-21156.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-21156"
url_eli: ""
fetched_at: "2026-04-09T15:18:03Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 2 de octubre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Gestión de Informática.
...
f) No poseer la condición de personal funcionario de carrera de la Escala de Gestión de Informática de la Universidad de Granada.
...
Granada, 2 de octubre de 2025.–El Rector, Pedro Mercado Pacheco.
...
1. Redes de ordenadores. Clasificación por topología, tecnología y servicio. Modelo de referencia OSI. Conceptos generales sobre transmisión de datos. Sistemas de Cableado estructurado: Estructura y diseño. Medios físicos. Certificación (procedimientos, normativa y equipamiento). Protocolos Ethernet y TCP/IP. Características, estructura y conceptos. IPv4 e Ipv6. Mecanismos de transición. Internet: estructura y organización.

2. Seguridad en redes. Control de acceso a la red. Protección perimetral de la red. Servicios de Balanceo (comunicaciones, servidores, aplicaciones). Monitorización de la seguridad en redes.

3. Redes de área local y extensa: Elementos, arquitectura, protocolos y gestión (control y monitorización). SDN. Redes privadas virtuales: Protocolos de interconexión para servicios LAN. Servicios de acceso remoto.

4. Redes inalámbricas. Arquitectura, protocolos, seguridad, diseño, despliegue y monitorización. Servicios de conectividad federados (Eduroam y govroam). IoT.

5. Despliegue de sistemas operativos y aplicaciones. Opengnsys. Microsoft EndPoint Configuration Manager. Cloudpaging.

6. Sistemas de Almacenamiento de Altas Prestaciones. Arquitecturas y protocolos en red: SAN, NAS, FC. Equipamiento tolerante a fallos. Multipath. Gestión del almacenamiento: RAID Groups, Volúmenes, LUNs. Modelos de Replicación, Snapshot. Virtualización del almacenamiento. Monitorización.

7. Modelos de Virtualización de Sistemas y Escritorios. Arquitecturas escalables en alta disponibilidad. Despliegue de granjas de Servidores virtualizados. Monitorización y Reasignación de recursos en hipervisores. Plataformas de virtualización: Vmware, Promox.

8. Administración General de Sistemas Operativos LINUX. Sistemas de archivos Ext4, XFS. Sistema de archivos en red NFS. Administración Avanzada de Sistemas Operativos LINUX en modelos tolerantes a fallos: Cluster, alta disponibilidad, balanceo de carga. Ajuste y Optimización de Sistemas LINUX: Herramientas internas de Monitorización del sistema.

9. Administración General de Sistemas Windows. Configuración y Gestión del Sistema: Servicios, Red, Almacenamiento, Usuarios. Directivas de seguridad, de grupo, dominios.
...
11. Servicio de directorio Corporativo LDAP. Esquemas de Datos. Arquitecturas en alta disponibilidad. Configuración, Control de acceso y seguridad de datos. Active Directory de Microsoft.

12. Servicios y Arquitecturas de Alta Computación: High Performance Computing (HPC), Big Data, Cloud Computing.

13. Tecnologías de autenticación y la gestión de acceso federado: Agentes, Protocolos e implementaciones (SAML, Shibboleth), Plataformas (IdP, SP, WAYF). Federación SIR2. Administración de soluciones basados en SAML.

14. Servicios de Mensajería. Protocolos. RFCs. Agentes y configuraciones en un modelo de mensajería institucional. Arquitecturas Escalables y en Alta Disponibilidad. Administración y monitorización de servidores de mensajería basados en Postfix. Seguridad.

15. Servicios Web. Protocolos. Arquitecturas Escalables y en Alta Disponibilidad. Administración de servidores web basados en Apache. Herramientas de administración y monitorización.

16. Administración de servidores basados en Tomcat y Weblogic: módulos básicos, configuración y parametrización, Monitorización y optimización. Operación en entornos DevOps.

17. Servicios Cloud. IaaS, PaaS, SaaS. Nubes privadas, públicas e híbridas. Contenedores: Docker y Kubernetes. Servicios de almacenamiento de archivos en nube privada. Diseño y despliegue de arquitecturas escalables. Seguridad en Cloud.

18. Bases de datos. Nivel conceptual, lógico y físico. Conceptos básicos de integridad, seguridad e independencia. Administración, estructura y arquitectura del SGBD Oracle. Arquitecturas de conexión a las Bases de Datos. El diccionario de datos e instrumentos de consulta.

19. Datawarehouse, Datamarts y minería de datos. Diccionarios de recursos de información. Metadatos. Repositorios. Bancos de datos.

20. Sistemas LMS: Moodle en entornos de alta concurrencia. Análisis y diseño de la arquitectura. Administración y configuración de la plataforma.

Módulo de Desarrollo

21. Metodologías y Modelos de desarrollo. Modelos de desarrollo ágiles. SCRUM. Desarrollo en entornos DevOps. Herramientas de control de versiones.

22. Herramientas de desarrollo de aplicaciones de gestión: Oracle Forms and ReportsOracle Fussion Middelware 11g/12.

23. Diseño de bases de datos. Bases de datos relacionales. El modelo Entidad/ Relación (E/R), Programación en Oracle. SQL y PL/SQL.

24. Diseño de aplicaciones Java. Frameworks de desarrollo. Jakarta EE y Spring.

25. Diseño de interfaces web dinámicas. Aplicaciones multiplatorma y multidispositivo. Frameworks de desarrollo web Javascript.

26. Construcción y diseño de la experiencia de usuario: Sistemas de plantillas: Thymeleaf. Bootstrap. Accesibilidad diseño universal y usabilidad.

27. Arquitecturas orientadas a la Interoperabilidad. Servicios web. Estándares y protocolos asociados. Seguridad.

28. Intercambio de información con lenguajes de marcas. XML y JSON. Objetos de datos Oracle XMLType.

29. Administración electrónica. Sede electrónica. Características, requisitos y componentes técnicos basados en las Leyes 11/2007, 39/2015 y 40/2015. Políticas de identidad de gestión de documentos electrónicos y de firma electrónica. Estándares de gestión de documentos y expedientes electrónicos. Accesibilidad y transparencia.

30. Arquitecturas de software en Java y metodologías relacionadas. Buenas prácticas en programación. Herramientas de garantía de la calidad del software: SonarQube.
...
Primer ejercicio: Tendrá carácter eliminatorio y consistirá en contestar un cuestionario de 100 preguntas, con cuatro respuestas alternativas, de las que solo una será correcta, basado en el contenido del programa que figura como anexo I de esta convocatoria. Para la realización de este ejercicio las personas aspirantes dispondrán de 100 minutos.
...
Segundo ejercicio: Tendrá carácter eliminatorio y consistirá en la realización de dos supuestos prácticos a elegir de entre, al menos, cuatro propuestos por el Tribunal, que contendrán cuestiones relacionadas con aspectos prácticos del bloque específico del programa que figura como anexo I de esta convocatoria.
...
1. Servicios prestados como personal funcionario en la misma Escala objeto de esta convocatoria o como personal laboral en la categoría laboral equivalente de la Universidad de Granada: 0,40/30 puntos por día de servicios.

2. Servicios prestados como personal funcionario en los Cuerpos o Escalas equivalentes a la Escala objeto de esta convocatoria en otras Universidades públicas: 0,20/30 puntos por día de servicios.

3. Servicios prestados como personal funcionario en los Cuerpos o Escalas equivalentes a la Escala objeto de esta convocatoria en otras Administraciones públicas: 0,10/30 puntos por día de servicios.

b) Superación de ejercicios obligatorios de cualquier convocatoria de acceso anterior en procesos selectivos de la misma Escala y puesto objeto de esta convocatoria o como personal en la categoría laboral equivalente de la Universidad de Granada, o de Cuerpos o Escalas equivalentes a la Escala objeto de esta convocatoria de otras Universidades públicas, a razón de 0,50 puntos por ejercicio obligatorio superado con un máximo de 5 puntos.
