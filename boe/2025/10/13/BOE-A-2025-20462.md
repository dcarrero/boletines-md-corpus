---
identificador: "BOE-A-2025-20462"
titulo: "Resolución de 6 de octubre de 2025, de la Subsecretaría, por la que se publica el Convenio entre la Agencia Estatal de Administración Digital y la Abogacía General del Estado, para la prestación de la solución de nube híbrida NubeSARA, financiado por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 132945
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-20462"
url_pdf: "https://www.boe.es/boe/dias/2025/10/13/pdfs/BOE-A-2025-20462.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-20462"
url_eli: ""
fetched_at: "2026-04-09T14:39:28Z"
...
La Presidenta de la Agencia Estatal de Administración Digital y el Abogado General del Estado han suscrito, con fecha de 18 de septiembre de 2025, un convenio para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU.
...
## ANEJO. Convenio entre la Agencia Estatal de Administración Digital y la Abogacía General del Estado para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU
...
Que la Abogacía General del Estado, para el desarrollo de las funciones establecidas en el Real Decreto 1057/2024, de 15 de octubre, por el que se aprueba el Reglamento General de la Abogacía General del Estado, precisa hacer uso del servicio NubeSARA.
...
Que la Abogacía General del Estado ostenta un interés manifiesto en establecer un marco de colaboración con la AEAD para la utilización de los servicios compartidos mencionados y su implantación.

## Duodécimo.

Que es posible la aplicación del Fondo de Recuperación Next Generation EU, como instrumento destinado a hacer efectiva la Medida 7 «Servicio de infraestructuras cloud» para el fortalecimiento de la solución de nube híbrida NubeSARA. Mediante el presente convenio, se facilita a la Abogacía General del Estado que pueda hacer uso del servicio NubeSARA.
...
1. Constituye el objeto del presente convenio el establecimiento de un marco de colaboración entre la Agencia Estatal de Administración Digital (en adelante, AEAD) y la Abogacía General del Estado para el desarrollo de actuaciones conjuntas que permitan el uso del servicio NubeSARA de acuerdo con los términos y condiciones generales expuestos a continuación y que conferirán a la Abogacía General del Estado la condición de Centro Usuario de NubeSARA.
...
1.º Poner a disposición de la Abogacía General del Estado el servicio NubeSARA en su modalidad Infraestructura como Servicio (IaaS, por sus siglas en inglés) y actuar como administrador de la infraestructura de sistemas, comunicaciones y almacenamiento necesaria para proporcionar dicho servicio.

2.º Adscribir los medios humanos y técnicos necesarios para la adecuada adaptación e implantación del servicio para su utilización por parte de la Abogacía General del Estado.
...
5.º Notificar a los responsables del servicio en la Abogacía General del Estado cualquier intervención, actuación o problema que pudiera afectar al adecuado funcionamiento del servicio.

6.º Poner a disposición de la Abogacía General del Estado las licencias relativas a los sistemas operativos Windows y Red Hat que precise la infraestructura acordada según lo descrito en el anexo I.

7.º Atender las incidencias y peticiones realizadas por parte de la Abogacía General del Estado en relación con el funcionamiento del servicio, de acuerdo con lo señalado en los anexos I y II.
...
## Tercera. Obligaciones de la Abogacía General del Estado.

La Abogacía General del Estado, a través de la unidad designada, se compromete a cumplir las siguientes obligaciones:
...
3. En caso de incumplimiento del presente convenio imputable a la Abogacía General del Estado, se aplicarán las medidas incluidas en la normativa nacional y europea relativa al destino del Fondo de Recuperación Next Generation EU.
...
A partir del año 2026, la AEAD continuará aportando la infraestructura tecnológica, de la que se beneficiarán los usuarios, entre ellos la Abogacía General del Estado, que deberá ser actualizada y mejorada de forma continua para garantizar la renovación de la inversión, su correcta actualización y mejora tecnológica sin riesgo de obsolescencia.
...
## Séptima. Obligaciones Económicas de la Abogacía General del Estado.

1. La Abogacía General del Estado contribuirá anualmente, con una contraprestación económica que se determina en base al uso del servicio, al mantenimiento de:
...
2. No obstante, hasta el fin del año 2025 la inversión en infraestructura de nube híbrida NubeSARA realizada por la AEAD está financiada con cargo al Fondo de Recuperación Next Generation EU, y en el cálculo de la contribución de la Abogacía General del Estado no se incluirá la parte correspondiente de dicha inversión.

3. A partir del año 2026, la contribución de la Abogacía General del Estado tendrá en cuenta tanto los recursos necesarios para la operación como la parte proporcional de la inversión necesaria para la renovación y ampliación de la infraestructura.

4. Al ser NubeSARA una infraestructura compartida y utilizada de forma simultánea por todos los órganos y organismos usuarios del servicio, la contribución de la Abogacía General del Estado en cualquiera de los conceptos estará siempre asociada a los recursos que la Abogacía General del Estado utilice del total disponible en NubeSARA, basándose en los costes unitarios recogidos en el anexo I.
...
Y, en prueba de conformidad, las partes firman el presente convenio en la fecha de la última firma electrónica.–La Presidenta de la Agencia Estatal de Administración Digital, Clara Mapelli Marchena.–El Abogado General del Estado, David Segundo Vilas Álvarez.
...
Con el objetivo de colaborar en la sostenibilidad funcional y técnica de los servicios compartidos, la Abogacía General del Estado contribuirá con una contraprestación económica que se determina en base al uso de dichos servicios.

De los servicios del catálogo de la AEAD, la Abogacía General del Estado ha mostrado interés en utilizar algunos de ellos con la siguiente estimación inicial de uso de recursos en el primer año:

– NubeSARA-Cómputo-x86 sin licencia.

● 8 vCPUs, 32 GB de RAM y 0,40 TB de disco.

– NubeSARA-Cómputo-x86 Windows.

● 482 vCPUs, 1864 GB de RAM y 14 TB de disco.

– NubeSARA-Cómputo-x86 Red Hat.

● 20 vCPUs, 83 GB de RAM y 1 TB de disco.

– NubeSARA-Ficheros.

● 32 TB en calidad NAS alto rendimiento.

– NubeSARA-Backup-Cómputo.

● 15,10 TB mediante snapshot.

– NubeSARA-Backup-Ficheros.

● 64,80 TB sobre ficheros de NAS alto rendimiento.

– NubeSARA-Servicios complementarios.

● 2 Servicio de balanceo.

El importe unitario de los servicios comunes de la AEAD que utilizará la Abogacía General del Estado, incluyendo las modalidades, calidades y opciones deseadas se encuentra en las tablas correspondientes del anexo I.
