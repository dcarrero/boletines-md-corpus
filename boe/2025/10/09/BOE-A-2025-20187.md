...
diario_numero: "243"
pagina_inicial: 130117
pagina_final: 130125
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-20187"
url_pdf: "https://www.boe.es/boe/dias/2025/10/09/pdfs/BOE-A-2025-20187.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-20187"
url_eli: ""
...
– Se eliminarán del proyecto de la planta solar fotovoltaica, las poligonales 5, 6 y 7 de Arenas II, además de las zonas eliminadas por el promotor durante el procedimiento. (Condición núm. 4).

– A la vista de la evaluación ambiental practicada, el proyecto deberá desarrollar la «alternativa 3» de las plantas solares fotovoltaicas, la «alternativa 3» de la línea eléctrica de evacuación y la «alternativa 3» de la SET Arenas I-II-III, (Condición núm. 6).

– Las placas de los paneles solares se colocarán a una altura mínima de 0,5 m sobre la altura esperada para la lámina de agua para la avenida de periodo de retorno de T=500. (Condición núm. 16).
...
– Se elaborará un estudio sobre la ubicación de las nidificaciones de águila imperial (Aquila adalberti) existentes, según condición núm. 39.

– No se realizarán actuaciones en un radio de 500 m de cualquier nido de águila imperial ibérica y, en ningún caso, se autorizará la instalación de una planta solar fotovoltaica a una distancia inferior a 1.000 m de un nido de águila imperial ibérica existente (Condición núm. 40).

– Los primillares del área de estudio identificados deberán quedar libres de instalaciones temporales y permanentes, en una superficie circular correspondiente a un radio de 500 m. (Condición núm. 42).

– Se tomará como pérdida máxima asumible el 5 % del hábitat potencial de alimentación del cernícalo primilla en relación con la superficie circular correspondiente a un radio de 4 km, tomando como centro el primillar (Condición núm. 43).

– Para mitigar el impacto por fragmentación y pérdida de hábitat, se deberá ajustar el vallado a la ubicación final de los módulos fotovoltaicos, con objeto de evitar que las zonas libres de módulos queden valladas. Además, el pitch entre seguidores no deberá ser inferior a 14 m y el pasillo útil entre paneles en posición horizontal en ningún caso deberá ser inferior a 8 m. (Condición núm. 44).

– No se podrá ubicar ningún elemento, temporal o permanente, en las zonas tampón o núcleo de la Reserva de la Biosfera «La Mancha Húmeda». (Condición núm. 53).

– Se deberá minimizar la longitud del vallado, ajustándolo a las instalaciones finalmente autorizadas. (Condición núm. 54).

– Se deberá colocar una pantalla vegetal alrededor de todo el perímetro del cerramiento, en el exterior de este (Condición núm. 55).
...
Por tanto, la infraestructura de evacuación de energía eléctrica conectará el parque fotovoltaico con la red de transporte, en la subestación de Arenas de San Juan 220 kV, propiedad de Red Eléctrica de España, SAU, a través de una nueva posición de la red de transporte en dicha subestación.
...
Otorgar a Mitra Delta, SLU, autorización administrativa previa para la instalación fotovoltaica «FV Arenas II», de 54,6 MW de potencia instalada, y sus infraestructuras de evacuación, que seguidamente se detallan, con las características recogidas en el proyecto «Proyecto Técnico Administrativo Instalación Fotovoltaica FV Arenas II de 95 MWn», fechado en octubre de 2023, y con las particularidades recogidas en la presente resolución.
...
– Potencia pico de módulos: 132,26 MW.
...
– Términos municipales afectados: Campo de Criptana y Arenales de San Gregorio, en la provincia de Ciudad Real.

Las infraestructuras de evacuación se componen de:

– Los Centros de Transformación de la planta se unen entre sí mediante líneas subterráneas de media tensión confeccionando 6 circuitos independientes, y desde el último CT de cada uno de ellos mediante cables subterráneos, se conectan al embarrado de MT de la SET.
