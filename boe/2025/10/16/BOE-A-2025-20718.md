---
identificador: "BOE-A-2025-20718"
titulo: "Resolución de 9 de octubre de 2025, de la Presidencia del Tribunal Constitucional, por la que se convoca proceso selectivo para la provisión de plazas de personal laboral de Ayudante de Informática, por el sistema de concurso-oposición."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "249"
pagina_inicial: 135130
pagina_final: 135140
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-20718"
url_pdf: "https://www.boe.es/boe/dias/2025/10/16/pdfs/BOE-A-2025-20718.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-20718"
url_eli: ""
fetched_at: "2026-04-09T14:54:12Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 9 de octubre de 2025, de la Presidencia del Tribunal Constitucional, por la que se convoca proceso selectivo para la provisión de plazas de personal laboral de Ayudante de Informática, por el sistema de concurso-oposición.

De conformidad con lo previsto en los artículos 15 y 102 de la Ley Orgánica 2/1979, de 3 de octubre, del Tribunal Constitucional, los artículos 14, 21, 49, 52, 59 y concordantes del Reglamento de Organización y Personal del Tribunal Constitucional, el capítulo 3 del Convenio colectivo del Tribunal Constitucional y en la restante normativa de aplicación,

Esta Presidencia, previo acuerdo de la Junta de Gobierno, se convoca proceso selectivo, por el sistema de concurso-oposición, para la provisión de tres plazas de ayudante de informática, descrita en el anexo I, de la plantilla de personal laboral del Tribunal Constitucional, con arreglo a las siguientes
...
4.2 La fase de oposición consistirá en la realización de los siguientes ejercicios obligatorios y eliminatorios:

4.2.1 Primer ejercicio: Contestación por escrito a un cuestionario tipo test de cincuenta preguntas, sobre las materias del temario que figura como anexo V, con cuatro respuestas alternativas, siendo solamente una de ellas la correcta, durante un tiempo máximo de noventa minutos sin que pueda disponerse de documentación, diccionarios ni dispositivos electrónicos. Se asignarán dos puntos por solución correcta y se penalizará con medio punto cada respuesta errónea. No se valorarán las preguntas en blanco ni las nulas (con más de una respuesta marcada). La prueba tendrá carácter eliminatorio, siendo necesario obtener un mínimo de 50 puntos para aprobarla. Los aspirantes podrán llevarse copia de su ejercicio.
...
4.2.2 Segundo ejercicio: Realización de una prueba práctica, consistente en la resolución de cinco supuestos relacionados con las tareas propias de las plazas convocadas durante un tiempo máximo de dos horas, sin que pueda disponerse de documentación, diccionarios ni dispositivos electrónicos. El ejercicio será leído públicamente ante la comisión de valoración, para lo cual se convocará a los solicitantes en convocatoria única a partir del día siguiente hábil a su realización. La comisión de valoración podrá solicitar las aclaraciones que considere oportunas al aspirante en relación con su ejercicio. En el ejercicio se puntuará de 0 a 20 puntos cada uno de los supuestos, sobre un máximo de 100 puntos, siendo necesario obtener un mínimo de 50 para superarlo.
...
La sesión de lectura del segundo ejercicio será objeto de grabación audiovisual, con fines de transparencia y seguridad jurídica, y con las garantías previstas en la normativa de protección de datos personales.

4.2.3 Las convocatorias a las pruebas que constituyen la fase de oposición serán publicadas por la comisión de valoración en la página web del Tribunal Constitucional, sin perjuicio de la utilización de otras posibles formas de notificación.
...
4.3 En la fase de concurso, a la que se convocará a los aspirantes que hayan superado la fase de oposición, se valorarán los méritos profesionales y los méritos académicos de los aspirantes. Las dos terceras partes corresponderán a méritos profesionales y una tercera parte a méritos académicos, con arreglo al baremo contenido en el anexo III de esta resolución, estableciéndose un máximo de 75 puntos y una puntuación mínima de 10 puntos para superar esta fase.
...
– Secretaría: Un empleado/a público al servicio del Tribunal Constitucional, designado por el secretario general.
...
Con anterioridad a la formalización del contrato, los aspirantes seleccionados deberán aportar, en el plazo de veinte días hábiles a contar desde la publicación del resultado del concurso en el «Boletín Oficial del Estado», los documentos que se relacionan a continuación, acreditativos del cumplimiento de los correspondientes requisitos:
...
La presente convocatoria tendrá en cuenta el principio de igualdad de trato entre mujeres y hombres por lo que se refiere al acceso al empleo, de acuerdo con el artículo 14 de la Constitución Española y la Ley Orgánica 3/2007, de 22 de marzo, para la igualdad efectiva de mujeres y hombres.
...
Salario base 16.932,44 euros.

Plus convenio 18.764,06 euros.
...
## ANEXO II. Solicitud de participación en el concurso-oposición para la cobertura de tres plazas de ayudante de informática de la plantilla laboral del Tribunal Constitucional, convocado por Resolución de la Presidencia del Tribunal Constitucional de fecha 9 de octubre de 2025
...
2.4 Por formación complementaria: Se valorará con 0,25 puntos cada curso de formación relacionado con las tareas correspondientes a las plazas convocadas, de al menos 15 horas y de menos de 5 años de antigüedad, con un máximo de hasta 6 puntos. En el caso de que la documentación presentada por el solicitante no especificase el número de horas, viniendo señalada la duración por días, semanas o meses, se considerará que cada día de curso equivale a dos horas.
...
1. La Constitución Española de 1978: principios, derechos fundamentales y protección jurisdiccional.

2. El Tribunal Constitucional: funciones, estructura y normativa laboral aplicable. Igualdad de trato y no discriminación.
...
4. Normativa sobre protección de datos personales y seguridad de la información en el ámbito público (RGPD y ENS).

5. Arquitectura básica de ordenadores personales y portátiles. Componentes hardware y periféricos.

6. Diagnóstico y resolución de problemas comunes de hardware y software en el puesto de trabajo.

7. Sistemas operativos de escritorio: instalación, configuración y administración básica en Windows 10/11 y MacOS.

8. Dispositivos móviles: smartphones y tablets con sistemas Android e iOS. Instalación, configuración básica, conectividad, gestión de cuentas, seguridad y resolución de incidencias.

9. Gestión de cuentas de usuario, perfiles, permisos y conectividad en red local.

10. Sistemas de almacenamiento en red (NAS).

11. Sistemas de Inteligencia Artificial en el puesto de trabajo.

12. Copias de seguridad, recuperación de datos y protección frente a malware.

13. Redes cableadas y Wi-Fi: estándares Ethernet y Wi-Fi, configuración básica, diagnóstico y resolución de incidencias.

14. Conectividad a Internet e Intranet: navegadores, servicios básicos, VPN, seguridad en redes IP.

15. Función de Help Desk y Service Desk: atención a usuarios, gestión de incidencias y peticiones según ITIL e ISO 20000.

16. Herramientas de monitorización y mantenimiento preventivo del puesto de trabajo.

17. Comunicación efectiva con usuarios: registro de incidencias, seguimiento y resolución.

18. Ofimática local y en la nube: Microsoft Office, Office 365, correo electrónico, calendario, PDF, videoconferencia.

19. Identidad digital y firma electrónica. Uso básico de biometría.
