---
identificador: "BOE-A-2025-19840"
titulo: "Resolución de 29 de septiembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Apoyo a la Docencia y a la Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 127789
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-19840"
url_pdf: "https://www.boe.es/boe/dias/2025/10/06/pdfs/BOE-A-2025-19840.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-19840"
url_eli: ""
fetched_at: "2026-04-09T14:08:35Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 29 de septiembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Apoyo a la Docencia y a la Investigación.
...
1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala Básica de Apoyo a la docencia y a la Investigación de la Universidad de Granada, Grupo C, Subgrupo C1, (Mecánica y Materiales).
...
1.4 La fase de oposición se desarrollará con los ejercicios y puntuaciones establecidas en el anexo II de esta convocatoria, y el programa de materias en que se basarán será el contenido en el anexo I. La fecha y lugar para la realización del primer ejercicio de la fase de oposición, que no podrá iniciarse antes del día 15 de enero de 2026, se fijará en la forma establecida en la base 4.1 de esta convocatoria.
...
Granada, 29 de septiembre de 2025.–El Rector, Pedro Mercado Pacheco.
...
1. Materiales. Tipos de materiales: metálicos, plásticos, cerámicos y compuestos. Propiedades físicas y mecánicas. Aplicaciones y limitaciones de estos materiales en procesos de fabricación mecánica. Criterios de selección de materiales para su empleo en equipos científicos o de experimentación.

2. Procesos de fabricación. Procesos de deformación plástica, fundición y unión. Fundamentos y conceptos básicos de: fundición, moldeo, pulvimetalurgia, forja, extrusión, laminación, estirado, trefilado, doblado, curvado, entallado, repujado, embutido, corte, estampado y punzonado. Unión/soldadura: tipos, procesos y equipos. Procesos de unión por adhesivos.

3. Herramientas y máquinas herramientas convencionales I. Tornos, fresadoras, taladradoras, sierras, limas y limadoras: tipos, partes principales, herramientas de corte, utillajes y accesorios. Conceptos básicos sobre mantenimiento preventivo y correctivo, así como de sus instalaciones asociadas. Operaciones de torneado, de fresado, de taladrado. Requisitos para procesar los materiales de partida, consideraciones operativas durante los procesos y actuaciones post-procesado.

4. Control numérico para máquinas herramientas. Fundamentos. Elementos principales: configuración, funcionamiento de cada uno e interrelación entre ellos. Tipos de programaciones. Programación CAM a partir de herramientas CAD, con distintos formatos de ficheros CAD. Principales instrucciones en código ISO.

5. Equipos de fresado CNC I. Fundamento teórico, similitudes/diferencias y ventajas/inconvenientes/criterios de selección entre equipos de 3 y 5 ejes. Componentes, e instalaciones/elementos auxiliares si los hubiera, habituales de los equipos: configuración instrumental, funcionamiento de cada componente e interrelación entre ellos. Conceptos básicos de funcionamiento de los equipos.

6. Equipos de fresado CNC II. Requisitos para procesar los materiales de partida, consideraciones operativas durante los procesos y actuaciones post-procesado. Alcance y limitaciones de los equipos. Conceptos básicos de verificación, calibración y mantenimiento preventivo y correctivo de los equipos, así como de sus instalaciones.

7. Tecnología de fabricación aditiva. Principios de funcionamiento, clasificación de técnicas, materiales empleados, procesos de diseño y post-procesado. Aplicaciones en entornos científicos y de prototipado.

8. Equipos de impresión 3D FDM. Fundamento teórico, similitudes/diferencias y ventajas/inconvenientes/criterios de selección con otras técnicas de impresión 3D. Componentes, e instalaciones/elementos auxiliares si los hubiera, habituales de los equipos: configuración instrumental, funcionamiento de cada componente e interrelación entre ellos. Conceptos básicos de funcionamiento de los equipos. Requisitos para procesar los materiales de partida, consideraciones operativas durante los procesos y actuaciones post-procesado. Alcance y limitaciones de los equipos. Conceptos básicos de verificación, calibración y mantenimiento preventivo y correctivo de los equipos, así como de sus instalaciones.

9. Seguridad personal y ambiental a considerar para/durante/después de herramientas manuales, máquinas herramientas convencionales, equipos de fresado CNC, y equipos de impresión 3D FDM. Seguridad personal y ambiental para/durante/después de su uso. Seguridad en los procesos. Seguridad en laboratorios y entornos de trabajo tecnológico. Riesgos asociados a maquinaria, electricidad, productos químicos y ambientes térmicos. Evaluación, medidas preventivas, protocolos de actuación y EPI.

10. Metrología I: Conceptos generales de control dimensional. Conceptos de medida, unidades de medida más habituales. El sistema internacional de unidades. Errores en la medición, imprecisiones, incertidumbres y trazabilidad.

11. Metrología II: Instrumentos de control dimensional. Similitudes y diferencias entre instrumentos de medida directa e indirecta. Ventajas e inconvenientes y criterios de selección de cada tipo. Instrumentos de medida directa: Clasificación, conceptos básicos de funcionamiento, alcance y limitaciones. Instrumentos de medida indirecta: Clasificación, conceptos básicos de funcionamiento, alcance y limitaciones. Conceptos básicos de verificación, calibración y mantenimiento de los instrumentos.

12. Metrología III: Medición en el taller. Métodos de medición y verificación de parámetros en roscas, engranajes y conos. Verificación geométrica, paralelismo, perpendicularidad y rugosidad. Tolerancias, cotas, unidades y normalización de eje-agujero.

13. Mantenimiento de instalaciones experimentales. Tipología de averías, planificación del mantenimiento preventivo y correctivo, control de repuestos, documentación técnica asociada. Normativa de seguridad aplicable.

14. Calidad en procesos experimentales. Normas de calidad, control de procesos, validación de datos y calibración de equipos. Documentación de procedimientos, trazabilidad y auditorías internas.

15. Gestión de residuos tecnológicos y sostenibilidad en el entorno científico. Tipos de residuos, segregación, almacenamiento y gestión conforme a normativa. Medidas de eficiencia energética y uso responsable de recursos.
