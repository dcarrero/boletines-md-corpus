---
identificador: "BOE-A-2025-19839"
titulo: "Resolución de 26 de septiembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Apoyo a la Docencia y a la Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 127775
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-19839"
url_pdf: "https://www.boe.es/boe/dias/2025/10/06/pdfs/BOE-A-2025-19839.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-19839"
url_eli: ""
fetched_at: "2026-04-09T14:08:34Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 26 de septiembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Apoyo a la Docencia y a la Investigación.
...
1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala Básica de Apoyo a la docencia y a la Investigación de la Universidad de Granada, Grupo C, Subgrupo C1, (Instrumentación y Sistemas).
...
1. Muestreo de variables meteorológicas y oceanográficas I: Definiciones. Representatividad en el tiempo y en el espacio. Espectros de magnitudes atmosféricas y oceanográficas. Series temporales, espectros de potencia y filtros: análisis de series temporales, medición de espectros, respuesta del sistema de instrumentos y filtros.

2. Muestreo de variables meteorológicas y oceanográficas II: Determinación de las características de los sistemas: determinación de la respuesta mediante medición directa, mediante cálculo y mediante estimación. Muestreo: técnicas de muestreo, frecuencias de muestreo y control de la calidad. Medición de variables atmosféricas en altitud (radiosondas) y oceanográficas en profundidad (ecosondas).

3. Reducción de datos: Definiciones. Requisitos meteorológicos. El proceso de reducción de datos. Aplicación de funciones de calibración. Linealización. Promediado. Variables y estadísticas derivadas. Gestión de la calidad. Compilación de metadatos.

4. Prueba, calibración e intercomparación: Definiciones. Programas de prueba y de calibración. Pruebas: finalidad, programa de pruebas ambientales, pruebas de interferencia eléctrica y electromagnética y pruebas funcionales. Calibración: finalidad, patrones, trazabilidad y prácticas de calibración. Intercomparaciones de instrumentos.

5. Temperatura atmosférica y del agua: Definición. Unidades y escalas. Métodos de medición y observación. Incertidumbre de medición. Aseguramiento de la trazabilidad y calibración. Fuentes de error. Termómetros eléctricos. Termómetros de líquido en tubo de vidrio. Termógrafos mecánicos. Protección contra las radiaciones. Medición en agua: cadenas de termistores, CTD, XBT.

6. Presión atmosférica y en columna de agua: Definición. Unidades y escalas. Métodos de medición y observación. Incertidumbre de medición. Aseguramiento de la trazabilidad y calibración. Fuentes de error. Cambio barométrico y tendencia de la presión. Ajuste de las lecturas del barómetro a un nivel normalizado y a otros niveles. Métodos de medición y observación de la profundidad y presión: sensores de presión, ecosondas, profundímetros. CTD y gliders. Estándar TEOS-10 para cálculo de la densidad del agua de mar.

7. Humedad atmosférica: Definición. Unidades y escalas. Métodos de medición y observación. Incertidumbre de medición. Aseguramiento de la trazabilidad y calibración. Fuentes de error. Fórmulas para el cálculo de las mediciones de la humedad. Higrómetros de capacitancia eléctrica. Psicrómetro. Aspiropsicrómetro de Assmann y otros psicrómetros de aspiración. Psicrómetro de garita. Psicrómetros de honda o en noria. Higrómetro de punto de rocío con espejo enfriado. Higrómetros de absorción de radiación electromagnética.

8. Medición del viento: Definición. Unidades y escalas. Incertidumbre de medición. Métodos de medición y observación. Métodos instrumentales simples. Anemómetros de cazoletas y de hélice. Veletas. Sensores y combinaciones de sensores para la medición de las componentes. Sensores e instrumentos de medición del viento en altitud. Ubicación del equipo en tierra. Comparación, calibración y mantenimiento. Fuentes de error.

9. Medición de la precipitación: Definición. Unidades y escalas. Incertidumbre de medición. Métodos de medición y observación. Fuentes de error. Emplazamiento y exposición. Medidores de precipitación no registradores. Errores y correcciones en los medidores. Medidores de precipitación registradores. Medición del rocío, de la acumulación de hielo y de la precipitación de niebla.

10. Medición de la radiación: Definición. Magnitudes radiométricas y fotométricas. Unidades y escalas. Incertidumbre de medición. Métodos de medición y observación. Fuentes de error. Medición de la radiación solar directa. Medición de la radiación celeste global y difusa. Medición de la radiación total y de onda larga. Medición de la luz diurna. Medición de la radiación fotosintéticamente activa. Medición de la radiación ultravioleta.

11. Medición de la evaporación: Definición. Unidades y escalas. Incertidumbre de medición. Métodos de medición y observación. Fuentes de error. Emplazamiento y exposición. Atmómetros. Evaporímetros de cubeta y tanques de evaporación. Evapotranspirómetros (lisímetros). Estimación de la evaporación a partir de superficies naturales.

12. Medición de la humedad del suelo: Definición. Unidades y escalas. Medición gravimétrica directa del contenido hídrico del suelo. Contenido hídrico del suelo: métodos indirectos. Instrumentos para medir el potencial hídrico del suelo. Selección del emplazamiento y tamaño de la muestra. Teledetección de la humedad del suelo. Teledetección por microondas. Incertidumbre de medición. Fuentes de error.

13. Medición de la composición atmosférica I: Definiciones y descripciones. Unidades y escalas. Principios y técnicas de medición. Garantía de la calidad. Mediciones del ozono (estratosférico). Gases de efecto invernadero. Teledetección de gases de efecto invernadero. Gases reactivos. Deposición atmosférica húmeda: recogida de la muestra y análisis químico.

14. Medición de la composición atmosférica II: Medición química de los aerosoles. Medición in situ de las propiedades radiativas de los aerosoles. Concentración del número y distribución por tamaño de las partículas. Núcleos de condensación de nube. Espesor óptico del aerosol. Lidar de aerosoles de la Vigilancia de la Atmósfera Global.

15. Técnicas especiales de perfilado de la capa límite y la troposfera: Generalidades. Técnicas de teledetección de superficie. Radares perfiladores de viento. Radiómetros de microondas. Radares láser (lidares). Lidares Doppler de pulsos heterodino. Técnicas con globos. Torres y mástiles con instrumentos. Globos cautivos con instrumentos.

16. Mediciones de estaciones meteorológicas automáticas: Definición. Finalidad. Requisitos meteorológicos. Consideraciones sobre el emplazamiento de las estaciones meteorológicas automáticas. Configuración del sistema. Suministro de energía. Protección del recinto. Estructura de la instalación. Tipos de estaciones meteorológicas automáticas. Instrumentación de una estación meteorológica automática. Diagnóstico y mantenimiento a distancia. Control de la calidad y mantenimiento: niveles de servicio y calibración e inspección del emplazamiento.

17. Nivel del mar: Definición. Unidades y escalas. Origen y características de las oscilaciones. Niveles medios y extremos. Instrumentación y tipos de sensores para su medida: mareógrafos, sensores acústicos y radar y altimetría. Boyas de oleaje escalares y direccionales. Calibración y referenciación.

18. Salinidad del agua: Definición formal. Unidades y escalas. Métodos de medición y observación. Sensores químicos, físicos. Sensores de conductividad, CTD. Incertidumbre de medición. Mantenimiento de los sensores.

19. Informática: Bases de datos científicas. Estructura, normalización y mantenimiento. Sistemas de gestión (MySQL, PostgreSQL, SQLite). Características, configuración y administración de sistemas operativos (Linux y Windows). Programación básica de tareas de procesamiento y monitorización en software libre (Python).
