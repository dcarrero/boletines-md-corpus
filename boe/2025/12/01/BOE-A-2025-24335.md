---
identificador: "BOE-A-2025-24335"
titulo: "Resolución de 24 de noviembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Conservación y Mantenimiento."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "288"
pagina_inicial: 156404
pagina_final: 156417
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-24335"
url_pdf: "https://www.boe.es/boe/dias/2025/12/01/pdfs/BOE-A-2025-24335.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-24335"
url_eli: ""
fetched_at: "2026-04-10T06:03:29Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 24 de noviembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Conservación y Mantenimiento.

En cumplimiento de lo dispuesto en los Estatutos de esta Universidad, aprobados por Decreto 231/2011, de 12 de julio, del Consejo de Gobierno de la Junta de Andalucía, y publicados en el «Boletín Oficial de la Junta de Andalucía» núm. 147, de 28 de julio de 2011; en la Resolución de 5 de diciembre de 2022, de la Universidad de Granada, por la que se publica la Oferta de Empleo Público del personal de administración y servicios para el año 2022, en virtud de la Orden de 20 de octubre de 2023, del Consejero de Universidad, Investigación e Innovación, por la que se autoriza a la Universidad de Granada, para la convocatoria de plazas de personal técnico, de gestión y de administración y servicios, en ejecución de la Oferta de Empleo Público de 2022, y con el fin de atender las necesidades de personal técnico, de gestión y de administración y servicios,

El Rector, en uso de las competencias atribuidas en el artículo 50 de la Ley Orgánica 2/2023, de 22 de marzo, del Sistema Universitario, en relación con el artículo 3.2.j) de la misma norma, así como en los artículos 45 y 162 de los Estatutos de esta Universidad, ha resuelto convocar proceso selectivo de acceso libre para el ingreso en la Escala Básica de Conservación y Mantenimiento de esta Universidad, de acuerdo con las siguientes

Bases

1. Normas generales

1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala Básica de Conservación y Mantenimiento de la Universidad de Granada, grupo C, subgrupo C1 (Técnico/a de Mantenimiento-Modelador BIM).
...
1.4 La fase de oposición se desarrollará con los ejercicios y puntuaciones establecidas en el anexo II de esta convocatoria, y el programa de materias en que se basarán será el contenido en el anexo I. La fecha y lugar para la realización del primer ejercicio de la fase de oposición, que no podrá iniciarse antes del día 1 de marzo de 2026, se fijará en la forma establecida en la base 4.1 de esta convocatoria.
...
f) No poseer la condición de personal funcionario de carrera de la Escala Básica de Conservación y Mantenimiento de la Universidad de Granada.
...
Granada, 24 de noviembre de 2025.–El Rector, Pedro Mercado Pacheco.
...
1. Roles en la Metodología BIM: Roles y responsabilidades en un entorno BIM: Modelador BIM, Coordinador BIM, BIM Manager. Organización y jerarquía de un equipo de trabajo BIM. Competencias, funciones y comunicación entre perfiles profesionales.

2. Estándares, Protocolos y Sistemas de Clasificación BIM según ISO 19650: Estándares y protocolos: AIR, PIR, EIR, AIM, PIM, BEP. Formatos de archivo BIM (nativos, IFC, DWG, RVT, otros). Importancia del formato IFC como estándar abierto de interoperabilidad. Niveles de detalle (LOD) y niveles de información (LOI). Sistemas de clasificación (OmniClass, UniClass, GuBIMClass, otros).

3. Plan de Incorporación de la Metodología BIM en la Contratación Pública: Plan de incorporación en la contratación pública de la Administración General del Estado y organismos públicos. Estrategias, fases de implementación y marco legal aplicable.

4. Modelado Arquitectónico con Autodesk Revit: Creación y gestión de elementos constructivos: muros, suelos, techos, cubiertas. Modelado de carpintería y mobiliario (familias). Emplazamientos: topografía y elementos de sitio. Control de visibilidad, fases y materiales.

5. Modelado Estructural con Autodesk Revit: Modelado de cimentaciones, pilares, vigas, losas y forjados. Relación y coordinación entre modelos arquitectónicos y estructurales. Parámetros y niveles de detalle estructural. Revisión y análisis de interferencias.

6. Modelado MEP con Autodesk Revit: Modelado de sistemas de fontanería, saneamiento, climatización (HVAC), ventilación y extracción. Modelado de sistemas eléctricos (iluminación, baja tensión, cuadros). Conexiones, trazados, reglas de diseño MEP y coordinación con arquitecturas y estructuras. Gestión de familias específicas de MEP y sus parámetros funcionales.

7. Familias en Revit: Definición y tipos de familias: sistema, carga y modelado in situ. Creación y gestión de parámetros compartidos y específicos. Buenas prácticas para familias reutilizables y eficientes. Familias MEP: tipos, conexiones, simbología y estándares de interoperabilidad.

8. Coordinación BIM: Coordinación de modelos mediante herramientas de coordinación (ej. Navisworks). Detección y resolución de interferencias (clash detection). Gestión de incidencias y comunicación en el equipo (BCF). Control de calidad del modelo y validación de la información.

9. Trabajo Colaborativo en Entorno BIM: Entorno Común de Datos (CDE): definición, estructura y herramientas. Flujos de trabajo y protocolos de comunicación. Gestión de versiones, revisiones y permisos. Metodologías de colaboración basadas en ISO 19650.

10. Documentación y Gestión de Datos BIM: Generación de planos, secciones y alzados a partir del modelo. Tablas de planificación y mediciones (5D). Extracción de información no geométrica (parámetros) y uso para presupuestos. Gestión de propiedades, plantillas y estándares de documentación. Protocolo COBie: formato estándar para la transferencia de información del modelo a la fase de operación y mantenimiento, facilitando la gestión del activo.

11. Visualización BIM: Creación de vistas 3D, perspectivas y recorridos virtuales. Aplicación de materiales y texturas. Renderizado de imágenes y animaciones. Técnicas de presentación y comunicación visual para proyectos BIM.

12. Autodesk AutoCAD: Funciones básicas de dibujo 2D. Referencias externas y organización de capas. Modelado 3D en AutoCAD. Interoperabilidad AutoCAD ↔ Revit (DWG, IFC).

13. Nube de Puntos y Proceso Scan-to-BIM: Definición y propósito de la nube de puntos en levantamientos «as-built». Principios de captura con escáner láser 3D. Formatos comunes (.e57,.las), georreferenciación y registro. Métodos de importación y uso de nube de puntos como referencia en Revit.

14. Dynamo y Automatización de Procesos BIM: Elementos básicos del entorno Dynamo. Automatización de tareas repetitivas: creación masiva de elementos, numeración y colocación de familias. Manipulación y gestión masiva de parámetros y datos (exportación/importación con Excel).

15. Código Técnico de la Edificación - Documento Básico SUA: Documento Básico de Seguridad de Utilización y Accesibilidad (DB-SUA). Aplicación del Real Decreto 314/2006 y modificaciones relevantes. Aspectos técnicos de accesibilidad y criterios de cumplimiento en espacios docentes.

16. Normativa andaluza y Documento Técnico sobre Accesibilidad: Decreto 293/2009, de 7 de julio - Reglamento sobre accesibilidad en infraestructuras, urbanismo, edificación y transporte en Andalucía. Documento Técnico sobre el Decreto andaluz de accesibilidad (Departamento de Accesibilidad, abril 2012) –aplicación práctica en espacios docentes. Interpretación y criterios de diseño accesible.

17. Real Decreto 486/1997 sobre Seguridad y Salud en los Lugares de Trabajo: Disposiciones mínimas de seguridad y salud aplicables a ambientes docentes y de trabajo. Criterios de diseño preventivo y medidas básicas de seguridad.
...
Primer ejercicio: Tendrá carácter eliminatorio y consistirá en contestar un cuestionario de cien preguntas, con cuatro respuestas alternativas, de las que solo una será correcta, basado en el contenido del programa que figura como anexo I de esta convocatoria. Para la realización de este ejercicio las personas aspirantes dispondrán de cien minutos.
...
Sistema de Corrección de los Ejercicios con Respuesta Alternativa (primer ejercicio). Número de preguntas puntuables (NPP): El número de preguntas puntuables para cada persona opositora será igual al número de preguntas correctas (NPC) menos el número de preguntas incorrectas (NPI) dividido por el número de respuestas alternativas de cada pregunta (NRAP). La fórmula a aplicar será la siguiente:
