---
identificador: "BOE-A-2025-24337"
...
diario_numero: "288"
pagina_inicial: 156432
pagina_final: 156445
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-24337"
url_pdf: "https://www.boe.es/boe/dias/2025/12/01/pdfs/BOE-A-2025-24337.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-24337"
url_eli: ""
fetched_at: "2026-04-10T06:03:31Z"
...
1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala Básica de Conservación y Mantenimiento de la Universidad de Granada, Grupo C, Subgrupo C1, (Técnico/a de Mantenimiento – Aplicación PRISMA).
...
1. Fundamentos del Reglamento Electrotécnico para Baja Tensión (REBT): Instalaciones interiores o receptoras (ITC-BT-19 a ITC-BT-24), locales de pública concurrencia (ITC-BT-28), instalaciones a muy baja tensión (ITC-BT-36), instalación de receptores y motores (ITC-BT-47), sistemas de automatización y seguridad (ITC-BT-51).

2. Fundamentos del Reglamento de Instalaciones Térmicas en los Edificios (RITE): Eficiencia energética (IT 1.2.4.2.5), sistemas de control (IT 1.2.4.3), contabilización de consumos (IT 1.2.4.4), instrucciones de funcionamiento (IT 3.7), términos y definiciones.

3. Fundamentos de Equipos de Bombeo y Ventilación: Principios de funcionamiento, motores eléctricos, sistemas de regulación y variadores de frecuencia.

4. Fundamentos de Sistemas y Equipos de Climatización: Tecnologías aire-agua, agua-agua, aire-aire, VRF, calderas.

5. Fundamentos de Balance Energético en Instalaciones: Fundamentos para cálculo y optimización del rendimiento energético en climatización y ACS.

6. Automatismos Eléctricos: Interpretación y desarrollo de esquemas eléctricos de potencia y maniobra.

7. Arquitectura de Sistemas de Control de Edificios (BMS/BAS): Norma UNE-EN ISO 16484, elementos constituyentes y compatibilidad electromagnética.

8. Redes y Comunicaciones Industriales: Modelo OSI, infraestructuras, Ethernet, protocolos TCP/IP, buses de comunicación.

9. Protocolos de Comunicación para la Automatización: BACnet, Modbus, KNX, Lon, DALI, DMX, M-Bus, Zigbee, LoRa.

10. Instrumentación y Elementos de Campo: Sensores y actuadores.

11. Controladores y Periféricos: Entradas y salidas, conexionado y especificaciones de cableado.

12. Bases de Datos Relacionales: Lenguaje SQL.

13. Herramientas de Tratamiento de Datos: Uso avanzado de hojas de cálculo (Excel).

14. Fundamentos de Programación: Programación orientada a objetos en Java.

15. Programación de Estrategias de Control: Desarrollo de lógicas de funcionamiento.

16. Gestión del Mantenimiento: Mantenimiento preventivo y correctivo, sistemas informatizados (GMAO).

17. Monitorización y Supervisión de Sistemas: Herramientas y técnicas para adquisición de datos y seguimiento.

18. Operación y Optimización de Instalaciones: Procedimientos para vigilancia y garantía del correcto funcionamiento.

19. Diagnóstico y Resolución de Incidencias: Metodologías para análisis de fallos y acciones correctoras.
