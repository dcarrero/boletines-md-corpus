---
identificador: "BOE-A-2025-27196"
titulo: "Orden APA/1561/2025, de 29 de diciembre, por la que se definen los bienes y los rendimientos asegurables, las condiciones técnicas mínimas de cultivo, el ámbito de aplicación, los periodos de garantía, las fechas de suscripción y los precios unitarios del seguro de explotaciones de cereza comprendidos en el Cuadragésimo Séptimo Plan de Seguros Agrarios Combinados."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "315"
pagina_inicial: 181076
pagina_final: 181095
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-27196"
url_pdf: "https://www.boe.es/boe/dias/2025/12/31/pdfs/BOE-A-2025-27196.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-27196"
url_eli: ""
fetched_at: "2026-04-10T08:03:26Z"
parser_version: "boletines-md/0.1"
---

# Orden APA/1561/2025, de 29 de diciembre, por la que se definen los bienes y los rendimientos asegurables, las condiciones técnicas mínimas de cultivo, el ámbito de aplicación, los periodos de garantía, las fechas de suscripción y los precios unitarios del seguro de explotaciones de cereza comprendidos en el Cuadragésimo Séptimo Plan de Seguros Agrarios Combinados.
...
e) En los módulos 1 y 2 para el riesgo de helada y resto de adversidades climáticas, las explotaciones de los asegurados de reiterada y alta siniestralidad (en adelante, RAS) tipo 2, según se establece en las condiciones especiales de este seguro.
...
i) Asegurados RAS: asegurados que, para los riesgos de helada y resto de adversidades climáticas y/o para el riesgo de lluvia, cumplen los criterios previstos en las condiciones especiales de este seguro.
...
3.º En la provincia de Cáceres la parcela a efectos del seguro se podrá conformar sin incluir el recinto.
...
3. Para aquellas parcelas inscritas en registros de figuras de calidad diferenciada se considerarán como técnicas mínimas de cultivo la realización de las prácticas de cultivo recogidas en la normativa vigente que regula dichas figuras.

4. Asimismo, y con carácter general, cualquier otra práctica cultural utilizada deberá realizarse de acuerdo con las buenas prácticas agrarias, todo ello en concordancia con la producción fijada en la declaración del seguro.

5. En todo caso, el asegurado deberá atenerse a lo dispuesto en las normas que se dicten sobre lucha antiparasitaria, tratamientos integrados y medidas culturales o preventivas de carácter fitosanitario.
...
i. Parcelas incluidas en la base de datos.
...
ii. Parcelas no incluidas en la base de datos.
...
La resolución de las revisiones iniciadas de oficio por el Ministerio de Agricultura, Pesca y Alimentación se dictará antes de que transcurran seis meses desde la fecha del acuerdo de iniciación del expediente. Dicha resolución se comunicará al asegurado y a AGROSEGURO.
...
b) Cursar la solicitud a Agroseguro, a través del impreso establecido al efecto, en la que deberán consignar el nombre o la razón social del solicitante, su NIF o CIF, su domicilio, el código postal y un número de teléfono de contacto.
...
i. Copia del NIF/CIF del titular de la explotación.

ii. Copia de la declaración de seguro formalizada por el titular de la explotación.

iii. Documentación que justifique la existencia de errores.
...
1. Seguro principal: Su ámbito de aplicación se extiende, para los módulos 1, 2, 3 y P a todas las parcelas de cereza situadas en todo el territorio nacional.
...
Teniendo en cuenta los períodos de garantía anteriormente indicados y lo establecido en el Cuadragésimo Séptimo Plan de Seguros Agrarios Combinados, los periodos de suscripción serán los que se recogen en el anexo VII.
...
2. Para aquellas parcelas que en la declaración de seguro figuren con precio distinto por pertenecer a Denominaciones de Calidad diferenciada reconocida, el tomador del seguro deberá disponer, en el momento de la contratación, de copia de la certificación de inscripción de dichas parcelas en los registros correspondientes. En el caso de ocurrencia de siniestro, deberá aportarse dicha certificación en el momento de la tasación inmediata o de la tasación definitiva.

En caso de no aportarse dicha certificación, la indemnización se calculará con el precio de la producción convencional.

3. Si el agricultor suscribiera el seguro complementario deberá aplicar los mismos precios que hubiera establecido para el seguro principal.
...
Madrid, 29 de diciembre de 2025.–El Ministro de Agricultura, Pesca y Alimentación, Luis Planas Puchades.
...
Deberá disponer al menos un poste cada 50 m². No obstante, si son metálicos y disponen de postes con al menos 75 mm de diámetro en las posiciones de mayor esfuerzo y/o sobre estos postes disponen de vientos anclados, se admitirá al menos un poste cada 60 m², contabilizándose en este caso cada uno de los vientos de anclaje como un poste.
...
Ambrunés, Pico Negro, Pico Limón Negro, Pico Colorado o Picota.
...
Las parcelas que se incluyen en la base de datos son aquellas de las que se dispone de información del seguro de al menos tres planes de la serie 2020 a 2025.
...
i. Parcelas con siniestro: la producción real final incrementada con las pérdidas ocasionadas por los riesgos de pedrisco, lluvia y riesgos excepcionales.

ii. Parcelas sin siniestro: la producción asegurada en el seguro principal más la producción asegurada en el seguro complementario.

Se considerarán parcelas individualizables aquellas que tengan información en al menos tres planes de la serie 2020 a 2025, ambos incluidos.

Para estas parcelas, se fijará un rendimiento individualizado (en Kg/ha y en Kg/árbol), que será:

i. Si se hubieran asegurado los seis años anteriores, el mayor valor de entre la media de los rendimientos obtenidos y la media sin contar con el mayor ni menor dato.

ii. Si se hubieran asegurado menos años, la media de los años asegurados.

## ANEXO V. Rendimientos máximos asegurables

1. Plantaciones en secano y plantaciones en regadío con menos de 300 árboles por hectárea (kg/árbol)
...
2. Plantaciones en regadío con 300 o más árboles por hectárea. (kg/hectárea)
...
| Producción. | Pedrisco. | Estado fenológico «D». | 15 de agosto de 2026:
...
| ^(1)^Entre dichas adversidades, se incluirán asimismo los daños ocasionados por los riesgos de pedrisco, helada, lluvia y riesgos excepcionales entre el estado fenológico «B» y los inicios de garantías establecidos para estos riesgos.
 ^(2)^Para las variedades Lapins, Lamper o Garrafal Lamper y Sweet Heart, en la provincia de Burgos, el final de garantías se establece a 31 de agosto de 2026.
 Para las variedades Summer Charm y Skeena, en la comunidad autónoma de La Rioja, el final de garantías se establece a 15 de agosto de 2026. |  |  |  |

## ANEXO VII. Periodos de suscripción

| Seguro | Inicio suscripción | Ámbito de aplicación | Final suscripción |
| --- | --- | --- | --- |
| Principal. | 1 de enero de 2026. | Cáceres. | 28 de febrero de 2026. |
| Resto del ámbito. | 15 de febrero de 2026. |  |  |
| Complementario. | 16 de febrero de 2026. | Albacete, Almería, Badajoz, Illes Balears, Cádiz, Castelló/Castellón, Córdoba, Huelva, Jaén, Las Palmas, Santa Cruz de Tenerife, Sevilla y València/Valencia. | 31 de marzo de 2026. |
| 16 de febrero de 2026. | Alacant/Alicante, Burgos, Cáceres, León, Murcia, Palencia, Salamanca, Segovia, Soria, Valladolid, Zamora, Zaragoza (excepto la comarca de Caspe) y comarca Cuenca del Jiloca (Teruel). | 30 de abril de 2026. |  |
| Resto del ámbito. | 15 de abril de 2026. |  |  |

| Seguro | Inicio de suscripción | Ámbito de aplicación | Final de suscripción |
| --- | --- | --- | --- |
| Principal. | 16 febrero de 2026. | Albacete, Almería, Badajoz, Illes Balears, Cádiz, Castelló/Castellón, Córdoba, Huelva, Jaén, Las Palmas, Santa Cruz de Tenerife, Sevilla y València/Valencia. | 31 de marzo de 2026. |
| Principal. | 16 febrero de 2026. | Alacant/Alicante, Burgos, Cáceres, Murcia, Palencia, Salamanca, Segovia, Soria, Valladolid, Zamora, Zaragoza (excepto la comarca de Caspe y Calatayud) y comarca Cuenca del Jiloca (Teruel). | 30 de abril de 2026. |
| León y Calatayud (Zaragoza). | 10 de mayo de 2026. |  |  |
| Resto del ámbito. | 15 de abril de 2026. |  |  |

| Seguro | Inicio de suscripción | Ámbito de aplicación | Final de suscripción |
| --- | --- | --- | --- |
| Principal. | 16 febrero de 2026. | Albacete, Almería, Badajoz, Illes Balears, Cádiz, Castelló/Castellón, Córdoba, Huelva, Jaén, Las Palmas, Santa Cruz de Tenerife, Sevilla y València/Valencia. | 31 de marzo de 2026. |
| Alacant/Alicante, Burgos, Cáceres, Murcia, Palencia, Salamanca, Segovia, Soria, Valladolid, Zamora, Zaragoza (excepto la comarca de Caspe y Calatayud) y comarca Cuenca del Jiloca (Teruel). | 30 de abril de 2026. |  |  |
| León y Calatayud (Zaragoza). | 10 de mayo de 2026. |  |  |
| Principal. | 16 febrero de 2026. | Resto del ámbito. | 15 de abril de 2026. |
...
| Grupo II.3B (California 1B). | Burlat^(1)^, Moreau, Precoce Bernat, Red Pacific, Royal Tioga, Sweet Early. | 144 | 193 |  |
...
| Grupo II. 5B (California 3B). | Ambrunesa especial o acanalada, Castañera o Revenchón, Early Van Compact, Guadalupe, Marmotte, Ruby, Santina Sonata, Van^(1)^, Vera, 4-84, 13N -659, 13S 3 13. | 115 | 154 |  |
| Grupo II.6 (California 5). | Canada Giant, Larian, New Star, Prime Giant, Samba (13 S 36 18), Sumburst, Summit, Sandra Rose. | 115 | 154 |  |
| Grupo II.7 (California 4). | Bing, Duroni 1, Duroni 3, Duroni Negro, Hudson, Lapins^(1)^, Sam, Skeena, Sommerset, Summer Charm o Staccato, Summerland, Sweet Heart (228), Symphony, WW 44. | 115 | 154 |  |
...
| ^(1)^Para las parcelas calificadas por la Denominación de Origen Protegida «Cereza del Jerte» y exclusivamente para las variedades amparadas por la misma los precios máximos a efectos del seguro podrán incrementarse hasta 10 euros/100 Kg.
 ^(2)^Para las variedades Lapins y Sweet Heart, en la Comarca de La Bureba (Burgos), el precio máximo a efectos del seguro será de 180 euros/100 kg. |  |  |  |  |

| Tipos de plantón | Euros/unidad |  |
| --- | --- | --- |
| Precios mínimos | Precios máximos |  |
| Plantones. | 4 | 6 |
