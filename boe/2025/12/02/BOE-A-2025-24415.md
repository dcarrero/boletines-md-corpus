---
identificador: "BOE-A-2025-24415"
titulo: "Resolución de 25 de noviembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Gestión de Apoyo a la Docencia y a la Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "289"
pagina_inicial: 157433
pagina_final: 157447
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-24415"
url_pdf: "https://www.boe.es/boe/dias/2025/12/02/pdfs/BOE-A-2025-24415.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-24415"
url_eli: ""
fetched_at: "2026-04-10T06:08:10Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 25 de noviembre de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Gestión de Apoyo a la Docencia y a la Investigación.
...
1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala de Gestión de Apoyo a la Docencia y a la Investigación de la Universidad de Granada, Grupo A, Subgrupo A2, (Sala Limpia para Laboratorio de Nanoelectrónica y Materiales bidimensionales del CITIC-UGR).
...
e) Estar en posesión del título de Grado, Diplomado, Ingeniero Técnico, Arquitecto Técnico, o equivalente de conformidad con la normativa de aplicación, o de la justificación acreditativa de haberlo solicitado y abonado los correspondientes derechos para su obtención.
...
Granada, 25 de noviembre de 2025.–El Rector, Pedro Mercado Pacheco.
...
1. Física avanzada de semiconductores: portadores, dopado, recombinación, transporte, modelos de dispositivos (diodos, BJT, MOSFET) y efectos de escala.

2. Arquitecturas de dispositivos y circuitos integrados: CMOS planar y tecnologías avanzadas (FDSOI, FinFET a nivel conceptual), sensores, MEMS básicos y dispositivos optoelectrónicos.

3. Diseño de circuitos integrados analógicos/mixtos para test de proceso: celdas de prueba, biasing, pads, ESD, referencias, anillos de test.

4. Diseño de máscaras y layout: reglas de diseño, DRC/LVS, parásitos, topologías, retículas; herramientas CAD (p. ej., KLayout/Cadence).

5. Fabricación de fotomáscaras: e-beam/laser writer, cromado, transparencia, resolución, limpieza y verificación de máscaras.

6. Planificación de flujos de procesos: árbol de operaciones, compatibilidades químicas, ventanas térmicas y de materiales, documentación de procesos.

7. Metrología dimensional y de espesor: perfilometría, elipsometría, reflectometría, AFM para rugosidad y espesor, calibraciones y trazabilidad.

Módulo B. Operación de sala limpia y seguridad

8. Clasificación de sala limpia y control de contaminación: ISO, flujo laminar, vestimenta, control de partículas, bio-contaminación, limpieza y verificación.

9. Vacío y gases: bombas (rotativas, turbo-moleculares), MFCs, líneas de gases especiales, purgas, leak-check, seguridad en gases comprimidos.

10. Gestión integral de seguridad: química (HF, peróxidos, solventes), criogénicos, láser/UV, alto voltaje y RF; permisos, formación, EPIs, hojas de datos (SDS).

11. Gestión de residuos y normativa: segregación, etiquetado, neutralización, almacenamiento temporal, trazabilidad, normativa ambiental aplicable.

12. Mantenimiento preventivo y resolución de incidencias: planes PM, repuestos críticos, diagnóstico de fallos en equipos de proceso y utilidades.

Módulo C. Procesos de deposición y tratamientos térmicos

13. CVD y PE-CVD: mecanismos de crecimiento, precursores, nucleación, uniformidad, tensiones, ejemplos (SiO₂, SiNₓ, a-Si, grafeno/2D a nivel práctico).

14. ALD: química de superficie, secuencias, conformalidad con elevado «aspect ratio», materiales típicos (Al₂O₃, HfO₂, TiO₂), control atómico de espesor.

15. Metalizaciones: evaporación térmica/e-beam y sputtering; capas de adhesión, stress film, pureza, tasas y máscaras de sombra; control de resistividad.

16. Oxidación y difusión: hornos, RTP, atmósferas secas/húmedas, drive-in, perfiles y caracterización eléctrica de óxidos.

17. Tratamientos térmicos y plasma: recocidos (forming gas), limpieza con O₂ plasma, descargas y compatibilidad con resinas. Recocidos con láser pulsado.

Módulo D. Litografía, resinas, ataque y grabado

18. Spin-coating y prebakes: viscosidad, perfiles, edge-bead removal, uniformidad.

19. Exposición y revelado: fuentes (i-line, h-line, UV), dosis/tiempo, focus/exposure matrix, positivos/negativos (p. ej., SU-8), control de CD.

20. Lift-off: bilayers, undercut, solventes, compatibilidad con metalización y limpieza post-proceso.

21. Ataque húmedo: selectividad y anisotropía en BOE, KOH, TMAH, grabados metálicos; cinética, stop-layers y seguridad.

22. RIE/ICP: química de grabado (fluorados/clorados), potencia RF, bias, passivation/etch, selectividad, perfil y rugosidad; endpoint detection.

23. Paginación, corte y preparación de dies: scribing, dicing, limpieza post-corte, manejo de obleas y dies, prevención de contaminación y daños.

24. Pasivaciones y recubrimientos protectores: SiNₓ/SiO₂, polímeros, barreras de humedad/iones, requisitos para encapsulado y test.

Módulo E. Integración, ensamblaje y encapsulado

25. Integración de procesos: compatibilidades químicas, térmicas y mecánicas; apilados; planificación de procesos y rendimientos.

26. Die-attach y packaging: adhesivos, soldaduras, underfill, sustratos (FR-4, Al₂O₃, Si), tipos de encapsulado y estándares de pines.

27. Wire bonding: ball/wedge, oro/aluminio/cobre, pull-test, shear-test, troubleshooting (heel crack, non-stick).

28. PCB de prueba y zócalos: diseño para test (DFT), impedancias, ESD, blindajes y cableado de baja interferencia.

Módulo F. Microfluídica y soft-lithography

29. Diseño de chips microfluídicos: régimen laminar, difusivo, mezcladores, válvulas y interfaces con electrónica/sensórica.

30. Moldeado y PDMS: resinas SU-8, curado, desmoldeo, tratamientos de superficie, unión PDMS-vidrio (plasma), fugas y biocompatibilidad.

31. Impresión 3D para moldes: materiales, resolución, post-curado, compatibilidad química; validación dimensional y sellado.

Módulo G. Caracterización eléctrica, óptica y estructural

32. Medidas eléctricas DC/AC: I-V, C-V, barridos, ruidos, conexiones de baja impedancia, blindaje, masas y mitigación de interferencias.

33. Técnicas avanzadas: cuatro puntas, TLMs, Van der Pauw y Hall; extracción de movilidad, concentración y resistencia laminar.

34. Microscopías y espectroscopías: óptica/confocal, AFM, Raman, SEM-EDX, elipsometría; preparación de muestra, calibración y análisis de datos.

35. Laboratorio de caracterización—gestión integral: colas de medida, Analisis del Sistema de medida, repetitibilidad y reproducibilidad, mantenimiento/calibración de equipos, libros de registro, control de calidad y trazabilidad.

Módulo H. Propiedad Intelectual y transferencia

36. Gestión de Propiedad Intelectual y Transferencia en Nanoelectrónica.
