---
identificador: "BOE-A-2025-25876"
titulo: "Resolución de 5 de diciembre de 2025, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema de acceso libre, a la categoría de Técnico Auxiliar de Laboratorios y Talleres."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "302"
pagina_inicial: 167478
pagina_final: 167499
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-25876"
url_pdf: "https://www.boe.es/boe/dias/2025/12/17/pdfs/BOE-A-2025-25876.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-25876"
url_eli: ""
fetched_at: "2026-04-10T07:11:26Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 5 de diciembre de 2025, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema de acceso libre, a la categoría de Técnico Auxiliar de Laboratorios y Talleres.

De conformidad con lo establecido en las Resolución del Rector de la Universitat Politècnica de València de fecha 11 de junio de 2025 («Diari Oficial de la Generalitat Valenciana» núm. 10133, de fecha 18 de junio de 2025) por la que se aprueba la oferta de empleo público para el año 2025 y con el fin de atender las necesidades de personal en esta Universitat, en ejercicio de las atribuciones previstas en el artículo 50 de la Ley Orgánica 2/2023, de 22 de marzo, del Sistema Universitario y en el artículo 152.3 del Decreto 122/2024, de 24 de septiembre, del Consell, por el que se aprueban los Estatutos de la Universitat Politècnica de València,
...
1.1 Esta convocatoria tiene por objeto la selección de personal, mediante el sistema de concurso-oposición por el turno libre, para cubrir una (1) vacante del grupo C, subgrupo C1, sector de Administración Especial, técnico auxiliar de laboratorios y talleres en el área ingeniería mecánica y materiales en la Universitat Politècnica de València.
...
Las preguntas de reserva forman parte del ejercicio, si bien únicamente serán corregidas y valoradas si se produce alguna anulación del resto de pregunta, en caso contrario no serán objeto de corrección ni de valoración por el órgano técnico de selección.
...
Cada supuesto será evaluado con una puntuación de 0 a 12 puntos, y será necesario alcanzar un mínimo de 18 puntos en total para superar el ejercicio.
...
7.1.1 El primer ejercicio se puntuará de 0 a 24 puntos. Cada pregunta contestada erróneamente tendrá una penalización de un tercio sobre las correctas y las contestaciones en blanco no puntuarán. Será necesario obtener un mínimo de 12 puntos para superar este ejercicio.
...
7.1.2 El segundo ejercicio se puntuará de 0 a 36 puntos, siendo eliminadas las personas aspirantes que no alcancen un mínimo de 18 puntos.
...
Si el empate persiste entre dichas personas o las personas empatadas no tienen discapacidad, el orden se establecerá atendiendo, en primer lugar, a la mayor puntuación obtenida en el segundo ejercicio, y en segundo lugar, de mantenerse éste, a la mayor puntuación obtenida en el primer ejercicio.
...
8.3 Caso de realizarse el ejercicio en varias sesiones, el orden de intervención de las personas aspirantes comenzará por la letra «T», siguiendo el orden alfabético de apellidos conforme a la Resolución de 12 de marzo de 2025 de la Conselleria de Justicia y Administración Pública («Diari Oficial de la Generalitat Valenciana» núm. 10068, de 17 de marzo de 2025).
...
El órgano técnico elevará al rector las listas definitivas de las personas aspirantes que han aprobado las pruebas por orden de puntuación, para su publicación en el «Diari Oficial de la Generalitat Valenciana».
...
13.1 La Universitat Politècnica de València (UPV), con domicilio en camino de Vera, s/n, 46022 Valencia, es la responsable del tratamiento de la información y de los datos personales.
...
Valencia, 5 de diciembre de 2025.–El Rector, José Esteban Capilla Romá.
...
– Manejo y preparación metalográfica de muestras mediante corte, desbaste, pulido y ataque químico para su observación mediante microscópica óptica.

– Preparación y caracterización morfológica mediante microscopía electrónica.

– Obtención y caracterización mecánica de materiales: tracción, flexión, fatiga, dureza y microdureza. Manejo de equipos para la realización de ensayos mecánicos (tracción, compresión y flexión), ensayos de impacto Charpy, ensayos de dureza y microdureza.

– Manejo de hornos y sistemas para fusión y tratamientos térmicos con atmósferas controladas.

– Manejo básico de técnicas de ensayos no destructivos.

– Preparación y caracterización de propiedades térmicas, eléctricas y magnéticas de materiales.
...
Bloque 1. Composición y estructura de los materiales

4. Estructura de los materiales. Materiales Cristalinos y amorfos. Difracción de rayos X. Microscopía óptica aplicada a materiales. Preparación de muestras: corte, desbaste, pulido y ataque químico y térmico. Preparación de muestras para la observación microscópica electrónica de barrido.

5. Análisis y determinación del tipo de estructura. Tipos de defectos y control del tamaño de grano.

6. Diagramas de fases. Aleaciones con solubilidad total en estado sólido. Aleaciones con solubilidad parcial en estado sólido. Transformaciones eutécticas. Aleaciones con transformación eutéctica. Aleaciones con transformación eutectoide. Aceros. Diagrama Fe-C. Efecto de los aleantes en las transformaciones.

7. Tratamientos fuera del equilibrio. Endurecimiento por precipitación. Envejecimiento y sobrenvejecimiento. Transformación martensítica. Aceros de temple y revenido. Curvas TTT. Tratamientos de recocido y normalizado. Revenido de aceros.

8. Aleaciones metálicas I: Aceros. Clasificación. Aceros de construcción de uso general. Aceros de temple y revenido. Criterios de selección. Aceros especiales de fácil mecanización.

9. Aleaciones metálicas II: Aleaciones ligeras. Aleaciones de aluminio. Clasificación. Tratamientos térmicos y aplicaciones.

10. Materiales cerámicos. Cerámicas tradicionales. Cementos y hormigones. Cerámicas técnicas de alta tenacidad. Cerámicas refractarias. Materias primas. Procesado. Comportamiento mecánico de cerámicas.

11. Materiales poliméricos. Termoplásticos de uso general, termoplásticos técnicos y elastómeros. Estructura y propiedades. Propiedades y aplicaciones. Composites: propiedades y métodos de fabricación.

Bloque 2. Propiedades de los materiales para ingeniería

12. Propiedades mecánicas de los materiales. Comportamiento elástico y plástico. Resistencia y ductilidad. Tenacidad y fractura. Efectos de la naturaleza del material y de la estructura.

13. Ensayos de caracterización mecánica: Ensayos de tracción, flexión, compresión, fatiga y dureza. Tenacidad y resiliencia.

14. Propiedades térmicas de los materiales. Capacidad calorífica y calor específico. Conductividad térmica. Coeficiente de dilatación térmica. Tensiones térmicas. Ensayos de caracterización.

15. Propiedades eléctricas de los materiales. Conductividad. Conductores y semiconductores. Materiales aislantes.

16. Propiedades magnéticas de los materiales. Estructura magnética. Materiales magnéticos blandos y duros. Propiedades y aplicaciones.

Bloque 3. Tecnología de materiales

17. Procesos de solidificación y colada de materiales metálicos. Defectología y control de la microestructura.

18. Procesos de deformación plástica de materiales. Endurecimiento de metales por deformación plástica: acritud. Deformación en caliente. Tratamientos térmicos de recuperación y alivio de tensiones. Recocidos de recristalización: ablandamiento de las estructuras deformadas.

19. Principios generales de soldadura. Técnicas de soldeo en estado sólido. Técnicas de soldeo por fusión. Soldabilidad de aleaciones metálicas. Adhesivos.

20. Tratamientos térmicos y termoquímicos (Nitruración y/o Cementación). Temple superficial. Recubrimientos CVD y PVD. Proyección térmica. Recubrimientos electrolíticos y electrostáticos

21. Técnicas de obtención de materiales sinterizados. Pulvimetalurgia. Preparación y obtención de polvos. Compactación. Sinterización. Tratamientos de acabado.

22. Ensayos no destructivos para la detección de defectos: Líquidos penetrantes y partículas magnéticas. Fundamentos de ultrasonidos y radiografía industrial.

23. Fundamentos de corrosión. Corrosión seca y húmeda. Tipos de corrosión. Ensayos de corrosión. Estrategias de diseño frente a la corrosión.

24. Procesado de materiales termoplásticos. Aditivos y cargas Reología. Principios de la inyección y extrusión. Procesos secundarios. Aplicaciones.

25. Diseño con materiales compuestos. Matrices y refuerzos. Procesos de fabricación. Aplicaciones.

Bloque 4. Informática

26. El entorno de trabajo de Windows. Internet. Navegación. Búsqueda de Información. La página web de la Universitat Politècnica de València. Correo electrónico. Antivirus y cortafuegos.

27. Creación de documentos en Word. Edición e impresión. Formatos, ortografía y gramática. Diseño de páginas y tablas. Estilos, imágenes y gráficos.

28. Hoja de cálculo Excel. Generación, edición e impresión de hojas. Operaciones básicas. Funciones. Gráficas. Generación y edición de diapositivas y presentaciones con Powerpoint.

29. Software específico: GRANTA Edupack (ANSYS).
