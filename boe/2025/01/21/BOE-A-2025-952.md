...
pagina_inicial: 8432
pagina_final: 8437
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-952"
url_pdf: "https://www.boe.es/boe/dias/2025/01/21/pdfs/BOE-A-2025-952.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-952"
url_eli: ""
fetched_at: "2026-04-08T19:06:30Z"
...
Esta Subsecretaría, en uso de las atribuciones conferidas en el artículo 63 de la Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público, acuerda convocar la provisión, por el procedimiento de libre designación, de los puestos de trabajo que se relacionan en el anexo I de la presente resolución, con arreglo a las siguientes
...
| Orden | Centro directivo/Puesto de trabajo | Núm. plazas | Nivel | C.E | Localidad | Admón. | Grupo | Funciones | Requisitos | Observaciones |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | *Dirección General de Protección Civil y Emergencias* |  |  |  |  |  |  |  |  |  |
| 1 | Subdirección General de Gestión de Recursos y Subvenciones. | 1 | 30 | 29.112,02 | Madrid. | AE | A1 | Detección y análisis de necesidades de las diferentes áreas de gestión para la elaboración de la propuesta de presupuesto.
 Gestión órgano de contratación de22 la Dirección General de Protección Civil y Emergencias(DGPCE).
 Gestión de la Caja Pagadora de la DGPCE.
 Indemnizaciones por razón del servicio.
 Preparación y tramitación de Reales Decretos-ley y otro tipo de normativa dictados por el Gobierno de la Nación para el establecimiento de medidas urgentes para paliar daños derivados de catástrofes.
 Preparación y coordinación de informes de Comisiones interministeriales de seguimiento de Reales Decretos-ley.
 Control administrativo y contable de expedientes de en el marco del Real Decreto 307/2005 para paliar los daños producidos en situaciones de emergencia o naturaleza catastrófica.
 Análisis y valoración de expedientes de subvenciones a municipios incluidos en los planes de emergencia nuclear.
 Preparación de expedientes de tramitación de ampliaciones de crédito. | Experiencia en funciones directivas.
 ...
 Experiencias en modificaciones de credito, ampliaciones de crédito
 Formación acreditada en contratación.
 Formación acreditada en gestión económica y documental.
 Formación acreditada en subvenciones
 Antigüedad mínima de 1 año como funcionario de carrera A1.
 Licenciado/Máster en Ciencias Económicas y Empresariales o Ingeniería. | La idoneidad del aspirante se evaluará a través de su CV, la justificación de idoneidad remitida y el cuestionario de autoevaluación.
