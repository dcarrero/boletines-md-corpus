---
identificador: "BOE-A-2025-15099"
titulo: "Resolución de 15 de julio de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Comunicación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 97382
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-15099"
url_pdf: "https://www.boe.es/boe/dias/2025/07/21/pdfs/BOE-A-2025-15099.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-15099"
url_eli: ""
fetched_at: "2026-04-09T09:33:13Z"
...
El Rector, en uso de las competencias atribuidas en el artículo 50 de la Ley Orgánica 2/2023, de 22 de marzo, del Sistema Universitario, en relación con el artículo 3.2.j) de la misma norma, así como en los artículos 45 y 162 de los Estatutos de esta Universidad, ha resuelto convocar proceso selectivo de acceso libre para el ingreso en la Escala Básica de Comunicación de esta Universidad, de acuerdo con las siguientes

Bases

1. Normas generales

1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala Básica de Comunicación de la Universidad de Granada, Grupo C, Subgrupo C1, (Técnico/a N7-Diseño Gráfico).
...
f) No poseer la condición de personal funcionario de carrera de la Escala Básica de Comunicación de la Universidad de Granada.
...
Seleccionando como destino el Servicio de Personal Técnico, de Gestión y de Administración y Servicios.
...
Granada, 15 de julio de 2025.–El Rector, Pedro Mercado Pacheco.
...
1. Diseño editorial para publicaciones institucionales: principios de maquetación, composición y tipografía.

2. Materiales, tecnología y producción gráfica: color, preimpresión, arte final y técnicas de impresión.

3. Programas de autoedición y maquetación: Adobe InDesign.

4. Base y fundamentos de la fotografía digital. Optimización y manipulación digital: procesado y tratamiento digital, mejora y optimización de las fotografías digitales.

5. Programas para el tratamiento de imágenes y fotografía digital: Adobe Photsoshop y Adobe Lightroom.

6. Conceptos básicos de edición y postproducción de video. Adobe Premiere.

7. Diseño vectorial: creación de iconos y logotipos. Ilustración aplicada al diseño y la comunicación corporativa: Ilustración científica, editorial y publicitaria. Técnicas de Ilustración digital.

8. Programas de diseño vectorial: Adobe Illustrator.

9. Conceptos básicos de diseño web: Lenguaje etiquetado (HTML), elementos estructurales y semánticos. Hojas de Estilo (CSS). Normas básicas de accesibilidad web.

10. Identidad visual corporativa en la Universidad de Granada: normativa y niveles de identificación institucional.

11. Identidad visual corporativa en la Universidad de Granada: manual de identidad visual.

12. Identidad visual corporativa en la Universidad de Granada: plantillas y modelos de documentos.
...
15. Diseño gráfico e imagen de marca aplicado a las redes sociales de la Universidad de Granada.

16. Cartelería digital en el ámbito de la Universidad de Granada.

17. Herramientas de IA para el diseño gráfico y el tratamiento de imágenes. Recomendaciones de uso de la IA en la UGR.
...
Primer ejercicio: Tendrá carácter eliminatorio y consistirá en contestar un cuestionario de 100 preguntas, con cuatro respuestas alternativas, de las que solo una será correcta, basado en el contenido del programa que figura como anexo I de esta convocatoria. Para la realización de este ejercicio las personas aspirantes dispondrán de cien minutos.
...
– NC (nota de corte): La puntuación mínima necesaria para superar el ejercicio será la correspondiente al 50 por 100 de la media aritmética de referencia (MAR), no pudiendo en ningún caso ser inferior al 35 por 100 del número de preguntas válidas (NPV) determinado para el ejercicio. La fórmula a aplicar será la siguiente:
