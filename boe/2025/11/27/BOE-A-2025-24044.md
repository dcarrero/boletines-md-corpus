---
identificador: "BOE-A-2025-24044"
titulo: "Resolución de 19 de noviembre de 2025, de la Subsecretaría, por la que se convoca concurso general para la provisión de puestos de trabajo."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 155067
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-24044"
url_pdf: "https://www.boe.es/boe/dias/2025/11/27/pdfs/BOE-A-2025-24044.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-24044"
url_eli: ""
fetched_at: "2026-04-10T05:48:16Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 19 de noviembre de 2025, de la Subsecretaría, por la que se convoca concurso general para la provisión de puestos de trabajo.
...
Madrid, 19 de noviembre de 2025.–El Subsecretario de Trabajo y Seguridad Social, José Ramón del Prado Cortés.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1 | 4686325 | JEFE / JEFA DE SECCIÓN DE APOYO GESTIÓN. | - MADRID.
 - MADRID. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Confección de nómina de personal funcionario, laboral y personal en el exterior, mediante la aplicación NEDAES, así como la rendición de sus cuentas justificativas.
 - Conciliación de Seguros Sociales e intercambio de información de cotización con la Tesorería de la Seguridad Social mediante las aplicaciones SILTRA y NEDAES. Control de las situaciones especiales de cotización y de deuda con la Seguridad Social.
 - Tramitación del expediente de pago de los seguros sociales mediante la aplicación SOROLLA2. Vigilancia, previsión y gestión presupuestaria del Concepto 160: Cuotas sociales, mediante las aplicaciones SOROLLA2 y CINCONET.
 - Gestión de problemas de cotización como autorizado del Sistema RED de la Seguridad Social. Consulta, gestión y modificación de los datos de cotización de los trabajadores. Comunicaciones mediante el sistema CASIA.
 
 **Perfil formativo/Cursos de formación:**
 
 - Getión económica-presupuestaria.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 1 | 2009262 | JEFE / JEFA DE SECCIÓN DE APOYO GESTIÓN. | - MADRID.
 - MADRID. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Control y seguimiento de la jornada y horario de trabajo mediante aplicaciones informáticas.
 - Tramitación de permisos, licencias, autorizaciones de flexibilidad horaria y de régimen de trabajo a distancia.
 - Tramitación de situaciones de incapacidad temporal del personal funcionario y laboral a través de SIGP y del sistema RED.
 - Certificación de horarios, permisos y licencias del personal funcionario y laboral.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3 | 1 | 1219127 | JEFE / JEFA DE SECCIÓN N22. | - MADRID.
 - MADRID. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación de expedientes de contratos menores de obras y servicios.
 - Realización de documentos contables y propuestas de gasto en la aplicación Sorolla 2.
 - Tramitación de anticipos de caja fija de suministros y servicios.
 - Manejo de las aplicaciones informáticas necesarias para el desempeño del puesto de trabajo y en la gestión de facturas electrónicas para el pago.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 7,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 4 | 1 | 4085002 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación de contratos menores de los servicios y suministros de las áreas de cafetería-comedor.
 - Tramitación de anticipos de caja fija en servicios y suministros en las áreas de cafetería-comedor y mantenimiento.
 - Control y gestión del consumo y gasto energético a través de la aplicación SigeeAge.
 - Uso y manejo de los programas de ofimática propios: Sorolla, Portafirmas y DocelWeb.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 7,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 5 | 1 | 4152635 | AYUDANTE DE OFICINA N14. | - MADRID.
 - MADRID. | 14 | 8.409,52 | C2 | AE | EX11 |  |  | APC1 | **Descripción del puesto de trabajo:**
 
 - Manejo y uso de la aplicación informática Geiser.
 - Apoyo administrativo en la gestión del servicio de notificaciones electrónicas de la Dirección Electrónica Habilitada Única (DEHú).
 - Gestión de situaciones administrativas, tramitación de documentos y seguimiento de las distintas bases de datos.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 6 | 1 | 4985556 | ANALISTA PROGRAMADOR. | - MADRID.
 - MADRID. | 20 | 6.638,10 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Administración de servidores de aplicaciones y web: gestión de JBoss en alta disponibilidad, despliegues J2EE y servidores Apache HTTPD Y Tomcat y administración de certificados asociados a dominios DNS.
 - Integración continua y automatización de procesos: desarrollo de tareas y administración de Jenkins para CI/CD en servidores JBoss y Apache y gestión y mantenimiento de procesos batch y tareas planificadas.
 - Migraciones y nuevas arquitecturas de entornos web: actualización de versiones de servidores web y de aplicaciones, herramientas de integración continua y análisis de implantación de arquitecturas software.
 - Monitorización, gestión de incidencias y coordinación técnica: gestión y explotación de herramientas de monitorización (Dynatrace, Nagios), administración de paneles y métricas y soporte a equipos de asistencia mediante herramientas de ticketing (Jira, SysAid).
 ...
 **Méritos específicos:**
 ...
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 7 | 1 | 5035731 | ANALISTA PROGRAMADOR. | - MADRID.
 - MADRID. | 20 | 6.638,10 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Desarrollo y mantenimiento informático de la tramitación y gestión electrónica del Registro de Cooperativas y Sociedades Laborales, a través de la aplicación COOPERATIVAS.
 - Soporte técnico y mantenimiento de la aplicación SERENA para la gestión electrónica de expedientes de Regulación de Empleo.
 - Desarrollo, mantenimiento y soporte informático para la tramitación del Registro de Elecciones Sindicales, a través de la aplicación ELECSIA.
 - Despliegue de aplicaciones web en Java J2EE, con arquitectura de tres capas, sobre servidores Apache y JBOSS, así como la arquitectura single page application (SPA) con Angular con manejo de base de datos Oracle y plataformas horizontales de la administración electrónica así como la utilización de las herramientas Eclipse - JIRA - SVN - Jenkins – Artifactory – Testlink.
...
| 8 | 1 | 3959772 | ANALISTA PROGRAMADOR. | - MADRID.
 - MADRID. | 18 | 6.638,10 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Colaboración en el mantenimiento y desarrollo de las siguientes aplicaciones del servicio de Desarrollo para el Fondo Social Europeo: FSEPLUS, FSE1420, FEAD. IDRF, FEADIGAE y FSE1420IGAE.
 - Seguimiento de los evolutivos e incidencias surgidas sobre las aplicaciones del Fondo Social Europeo, utilizando la herramienta JIRA para su gestión, y supervisión de los despliegues de las aplicaciones en entornos previos a producción para su validación, mediante el uso de metodologías ágiles y herramientas como SVN - Jenkins - Artifactory.
 - Revisión y elaboración de la documentación técnica de las aplicaciones del Fondo Social Europeo, principalmente documentos de requisitos, análisis funcionales, diseños técnicos y planes de pruebas.
 - Realización de pruebas unitarias e integradas de las aplicaciones del Fondo Social Europeo, en entornos no productivos para verificar la subsanación de las incidencias e implementación de evolutivos.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 9 | 1 | 3998798 | JEFE / JEFA DE SECCIÓN N22. | - MADRID.
 - MADRID. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Relaciones con órganos jurisdiccionales: gestión y tramitación de procedimientos judiciales, así como el envío y recepción de comunicaciones oficiales a los tribunales de Justicia.
 - Jefatura y coordinación del registro del órgano administrativo.
 - Manejo de la aplicación INSIDE (Infraestructura y Sistemas de Documentación Electrónica).
 - Colaboración en el diseño, desarrollo y mejora de aplicaciones informáticas vinculadas a la gestión administrativa y documental.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 10 | 1 | 3699015 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Organización y control de almacén de publicaciones.
 - Gestión de la difusión institucional y distribución comercial de las publicaciones.
 - Elaboración de albaranes de difusión y distribución comercial.
 - Manejo del programa informático GANES de Correos.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 11 | 1 | 4283108 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Control de depósitos, gestión de transferencias y proceso técnico.
 - Descripción y expurgo de la documentación.
 - Implementación Archivo electrónico.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 12 | 1 | 1073736 | PROGRAMADOR / PROGRAMADORA DE PRIMERA. | - MADRID.
 - MADRID. | 17 | 6.200,60 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Relaciones con órganos jurisdiccionales: gestión y tramitación de procedimientos judiciales así como el envío y recepción de comunicaciones oficiales a los tribunales de Justicia.
 - Colaboración en el diseño, desarrollo y mejora de aplicaciones informáticas vinculadas a la gestión administrativa y documental con el personal TIC.
 - Manejo de la aplicación INSIDE (Infraestructura y Sistemas de Documentación Electrónica).
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 13 | 1 | 2833745 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.060,14 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo a la gestión de expedientes administrativos.
 - Experiencia en el uso de las aplicaciones informáticas Excel y Word.
 - Conocimientos de GEISER.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 14 | 1 | 4349750 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Atención telefónica y derivación de las consultas que se reciben de las CCAA, los organismos de la Administración General del Estado y las entidades de acción social.
 - Preparación y realización de los envíos de documentación, convocatorias de reuniones y comunicaciones, incluido el mantenimiento y actualización de los buzones de correo electrónico.
 - Asistencia en la preparación y justificación de las comisiones de servicio en relación con desplazamientos, viajes y estancias de trabajo.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 15 | 1 | 2564019 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Atención telefónica y derivación de las consultas que se reciben de las CCAA, los organismos de la Administración General del Estado y las entidades de acción social.
 - Preparación y realización de los envíos de documentación, convocatorias de reuniones y comunicaciones, incluido el mantenimiento y actualización de los buzones de correo electrónico genéricos.
 - Asistencia en la preparación y justificación de las comisiones de servicio en relación con desplazamientos, viajes y estancias de trabajo.
 - Asistencia en la organización de reuniones y actos públicos, tanto nacionales como internacionales.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 1 | 907141 | JEFE / JEFA DE SECCIÓN N22. | - MADRID.
 - MADRID. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Recepción, depuración y validación de la información recibida mensualmente de las Autoridades Laborales competentes referida a las distintas modalidades de regulación de empleo.
 - Interlocución con las distintas Autoridades Laborales para la reclamación y la resolución de inconsistencias estadísticas surgidas del tratamiento de los datos estadísticos de regulación de empleo.
 - Proceso y gestión integral de los datos de los diferentes tipos de procedimientos de regulación de empleo en el ámbito del territorio nacional, con la finalidad de la elaboración y publicación de la Estadística de Regulación de Empleo.
...
| 17 | 1 | 3293625 | JEFE / JEFA DE SECCIÓN N22. | - MADRID.
 - MADRID. | 22 | 4.704,56 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Revisión de los datos cumplimentados en formularios estadísticos.
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 8,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 7,00 pts.). |  |
| 18 | 1 | 3574721 | JEFE / JEFA DE SECCIÓN DE ESTADÍSTICA N22. | - MADRID.
 - MADRID. | 22 | 4.704,56 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tratamiento de información relacionada con áreas de seguridad social o empleo.
 - Manejo de ficheros de datos para su tratamiento y elaboración de estadístcas e informes.
 - Utilización de hojas de cálculo, gestión de datos y herramientas de BI.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 19 | 1 | 4718164 | JEFE / JEFA DE SECCIÓN N22. | - MADRID.
 - MADRID. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión de registros de entrada y salida de documentos (GEISER, INSIDE, etc.).
 - Tramitación de expedientes de negociación colectiva (REGCON).
 - Tramitación de expedientes administrativos de otras áreas.
...
| 20 | 1 | 787512 | JEFE / JEFA DE SECCIÓN N22. | - MADRID.
 - MADRID. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 10,00 pts.). |  |
| 21 | 1 | 905652 | JEFE / JEFA DE SECCIÓN N20. | - MADRID.
 - MADRID. | 20 | 5.012,84 | A2
 C1 | AE |  |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión de registros de entrada y salida de documentos (GEISER, INSIDE, etc).
 - Tramitación de otros expedientes administrativos en materia de relaciones laborales.
 - Tramitación de expedientes de regulación de empleo y uso de la aplicación SERENA.
 ...
 **Méritos específicos:**
 ...
 1. Experiencia en tareas similares a las de la función 1 (máx: 5,00 pts.).
 2. Experiencia en tareas similares a las de la función 2 (máx: 15,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 22 | 1 | 1831657 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 ...
 **Méritos específicos:**
 ...
 1. Experiencia en tareas similares a las de la función 1 (máx: 5,00 pts.).
 2. Experiencia en tareas similares a las de la función 3 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.). |  |
| 23 | 1 | 3703578 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 10,00 pts.). |  |
| 24 | 1 | 4465297 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 25 | 1 | 2512959 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.060,14 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Desempeño de funciones administrativas en el ámbito de la oficina.
 - Desempeño de funciones administrativas en un contexto internacional en las relaciones con Ginebra.
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 26 | 1 | 2978441 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.060,14 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Desempeño de funciones administrativas.
 - Desempeño de funciones administrativas en un contexto internacional.
 - Atención telefónica al público.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 27 | 1 | 1403040 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.060,14 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 28 | 1 | 2206393 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.060,14 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 29 | 1 | 2922106 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.060,14 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 30 | 1 | 5671751 | SECRETARIO / SECRETARIA DE SUBDIRECTOR GENERAL. | - MADRID.
 - MADRID. | 16 | 7.296,94 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tareas de secretaría, manejo de agenda, correo electrónico y atención telefónica.
 - Registro electrónico de entrada y salida de documentos.
 - Redacción de notas y utilización de programas para publicación de noticias en páginas institucionales.
 - Archivo de la documentación oficial, correspondencia, informes y otros documentos.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 31 | 1 | 1894132 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 ...
 - Atención telefónica.
 - Utilización de aplicaciones informáticas GEISER o Portafirmas, así como procesadores de textos, hojas de cálculo y correo electrónico.
...
| 32 | 1 | 957316 | JEFE / JEFA DE NEGOCIADO N18. | - MADRID.
 - MADRID. | 18 | 4.704,56 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
