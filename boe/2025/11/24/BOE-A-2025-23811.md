...
pagina_final: 153613
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-23811"
url_pdf: "https://www.boe.es/boe/dias/2025/11/24/pdfs/BOE-A-2025-23811.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-23811"
url_eli: ""
...
Y de otra, doña Fabiola García Martínez, Conselleira de Política Social e Igualdad, en nombre y representación de la Comunidad Autónoma de Galicia, en virtud de lo dispuesto en la Ley 1/1983, de 22 de febrero, del Gobierno y Administración de Galicia, y de conformidad con el Decreto 139/2024, del 20 de mayo, por el que se establece la estructura orgánica de la Consellería de Política Social e Igualdad, y de conformidad con el acuerdo del Consejo de Gobierno de 3 de noviembre de 2025.
...
Que, por su parte, la Comunidad Autónoma de Galicia ha dispuesto, en sus presupuestos correspondientes al año 2025, créditos para la atención a las personas en situación de dependencia en aplicación de lo previsto en el artículo 32 de la Ley 39/2006, de 14 de diciembre.
...
La Comunidad Autónoma de Galicia aportará, para la financiación del presente convenio, con cargo a sus propios presupuestos, un crédito inicial de cincuenta y dos millones cuatrocientos sesenta y dos mil ochocientos once euros con ochenta y cinco céntimos euros (52.462.811,85 €), con cargo las aplicaciones presupuestarias 08.05.312D.228.1, 08.05.312E.228, 08.05-312D.460.0, 08.01-312D.480.3- y 08.04.312D.228.2.
...
Acción núm. 1. Plan especial de atención a la dependencia para reducir la lista de espera

| Descripción de la medida. | Se busca reducir la lista de espera tanto de las personas pendientes de valoración, como pendientes de PIA, de manera que el número pendiente de valoración sea inferior a 31 de diciembre, aun teniendo en cuenta el número de expedientes nuevos que se presentan diariamente. |
| --- | --- |
| Línea de base a 1 de enero de 2025. | Expedientes ptes de valoración: 39.
 Expedientes ptes. de PIA:1.256.
 Expedientes ptes. de PIA efectivo:1.464. |
| Impacto esperado sobre la lista de espera para 2025 (desde 1 de enero hasta 31 de diciembre). | Expedientes ptes de valoración: 30.
 Expedientes ptes. de PIA: 1.183.
 Expedientes ptes. de PIA efectivo: 800. |
| Indicadores de verificación de cumplimiento. |  |
| Determinación de costes previstos en 2025 derivados directamente de la medida/actuación. | 47.256.762,96 euros. |
| Observaciones. |  |

Acción núm. 2. Plan especial de atención a la dependencia para reducir la lista de espera

| Descripción de la medida. | Se buscan reducir los tiempos de tramitación. |
| --- | --- |
| Línea de base a 1 de enero de 2025. | Plazo entre Solicitud a Resolución grado: 257,20 días.
 Plazo entre Solicitud a Resolución de PIA:356,31 días. |
| Impacto esperado sobre la lista de espera para 2025 (desde 1 de enero hasta 31 de diciembre). | Plazo entre Solicitud a Resolución grado: 170 días.
 Plazo entre Solicitud a Resolución de PIA:350 días. |
| Indicadores de verificación de cumplimiento. | Tempos de tramitación. |
...
Acción núm. 3. Incremento de plazas públicas de atención residencial a personas mayores con dependencia
...
| Impacto esperado para 2025 (hasta 31 de diciembre de 2025). | 356 nuevas plazas públicas residenciales creadas. |
| Indicadores de verificación de cumplimiento. | Plazas públicas residenciales creadas. |
| Determinación de costes previstos en 2025 derivados directamente de la medida/actuación. | 1.519.344 euros. |
| Observaciones. |  |

Acción núm. 4. Creación de plazas de atención residencial y diurna para personas dependientes con discapacidad»

| Descripción de la medida. | Incremento de plazas en centros de atención residencial y diurna para personas con discapacidad. |
| --- | --- |
| Situación a 1 de enero de 2025. |  |
| Impacto esperado para 2025 (hasta 31 de diciembre de 2025). | 148 plazas creadas. |
| Indicadores de verificación de cumplimiento. | Las plazas nuevas creadas. |
| Determinación de costes previstos en 2025 derivados directamente de la medida/actuación. | 2.861.683,61 euros. |
| Observaciones. |  |

Acción núm. 5. Incremento de las intensidades en el servicio de ayuda a domicilio (título)

| Descripción de la medida. | Incremento intensidad horas SAD. |
| --- | --- |
| Situación a 1 de enero de 2025. | Intensidad media de los 3 grados (horas)=47,16. |
| Impacto esperado para 2025 (hasta 31 de diciembre de 2025). | Intensidad media de los 3 grados (horas)=49,20. |
| Indicadores de verificación de cumplimiento. | Intensidad media de los 3 grados de dependencia. |
| Determinación de costes previstos en 2025 derivados directamente de la medida/actuación. | 473.251,20 euros. |
| Observaciones. |  |

Acción núm. 6. Implantación de sistema de gestión de la calidad ISO 9001 en residencias de mayores con dependencia

| Descripción de la medida. | Con el objetivo de promover de forma continua la mejora de la calidad y proceder a la evaluación y acreditación de la misma, se lleva a cabo la implantación de la norma ISO 9001 en residencias de mayores con dependencia. La acreditación del cumplimiento de la norma se realiza a través de AENOR. |
| --- | --- |
| Situación a 1 de enero de 2025. | 11 residencias acreditadas. |
| Impacto esperado para 2025 (hasta 31 de diciembre de 2024). | 15 residencias acreditadas. |
| Indicadores de verificación de cumplimiento. | Residencias acreditadas. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 26.050,20 euros. |
| Observaciones. |  |

Acción núm. 7. Acreditación como centro libre de sujeciones por la Confederación Española Organizaciones de Mayores CEOMA

| Descripción de la medida. | Con el objetivo de promover de forma continua la mejora de la calidad se acreditan por la Confederación Española Organizaciones de Mayores CEOMA, como residencias libres de sujeciones. |
| --- | --- |
| Situación a 1 de enero de 2025. | 1 residencias acreditadas, |
| Impacto esperado para 2025 (hasta 31 de diciembre de 2024). | 2 residencias acreditadas. |
| Indicadores de verificación de cumplimiento. | Residencias acreditadas. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 6.655,00 euros. |
| Observaciones. |  |
...
Acción núm. 8. En las licitaciones tramitadas en el año 2025, se incrementó el precio/plaza/día en los centros de atención diurna para personas con alzhéimer

| Descripción de la medida. | En el año 2025, se procedió a incrementar el precio/plaza/día de las plazas de atención diurna para personas con alzhéimer en los centros de titularidad de la Xunta de Galicia de gestión externa en la modalidad de Concierto Social. |
| --- | --- |
| Situación a 1 de enero de 2025. | 41,50 euros/plaza día de atención diurna y 13,20 euros plaza/día de transporte vinculado a esas plazas. |
| Impacto esperado para 2025 (hasta 31 de diciembre de 2024). | Se incrementó el precio/plaza/día de pasando de 41,50 euros/plaza día de atención diurna a 42,45 euros y de 13,20 a 13,50 euros/plaza/día de transporte vinculado a esas plazas. |
| Indicadores de verificación de cumplimiento. | El incremento del precio/plaza/día. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 53.663,28 euros. |
| Observaciones. | Esta medida incide directamente en el salario de los trabajadores de los centros de atención diurna para personas con alzhéimer. |

Acción núm. 9. En las licitaciones tramitadas en el año 2025, se incrementó el precio/plaza/día de licitación hasta los 72,80 euros (70 euros + IVA)

| Descripción de la medida. | Así mismo, en las distintas licitaciones tramitadas a lo largo del 2025 cuyo objeto fue el servicio de atención residencial en centros titularidad de la Xunta de Galicia o reserva y ocupación de plazas residenciales en centros de titularidad privada, se incrementó el precio/plaza/día de licitación hasta los 72,80 euros (70 euros + IVA). |
| --- | --- |
| Situación a 1 de enero de 2025. | Supuso un incremento de entre 20-20 euros por plaza, teniendo en cuenta que hasta las nuevas licitaciones el precio/plaza/día estaba por debajo de los 60 euros. |
| Impacto esperado para 2025 (hasta 31 de diciembre de 2024). | La determinación del precio/plaza/día en 72,80 euros supuso un incremento de entre 20-20 euros por plaza, teniendo en cuenta que hasta las nuevas licitaciones el precio/plaza/día estaba por debajo de los 60 euros. |
| Indicadores de verificación de cumplimiento. | EL precio el precio/plaza/día de las licitaciones cuyo objeto fue el servicio de atención residencial. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 214.401,60 euros. |
| Observaciones. | Esta medida incide directamente en el salario de los trabajadores en centros residenciales. |

Acción núm. 10. Actividades formativas dirigidas a personal de los centros residenciales dependientes de la Consellería de Política Social e Igualdade

| Descripción de la medida. | Se desarrollarán cursos de formación dirigidos a personal de los centros residenciales públicos. |
| --- | --- |
| Situación a 1 de enero de 2025. |  |
| Impacto esperado para 2025 (hasta 31 de diciembre de 2024). | 2 cursos. |
| Indicadores de verificación de cumplimiento. | Realización de la formación. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 51.000 euros. |
| Observaciones. |  |
...
Que, según consta en los archivos de esta Comunidad Autónoma, se ha recibido de los Presupuestos Generales del Estado en el año 2025 del IMSERSO, una aportación por importe total de cincuenta y dos millones cuatrocientos sesenta y dos mil ochocientos once euros con ochenta y cinco céntimos (52.462.811,85 €), con cargo a la aplicación económica 31.34.451.2, siendo el estado de ejecución del ejercicio 2025 el que se especifica a continuación:

Aportaciones del Instituto de Mayores y Servicios Sociales en concepto de nivel acordado: 52.462.811,85 euros
