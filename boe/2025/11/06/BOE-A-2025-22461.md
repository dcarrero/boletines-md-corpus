---
identificador: "BOE-A-2025-22461"
titulo: "Resolución de 29 de octubre de 2025, de la Subsecretaría, por la que se convoca concurso específico para la provisión de puestos de trabajo en el Instituto Nacional de Seguridad y Salud en el Trabajo."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 145643
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-22461"
url_pdf: "https://www.boe.es/boe/dias/2025/11/06/pdfs/BOE-A-2025-22461.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-22461"
url_eli: ""
fetched_at: "2026-04-09T16:36:08Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 29 de octubre de 2025, de la Subsecretaría, por la que se convoca concurso específico para la provisión de puestos de trabajo en el Instituto Nacional de Seguridad y Salud en el Trabajo.

De conformidad con lo dispuesto en el artículo 20 de la Ley 30/1984, de 2 de agosto, de medidas para la reforma de la Función Pública y en el artículo 40.1 del Reglamento General de Ingreso del personal al servicio de la Administración General del Estado y de Provisión de puestos de trabajo y Promoción profesional de los funcionarios civiles de la Administración General del Estado, aprobado por Real Decreto 364/1995, de 10 de marzo, previa la aprobación de la Secretaría de Estado de Función Pública, dispongo convocar concurso específico para cubrir las vacantes, dotadas presupuestariamente, que se relacionan en el anexo a esta resolución, con arreglo a las siguientes bases.
...
1. Las solicitudes para tomar parte en este concurso se dirigirán a la Secretaría General del Instituto Nacional del Instituto General de Seguridad y Salud en el Trabajo, Avenida de Torrelaguna, 73, 28027 Madrid, ajustándose a los modelos publicados como anexos a esta resolución, y se presentarán en el plazo de quince días hábiles, a contar desde el siguiente al de la publicación de la presente convocatoria en el «Boletín Oficial del Estado».

Las instancias se presentarán través del Portal Funciona (Área Personal < Mis servicios de RRHH (Sigp) < concurso de méritos < Solicitud concurso de méritos), siendo imprescindible la acreditación por medio de certificado electrónico (DNI-e o certificado de la FNMT), sin perjuicio de lo indicado en esta base.
...
– Anexo V: Consentimiento para realizar consulta de verificación de datos de residencia (conciliación por cuidado de hijo/a o familiar).
...
Únicamente se podrán valorar los cursos que previamente figuren incluidos en el listado anual de cursos publicado por el Departamento u Organismo convocante, y en el área de conocimiento al que pertenezca el puesto objeto de valoración, que aparecen publicados en la página web de este organismo: https://www.insst.es/documents/d/portal-insst/concurso-especifico-insst-2025-catalogo-de-formacion.
...
Madrid, 29 de octubre de 2025.–El Subsecretario de Trabajo y Economía Social, José Ramón del Prado Cortés.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1 | 2569874 | CONSEJERO TECNICO / CONSEJERA TECNICA. | - MADRID.
 - MADRID. | 28 | 16.054,08 | A1 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo técnico a la Dirección en la planificación estratégica y operativa, así como en el seguimiento de proyectos estratégicos prioritarios en el ámbito de la seguridad y salud en el trabajo.
 - Redacción de informes y documentos técnicos y operativos requeridos por la Dirección, así como preparación de discursos, ponencias y presentaciones.
 - Coordinación de trabajos interdepartamentales y de grupos de trabajo internos estratégicos creados por la Dirección.
 - Coordinación control y seguimiento del grado de ejecución de planes, programas y proyectos institucionales de la Dirección, en coordinación con las unidades responsables.
 - Participación en órganos colegiados nacionales e internacionales relacionados con seguridad y salud en el trabajo y la prevención en riesgos laborales.
...
| 2 | 1 | 3352300 | JEFE / JEFA DE UNIDAD TECNICA. | - MADRID.
 - MADRID. | 27 | 15.073,94 | A1 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Elaboración y publicación de contenidos de la página web (publicaciones, noticias, materias/portales temáticos, entre otros) relacionados con la prevención de riesgos laborales.
 - Elaboración de documentación técnica relacionada con las actividades que llevan a cabo, a nivel nacional, las instituciones públicas, en relación con la prevención de riesgos laborales y la mejora de las condiciones de seguridad y salud en el trabajo.
 - Coordinación, diseño, supervisión, desarrollo y revisión ortográfica y de estilo de revista especializada sobre seguridad y salud en el trabajo y publicación de artículos científico-técnicos relacionados con la prevención de riesgos laborales.
 - Resolución de consultas técnicas relacionadas con el área web y con el área de publicaciones y asesoramiento en la gestión de consultas técnicas sobre prevención de riesgos laborales.
 - Coordinación, elaboración y publicación de contenidos relacionados con la prevención de riesgos laborales en redes sociales y Newsletter.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3 | 1 | 5074689 | JEFE / JEFA DE UNIDAD TECNICA. | - MADRID.
 - MADRID. | 27 | 15.073,94 | A1 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Planificación, ejecución y supervisión de campañas de comunicación multicanal (prensa, digital, TV, radio, Out of Home) y acciones enfocadas en la sensibilización sobre prevención de riesgos laborales, así como la coordinación de todos sus actores implicados (agencia creativa, agencia de compra de medios, Secretaria de Estado de Comunicación y grupos de trabajo técnicos).
 - Gestión estratégica de la imagen institucional, alineando la identidad, valores y acciones de la institución con una comunicación estratégica en soportes físicos (eventos, cartelería, folletos, mobiliario urbano para la información) y digitales (banners, landing pages, redes sociales).
 - Coordinación de relaciones con terceros y formalización en convenios y protocolos, así como la gestión de alianzas para impulsar los objetivos en materia de seguridad y salud en el Trabajo de la Organización.
 - Redacción y supervisión de pliegos de prescripciones técnicas para la contratación de servicios creativos así como para la contratación de servicios de compra de medios.
 - Planificación, creación y supervisión de contenidos especializados en seguridad y salud laboral, incluyendo notas de prensa, whitepapers, banners digitales, newsletter, publicaciones en redes sociales y materiales Out of Home, asegurando la alineación con normativas de comunicación pública y la optimización de campañas mediante herramientas de analítica digital (Google Analytics, social listening).
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 4 | 1 | 3270149 | CONSEJERO TECNICO / CONSEJERA TECNICA. | - MADRID.
 - MADRID. | 28 | 18.904,20 | A1 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Participación en la formulación, desarrollo y contratación de proyectos vinculados a políticas públicas de seguridad y salud en el trabajo, en particular de la Estrategia Española de Seguridad y Salud en el Trabajo.
 - Apoyo metodológico y estadístico en el desarrollo de proyectos.
 - Coordinación de grupos multidisciplinares de trabajo técnico de prevención de riesgos laborales y salud laboral.
 - Participación y asesoramiento en grupos de trabajo de la Comisión Nacional de Seguridad y Salud en el Trabajo.
 - Diseño y elaboración de informes específicos de salud laboral, siniestralidad y condiciones de trabajo en grupos o áreas de interés, integrando la perspectiva de género.
 ...
 **Méritos específicos:**
 ...
 5. Experiencia y/o conocimiento en tareas similares a las de la Función 5 (máx: 3,00 pts.). |  |
| 5 | 1 | 3802534 | COORDINADOR / COORDINADORA DE SISTEMAS DE PREVENCION. | - MADRID.
 - MADRID. | 28 | 15.073,94 | A1 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Funciones preventivas de nivel superior correspondiente a las tres especialidades y disciplinas preventivas de Seguridad en el Trabajo, Higiene Industrial, Ergonomía y Psicosociología Aplicada. Mediciones Higiénicas de agentes físicos, químicos y biológicos.
 - Planificación, coordinación y control de los procesos desarrollados en el Servicio de Prevención Propio. Elaboración, implantación, seguimiento de procedimientos del sistema de gestión de seguridad y salud laboral.
 - Diseño y elaboración de campañas de salud laboral. Diseño y desarrollo de materiales y estrategias de comunicación y campañas de sensibilización enfocadas a promover condiciones de trabajo seguras.
 - Diseño e impartición de actividades formativas en materia de prevención en riesgos laborales, incluyendo la participación en el curso de capacitación para el desempeño de funciones de prevención de nivel intermedio.
 - Participación en grupo de trabajo para evaluaciones de riesgos interna y como miembro de la Unidad de Igualdad.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 6 | 1 | 4073803 | JEFE / JEFA DE UNIDAD TECNICA. | - BARCELONA.
 - BARCELONA. | 27 | 15.073,94 | A1 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión y coordinación de equipo de trabajo en actividades centradas en la organización del trabajo e investigación psicosocial.
 - Organización e impartición de actividades formativas en diseño de proyectos, procedimientos y técnicas de investigación psicosocial.
 - Desarrollo y apoyo en proyectos de construcción y validación de herramientas de evaluación psicosocial.
 - Diseño y ejecución de la explotación de datos en proyectos de investigación, específicamente en el ámbito de los riesgos psicosociales.
 - Elaboración de publicaciones y documentos técnicos en materia de prevención de riesgos laborales, específicamente en los relacionados con diseño de estudios, metodologías y explotación de datos en investigación en ciencias sociales.
 ...
 **Méritos específicos:**
 ...
 4. Experiencia y/o conocimiento en tareas similares a las de la Función 4 (máx: 5,00 pts.).
 5. Experiencia y/o conocimiento en tareas similares a las de la Función 5 (máx: 5,00 pts.). |  |
| 7 | 1 | 4221684 | JEFE / JEFA DE SERVICIO. | - BARCELONA.
 - BARCELONA. | 26 | 12.721,10 | A1
 A2 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión de Recursos Humanos incluyendo: tramitación de expedientes de personal, control horario, absentismo, tramitación de altas, bajas, incidencias en afiliación a la Seguridad Social y MUFACE, utilizando aplicaciones informáticas específicas de la AGE en estas materias como Consulta del Registro Cental de Personal, SIGP, Sistema RED y TRAMA.
 - Gestión y control del servicio de mantenimiento, atendiendo las tareas relativas a la tramitación de expedientes de gasto, control y conformidad de facturas a través de la aplicación SOROLLA2.
 - Gestión en materia de contratación y presupuestos, utilizando aplicaciones informáticas específicas como DocelWeb y SOROLLA2. Elaboración y tramitación de informes, memorias y certificados de contratos administrativos.
 - Gestión, coordinación y liderazgo de equipos de trabajo en los ámbitos de trabajo de administración, personal, mantenimiento y registro.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia y/o conocimiento en tareas similares a las de la Función 3 (máx: 5,00 pts.).
 4. Experiencia y/o conocimiento en tareas similares a las de la Función 4 (máx: 5,00 pts.). |  |
| 8 | 1 | 1981297 | TECNICO / TECNICA DE PREVENCION N24. | - BARCELONA.
 - BARCELONA. | 24 | 10.785,32 | A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación administrativa y electrónica de expedientes, así como elaboración de documentos administrativos, archivo y registro.
 - Desarrollo de tareas de apoyo inherentes a la gestión administrativa.
...
| 9 | 1 | 2733753 | JEFE / JEFA DE SECCION. | - BARCELONA.
 ...
 - Desarrollo de tareas de apoyo inherentes a la gestión administrativa.
 - Manejo de aplicaciones informáticas.
 - Registro electrónico de entrada y salida de documentación a través de la Gestión Integrada de Servicios de Registro (GEISER).
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 10 | 1 | 1224737 | TECNICO / TECNICA SUPERIOR DE PREVENCION N26. | - MADRID.
 - MADRID. | 26 | 13.292,58 | A1 | A3 | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Participación en grupos de trabajo internacionales de normalización, y grupos de trabajo nacionales, en colaboración con las Comunidades Autónomas, en el ámbito de la prevención de riesgos laborales frente a la exposición a agentes físicos.
 - Participación en grupos de trabajo de estudio, investigación, asesoramiento y elaboración y actualización de Guías Técnicas de prevención de riesgos laborales en el campo de los agentes físicos.
 - Apoyo, asistencia técnica y participación en actividades de promoción de la Seguridad y Salud, como campañas de información y coordinación de la Red Española de Empresas saludables.
 - Asesoramiento técnico especializado y resolución de consultas técnicas a nivel nacional en el ámbito de los agentes físicos, promoción de la salud y epidemiología laboral.
 - Impartición y participación en jornadas técnicas, seminarios, talleres o cursos en al ámbito de prevención en riesgos laborales.
...
| N.º orden | N.º plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 11 | 1 | 1376336 | JEFE / JEFA DE PROYECTO. | - BIZKAIA.
 - BARAKALDO. | 26 | 15.383,76 | A1
 A2 | A3 | EX11 |  |  | EPD2 | **Descripción del puesto de trabajo:**
 
 - Desarrollo de actividades de gestión de calidad en laboratorio de metrología de agentes químicos.
 - Desarrollo de actividades de estudio, investigación y asesoramiento en materia de prevención de riesgos laborales, especialmente en el área de higiene y ergonomía.
 - Participación en la elaboración y revisión de Guías Técnicas en el ámbito de la prevención de riesgos laborales en las diferentes especialidades.
 - Desempeño de funciones preventivas en Servicios de Prevención Propio como Empleado Público Designado..
 - Participación en la aplicación del Sistema de Investigación, Divulgación, Innovación y Sensibilización (Método Sistema de Investigación, Divulgación, Innovación y Sensibilización) en proyectos de investigación como facilitadora.
 ...
 **Méritos específicos:**
 ...
 4. Experiencia y/o conocimiento en tareas similares a las de la Función 4 (máx: 5,00 pts.).
 5. Experiencia y/o conocimiento en tareas similares a las de la Función 5 (máx: 5,00 pts.). |  |
| 12 | 1 | 5074663 | JEFE / JEFA DE SECCION DE APOYO N24. | - BIZKAIA.
 - BARAKALDO. | 24 | 6.200,60 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Desarrollo de tareas de apoyo inherentes a la gestión administrativa y elaboración de documentos.
 - Elaboración de informes de seguimiento de la jurisprudencia en materia de prevención de riesgos laborales.
 - Desarrollo de tareas de apoyo a la gestión administrativa, con especial atención a la participación en proyectos subvencionables.
 - Emisión, seguimiento y control de certificados electrónicos.
 - Registro electrónico de entrada y salida de documentación a través de la Gestión Integrada de Servicios de Registro (GEISER).
 ...
 **Méritos específicos:**
 ...
 4. Experiencia y/o conocimiento en tareas similares a las de la Función 4 (máx: 5,00 pts.).
 5. Experiencia y/o conocimiento en tareas similares a las de la Función 5 (máx: 5,00 pts.). |  |
| 13 | 1 | 2425219 | JEFE / JEFA DE SECCION N22. | - BIZKAIA.
 - BARAKALDO. | 22 | 5.012,84 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión administrativa y del presupuesto de gastos descentralizados, así como tramitación de compras, pedidos, adquisición de material y facturación.
 - Gestión de proveedores (control de servicios y suministros recibidos).
 - Gestión de justificantes de gasto de anticipos de caja fija mediante SOROLLA2.
 - Manejo y utilización de aplicaciones informáticas.
 - Elaboración y tramitación de documentos administrativos, así como seguimiento de expedientes y apoyo a habilitación.
 
 **Perfil formativo/Cursos de formación:**
 
 - Administración y oficina presupuestaria.
