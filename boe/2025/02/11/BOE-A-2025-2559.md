---
identificador: "BOE-A-2025-2559"
titulo: "Resolución de 4 de febrero de 2025, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la categoría de Técnico Superior de Laboratorio."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 18705
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-2559"
url_pdf: "https://www.boe.es/boe/dias/2025/02/11/pdfs/BOE-A-2025-2559.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-2559"
url_eli: ""
fetched_at: "2026-04-08T20:32:10Z"
...
6.3.2 Segundo ejercicio: Consistirá en la resolución de tres supuestos prácticos de 30 minutos cada uno, utilizando el equipamiento del laboratorio relacionado con el temario especificado en el bloque de conocimientos específicos, así como con las funciones descritas en el anexo I.
...
– Manejo, mantenimiento y diagnóstico de fallos de las máquinas de taller relacionadas con la ingeniería de fabricación (tornos, fresadoras, taladros, rectificadoras, prensa y electroerosión).

– Manejo y programación de máquinas de control numérico.

– Manejo de extrusora e inyectora de polímeros.

– Preparación y ajuste de parámetros de soldadura y uso de equipos de soldadura: SMAW, GTAW, GMAW, resistencia eléctrica.

– Preparación de moldes y ejecución de procesos de fundición en arena verde.

– Uso de equipos de metrología y aparatos de medida: calibres, micrómetros, relojes comparadores.

– Medición y análisis de rugosidad superficial con rugosímetro, junto con el manejo de máquinas de medir por coordenadas (MMC).

– Manejo de impresoras 3D de diferentes tecnologías (FDM, SLA, entre otras), incluyendo la preparación y optimización de archivos CAD/CAM, así como la configuración y calibración de parámetros de impresión en distintos materiales.

– Aplicación de normas de seguridad e higiene, así como control de residuos y materiales utilizados en los procesos.

– Asistencia en investigación y gestión del laboratorio.
...
Módulo 1: Metrología y Normalización.

1. Fundamentos de Metrología Dimensional: Unidades, Patrones, Precisión, Trazabilidad y Plan de calibración.

2. Normalización: Tolerancias, Sistema ISO, Ajustes, Simbología y Calibres Pasa/No Pasa.

3. Técnicas de Medición I: Instrumentos de medida de longitudes, micrométricos y nonios.

4. Técnicas de Medición II: Medida de rugosidad superficial, MMC y tolerancias geométricas.

5. Calibración y Verificación de Instrumentos de Medición: Métodos, equipos y certificación de la calibración.

Módulo 2: Procesos de Moldeo y Fundición.

6. Fundamentos del Conformado por Moldeo: Características, Materiales y Diseño de sistemas.

7. Conformado por Moldeo en Arena: Tipos de arena, control y preparación.

8. Técnicas de Fundición Especiales: Fundición a presión, en coquilla y centrífuga.

9. Calidad en Piezas Fundidas: Clasificación de defectos y reglas de diseño.

Módulo 3: Conformado de Materiales.

10. Fundamentos del Conformado por Deformación Plástica: Fundamentos y Análisis de tensión y deformación.

11. Procesos de Conformado de Materiales Poliméricos y Compuestos: Inyección, Extrusión, Termoconformado y Soplado.

12. Conformado de Chapa: Laminado, Procesos con y sin separación de material.

13. Tratamientos Térmicos y Superficiales: Temple, revenido, recocido, nitruración, anodizado, galvanizado.

Módulo 4: Procesos de Unión.

14. Fundamentos de la Soldadura: Procesos de unión, soldabilidad y simbología.

15. Técnicas de Soldadura eléctrica: SMAW, TIG, MIG/MAG, soldadura por plasma, soldadura por resistencia y láser.

16. Otros Procesos de Unión: Soldadura oxiacetilénica y adhesivos.

Módulo 5: Procesos de Mecanizado y Control Numérico.

17. Generalidades del Conformado por Arranque de Material: Conceptos básicos y herramientas de corte.

18. Máquinas Herramienta: Cepilladora, Limadora, Mortajadora, Brochadora, Torno, Fresadora y Taladradora.

19. Programación y Control Numérico: Automatización, Programación CNC y Robots industriales.

20. Mecanizado de Alta Precisión: Electroerosión, rectificado, torneado y fresado de precisión.

Módulo 6: Fabricación Aditiva.

21. Introducción a la Fabricación Aditiva: Tecnologías y aplicaciones.

22. Tecnologías de Impresión 3D: FDM, SLA, SLS y Materiales empleados.

23. Procesado y Postprocesado de Piezas Aditivas: Parámetros, optimización y validación de piezas.

Módulo 7: Ingeniería Inversa.

24. Fundamentos de Ingeniería Inversa: Definición, aplicaciones y beneficios en la industria.

25. Digitalización 3D y Reconstrucción de Modelos: Escaneo 3D, técnicas de reconstrucción y software.

Módulo 8: Ofimática e Informática Aplicada.

26. Conocimientos Básicos de Ofimática: Windows, Word, Excel, PowerPoint.

27. Conocimientos Complementarios de Informática: Autocad, Mástercam, software de diseño y simulación.

Módulo 9: Seguridad, Salud y Medio Ambiente.

28. Protección en Laboratorios y Talleres: Riesgos mecánicos, eléctricos y químicos.

29. Ergonomía del Puesto de Trabajo y Pantallas de Visualización: Riesgos posturales y visuales.

30. Planificación de la Actividad Preventiva de Riesgos: Implementación y control.

31. Guía de prácticas de alumnos en Laboratorios con riesgos mecánicos. Información accesible en: http://www.sprl.upv.es/Guiapracalummecan.htm.

32. Los equipos de trabajo. Información accesible en: http://www.sprl.upv.es/D7_9_b.htm.

Módulo 10: Control de Calidad y Gestión de Laboratorio.

33. Control de Calidad en Procesos de Fabricación: Inspección y análisis de defectos.

34. Gestión del Laboratorio: Inventario, mantenimiento y organización.

35. Gestión ambiental y de residuos en la Universitat Politècnica de València. Normativa aplicable. Información accesible en: http://www.upv.es/medioambiente.
