---
identificador: "BOE-A-2025-11265"
titulo: "Resolución de 28 de mayo de 2025, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Técnica de Apoyo a la Docencia y a la Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 73720
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-11265"
url_pdf: "https://www.boe.es/boe/dias/2025/06/05/pdfs/BOE-A-2025-11265.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-11265"
url_eli: ""
...
El Rector, en uso de las competencias atribuidas en el artículo 50 de la Ley Orgánica 2/2023, de 22 de marzo, del Sistema Universitario, en relación con el artículo 3.2.j) de la misma norma, así como en los artículos 45 y 162 de los Estatutos de esta Universidad, ha resuelto convocar proceso selectivo de acceso libre para el ingreso en la Escala Técnica de Apoyo a la Docencia y a la Investigación de esta Universidad, de acuerdo con las siguientes

Bases

1. Normas generales

1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala Técnica de Apoyo a la Docencia y a la Investigación de la Universidad de Granada, Grupo A, Subgrupo A1, (puesto de Titulado/a Superior Responsable Área/Área de Microscopía del Centro de Instrumentación Científica).
...
f) No poseer la condición de personal funcionario de carrera de la Escala Técnica de Apoyo a la Docencia y a la Investigación de la Universidad de Granada.
...
Granada, 28 de mayo de 2025.–El Rector, Pedro Mercado Pacheco.
...
7. Reglamento de actuación y funcionamiento del sector público por medios electrónicos, aprobado por el Real Decreto 203/2021, de 30 de marzo.
...
10. Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales: Título I. Disposiciones generales, Título II. Principios de protección de datos y Título III. Derechos de las personas.
...
2. Microscopio electrónico de transmisión. Obtención de un haz de electrones. Dispersión elástica. Dispersión inelástica. Difracción de electrones. Interpretación.

3. Obtención de imágenes: Principios básicos de la formación de la imagen. Mecanismos de contraste. Tipos de detectores. Estrategias en el manejo y en la formación de imagen. Concepto de alta resolución.

4. Métodos de fijación para TEM. Químicos y físicos. Tipos de fijadores: aldehídos, tetróxido de osmio. Naturaleza, efectos y limitaciones. Factores que afectan a la calidad de fijación para TEM.

5. Tipos de tampones. Efectos de la fijación sobre diferentes tejidos en microscopia electrónica de transmisión. Cambios en el volumen de la muestra. Cambios *post mortem*. Artefactos.

6. Lavado, deshidratación e inclusión. Infiltración y medios de inclusión. Pasos a seguir en la infiltración y polimerización. Orientación de la muestra y etiquetado. Reinclusión.

7. Procedimiento para la obtención de secciones semifinas: con micrótomos. Tipos de cuchillas para la obtención de cortes para microscopía electrónica. Tallado y preparación del bloque. Líquido de flotación.

8. Procedimiento para la obtención de secciones con Vibratomo.

9. Ultramicrotomía. Procedimiento de obtención de cortes, materiales y procedimiento.

10. Tipos de rejilla para la recolección de cortes. Películas de soporte para rejillas.

11. Métodos de tinción: Tinción positiva. Tinción con azul alcián, oro coloidal, diamino-bencidina, rojo de rutenio, plata, ácido tánico. Tinción con plomo. Tinción con sales de uranio.

12. Métodos de tinción: Tinción negativa. Preparación y tratamiento de la muestra. Beneficios y desventajas de la técnica. Tipos de metales disponibles.

13. Inmunomicroscopía electrónica. Método de pre-inclusión. Método de post-inclusión.

14. Criofijación. Características y modalidades. Métodos de criofijación. Parámetros y condiciones de la muestra para la criofijación. Crioprotectores.

15. Crioultramicrotomía. Inclusión a baja temperatura. Aparatos para la obtención de criocortes. *Freeze-drying*, crio-sustitución, crio-fractura y criograbado. Microscopía correlativa.

Procesamiento de muestras para SEM

16. Microscopio electrónico de barrido. Componentes de la columna. Interacción del haz de electrones con la muestra y señales en el microscopio electrónico de barrido.

17. Formación de la imagen. Composición y topografía en la imagen. Factores que afectan a la resolución de la imagen. Tipos de detectores. Profundidad de campo. Resolución.

18. Procesamiento de muestras biológicas para SEM. Obtención de las muestras. Fijación de las muestras: químicos y físicos.

19. Procesamiento de muestras para Micro-espectroscopía Raman, técnicas asociadas como la espectroscopía de dispersión de energía de rayos X (X-EDS) y la espectroscopía de pérdida de energía de electrones (EELS).

20. Técnicas de exposición de estructuras internas. Métodos de limpieza. Métodos de disección. Métodos de corte y fractura.

21. Métodos de exposición de estructuras internas por digestión. Métodos químicos de digestión. Métodos enzimáticos de digestión. Métodos químico-enzimáticos. Métodos de digestión con detergentes.

22. Métodos de exposición de estructuras intracelulares. Exposición de organelas limitadas por membranas propias. Exposición del citoesqueleto. Exposición de estructuras nucleares.

23. Métodos de desecación de las muestras. Desecación al aire. Desecación por congelación-sublimación. Método del punto crítico. Ventajas e inconvenientes de los distintos métodos de desecación. Problemas asociados.

24. Montaje de las muestras. Objetivos. Estrategias a seguir. Materiales. Normas para el montaje de las muestras. Almacenamiento de las muestras.

25. Métodos para hacer las muestras conductoras a la electricidad. Recubrimientos metálicos: evaporación en vacío. Método del «ion sputtering». Eliminación de la película metálica. Impregnación de las muestras con metales pesados. Tratamiento con antiestáticos. Observaciones de muestras sin tratamiento conductor.

26. Métodos de preparación de material vegetal, polen, madera.

27. Métodos de preparación de hongos.

28. Métodos de preparación de células y organismos en suspensión.

29. Métodos de preparación de artrópodos.

30. Preparación de bacterias: en suspensión, colonias sobre soporte sólido o bacterias creciendo en organismos.

31. Métodos de preparación para muestras inorgánicas. Adelgazador iónico: preparación de aros. Pulido mecánico. Pulido iónico.

32. Localización de moléculas por medio de SEM. Inmunomicroscopía de barrido: fijación, detección indirecta, localización de anticuerpos y otros ligandos marcados con peroxidasa.

33. Autorradiografía. Fundamento y desarrollo técnico.

Prevención y riesgo. Gestión de residuos

34. Seguridad en el laboratorio. Buenas prácticas de laboratorio (BPL).

35. Sistema de gestión de residuos peligros. Manipulación de productos químicos. Envasado y etiquetado.

36. Tratamiento de residuos: manual de residuos de la UGR. Almacenamiento y recogida de residuos. Procedimiento de gestión.
