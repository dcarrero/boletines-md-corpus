...
pagina_final: 76794
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2025-11810"
url_pdf: "https://www.boe.es/boe/dias/2025/06/12/pdfs/BOE-A-2025-11810.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2025-11810"
url_eli: "https://www.boe.es/eli/es/rd/2025/05/27/404"
fetched_at: "2026-04-09T06:44:39Z"
...
Así, este real decreto, conforme a lo previsto en el Real Decreto 659/2023, de 18 de julio, establece y regula, en los aspectos y elementos básicos antes indicados, el certificado profesional en Operaciones con maquinaria de transporte de tierras en construcción.
...
Este real decreto tiene por objeto el establecimiento del certificado profesional en Operaciones con maquinaria de transporte de tierras en construcción y de los grados B y A vinculados a este, con carácter oficial y validez en todo el territorio nacional, así como de su currículo.
...
El certificado profesional en Operaciones con maquinaria de transporte de tierras en construcción queda identificado para todo el territorio nacional por los siguientes elementos:

a) Denominación: Operaciones con maquinaria de transporte de tierras en construcción.

b) Código: EOC_C_011_4B.
...
El perfil profesional del certificado profesional en Operaciones con maquinaria de transporte de tierras en construcción queda determinado por su competencia general, sus competencias profesionales y para la empleabilidad y por la relación de estándares de competencias profesionales del Catálogo Nacional de Estándares de Competencias Profesionales incluidos en el certificado profesional.

## Artículo 4. Competencia general.

La competencia general de este certificado profesional consiste en realizar operaciones con maquinaria de transporte de tierras por vías privadas en las distintas actividades del sector de la construcción y obras públicas, así como en canteras, areneras, graveras y explotación de tierras industriales, cumpliendo la normativa relativa a protección medioambiental, los estándares de calidad y la prevención de riesgos laborales.
...
a) Revisar el estado de la máquina de transporte de tierras en construcción para detectar elementos en posible mal estado, asegurando el estado funcional y operativo previo a la puesta en marcha.

b) Realizar la puesta en marcha de la máquina para realizar el transporte de tierras en construcción, siguiendo el manual de operación y mantenimiento, para ponerla en disposición de trabajo.
...
d) Ejecutar trabajos de transporte de tierras en construcción sobre el terreno, adaptándose a las distintas tipologías de obras, cumpliendo con las órdenes de trabajo y las normas de seguridad establecidas en el plan de seguridad y salud en el trabajo.

e) Realizar las operaciones de transporte de tierras en construcción de fin de jornada para evitar daños inesperados a las personas o a la máquina, de acuerdo con lo indicado en el manual de operación y mantenimiento, siguiendo las normas de seguridad establecidas en el plan de seguridad y salud en el trabajo.

f) Realizar las operaciones de mantenimiento preventivo propias del operador de maquinaria de transporte de tierras en construcción para evitar averías, siguiendo las instrucciones del manual de operación y mantenimiento, cumpliendo las normas establecidas en el plan de gestión medioambiental.
...
## Artículo 6. Relación de estándares de competencias profesionales del Catálogo Nacional de Competencias Profesionales incluidos en este certificado profesional.

Los estándares de competencias profesionales de este certificado profesional son los que se relacionan a continuación:

a) UC2461_2: Realizar operaciones de transporte de tierras en actividades de construcción y obras públicas.

b) UC2327_2: Realizar las funciones de nivel básico para la prevención de riesgos en construcción.

## Artículo 7. Entorno profesional.

1. Las personas que hayan obtenido el certificado profesional que acredita la superación de este grado C pueden ejercer su actividad en todos los sectores económicos que desarrollen actividades de construcción, así como en canteras, areneras, graveras y explotación de tierras industriales.

Desarrollan su actividad profesional dentro del área de producción dedicado a edificación y obra civil, así como canteras, areneras, graveras y la explotación de tierras industriales del sector de la construcción y obras públicas, circulando por vías de carácter privado (no públicas ya que necesitan competencias de circulación específicas), en entidades de naturaleza pública o privada, en empresas de gran tamaño, medianas o pequeñas, tanto por cuenta propia como ajena, con independencia de su forma jurídica.

Desarrollan su actividad dependiendo, en su caso, funcional y/o jerárquicamente de un superior. Pueden tener personal a su cargo en ocasiones, por temporadas o de forma estable. En el desarrollo de la actividad profesional se aplican los principios de accesibilidad y diseño universal para todas las personas de acuerdo con la normativa aplicable.

2. Las ocupaciones y puestos de trabajo más relevantes son los siguientes:

a) Operadores y operadoras de camión volquete.

b) Operadores y operadoras de camión auxiliar.

c) Operadores y operadoras de dumper.
...
a) 1745. Operaciones de transporte de tierras en construcción.
...
| --- | --- | --- |
| 1745. Operaciones de transporte de tierras en construcción. | EOC_B_1745.
 Operaciones de transporte de tierras en construcción. | 300 |
...
| --- | --- | --- |
| EOC_A_1745_01.
 Trabajos de transporte de tierras en construcción. | RA1. Describe los trabajos de transporte de tierras en construcción, identificando los componentes de las maquinarias y las condiciones de utilización y recepción. | 40 |
| EOC_A_1745_02.
 Comprobación del estado de la máquina de transporte de tierras en construcción. | RA2. Comprueba el estado de la máquina de transporte de tierras en construcción, identificando elementos en posible mal estado y asegurando el estado funcional y operativo previo a la puesta en marcha en trabajos de transporte de tierras en construcción. | 40 |
| EOC_A_1745_03.
 Puesta en marcha de la máquina de transporte de tierras en construcción. | RA3. Realiza la puesta en marcha de la máquina de transporte de tierras en construcción, siguiendo las indicaciones del manual de operación y mantenimiento para ponerla en disposición de trabajo. | 50 |
| EOC_A_1745_04.
 Técnicas de desplazamiento de máquinas de transporte de tierras en construcción. | RA4. Aplica técnicas de desplazamiento de máquinas de transporte de tierras en construcción de forma segura, siguiendo el protocolo de actuación. | 40 |
| EOC_A_1745_05.
 Operaciones con máquinas de transporte de tierras en construcción sobre el terreno. | RA5. Opera máquinas de transporte de tierras en construcción sobre el terreno de acuerdo con el trabajo a ejecutar, cumpliendo las normas de seguridad establecidas. | 50 |
| EOC_A_1745_06.
 Puesta fuera de servicio o fin de jornada de maquinaria de transporte de tierras en construcción. | RA6. Realiza la puesta fuera de servicio o fin de jornada de la maquinaria de transporte de tierras en construcción, siguiendo el protocolo establecido. | 40 |
| EOC_A_1745_07.
 Operaciones de mantenimiento preventivo en maquinarias de transporte de tierras en construcción y gestión de residuos. | RA7. Aplica operaciones de mantenimiento preventivo en maquinarias de transporte de tierras en construcción y gestión de residuos, atendiendo al manual de operación y mantenimiento y al plan de gestión de residuos. | 40 |
| Total. | 300 |  |
...
| --- | --- | --- |
| 1745 | Operaciones de transporte de tierras en construcción. | 300 |
| 1724 | Prevención de riesgos laborales en construcción. | 60 |
| Total. | 360 |  |

**Módulo Profesional: Operaciones de transporte de tierras en construcción.**
...
1. Describe los trabajos de transporte de tierras en construcción, identificando los componentes de las maquinarias y las condiciones de utilización y recepción.

Criterios de evaluación:

a) Se han definido los distintos campos de aplicación: edificación, obras públicas e industrias extractivas.

b) Se han reconocido los tipos de movimientos de tierras relacionadas con el transporte.

c) Se han identificado los componentes de las maquinarias de transporte de tierras en construcción, interpretando su funcionamiento.

d) Se han determinado las condiciones de utilización y recepción de las máquinas de transporte de tierras en construcción, interpretando el manual de operación y mantenimiento y las fichas técnicas y de seguridad.

e) Se han diferenciado las técnicas preventivas y de protección antes del inicio de trabajos con maquinaria de transporte de tierras y materiales en construcción.

2. Comprueba el estado de la máquina de transporte de tierras en construcción, identificando elementos en posible mal estado y asegurando el estado funcional y operativo previo a la puesta en marcha en trabajos de transporte de tierras en construcción.

Criterios de evaluación:

a) Se han reconocido los componentes externos de la maquinaria de transporte, identificando el estado de conservación y los puntos de engrase.

b) Se han identificado el tren de rodaje y los elementos estructurales y componentes de las cajas o volquetes que forman parte de las máquinas de transporte, comprobando su idoneidad para el tipo de trabajo a realizar y describiendo sus posibles anomalías o defectos.

c) Se ha realizado la comprobación de los niveles de aceite, refrigerante o de frenos o líquidos hidráulicos en la máquina de transporte, complementando los mismos en función de lo indicado en el manual de operación y mantenimiento.

d) Se ha efectuado la comprobación del nivel de combustible en la máquina de transporte, complementando el mismo en función del tipo de trabajo a realizar.

e) Se ha verificado el estado de las protecciones antivuelco y/o antiproyecciones de la máquina de transporte, justificando que son adecuados a los trabajos a realizar.

f) Se ha comprobado el estado del compartimento de motor de la máquina de transporte, determinando el desgaste de las correas e identificando posibles fugas en colectores, culata, estado anómalo de alternadores, compresores y otros componentes del circuito hidráulico.

g) Se han tenido en cuenta los riesgos laborales específicos de la actividad, aplicando las medidas de prevención adecuadas.

3. Realiza la puesta en marcha de la máquina de transporte de tierras en construcción, siguiendo las indicaciones del manual de operación y mantenimiento para ponerla en disposición de trabajo.
...
d) Se ha llevado a cabo el arranque de la máquina de transporte para la puesta en servicio, de acuerdo con lo establecido en el manual de operación y mantenimiento y aplicando la normativa de seguridad correspondiente.

4. Aplica técnicas de desplazamiento de máquinas de transporte de tierras en construcción de forma segura, siguiendo el protocolo de actuación.

Criterios de evaluación:

a) Se han descrito los circuitos de la máquina y el equipo de trabajo necesarios para realizar el desplazamiento hasta el lugar de trabajo, siguiendo las indicaciones del manual de operación y mantenimiento.

b) Se ha descrito el proceso de desplazamiento y activación de los avisadores para el desplazamiento de la maquinaria de transporte, indicando el protocolo de actuación.
...
e) Se ha llevado a cabo el establecimiento de la maquinaria de transporte para realizar un trabajo concreto, acondicionando el terreno y retirando materiales y/u objetos que puedan suponer un riesgo para realizar el trabajo seguro.

5. Opera máquinas de transporte de tierras en construcción sobre el terreno de acuerdo con el trabajo a ejecutar, cumpliendo las normas de seguridad establecidas.

Criterios de evaluación:

a) Se han descrito los distintos tipos de trabajos de transporte de tierras indicando los procedimientos y protocolos de trabajo, según sean en obra o cantera.

b) Se han descrito los tipos de desplazamientos de cargas de material en obra o cantera, indicando los procedimientos y protocolos de trabajo, según sea en descarga directa sobre terreno o vertedero o descarga sobre medios de acarreo o clasificación.

c) Se ha llevado a cabo un trabajo de carga de material sobre maquinaria para el transporte de tierras en construcción de acuerdo a las normas de seguridad.

d) Se ha realizado el transporte de material a los lugares habilitados, respetando los protocolos de seguridad.

e) Se ha ejecutado un trabajo de descarga de material en el lugar habilitado, cumpliendo la normativa de seguridad.

6. Realiza la puesta fuera de servicio o fin de jornada de la maquinaria de transporte de tierras en construcción, siguiendo el protocolo establecido.

Criterios de evaluación:

a) Se ha descrito el protocolo para estacionar y poner fuera de servicio máquinas de transporte de acuerdo con lo indicado en el manual de operación y mantenimiento.

b) Se ha llevado a cabo una operación de puesta fuera de servicio de máquinas de transporte, garantizando su desconexión.
...
7. Aplica operaciones de mantenimiento preventivo en maquinarias de transporte de tierras en construcción y gestión de residuos, atendiendo al manual de operación y mantenimiento y al plan de gestión de residuos.
...
c) Se han comprobado los niveles de aceite, refrigerante y líquidos de frenos de la maquinaria de transporte, relacionándolos con los periodos de mantenimiento.

d) Se ha establecido un plan de limpieza y conservación de los elementos de la maquinaria de transporte, garantizando su mantenimiento.

e) Se ha llevado a cabo la gestión de los residuos producidos en el mantenimiento, siguiendo las indicaciones del plan de gestión medioambiental.
...
| Aula polivalente. | Mesa y silla para el personal formador.
 ...
 Ordenador instalado en red con posibilidad de impresión de documentos, cañón de proyección e Internet para el personal formador.
...
| Terreno para prácticas*. | Equipos de protección individual.
 ...
 Maquinaria de transporte de tierras: camión volquete o *dumper*.
 Pala cargadora o retrocargadora mixta para la realización de los supuestos prácticos de carga sobre la maquinaria de transporte.
...
## ANEXO V. Especialidades del profesorado con atribución docente en los módulos profesionales del certificado profesional en Operaciones con maquinaria de transporte de tierras en construcción
...
| --- | --- |
| UC2461_2: Realizar operaciones de transporte de tierras en actividades de construcción y obras públicas. | 1745. Operaciones de transporte de tierras en construcción. |
...
| --- | --- |
| 1745. Operaciones de transporte de tierras en construcción. | UC2461_2: Realizar operaciones de transporte de tierras en actividades de construcción y obras públicas. |
