...
diario_numero: "287"
pagina_inicial: 163305
pagina_final: 163335
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2022-19911"
url_pdf: "https://www.boe.es/boe/dias/2022/11/30/pdfs/BOE-A-2022-19911.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2022-19911"
url_eli: "https://www.boe.es/eli/es/rd/2022/11/29/988"
fetched_at: "2026-04-12T02:07:45Z"
...
3. Las emisiones que calculará el sistema informatizado ECOGAN son: Gas nitrógeno (N~2~), óxido nitroso (N~2~O), óxidos de nitrógeno (NO~X~), amoníaco (NH~3~), metano (CH~4~). Además ECOGAN calculará el nitrógeno y fósforo total excretado de la explotación.
...
j) Producción anual de purines y estiércol sólido (m^3^/año para purines y toneladas/ año para estiércol sólido).
...
ii) Dimensiones del sistema de almacenamiento: superficie (m^2^) y capacidad (m^3^) de almacenamiento. En el caso de depósitos/tanques indicar la altura/profundidad y la forma del sistema de almacenamiento (rectangular, circular).
...
ii) Dimensiones del sistema de almacenamiento: superficie (m^2^) y capacidad (m^3^) de almacenamiento.
...
xvi) Tipo de cubierta (si dispone) y superficie que está cubierta (superficie total y superficie cubierta en m^2^).
...
b) Consumo anual previsto para cada uno de los tipos de suministro (m^3^/año),
...
m) Producción anual estiércol sólido/líquido (m^3^/año para estiércol líquido y toneladas/ año para estiércol sólido).
...
ii. Dimensiones del sistema de almacenamiento: superficie (m^2^) y capacidad (m^3^) de almacenamiento. En caso de depósito/tanque la altura/profundidad y la forma del sistema de almacenamiento: rectangular o circular.
