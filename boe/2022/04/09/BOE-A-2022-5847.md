---
identificador: "BOE-A-2022-5847"
titulo: "Resolución de 29 de marzo de 2022, de la Secretaría General Técnica, por la que se publica el Convenio entre el Instituto Nacional de la Seguridad Social y el Principado de Asturias, para el impulso y consolidación del sistema Tarjeta Social Digital."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 49013
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2022-5847"
url_pdf: "https://www.boe.es/boe/dias/2022/04/09/pdfs/BOE-A-2022-5847.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2022-5847"
url_eli: ""
fetched_at: "2026-04-11T14:12:57Z"
...
De otra parte, el Principado de Asturias, representado por doña Rita Camblor Rodríguez, Consejera de Presidencia, y doña Melania Álvarez García, Consejera de Derechos Sociales y Bienestar, nombradas por Decreto 14/2019, de 24 de julio, del Presidente del Principado de Asturias, por el que se nombra a los miembros del Consejo de Gobierno (BOPA de 25 de julio de 2019), en virtud de las facultades que les vienen conferidas a la Consejería de Presidencia en materia de gestión centralizada del soporte tecnológico y los servicios informáticos y de comunicaciones de la Administración del Principado de Asturias, y a la Consejería de Derechos Sociales y Bienestar en materia de gestión del Sistema Público Asturiano de Servicios Sociales, de conformidad con lo previsto en el Decreto 13/2019, de 24 de julio, del Presidente del Principado de Asturias, de reestructuración de las Consejerías que integran la Administración de la Comunidad Autónoma, autorizadas para la firma de este convenio por Acuerdo del Consejo de Gobierno, de fecha 18 de febrero de 2022.

Por otra parte, y en relación con la materia objeto de la Tarjeta Social Digital, el Principado de Asturias tiene competencia exclusiva en asistencia y bienestar social, de conformidad con lo previsto en el artículo 10.1.24 del Estatuto de Autonomía del Principado de Asturias.
...
Y en prueba de conformidad, las partes indicadas firman el presente documento en duplicado ejemplar, en el lugar y fecha indicada al comienzo.–Por el Instituto Nacional de la Seguridad Social, la Directora General del Instituto Nacional de la Seguridad Social, María del Carmen Armesto González Rosón.–Por el Principado de Asturias, la Consejera de Presidencia, Rita Camblor Rodríguez.–La Consejera de Derechos Sociales y Bienestar, Margarita Álvarez García.
...
| --- | --- |
| Manual de usuario IFI. http://lnnk.in/amjh | Manual de usuario de IFI. |
| Manual de actualización del Cliente IFI. http://lnnk.in/dOfd | Actualización del cliente IFI (para instalación del cliente en entornos no Windows). |
| Manual de instalación IFI. https://rb.gy/kusdmm | Manual de instalación. |
| Servicio de intercambio de ficheros institucionales. ClienteIFI4_10.exe.
 https://rb.gy/35mgbp | Ejecutable del cliente IFI. |
...
| CÓDIGOS RESPUESTA. | N | 5 | 476 | 500 | Posibles códigos de error devueltos tras la validación del registro de pie.
 Si existe error en registro de pie todos los registros de detalle contendrán el error 10000 (además de otros posibles errores de formato). La descripción de todos los posibles errores se encuentra en el ANEXO 20.
...
– Si la prestación que se pretende traspasar es Ingreso Mínimo Vital (IMV, código 1230102) o Renta de Integración Social (RIS, código 560202),

– Se rechazará directamente el movimiento.
...
| CÓDIGOS RESPUESTA. | N | 5 | 176 | 200 | Posibles códigos de error devueltos tras la validación del registro de cabecera.
 Si existe error en registro de cabecera todos los registros de detalle contendrán el error 10000 (además de otros posibles errores de formato). La descripción de todos los posibles errores se encuentra en el ANEXO 20.
 Si no se devuelven errores (todos a ceros) significa que el registro de cabecera es correcto. |
...
| CÓDIGOS RESPUESTA. | N | 5 | 176 | 200 | Posibles códigos de error devueltos tras el tratamiento del registro.
 ...
 La descripción de todos los posibles errores se encuentra en el ANEXO 20.
 Si no se devuelven errores (todos a ceros) significa que el registro se ha tratado correctamente.R. |
...
| LIMITACIÓN DE MOVILIDAD. | A | 2 | 402 | 402 | Posibles valores: Entre '00' y '15' y 'X ' (para desconocido). |
...
## ANEXO 20.1.1. Errores de formato en Prestaciones y Pagos
...
## ANEXO 20.1.2. Errores de formato en Situaciones Subjetivas
...
## ANEXO 20.2.1. Errores en la carga de datos en Prestaciones y Pagos
...
| 91030 | AVISO: aceptado con observaciones referentes al identificador.
 El campo OTRO IDENTIFICATIVO contendrá el nuevo identificativo. | Modificación de prestación/Cambio de situación de prestación | Carga diaria. |
...
## ANEXO 20.2.2. Errores en la carga de datos en Situaciones Subjetivas
