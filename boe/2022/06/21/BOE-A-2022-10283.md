---
identificador: "BOE-A-2022-10283"
titulo: "Resolución de 16 de junio de 2022, del Instituto Nacional de Administración Pública, por la que se convocan cursos de especialización específicos para el ámbito local."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 85962
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2022-10283"
url_pdf: "https://www.boe.es/boe/dias/2022/06/21/pdfs/BOE-A-2022-10283.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2022-10283"
url_eli: ""
fetched_at: "2026-04-11T18:06:11Z"
...
Título: Curso de especialización en Haciendas locales

Fechas de realización: Del 10 de octubre de 2022 al 12 de septiembre de 2023.
...
Destinatarios del curso: Personal funcionario de las Administraciones Públicas, preferentemente de Administración local, que desarrollen o tengan que desempeñar su trabajo en el ámbito de la Hacienda local, especialmente técnicos, secretarios-interventores, interventores, tesoreros.

Objetivo del curso: Estudiar y profundizar en las diferentes áreas que componen la Hacienda local y su problemática actual.

Programa del curso: se estructura en tres módulos con 6 unidades y un trabajo fin de curso:

Módulo 1.

Unidad 1. Estabilidad presupuestaria y sostenibilidad financiera de las EE. LL.

Unidad 2. Técnicas presupuestarias locales.

Módulo 2.

Unidad 3. Contabilidad y cuenta general de las entidades locales.

Unidad 4. Control y fiscalización en el ámbito local.

Módulo 3.

Unidad 5. Tratamiento de los ingresos de las entidades locales.

Unidad 6. Tesorería de las entidades locales.
...
Lugar de celebración: Modalidad en línea. Aula virtual del INAP. Videoconferencias días 30 de septiembre y 17 de octubre de 2022.
...
Destinatarios del curso: Preferentemente personal funcionario de las EE. LL. relacionados con la contratación y gestión presupuestaria.

Objetivo del curso: Potenciar la correcta utilización de los contratos menores en el ámbito local y conocer los riesgos de su utilización inadecuada, así como los instrumentos jurídicos para evitar el abuso de esta figura.

Programa del curso:

Unidad 1.  Marco normativo aplicable a la contratación menor en las entidades locales.

Unidad 2. Contratación menor con fraccionamiento del objeto del contrato en el ámbito local.

Unidad 3. Control Interno de la contratación menor en el ámbito local.

Unidad 4. Satisfacción de las necesidades periódicas y repetitivas a través de alternativas distintas de la contratación menor en el ámbito local.

Título: Seminario sobre gobierno abierto en la Administración local: fundamentos, experiencias y herramientas

Fechas de realización: De 5 de octubre al 18 de noviembre de 2022.

Código: FL223074.

Lugar de celebración: Modalidad en línea Aula virtual del INAP. Doce videoconferencias días 5, 7, 10, 13, 17, 19, 21, 24, 26 y 28 de octubre y 2 y 4 de noviembre. Trabajo individual a entregar en plataforma hasta el 18 de noviembre
...
Destinatarios del curso: Personal al servicio de las Administraciones públicas, preferentemente de la Administración local, que desempeñen labores en áreas relacionadas con el objetivo del Seminario: participación ciudadana, transparencia e integridad, contratación, protección de datos y áreas de información e innovación pública local.

Objetivos del Seminario: Promover los principios y valores del Plan de Gobierno Abierto y desarrollar en el personal de las Entidades Locales competencias necesarias para una transformación efectiva de sus entornos de trabajo y, en última instancia, de la manera en que la Administración se concibe a sí misma e interactúa con la sociedad a la que sirve.

Informar sobre los aspectos de mayor relevancia de la transparencia, la contratación y la protección de datos desde una perspectiva local y resolver posibles dudas o cuestiones controvertidas.

Programa del curso:

1. Los fundamentos del Gobierno abierto y gobernanza abierta local.

2. Experiencias en la gestión del gobierno abierto local: transparencia y acceso a la información en las EE. LL. españolas, datos abiertos y apertura local en España, contratación pública en las EE. LL. Innovación pública.

3. Estrategias y herramientas para la democratización y desarrollo local.

## Segundo. Presentación de solicitudes.

De acuerdo con las condiciones generales de las actividades formativas durante 2022 establecidas en la citada Resolución de 13 de diciembre de 2021, del Instituto Nacional de Administración Pública, por la que se publica el Plan de Formación para el año 2022, quien desee participar en estas actividades formativas deberá cumplimentar y presentar la correspondiente solicitud que será accesible en línea en el Catálogo de Formación del portal web del INAP, tras la selección del curso correspondiente en el siguiente enlace https://buscadorcursos.inap.es, o en el apartado de Formación Local de la página web del INAP en el siguiente enlace http://www.inap.es/formacion-en-administracion-local dentro de los 1o días siguientes a la publicación de esta convocatoria en el BOE.
...
Madrid, 16 de junio de 2022.–La Directora del Instituto Nacional de Administración Pública, Consuelo Sánchez Naranjo.
