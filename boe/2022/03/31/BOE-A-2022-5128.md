---
identificador: "BOE-A-2022-5128"
titulo: "Resolución de 22 de marzo de 2022, de la Biblioteca Nacional de España, O.A., por la que se aprueban los precios públicos de aplicación a los servicios prestados por dicho organismo."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 43510
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2022-5128"
url_pdf: "https://www.boe.es/boe/dias/2022/03/31/pdfs/BOE-A-2022-5128.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2022-5128"
url_eli: "https://www.boe.es/eli/es/res/2022/03/22/(1)"
fetched_at: "2026-04-11T13:41:33Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 22 de marzo de 2022, de la Biblioteca Nacional de España, O.A., por la que se aprueban los precios públicos de aplicación a los servicios prestados por dicho organismo.
...
Mediante Resolución de 28 de febrero de 2018, de la Biblioteca Nacional de España se aprobó los vigentes precios públicos de aplicación a los servicios prestados por el Organismo. Posteriores modificaciones normativas, así como la necesidad de adaptar los precios públicos a la evolución de los servicios imponen la necesidad de modificar la referida Resolución.
...
En consecuencia, previa autorización del Ministro de Cultura y Deporte, de conformidad con lo establecido en el artículo 26.1.b) de la Ley 8/1989, de 13 de abril, de Tasas y Precios Públicos, resuelvo:
...
1. Será necesario para iniciar el proceso de obtención de los servicios solicitados el pago previo del importe de los precios establecidos.

2. El pago de los precios podrá efectuarse, según se determine, en la sede de la Biblioteca Nacional de España, por transferencia bancaria o por ingreso directo en la cuenta bancaria que se señale, o mediante tarjeta de crédito o débito.
...
## Artículo 5. Normas específicas para los precios públicos por servicios de préstamo interbibliotecario contenidos en el Anexo II.
...
3. En los servicios de préstamo interbibliotecario el pago se podrá hacer por transferencia, ingreso directo en la cuenta bancaria que se determine o mediante tarjeta de crédito o débito.

## Artículo 6. Normas específicas para los precios públicos por servicios de valoración.

1. Los precios de valoración establecidos en la presente resolución, anexo III, van dirigidos exclusivamente a instituciones públicas y tienen carácter orientativo.
...
Queda derogada la Resolución de 28 de febrero de 2018, de la Biblioteca Nacional de España, por la que se aprueban los precios públicos de aplicación a los servicios prestados por dicho organismo.

## Disposición final única. Entrada en vigor.

La presente resolución entrará en vigor el día siguiente al de su publicación en el «Boletín Oficial del Estado».

Madrid, 22 de marzo de 2022.–La Directora de la Biblioteca Nacional de España, O.A., Ana María Santos Aramburo.

## ANEXO I. Precios públicos por servicios de reproducción^(1)^

^(1)^ IVA no incluido en los precios.

Reproducciones de autoservicio

|  | Euros |
| --- | --- |
| 1. Fotocopia directa (máximo 20 % de una misma obra posterior a 1958): |  |
| B/N A4. | 0,12 |
| B/N A3. | 0,17 |
| Color A4. | 1,24 |
| Color A3. | 1,65 |
...
| B/N A3. | 0,17 |
| Color A4. | 1,24 |
| 3. Captura digital (máximo 20 % de una misma obra posterior a 1958): |  |
...
|  | Euros |
| --- | --- |
| 1. Copia de archivos digitales (JPG o PDF, en torno a 150 dpi) [1]: |  |
| B/N, escala de grises o color (según original). |  |
| Cada imagen. | 0,41 |
| A partir de 40 imágenes (del mismo documento páginas correlativas). | 16,53 |
| 2. Copia de archivos digitales alta resolución (TIFF/RGB, resolución 300 dpi). |  |
| Documento completo o imágenes sueltas. B/N, escala de grises o color (según original): |  |
...
## ANEXO II. Precios por servicio de préstamo interbibliotecario(1)^(2)^

^(2)^ IVA no incluido en los precios.
...
| Concepto | España
 ...
 Euros |
| --- | --- | --- | --- |
| Copias (archivo electrónico) hasta 40 páginas. |  |  |  |
| Archivo electrónico. | 5 | 8 | 8 |
| Copias (archivo electrónico) más de 40 páginas. |  |  |  |
| Precios España por cada página adicional. |  |  |  |
| Archivo electrónico. | 0,20 €/pág. |  |  |
| Precios fuera de España por cada bloque adicional. |  |  |  |
| Archivo electrónico (hasta 20 páginas). |  | 4 | 4 |

(1) El importe del préstamo interbibliotecario internacional se podrá abonar con bonos IFLA, cuyo valor en euros es el siguiente:

1 bono IFLA: 8 euros.

½ bono IFLA: 4 euros.

## ANEXO III. Valoración de documentos

Aplicable únicamente a instituciones públicas.
...
|  | Precios (sin IVA)
 ...
 Euros |
| --- | --- |
| Monografías modernas y publicaciones seriadas modernas (desde 1831). | 5 |
| Monografías antiguas (desde 1501 hasta 1830). | 20 |
| Publicaciones seriadas antiguas (hasta 1830). | 15 |
| Incunables. | 25 |
| Manuscritos modernos (desde 1801). | 15 |
| Manuscritos antiguos (hasta 1800)^2.^ | 30 |

^(1)^ Excepto la documentación manuscrita de archivos.

2. Si los servicios solicitados presentaran particularidades especiales que alterasen sustancialmente el coste de la contraprestación, su precio se establecerá mediante presupuesto, que se ajustará a los costes de producción, y que se notificará previamente al interesado para su conformidad.
