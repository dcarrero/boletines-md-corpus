---
identificador: "BOE-A-2019-10640"
titulo: "Resolución de 25 de junio de 2019, de la Entidad Pública Empresarial ENAIRE, por la que se publica el Convenio con la Universidad Politécnica de Madrid y el Centro de Referencia de Investigación, Desarrollo e Innovación ATM, para el desarrollo de actividades de I+D+i de interés común en el ámbito de eficiencia operativa y automatización en gestión del tráfico aéreo."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 78556
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2019-10640"
url_pdf: "https://www.boe.es/boe/dias/2019/07/19/pdfs/BOE-A-2019-10640.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2019-10640"
url_eli: ""
fetched_at: "2026-04-18T09:44:44Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 25 de junio de 2019, de la Entidad Pública Empresarial ENAIRE, por la que se publica el Convenio con la Universidad Politécnica de Madrid y el Centro de Referencia de Investigación, Desarrollo e Innovación ATM, para el desarrollo de actividades de I+D+i de interés común en el ámbito de eficiencia operativa y automatización en gestión del tráfico aéreo.
...
El objeto del presente Convenio es establecer las bases de participación conjunta de la UPM, ENAIRE y CRIDA para la realización de actividades durante el periodo 2019-2020, en áreas de I+D+i en el ámbito de Gestión del Tráfico Aéreo, de interés común, centradas en la investigación de soluciones y desarrollo potencial de herramientas.
...
ENAIRE aportará los medios económicos necesarios para sufragar las actividades objeto del presente Convenio, siendo el presupuesto máximo de ejecución de 60.000 euros.
...
La Comisión de Seguimiento se constituirá en el plazo de 45 días desde la publicación en «BOE» del presente Convenio y en cuanto a sus normas de funcionamiento se regirá por lo dispuesto en los artículos 15 y siguientes de la Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público.
...
Habiendo leído el presente por sí mismos y hallándose conformes, lo firman por triplicado y a un solo efecto, en lugar y fecha arriba citados.–Por ENAIRE, el Director General de ENAIRE, Ángel Luis Arias Serrano.–Por UPM, el Rector de la UPM, Guillermo Cisneros Pérez.–Por CRIDA, el Director de CRIDA, José Miguel de Pablo Guerrero.
...
| --- | --- | --- | --- | --- | --- |
| 1 | Revisión del trabajo inicial. | Revisar la caracterización y clasificación de flujos. Validar el algoritmo existente. | Data Science. | UPM. | T0 + Q1 |
| 2 | Análisis de sensibilidad. | Análisis de sensibilidad de los resultados de flujos al volumen de tráfico y al tiempo de análisis. | Data Science. | UPM. | T0 + Q1 |
| 3 | Determinación de márgenes de cálculo. | Determinar el número mínimo de aviones y días para obtener resultados representativos | Data Science. | UPM. | T0 + Q1 |
| 4 | Estudio de eficiencia en sectorización. | Estudiar la eficiencia de la sectorización según el origen/destino de los vuelos que cruzan el sector y los flujos a que pertenecen. | Eficiencia Operacional. | CRIDA-ENAIRE. | T0 + Q1 |
| 5 | Visualización avanzada. | Desarrollar una visualización de flujos más avanzada enfocada a los requisitos del usuario | Eficiencia Operacional. | CRIDA-ENAIRE. | T0 + Q1 |
| 6 | Parámetros dinámicos. | Identificar los parámetros del algoritmo que puedan ser dinámicos (frente a estáticos actuales) para los diferentes sectores operativos. Generalización del algoritmo. | Data Science. | UPM. | T0 + Q2 |
| 7 | Análisis de aplicabilidad de la metodología a TMA. | Extender la aplicación de flujos a otras fases de vuelo, con el objetivo de mejorar la eficiencia y predictibilidad de los procesos. | Eficiencia Operacional. | UPM. | T0 + Q2 |
| 8 | Comparativa entre tiempos de estudio. | Implementar y testar el algoritmo de comparación de flujos entre ciclos para identificar los mismos flujos | Data Science. | UPM. | T0 + Q2 |
| 9 | Detección comportamiento de flujos. | Definir metodología que permita localizar patrones de comportamiento para los flujos identificados (periodicidad, duración, ‘mutación’) | Data Science. | UPM. | T0 + Q2 |
| 10 | Clasificación de flujos. | Clasificar flujos según su comportamiento y las implicaciones en la carga de sectores | Eficiencia Operacional. | CRIDA-ENAIRE. | T0 + Q3 |
| 11 | Predicción de comportamiento de flujos. | Identificación de técnicas de análisis de datos y aprendizaje automático que permitan caracterizar y predecir patrones de flujos | Data Science. | UPM. | T0 + Q3 |
| 12 | Herramienta de predicción de comportamiento de flujos. | Desarrollo de una herramienta que permita caracterizar y predecir patrones. Enlace con la herramienta inicial FLUJOS | Data Science. | UPM. | T0 + Q3 |
| 13 | Estudio de eficiencia de sectorización global. | Estudiar la eficiencia de la sectorización global según el comportamiento de flujos en los sectores | Eficiencia Operacional. | CRIDA-ENAIRE. | T0 + Q4 |
| 14 | Sectorización dinámica basada en flujos. | Definir metodología que permita establecer una sectorización dinámica, basada en los flujos de tráfico de un sector, su comportamiento histórico y la predicción futura | Data Science. | UPM. | T0 + Q4 |
