...
pagina_final: 132188
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2019-17348"
url_pdf: "https://www.boe.es/boe/dias/2019/12/03/pdfs/BOE-A-2019-17348.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2019-17348"
url_eli: "https://www.boe.es/eli/es/cir/2019/11/27/4"
fetched_at: "2026-04-18T17:31:27Z"
...
[imagen] Retribución total del operador del sistema en el año n.

[imagen] Base de retribución del operador del sistema en el año n. Será aquella del periodo regulatorio p al que el año n pertenezca.

[imagen] Retribución por incentivos del operador del sistema en el año n.

[imagen] Importe anual devengado de la cuenta regulatoria por nuevas obligaciones.
...
[imagen] Base de retribución del operador del sistema del periodo regulatorio p.

[imagen] Término de retribución por OPEX incluido en la base de retribución del operador del sistema del periodo regulatorio p.

[imagen] Margen sobre el término de retribución por OPEX incluido en la base de retribución del operador del sistema del periodo regulatorio p.

[imagen] Término de amortización estándar incluido en la base de retribución del operador del sistema del periodo regulatorio p.

[imagen] Término de retribución financiera estándar incluido en la base de retribución del operador del sistema del periodo regulatorio p.
...
1. El margen sobre el término de retribución por OPEX [imagen] incluido en la base de retribución del operador del sistema del periodo regulatorio (p), se calculará a partir de la siguiente fórmula:

[imagen]

Donde:

[imagen] Margen, en porcentaje (%).

2. El margen [imagen] se establece en un 5 %.

## Artículo 7. Término de amortización estándar.

1. El término de amortización estándar [imagen] incluido en la base de retribución del operador del sistema del periodo regulatorio (p) se calculará a partir del gasto en concepto de amortización que figure en la contabilidad separada de la actividad de operación del sistema, tanto en el ámbito peninsular como en el de los sistemas no peninsulares, y a partir de la información regulatoria de costes de la actividad de operación del sistema de electricidad.
...
1. El término de retribución financiera estándar [imagen] incluido en la base de retribución del operador del sistema del periodo regulatorio (p) se calculará a partir de la fórmula siguiente:

[imagen]

Donde:

[imagen] Inmovilizado neto estándar incluido en la base de retribución del operador del sistema del periodo regulatorio p.

[imagen] Tasa de retribución financiera, en porcentaje (%) con 2 decimales. Tomará el valor de la tasa de retribución financiera de las actividades de transporte y distribución de energía eléctrica que se establezca en los años que se correspondan con el periodo regulatorio p, en la Circular 2/2019, de 12 de noviembre, de la Comisión Nacional de los Mercados y la Competencia, por la que se establece la metodología de cálculo de la tasa de retribución financiera de las actividades de transporte y distribución de energía eléctrica, y regasificación, transporte y distribución de gas natural.
...
1. La retribución por incentivos [imagen] del operador del sistema en el año n tomará un valor que podrá oscilar en la siguiente banda:
...
UmbralEnergiaInf~rrtt~ y UmbralEnergiaSup~rrtt~ vendrán definidos respectivamente como el producto de 0,9 por la energía anual mínima y máxima programada en los cinco años anteriores al comienzo del periodo regulatorio, y se fijarán mediante resolución para cada periodo.
...
a) Si el error absoluto es >=UmbralErrorSup~d~, el incentivo es (LId)

b) Si el error absoluto es <=UmbralErrorInf~d~, el incentivo es (LSd)

c) Si el error absoluto está entre UmbralErrorInf~d~ y UmbralErrorSup~d~, el incentivo se calculará aplicando la siguiente fórmula:

Incentivo= (LId-LSd)/(UmbralErrorSup~d~-UmbralErrorInf~d~)*(AbsError-UmbralErrorInf~d~)+LSd

Donde:

UmbralErrorInf~d~ y UmbralErrorSup~d~ vendrán definidos como el 0,9 multiplicado por el error anual de previsión mínimo y máximo registrado en los cinco años anteriores al comienzo del periodo regulatorio, y se fijarán mediante resolución para cada periodo.
...
a) Si el error absoluto es >=UmbralErrorSup~r~, el incentivo es (LIr) %

b) Si el error absoluto es <=UmbralErrorInf~r~, el incentivo es (LSr) %.

c) Si el error absoluto está entre UmbralErrorInf~r~ y UmbralErrorSup~r~, el incentivo se calculará aplicando la siguiente fórmula:

Incentivo= (LIr-LSr)/(UmbralErrorSup~r~-UmbralErrorInf~r~)*(AbsError-UmbralErrorInf~r~)+LSr

Donde:

UmbralErrorInf~r~ y UmbralErrorSup~r~ vendrán definidos como el 0,9 multiplicado por el error anual de previsión mínimo y máximo registrado en los cinco años anteriores al comienzo del periodo regulatorio, y se fijarán mediante resolución para cada periodo.
...
1. Antes del 1 de enero del año n la Comisión Nacional de los Mercados y la Competencia aprobará mediante resolución la cuantía de la retribución del operador del sistema del año n [imagen] a la que se refiere el artículo 3, con base en la metodología establecida en el capítulo II.
...
1.*[imagen]*71.593 miles €.

2.*[imagen]*53.208 miles €.

3.*[imagen]*2.660 miles €.

4.*[imagen]*13.400 miles €.

5.*[imagen]*2.325 miles €.

6.*[imagen]*41.669 miles €.

7.*[imagen]*5.000 miles €.

8. [imagen] 1.667 miles €.
...
Para el primer periodo, LI~rrtt~, LI~d~ y LI~r~ se establecen como LI/3, y LS~rrtt~, LS~d~ y LS~r~ se establecen como LS/3.
