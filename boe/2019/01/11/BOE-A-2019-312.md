---
identificador: "BOE-A-2019-312"
titulo: "Resolución de 11 de diciembre de 2018, del Consejo de Seguridad Nuclear, por la que se publica el Convenio de colaboración con Idom Consulting, Engineering and Architecture, SAU, para participar en el programa internacional \"Code Applications and Maintenance Program (CAMP)\"."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 2189
pagina_final: 2197
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2019-312"
url_pdf: "https://www.boe.es/boe/dias/2019/01/11/pdfs/BOE-A-2019-312.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2019-312"
url_eli: ""
fetched_at: "2026-04-17T21:27:43Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 11 de diciembre de 2018, del Consejo de Seguridad Nuclear, por la que se publica el Convenio de colaboración con Idom Consulting, Engineering and Architecture, SAU, para participar en el programa internacional "Code Applications and Maintenance Program (CAMP)".

El Presidente del Consejo de Seguridad Nuclear y el Director del Área Técnica de Servicios Nucleares de la Compañía Idom han suscrito, con fecha 23 de noviembre de 2018, un Convenio para participar en el programa internacional «Code Applications and Maintenance Program (CAMP)».
...
De otra parte: Don Xabier Ruiz Morín, en nombre y representación como Director del Área Técnica de Servicios Nucleares de Idom Consulting, Engineering and Architecture, SAU (en adelante Idom) con sede en Avenida Zarandoa, 23, 48015 Bilbao, Bizkaia.
...
Que la empresa Idom dispone de una amplia experiencia en la utilización de códigos termohidráulicos en el campo de la seguridad nuclear, entre otros, por lo que tiene interés en tener acceso a los códigos desarrollados por la USNRC.

## Cuarto.

Que la empresa Idom ha colaborado durante el período 2016 a 2017 en el programa CAMP de la USNRC, dentro del proyecto nacional asociado CAMP-España.

## Quinto.

Que el CSN y Idom (en adelante las Partes) consideran que la participación de Idom en el programa CAMP es beneficiosa para el cumplimiento de los objetivos establecidos para el mismo, y en particular para reforzar y complementar la participación española en el programa.
...
La contribución económica de Idom a la financiación del Convenio se establece en un total de diez mil (10.000) euros.
...
Por Idom: Don Oriol Parera Villacampa.

## Sexta. Organización.

A la fecha de la firma de este Convenio Idom se incorpora también a la estructura nacional de participación en el programa CAMP de la NRC denominada CAMP-España. Esta estructura tiene un órgano de gestión denominado Comité de Dirección del Proyecto que reúne dos veces al año a representantes de cada una de las organizaciones nacionales que colaboran con el CSN en el programa CAMP.
...
La empresa Idom Consulting, Engineering and Architecture, SAU (Idom) ha estado involucrada en CAMP-España durante el período 2016 a 2017.

Se ha recibido en el área MOSI, como coordinadores nacionales en el programa CAMP de la USNRC y del nacional asociado CAMP-España, solicitud de renovación del acuerdo vigente CSN-Idom para la colaboración en el programa CAMP-España.
...
– Responsable: Oriol Parera Villacampa.

– Equipo Investigación: Ainara Mira Medina, Daniel López Solé, Emili Martínez Sabán, lmanol Zamora Povea, lvan Horvatovic, Jorge Fradera Fernández, Mireia Salvat Curto, Mathieu lchard y Roger Martí.
...
Este acuerdo conlleva entre otros el compromiso por parte de Idom del pago anual al CSN de dos mil quinientos euros (2.500,00 €), lo que da un total de diez mil euros (10.000,00 €) por los años 2018 a 2021 de vigencia, en concepto de ayuda al pago de la cuota que el CSN hace a la USNRC por participar en CAMP.
