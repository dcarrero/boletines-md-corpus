---
identificador: "BOE-A-2019-4888"
titulo: "Resolución de 27 de marzo de 2019, del Instituto Nacional de Administración Pública, por la que se efectúa la segunda convocatoria del primer semestre de 2019 de actividades formativas en materia de tecnologías de la información y la comunicación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 34122
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2019-4888"
url_pdf: "https://www.boe.es/boe/dias/2019/04/02/pdfs/BOE-A-2019-4888.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2019-4888"
url_eli: ""
fetched_at: "2026-04-18T02:47:04Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 27 de marzo de 2019, del Instituto Nacional de Administración Pública, por la que se efectúa la segunda convocatoria del primer semestre de 2019 de actividades formativas en materia de tecnologías de la información y la comunicación.
...
Mediante esta resolución se por la que se efectúa la segunda convocatoria del primer semestre de 2019 de actividades formativas en materia de tecnologías de la información y la comunicación, que incluye los cursos relacionados en el anexo.
...
| --- | --- | --- | --- | --- | --- |
| 1345 | Aplicación práctica del análisis de datos en las Administraciones públicas. | Del 20 al 23 de mayo. | Pertenecer al subgrupo A1 y personal laboral equivalente. Perfil de gestión y/o directivo. | 20 | Presencial. |
| 1181 | Accesibilidad a las páginas web y a sus contenidos digitales. | Del 20 de mayo al 23 de junio. | Conocimientos básicos de informática a nivel usuario (uso de Windows, instalación de programas y manejo de navegadores: Internet Explorer, Firefox, Chrome). | 30 | Online. |

Área de redes, comunicaciones e internet

| Código | Actividad formativa | Fechas | Requisitos específicos | Horas | Modalidad |
| --- | --- | --- | --- | --- | --- |
| O228 | Redes y TCP/IP. | Del 10 al 14 de junio. | Poseer onocimientos básicos de informática a nivel usuario (Windows, Internet). | 25 | Presencial. |
| O297 | Directorio activo en Windows Server, herramientas y utilidades. | Del 27 al 31 de mayo. | Desempeñar funciones de administración basadas en Microsoft Windows o personal de soporte técnico a usuarios con redes basadas en Directorio Activo. | 25 | Presencial. |
| 1212 | Redes WIFI. | Del 3 al 6 de junio. | Estar destinados en unidades de informática principalmente en unidades del CAU y/o sistemas y/o comunicaciones, con capacidad de instalación y/o configuración de equipos de sobremesa, servidores y equipos de comunicaciones. | 20 | Presencial, M.º Interior, calle Amador de los Ríos, número 7 (Madrid). |

Área de programación y lenguajes

| Código | Actividad formativa | Fechas | Requisitos específicos | Horas | Modalidad |
| --- | --- | --- | --- | --- | --- |
| 1341 | Programación web con HTML5, CSS3 y JQUERY. | Del 3 al 12 de junio. | Poseer conocimientos básicos de programación, estructura de aplicaciones WEB, HTML, JAVASCRIPT y CSS. | 40 | Presencial, M.º Hacienda, calle Alcalá, n.º 5 (Madrid). |

Área de seguridad de sistemas

| Código | Actividad formativa | Fechas | Requisitos específicos | Horas | Modalidad |
| --- | --- | --- | --- | --- | --- |
| O973 | Técnicas de hacking en la evaluación de la seguridad. | Del 17 al 21 de junio. | Estar destinados en unidades TIC, con conocimientos básicos en redes de comunicaciones y en administración de sistemas. | 25 | Presencial, M.º Hacienda, calle Alcalá, n.º 5 (Madrid). |
| 1112 | Seguridad en sistemas Windows. | Del 3 al 7 de junio. | Poseer conocimientos de redes de ordenadores y conocimientos básicos de programación y de sistemas operativos. | 25 | Presencial. |

Área de herramientas informáticas

| Código | Actividad formativa | Fechas | Requisitos específicos | Horas | Modalidad |
| --- | --- | --- | --- | --- | --- |
| O281 | Linux como servidor. | Del 17 al 21 de junio. | Poseer conocimientos básicos de administración de Linux, de servidores web, de redes en entornos Linux y de almacenamiento en Linux. | 25 | Presencial. |
| O283 | Integración de servicios para la tramitación digital. | Del 3 al 7 de junio. | Pertenecer a los subgrupos A1, A2 y personal laboral equivalente. Estar destinados en puestos técnicos y realizar tareas relacionadas con el desarrollo de aplicaciones. | 23 | Presencial. |
| O284 | Integración de servicios para la firma e identificación digital. | Del 10 al 14 de junio. | Pertenecer a los subgrupos A1, A2 y C1 y personal laboral equivalente. Estar destinados en puestos técnicos y realizar tareas relacionadas con el desarrollo de aplicaciones. | 23 | Presencial. |
| 1092 | Linux básico. | Del 27 de mayo al 30 de junio. | Poseer conocimientos básicos de informática y de los periféricos más comunes (manejar un entorno de ventanas, instalación de programas y de un sistema operativo). | 30 | Online. |
