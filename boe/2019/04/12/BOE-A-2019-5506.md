...
pagina_final: 38112
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2019-5506"
url_pdf: "https://www.boe.es/boe/dias/2019/04/12/pdfs/BOE-A-2019-5506.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2019-5506"
url_eli: ""
fetched_at: "2026-04-18T03:29:40Z"
parser_version: "boletines-md/0.1"
---

# Resolución 452/38102/2019, de 10 de abril, de la Subsecretaría, por la que se convocan procesos de selección para ingreso en los centros docentes militares de formación, mediante las formas de ingreso directo y promoción, para la incorporación como militar de carrera a las Escalas de Oficiales y Escalas Técnicas de los Cuerpos de Ingenieros.
...
## ANEXO I. Procesos de selección para el ingreso en los centros docentes militares de formación, mediante las formas de ingreso directo y promoción, para la incorporación como militar de carrera a las Escalas de Oficiales de los Cuerpos de Ingenieros
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Directo (2019041) | Promoción para cambio Escala / Cuerpo (2019042) |  |  |  |  |  |  |
| MC^1^ | MILCO^3^ | MTM^2^ |  |  |  |  |  |
| Tierra | Armamento | 140 | 1 | 2 | 2 (f) | 1 | 14 |
| Construcción | 141 | 1 | 1 |  |  |  |  |
| Telecomunicaciones y Electrónica | 142 | 4(d) | 2(e) |  |  |  |  |
| Armada | Ingenieros | 150 | 6 (a) | 1 (b) | 2 (b) | 3 (b) | 12 |
| Aire | Ingenieros | 160 | 4 (c) | 2 (c) | 2(c) | 1(c) | 9 |
| Total |  | 16 | 8 | 6 | 5 | 35 |  |
...
| Ejército | Especialidad | Código de plaza | Forma de ingreso | Total plazas |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Directo (2019051) | Promoción para cambio Cuerpo (2019052) | Promoción para cambio Escala o Cuerpo
 MILCO^3^
 (2019053) |  |  |  |  |  |
| MC^1^ | MTM^2^ |  |  |  |  |  |  |
| Tierra. | Construcción. | 170 | 1 | 2 (i) | 3 | 2 | 20 |
| Telecomunicaciones y Electrónica. | 171 | 4(g) |  |  |  |  |  |
| Mecánica. | 172 | 8(h) |  |  |  |  |  |
| Armada. | Ingenieros. | 180 | 1 (a) | 2 (a) | 2 (a) | 2 (a) | 7 |
| Aire. | Técnicas Aeroespaciales. | 190 | 3 (b) | 3 (c) | 3:
 2(d) y 1(e) | 2 (f) | 11 |
...
| --- | --- |
| Ingreso Directo.
 Técnicas Aeroespaciales (b). | Ingeniero Técnico Aeronáutico (*)/ Aeronaves.
 Ingeniero Técnico Aeronáutico (*)/Aeromotores.
 Ingeniero Técnico Aeronáutico (*)/Equipos y materiales aeroespaciales. |
| Promoción MC.
 Prioridad.
 Técnicas Aeroespaciales (c). | Ingeniero Técnico Aeronáutico (*)/Aeronaves.
 Ingeniero Técnico Aeronáutico (*)/Aeromotores.
 Ingeniero Técnico Aeronáutico (*)/Equipos y materiales aeroespaciales.
 Ingeniero Técnico Aeronáutico (*)/Aeronavegación.
 Ingeniero Técnico de Telecomunicación (*)/Sistemas Electrónicos.
...
| Promoción MILCO.
 Prioridad.
 Telecomunicaciones y Electrónica (f). | Ingeniero Técnico Aeronáutico (*)/Aeronavegación.
 Ingeniero Técnico de Telecomunicación (*)/Sistemas Electrónicos.
 Ingeniero Técnico de Telecomunicación (*)/Sistemas de Telecomunicación.
 Ingeniero Técnico Industrial (*)/ Electrónica Industrial.
 Ingeniero Técnico Aeronáutico (*)/Aeronaves.
...
| Promoción MTM.
 Prioridad.
 Telecomunicaciones y Electrónica (e). | Ingeniero Técnico Aeronáutico (*)/Aeronavegación.
 Ingeniero Técnico de Telecomunicación (*)/Sistemas Electrónicos.
 Ingeniero Técnico de Telecomunicación (*)/Sistemas de Telecomunicación.
 Ingeniero Técnico Industrial (*)/Electrónica Industrial.
 Ingeniero Técnico Aeronáutico (*)/Aeronaves.
...
| Promoción MTM.
 Prioridad.
 Infraestructura (d). | Ingeniero Técnico Aeronáutico (*)/Aeropuertos.
 Arquitecto Técnico (*).
 Ingeniero Técnico en Obras Públicas (*)/Construcciones Civiles.
 Ingeniero Técnico Aeronáutico (*)/Aeronavegación.
 Ingeniero Técnico de Telecomunicación (*)/Sistemas Electrónicos.
