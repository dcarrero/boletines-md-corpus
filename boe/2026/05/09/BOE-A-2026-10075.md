---
identificador: "BOE-A-2026-10075"
titulo: "Resolución de 27 de abril de 2026, de la Universidad Politécnica de Cartagena, por la que se convocan pruebas selectivas para ingreso, por el sistema de promoción interna, en la Escala Técnica Superior de Informática."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 64295
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-10075"
url_pdf: "https://www.boe.es/boe/dias/2026/05/09/pdfs/BOE-A-2026-10075.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-10075"
url_eli: ""
fetched_at: "2026-05-09T10:18:26Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 27 de abril de 2026, de la Universidad Politécnica de Cartagena, por la que se convocan pruebas selectivas para ingreso, por el sistema de promoción interna, en la Escala Técnica Superior de Informática.

En cumplimiento de lo dispuesto en el acuerdo del Consejo de Gobierno de 24 de marzo de 2026, se convocan pruebas selectivas, mediante el sistema de promoción interna, de tres plazas de la Escala Técnica Superior de Informática de la Universidad Politécnica de Cartagena.
...
Convocar pruebas selectivas para el ingreso en la Escala Técnica Superior de Informática de la Universidad Politécnica de Cartagena, mediante el sistema de promoción interna.
...
1.1 Se convocan pruebas selectivas para cubrir tres plazas de la Escala Técnica Superior de Informática de la Universidad Politécnica de Cartagena, mediante el sistema de promoción interna.
...
d) Haber prestado servicios efectivos como funcionario de carrera durante, al menos, dos años en la Escala Técnica Media de Informática de la Universidad Politécnica de Cartagena.

e) Pertenecer a la Escala de Gestión de Informática de la Universidad de Granada o a la Escala Técnica de Gestión de Sistemas e Informática de la Universidad de Almería y ocupar durante, al menos dos años, un puesto de trabajo con carácter definitivo en la Universidad Politécnica de Cartagena del subgrupo A2 y adscrito a la escala EX51.
...
7.2 La fase de oposición consistirá en un ejercicio de contenidos teóricos y prácticos en el que habrá que contestar un cuestionario de 96 preguntas con cuatro respuestas alternativas, siendo sólo una de ellas la correcta, basado en el contenido del programa de materias, establecido en el anexo. Las referencias normativas contenidas en el programa de materias se entenderán referidas a las normas vigentes en el momento de la realización del correspondiente ejercicio.

Las respuestas erróneas puntuarán negativamente, donde cada respuesta errónea deducirá un cuarto del valor asignado a cada respuesta correcta.
...
Cartagena, 27 de abril de 2026.–El Rector, Mathieu Kessler Neyer.
...
Tema 8. Principios básicos y requisitos mínimos del Esquema Nacional de Seguridad (ENS). Auditoria de la seguridad. Respuesta a incidentes de seguridad.

Tema 9. Política de Seguridad de la Información en la Universidad Politécnica de Cartagena. Normativa de Seguridad y uso de los recursos informáticos en la Universidad Politécnica de Cartagena.

Tema 10. El soporte al servicio para la gestión de la calidad en los servicios de tecnologías de información con ITIL v4. Service desk y Gestión de Incidencias.

Tema 11. La gestión de la configuración en los servicios de tecnologías de información con ITIL v4.

Tema 12. La gestión del cambio en los servicios de tecnologías de información con ITIL v4.

Tema 13. La gestión de los acuerdos de nivel de servicios (SLA) en los servicios de tecnologías de información con ITIL v4.

Tema 14. Interoperabilidad de sistemas (I). El Esquema Nacional de Interoperabilidad. Dimensiones de la interoperabilidad.

Tema 15. Interoperabilidad de sistemas (II). Las Normas Técnicas de Interoperabilidad. Interoperabilidad de los documentos y expedientes electrónicos y normas para el intercambio de datos entre Administraciones Públicas.

Tema 16. Infraestructuras, servicios comunes y compartidos para la interoperabilidad entre Administraciones públicas. Cl@ve, la Carpeta Ciudadana, el Sistema de Interconexión de Registros, la Plataforma de Intermediación de Datos, y otros servicios.

Tema 17. El cifrado. Criptografía simétrica y asimétrica. Algoritmos de encriptación y sistemas de cifrado. Blockchain.

Tema 18. Accesibilidad: Real Decreto 1112/2018, de 7 de septiembre, sobre accesibilidad de los sitios web y aplicaciones para dispositivos móviles del sector público. Disposiciones generales. Control, revisión, seguimiento y presentación de informes.

Tema 19. Conceptos de modelado de negocio y arquitectura empresarial. BMM 1.3 y TOGAF 9.2.

Tema 20. Metodologías de desarrollo de sistemas. Metodologías ágiles: Scrum y Kanban.

Tema 21. Niveles de capacidad y madurez de CMMI para desarrolladores (CMMI-Dev).

Tema 22. El estándar de verificación de seguridad en aplicaciones ASVS 4.0 de OWASP. Niveles de verificación, controles de seguridad y su aplicación en el ciclo de desarrollo seguro (DevSecOps).

Tema 23. Inteligencia Artificial en el ámbito universitario. Fundamentos y tipologías (*machine learning, deep learning*, modelos de lenguaje LLM). Generación aumentada por recuperación (RAG). Aplicaciones de la IA en la administración, la investigación y la docencia.

Tema 24. Diseño conceptual de bases de datos. Diseño lógico de bases de datos. Modelo Entidad-Relación. Normalización.

Tema 25. Gestión de cambios en proyectos de desarrollo de software. Gestión de la configuración y de versiones con Git. Integración y despliegue continuo (CI/CD).

Tema 26. Desarrollo de aplicaciones con Spring Boot. Arquitectura MVC, inyección de dependencias, JPA/Hibernate y JSF.

Tema 27. Framework Laravel 10. Arquitectura MVC, controladores, modelos, vistas y servicios.

Tema 28. Servidores Web: Apache Web Server 2.4, Apache Tomcat 11. Definición, componentes, funcionamiento y despliegue de aplicaciones.

Tema 29. Procesamiento cooperativo y modelo cliente-servidor. Arquitectura orientada a servicios (SOA). Servicios Web SOAP y REST.

Tema 30. Gestión de identidades. Single sign-on con CAS7. Federación de identidades con SAML2 y OAuth2. SIR2.

Tema 31. Servicios de directorio basados en OpenLDAP. Conceptos, arquitectura, componentes, seguridad y acceso.

Tema 32. Servicios de acceso remoto seguro. Redes privadas virtuales (VPN). Tipos y tecnologías. ZTNA.

Tema 33. Gestión de servicios IP. DNS, DHCP e IPAM. Arquitectura y componentes. Aspectos relacionados con la seguridad.

Tema 34. Sistemas de cableado. Interconexión de redes. Dispositivos. Alta disponibilidad.

Tema 35. El modelo OSI de ISO: arquitectura, capas, interfaces, protocolos, direccionamiento y encaminamiento.

Tema 36. Redes Inalámbricas: el estándar IEEE 802.11. Características funcionales y técnicas. Sistemas de acceso y autenticación Modos de operación. Seguridad.

Tema 37. Protocolo IPv6. Principales características y funcionalidades. Modos de convivencia con IPv4.

Tema 38. Microsoft 365. Administración del entorno y de sus principales servicios (Exchange, Teams, OneDrive y SharePoint). Gestión de la identidad y la seguridad.

Tema 39. Gestión del tráfico de red. Calidad de servicio y monitorización. Protocolo SNMP.

Tema 40. Seguridad en redes de comunicaciones. Administración de Cortafuegos Fortigate. VDOMs, políticas, perfiles de seguridad y otros componentes.

Tema 41. Cloud Computing. IaaS, PaaS, SaaS. Nubes privadas, públicas e híbridas.

Tema 42. Sistemas operativo Linux Redhat 9. Configuración. Usuarios. Procesos. Ficheros. Sistemas de ficheros y Gestión del almacenamiento. El shell, conceptos y programación. Configuración de Servicios y tareas programadas.

Tema 43. Sistemas operativos Microsoft. Fundamentos, administración, instalación, gestión.

Tema 44. Almacenamiento en red. DAS, SAN y NAS. Tecnologías FibreChannel, iSCSI, NFS y SMB/CIFS. Sistemas de almacenamiento en RAID. Políticas de copia de seguridad y retención. Sistemas de Backup.

Tema 45. Gestor de Base de Datos Oracle 19c. Tareas de administración, creación, inicialización, arranque y parada. Herramientas de protección y recuperación: TSM/RMAN, DataGuard y Data Pump.

Tema 46. Virtualización de sistemas con VMWare vSphere. Arquitectura de alta disponibilidad y tolerancia a fallos.

Tema 47. Virtualización de aplicaciones mediante contenedores Docker.

Tema 48. Orquestación y escalabilidad de contenedores con Kubernetes.

Tema 49. Arquitectura de Protección del Perímetro para la Interconexión de Sistemas de Información según el CCN-CERT: arquitecturas de protección, requisitos del ENS y requisitos sobre herramientas de seguridad.

Tema 50. El diseño físico de los centros de datos. Aspectos principales. Vulnerabilidades, riesgos típicos y mecanismos de protección.
