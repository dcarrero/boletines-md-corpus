---
identificador: "BOE-A-2026-10801"
titulo: "Resolución de 11 de mayo de 2026, de la Universidad Politécnica de Cartagena, por la que se convocan pruebas selectivas para ingreso, por el sistema de promoción interna, en la Escala Técnica Media de Informática."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 68633
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-10801"
url_pdf: "https://www.boe.es/boe/dias/2026/05/19/pdfs/BOE-A-2026-10801.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-10801"
url_eli: ""
fetched_at: "2026-05-19T12:22:31Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 11 de mayo de 2026, de la Universidad Politécnica de Cartagena, por la que se convocan pruebas selectivas para ingreso, por el sistema de promoción interna, en la Escala Técnica Media de Informática.

En cumplimiento de lo dispuesto en el acuerdo del Consejo de Gobierno de 24 de marzo de 2026, se convocan pruebas selectivas, mediante el sistema de promoción interna, de una plaza de la Escala Técnica Media de Informática de la Universidad Politécnica de Cartagena.
...
Convocar pruebas selectivas para el ingreso en la Escala Técnica Media de Informática de la Universidad Politécnica de Cartagena, mediante el sistema de promoción interna.
...
1.1 Se convocan pruebas selectivas para cubrir una plaza de la Escala Técnica Media de Informática de la Universidad Politécnica de Cartagena, mediante el sistema de promoción interna.
...
d) Haber prestado servicios efectivos como funcionario de carrera durante, al menos, dos años en la Escala Técnica Básica de Informática de la Universidad Politécnica de Cartagena.
...
Tema 7. Esquema Nacional de Seguridad (ENS): Capítulo I. Disposiciones generales. Capítulo II. Principios básicos. Capítulo III. Política de seguridad y requisitos mínimos de seguridad. Anexo I. Categorías de seguridad de los sistemas de información.

Tema 8. Política de Seguridad de la Información en la Universidad Politécnica de Cartagena. Normativa de Seguridad y uso de los recursos informáticos en la Universidad Politécnica de Cartagena.

Tema 9. El soporte al servicio para la gestión de la calidad en los servicios de tecnologías de información con ITIL v4. *Service desk* y Gestión de Incidencias.

Tema 10. La gestión de la configuración en los servicios de tecnologías de información con ITIL v4.

Tema 11. La gestión del cambio en los servicios de tecnologías de información con ITIL v4.

Tema 12. La gestión de los acuerdos de nivel de servicios (SLA) en los servicios de tecnologías de información con ITIL v4.

Tema 13. Interoperabilidad de los sistemas de información en las Administraciones públicas. El Esquema Nacional de Interoperabilidad. Objetivos, Principios Básicos y Dimensiones de la interoperabilidad.

Tema 14. Metodologías de desarrollo de sistemas. Metodologías ágiles: Scrum y Kanban.

Tema 15. Inteligencia Artificial en el ámbito universitario. Fundamentos básicos, tipos de sistemas (*machine learning, deep learning,* modelos de lenguaje LLM) y principales aplicaciones en la administración, la investigación y la docencia.

Tema 16. Lenguaje PL/SQL. Fundamentos, estructura básica y control de errores.

Tema 17. Diseño de bases de datos. Modelo entidad-relación, diseño lógico y normalización.

Tema 18. Ordenadores personales. Arquitectura. Procesadores. Tipos y características. Instalación y configuración de componentes*hardware*. BIOS y UEFI.

Tema 19. Dispositivos de almacenamiento, memorias, tarjetas gráficas, tarjetas de red, escáneres, impresión. Puertos y conectores.

Tema 20. Sistemas operativos para entornos de puesto de trabajo: MS Windows, MacOS y distribuciones Linux.

Tema 21. Programación en *scripting* para Linux (*shell bash*). Conceptos generales.

Tema 22. Windows *(Power Shell)*. Gestión de cuentas de usuarios y grupos. Carpetas compartidas. Discos. Red. Procesos y servicios. Tareas programadas y gestión de impresoras.

Tema 23. Navegadores de Internet y sus protocolos, *plugins* y extensiones. Configuración de conexión a red. Instalación y gestión de certificados digitales.

Tema 24. Microsoft Intune. Gestión de imágenes y despliegue de equipos virtualizados y físicos.

Tema 25. Microsoft Intune. Configuración dispositivos Windows y políticas de seguridad.

Tema 26 Servicios comunes de la Administración Electrónica. Plataformas de Interoperabilidad y servicios compartidos: Cl@ve, la Carpeta Ciudadana, el Sistema de Interconexión de Registros (SIR), la Plataforma de Intermediación de Datos (PID).

Tema 27. Identidad y firma electrónica: El reglamento eIDAS y Ley 6/2020 de 11 de noviembre.

Tema 28. El cifrado. Criptografía simétrica y asimétrica. Algoritmos de encriptación y sistemas de cifrado. Características básicas de Blockchain.

Tema 29. Dispositivos móviles: Aspectos de seguridad y gestión según CCN-CERT.

Tema 30. Introducción a los servicios de directorio basados en OpenLDAP. Esquemas de configuración: Directorio local replicado, distribuido y con referencias.

Tema 31. Redes privadas virtuales. Tipos y tecnologías. Protocolos: SSL, IPSec. Servicios de acceso remoto.

Tema 32. Modelo de referencia OSI de ISO. Arquitectura TCP/IP. Direccionamiento IP. Encaminamiento. Principales protocolos de la arquitectura TCP/IP.

Tema 33. Sistemas de cableado estructurado. Elementos pasivos/activos. Normativa y estándares.

Tema 34. Protocolo IPv6. Principales características y funcionalidades. Modos de convivencia con IPv4.

Tema 35. Redes Inalámbricas: el estándar IEEE 802.11. Características funcionales y técnicas. Sistemas de acceso. Normativa reguladora.

Tema 36. Medidas de seguridad contra *ransomware*del CCN-CERT.

Tema 37. Almacenamiento en red. DAS, SAN y NAS. Tecnologías FibreChannel, iSCSI, NFS y SMB/CIFS. Sistemas de almacenamiento en RAID. Políticas de copia de seguridad y retención. Sistemas de *backup*.

Tema 38. Virtualización de sistemas y aplicaciones con: VMWare vSphere, Docker.

Tema 39. Sistemas de Tecnologías de la Información en la UPCT. Infraestructura de redes y sistemas. Ciclo de vida de identidades.

Tema 40. Cloud Computing. IaaS, PaaS, SaaS. Nubes privadas, públicas e híbridas.
