---
identificador: "BOE-A-2026-14090"
titulo: "Resolución de 23 de junio de 2026, de la Subsecretaría, por la que se publica el Convenio entre la Agencia Española de Cooperación Internacional para el Desarrollo y el Instituto Nacional de Estadística, O.A., para la realización de programaciones de capacitación técnica e innovación del programa Intercoonecta."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 89786
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-14090"
url_pdf: "https://www.boe.es/boe/dias/2026/06/29/pdfs/BOE-A-2026-14090.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-14090"
url_eli: ""
fetched_at: "2026-06-29T10:58:44Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 23 de junio de 2026, de la Subsecretaría, por la que se publica el Convenio entre la Agencia Española de Cooperación Internacional para el Desarrollo y el Instituto Nacional de Estadística, O.A., para la realización de programaciones de capacitación técnica e innovación del programa Intercoonecta.

El Director de la Agencia Española de Cooperación Internacional al Desarrollo y la Presidenta del Instituto Nacional de Estadística, O.A., han suscrito, con fecha de 22 de mayo de 2026, un convenio para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta.
...
## ANEXO. Convenio entre la Agencia Española de Cooperación Internacional para el Desarrollo (AECID) y el INE - Instituto Nacional de Estadística para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta
...
Que el INE es un organismo autónomo de carácter administrativo, con personalidad jurídica y patrimonio propio, adscrito al Ministerio de Economía, Comercio y Empresa a través de la Secretaría de Estado de Economía y Apoyo a la Empresa, y que de acuerdo con la Ley 12/1989, de 9 de mayo, de la Función Estadística Pública (LFEP) (modificada en el BOE de 8 de julio de 2022), le corresponden entre otras funciones la elaboración de las estadísticas que le confiere el Plan Estadístico Nacional, la propuesta de normas comunes sobre conceptos, unidades estadísticas, clasificaciones y códigos así como la preparación y ejecución de los planes generales de cooperación técnica internacional en materia estadística.
...
El presente convenio tiene por objeto articular la colaboración entre la AECID y el INE - Instituto Nacional de Estadística para la ejecución de la programación Capacitación técnica en estadística oficial para fortalecer y modernizar los sistemas estadísticos en América Latina y el Caribe, seleccionada en el marco de la convocatoria Intercoonecta 2025, conforme a los términos establecidos en dicha convocatoria.
...
La ejecución de las actividades se desarrollará en modalidad virtual y/o presencial, según lo acordado en los procesos de cocreación entre la AECID y el INE. Las actividades virtuales se realizarán en la plataforma Intercoonecta, mientras que las presenciales se celebrarán en uno de los siguientes Centros de Formación de la Cooperación Española: Cartagena de Indias (Colombia), Santa Cruz de la Sierra (Bolivia), La Antigua (Guatemala) y en la Oficina de la Cooperación Española en Montevideo (Uruguay). La AECID determinará la sede específica para cada programación en función de su disponibilidad y pertinencia.

La programación «Capacitación técnica en estadística oficial para fortalecer y modernizar los sistemas estadísticos en América Latina y el Caribe» tiene como finalidad reforzar las capacidades técnicas e institucionales de los organismos estadísticos de la región, promoviendo la modernización de los sistemas estadísticos mediante el uso de nuevas metodologías, fuentes de datos innovadoras y herramientas tecnológicas, incluyendo inteligencia artificial y lenguaje R. A través de acciones formativas especializadas, se busca mejorar la calidad, disponibilidad y uso de la estadística oficial para el diseño, implementación y evaluación de políticas públicas basadas en evidencia, contribuyendo así a una mejor toma de decisiones, a la reducción de desigualdades y al cumplimiento de los Objetivos de Desarrollo Sostenible.

Actividades de la programación:

– Píldora formativa: La medición del progreso hacia los Objetivos de Desarrollo Sostenible: 2026 – Aula Virtual Intercoonecta (virtual).

– Seminario online: El uso de registros administrativos en las encuestas a hogares y censo del INE: 2026 – Aula Virtual Intercoonecta (virtual).

– Seminario online: Aplicaciones de R a la estadística oficial: 2026 – Aula Virtual Intercoonecta (virtual).

– Curso práctico: Estadísticas para la medición del turismo. Estadísticas tradicionales y nuevas fuentes de información: 2026-2027 Aula Virtual Intercoonecta (virtual).

– Curso práctico: Estadísticas laborales: Encuestas a hogares y uso asociado de registros administrativos: 2026-2027 Aula Virtual Intercoonecta (virtual).

– Taller: Aplicaciones de Machine Learning a la Estadística Oficial: 2026-2027 – OCE de Montevideo (Uruguay) (presencial).

– Curso práctico: Indicadores Demográficos: 2027 – Aula Virtual Intercoonecta (virtual).

– Curso práctico: Estadísticas Sociales: 2027 – Aula Virtual Intercoonecta (virtual).

– Taller: Censos basados en registros: 2027 – OCE de Montevideo (Uruguay) (presencial).

– Curso práctico: Cuentas Nacionales: 2027 – Aula Virtual Intercoonecta (virtual).

## Segunda. Compromisos de la AECID.

a) La designación de un equipo técnico acorde a la naturaleza de las propuestas seleccionadas, para trabajar conjuntamente con el INE en el proceso de diseño y formulación de actividades durante la fase de cocreación.
...
j) La AECID, a través de sus Unidades de Cooperación Española, gestionará directamente el alojamiento y manutención de los participantes destinatarios de las actividades.

k) Si en el momento en el que se suscribe el convenio el lugar en el que se ejecutarán todas las actividades no se ha definido, será AECID quien lo determine.
...
La AECID, financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, a través de su Oficina de la Cooperación Española en Montevideo (Uruguay) las obligaciones asumidas en la cláusula segunda por un importe de hasta 54.851 euros.

El INE - Instituto Nacional de Estadística financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, las obligaciones asumidas en la cláusula tercera por un importe de hasta 50.062 euros.
...
Igualmente, en caso de cancelación o aplazamiento unilateral por parte del INE, una vez comunicada la selección de participantes, esta asumirá los gastos que se hubieran generado, siempre que la decisión no obedezca a causas imprevistas, inevitables y ajenas a su voluntad.

2. Exclusión de futuras convocatorias.

El incumplimiento de las obligaciones establecidas en el presente convenio, especialmente aquellas relativas a la ejecución de las actividades, la gestión de participantes, la entrega de productos comprometidos o la rendición de cuentas, podrá conllevar la exclusión del INE en futuras convocatorias del programa Intercoonecta, previa valoración por parte de la AECID.
...
– Cargo: Subdirectora General de Relaciones Internacionales y Agenda 2030. INE.
...
Las causas de resolución del presente convenio son las establecidas en el artículo 51.2 de la Ley 40/2015, de 1 de octubre:
...
Y en prueba de conformidad y, para la debida constancia de cuanto queda convenido, las partes firman digitalmente el presente convenio en la fecha indicada en la firma electrónica. El convenio se entiende suscrito en la fecha de firma de la última parte firmante.–La Presidenta de la Agencia Española de Cooperación Internacional para el Desarrollo, P. D. (Resolución de 2 de julio de 2009), el Director de la Agencia Española de Cooperación Internacional para el Desarrollo, Antón Leis García.–La Presidenta del Instituto Nacional de Estadística, O.A., Elena Manzanera Díaz.
