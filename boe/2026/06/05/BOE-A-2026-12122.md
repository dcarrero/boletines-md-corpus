---
identificador: "BOE-A-2026-12122"
titulo: "Resolución de 13 de mayo de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la categoría de Técnico Diplomado de Laboratorio y Talleres."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 76736
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-12122"
url_pdf: "https://www.boe.es/boe/dias/2026/06/05/pdfs/BOE-A-2026-12122.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-12122"
url_eli: ""
fetched_at: "2026-06-05T12:22:26Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 13 de mayo de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la categoría de Técnico Diplomado de Laboratorio y Talleres.
...
1.1 Esta convocatoria tiene por objeto la selección de personal, mediante el sistema concurso-oposición por el turno libre, para cubrir una (1) plaza del grupo A, subgrupo A1, sector de Administración Especial, técnico diplomado de laboratorio y talleres en el área comunicaciones - electrónica de la Universitat Politècnica de València.
...
6.3.1 Primer ejercicio: se realizará por escrito y versará sobre los conocimientos que se especifican en el anexo I de la convocatoria.
...
6.3.2 Segundo ejercicio: de carácter práctico. Consistirá en una prueba práctica sobre el temario especificado en el bloque de conocimientos específicos y las funciones del puesto que figuran en el anexo I de la convocatoria.
...
Valencia, 13 de mayo de 2026.–El Rector, José Esteban Capilla Romá.
...
– Control de suministros y material de laboratorio, y elaborar en su caso las propuestas de compra o asistencia a compra del material y equipamiento necesario para el funcionamiento de los laboratorios.
...
– Mantenimiento del inventario del laboratorio.

– Desarrollo de módulos específicos para apoyo a la docencia de prácticas de laboratorio, incluyendo el diseño y realización de circuitos impresos y realización de montaje de prototipos configuración de equipos (osciloscopios, generadores de funciones, fuentes de alimentación, medidores de campo, equipos ópticos, cámaras de vídeo, tarjetas de sonido externas y micrófonos, etc).

– Instalación, puesta a punto y mantenimiento de los equipos informáticos existentes en los laboratorios docentes y de investigación del Departamento tanto a nivel de hardware como de software:

Hardware:

– Ampliación, mantenimiento y reparación.

– Interconexionado de equipos.

– Compra o asistencia a la compra de equipos.

Software:

– Instalación y configuración de los Sistemas Operativos incluyendo: Windows, Linux, MacOS y futuras actualizaciones.

– Instalación de los paquetes ofimáticos estándar, configuración del correo, navegadores, utilidades básicas, antivirus y software propio del Departamento.

– Instalación básica de servidores Windows.

– Instalación básica de servidores antivirus.

– Instalación de paquetes informáticos de audio y video.

– Instalación básica de otros servicios telemáticos que se requieran.

– Establecimiento y configuración de las comunicaciones de red para el correcto funcionamiento de los equipos. Gestión de red. Permisos de acceso a la red.

– Gestión de los permisos de usuario para acceder a los diferentes servicios del Departamento y Universidad (UPVNET, laboratorios, fotocopiadoras, tarjetas de red, etc).

– Gestión de medios comunes del departamento (control de accesos, impresoras, etc).

– Configuración de equipos multimedia para la docencia.
...
Bloque I: Gestión Ambiental y Seguridad

6. Gestión Ambiental en la UPV: Política ambiental. Gestión de residuos de laboratorio (químicos y electrónicos). Ahorro energético y consumo responsable.

7. Seguridad y Salud en el Laboratorio: Normativa vigente. Riesgos específicos en laboratorios de electrónica y comunicaciones. Equipos de protección individual y colectiva.

8. Seguridad Eléctrica: Riesgo eléctrico. Medidas de protección en instalaciones. Normas de seguridad en recintos de pública concurrencia y reglamentación aplicable.

Bloque II: Electrónica, Circuitos e Instrumentación

9. Componentes Electrónicos Pasivos: Resistencias, condensadores e inductancias. Especificaciones técnicas, identificación y selección.

10. Componentes Electrónicos Activos: Diodos, transistores y circuitos integrados. Amplificadores operacionales y circuitos de aplicación.

11. Electrónica Digital: Códigos de numeración, funciones lógicas y circuitos combinacionales y secuenciales básicos.

12. Fuentes de Alimentación y Corriente: Tipos, diseño básico, fuentes conmutadas y lineales. Medida de parámetros.

13. Circuitos de Radiofrecuencia: Conceptos básicos de RF. Amplificadores de potencia y de bajo ruido. Mezcladores y filtros.

14. Diseño e Implementación de Circuitos: Placas de prototipos y preperforadas. Herramientas de montaje y técnicas de soldadura.

15. Circuitos Impresos (PCB): Diseño asistido por ordenador (CAD), fabricación y montaje de prototipos. Mantenimiento y reparación.

16. Instrumentación Básica de Medida: El polímetro. El osciloscopio: funcionamiento, sondas y tipos de medida.

17. Instrumentación Avanzada en RF: El generador de señal y funciones. El analizador de espectros: fundamentos y aplicaciones. El analizador de redes.

18. Sistemas de Audio y Vídeo: Configuración de equipos multimedia, cámaras de vídeo, tarjetas de sonido externas y microfonía para docencia.

19. Equipamiento de Óptica: Medidores de potencia óptica, fuentes de luz y equipos específicos de laboratorio óptico. Mantenimiento preventivo.

Bloque III: Conectividad y Comunicaciones

20. Conexión en Baja Frecuencia: Cables, conectores y latiguillos. Tipos de terminales, construcción y aplicaciones en laboratorio.

21. Conexión en RF y Microondas: Guías de onda, cables coaxiales y conectores específicos. Adaptación de impedancias.

22. Comunicaciones Ópticas: Tipos de fibras ópticas, conectores. Técnicas de limpieza y empalme.

23. Infraestructura de Red en Laboratorios: Armarios de comunicaciones (Racks), paneles de conexión y gestión física del cableado.

Bloque IV: Sistemas Informáticos y Redes.

24. Arquitectura de Ordenadores: Componentes internos de equipos microinformáticos (sobremesa, portátiles, servidores). CPUs, memoria RAM, placas base, subsistema gráfico y tarjetas de red.

25. Almacenamiento y Periféricos: Sistemas de almacenamiento (SSD, HDD, NVMe). Periféricos de visualización, digitalización e impresión. Conectividad (USB, HDMI, DisplayPort).

26. Sistemas Operativos de Escritorio: Administración y configuración de Windows, Linux y MacOS. Gestión de actualizaciones y mantenimiento.

27. Sistemas Operativos de Servidor: Instalación y administración básica de Windows Server y Linux Server. Roles y servicios.

28. Dispositivos Móviles: Sistemas operativos (Android, iOS). Configuración, seguridad y conectividad con servicios universitarios.

29. Instalación de Software y Aplicaciones: Gestión de paquetes ofimáticos, entornos de programación (IDE), antivirus y herramientas de videoconferencia.

30. Administración de Redes Locales (LAN): Modelo TCP/IP. Direccionamiento IPv4 e IPv6. Protocolos fundamentales, gestión de subredes e intranets.

31. Redes inalámbricas: Conceptos básicos, estándares, seguridad.

32. Servicios de Internet y Red: Arquitectura y protocolos HTTP, HTTPS, SMTP, IMAP, POP3. Configuración de servicios telemáticos.

33. Acceso Remoto: Redes Privadas Virtuales (VPN). Acceso remoto seguro (SSH, RDP).

34. Virtualización: Virtualización de sistemas (hipervisores) y virtualización de puestos de usuario (VDI). Beneficios y configuración.

35. Gestión de Aulas Informáticas: Software de gestión y control de aulas. Gestión de usuarios y permisos de acceso a red (UPVNET).

36. Seguridad Informática: Seguridad en el puesto de usuario, antivirus y permisos.

37. Sistemas y técnicas de respaldo (backup) de datos.
