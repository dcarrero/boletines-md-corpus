---
identificador: "BOE-A-2026-14217"
titulo: "Resolución de 23 de junio de 2026, de la Subsecretaría, por la que se publica el Convenio entre la Agencia Española de Cooperación Internacional para el Desarrollo y la Agencia Española de Medicamentos y Productos Sanitarios, para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 90441
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-14217"
url_pdf: "https://www.boe.es/boe/dias/2026/06/30/pdfs/BOE-A-2026-14217.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-14217"
url_eli: ""
fetched_at: "2026-06-30T10:30:40Z"
...
El Director de la Agencia Española de Cooperación Internacional para el Desarrollo y la Directora de la Agencia Española de Medicamentos y Productos Sanitarios han suscrito, con fecha de 26 de mayo de 2026, un convenio para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta.
...
## ANEXO. Convenio entre la Agencia Española de Cooperación Internacional para el Desarrollo (AECID) y la Agencia Española de Medicamentos y Productos Sanitarios (AEMPS) para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta
...
Y de otra María Jesús Lamas Díaz, cargo de Directora, designada por Resolución, de 19 de julio de 2018, de la Presidencia de la Agencia Estatal Agencia Española de Medicamentos y Productos Sanitarios, actuando en nombre y representación de la Agencia Española de Medicamentos y Productos Sanitarios (AEMPS, en adelante), con domicilio en la calle Campezo, número 1, edificio 8, 28022 Madrid y NIF Q2827023I, conforme a las atribuciones establecidas en el Real Decreto 1275/2011, de 16 de septiembre, por el que se crea la Agencia estatal «Agencia Española de Medicamentos y Productos Sanitarios» y se aprueba su Estatuto, aprobado por el Ministro de la Presidencia del Gobierno de España, publicado en el «Boletín Oficial del Estado».
...
Que la AEMPS fue creada como Agencia estatal mediante el Real Decreto 1275/2011, de 16 de septiembre, por el que se aprueba su Estatuto, y se encuentra adscrita al Ministerio de Sanidad.

En el artículo 6 de dicho Estatuto, se declara, como objeto de esta, «el de garantizar que tanto los medicamentos de uso humano, como los de uso veterinario y los productos sanitarios, cosméticos y productos de higiene personal cumplan con estrictos criterios de calidad, seguridad, eficacia y correcta información con arreglo a la normativa vigente sobre estas materias en el ámbito estatal y de la Unión Europea».

Asimismo, su artículo 14.2, letra f) faculta al Director para «suscribir toda clase de actos, convenios, contratos y encomiendas en nombre de la Agencia» y su artículo 7.1 incluye entre sus competencias la de cooperar con países terceros, en especial con Iberoamérica en el ámbito del conocimiento científico y regulatorio en materia de medicamentos, productos sanitarios y otros productos competencia de la AEMPS.
...
El presente convenio tiene por objeto articular la colaboración entre la AECID y AEMPS para la ejecución de las programaciones: «Capacitación en productos objeto de evaluación, autorización y control por las autoridades competentes en medicamentos en el marco de la red EAMI» y « Resistencia a los antimicrobianos en el contexto de Una Sola Salud: itinerario de formación para el fortalecimiento de capacidades en Iberoamérica», seleccionadas en el marco de la convocatoria Intercoonecta 2025, conforme a los términos establecidos en dicha convocatoria.
...
La programación «Capacitación en productos objeto de evaluación, autorización y control por las autoridades competentes en medicamentos en el marco de la red EAMI», se enfoca en: Aumentar las competencias y capacidades del personal al servicio de las autoridades competentes en materia de regulación sanitaria de manera que se fortalezca la armonización entre instituciones participantes de la Red lo cual redunde en la implementación de políticas públicas y mejoras de los sistemas nacionales de salud de la región, mayor cohesión social e impulso de la Agenda 2030.

La Red de Autoridades en Medicamentos de Iberoamérica (EAMI) formada por autoridades competente de 22 países iberoamericanos, y coordinada por la Agencia Española de Medicamentos y Productos Sanitarios (AEMPS). Su objetivo es cooperar, armonizar y generar conocimiento a través del intercambio de experiencias, información técnica y legislativa en el campo de la regulación de medicamentos, dispositivos médicos, cosméticos, biocidas y productos de cuidado personal. Tiene, por tanto, una perspectiva de servicio público y se enfoca en garantizar el acceso, calidad, seguridad y eficiencia en la región en lo relativo a los campos de su ámbito de competencia.

Se trabajará en varias líneas de actuación como que abarcan distintos enfoques de la salud pública, desde la fabricación de medicamentos y productos sanitarios hasta la vigilancia y detección de riesgos una vez se comercializan.

Para lograrlo se propone una serie de actividades:

1. Detección de señales en bases de datos de notificación espontánea – Aula Virtual Intercoonecta en 2026.

2. Detección de señales en bases de datos de notificación espontánea – Fase presencial en el Centro de Formación de la Cooperación Española en Sta. Cruz de la Sierra, Bolivia en 2026.

3. Comunicación y gestión de riesgos en farmacovigilancia – Aula Virtual Intercoonecta, en 2027.

4. Farmacovigilancia veterinaria: herramienta para el mejor conocimiento de la seguridad y eficacia de los medicamentos utilizados en veterinaria – Aula Virtual Intercoonecta, en 2027.

5. Instalaciones de fabricación, importación de dispositivos médicos, cosméticos, biocidas y productos de cuidado personal – Aula Virtual Intercoonecta, en 2026.

6. Autorización de biocidas y productos de cuidado persona (tintas de tatuaje, mascarillas, productos de masaje deportivo, etc.). Casos prácticos – Aula Virtual Intercoonecta, en 2026.

La programación: «Resistencia a los antimicrobianos en el contexto de Una Sola Salud: itinerario de formación para el fortalecimiento de capacidades en Iberoamérica», cuya finalidad es Fortalecer las capacidades técnicas e intersectoriales de las instituciones en Iberoamérica para enfrentar la resistencia a los antimicrobianos (RAM) desde el enfoque más holístico, que combine formación e innovación, que además promueva la inclusión de salud humana, animal y del medioambiente en los Planes Nacionales de Acción (PNAs); Capacitar en estrategias de comunicación para el cambio de comportamiento y la participación comunitaria.

La resistencia a los antimicrobianos (RAM) es una de las principales amenazas para la salud global (en 2021 se estimaron 4,71 millones de muertes globales asociadas a la RAM con un coste sanitario de 1.500 millones de euros y se estima que para 2050, si no se toman medida se convertirá en la primera causa de mortalidad global). Para atajar este problema sanitario es imperativo abordarlo desde todos los frentes implicados (medioambiente, salud humana y animal) y fortalecer la colaboración entre regiones. Proponemos un itinerario de formación continua, alineado con los Objetivos de Desarrollo Sostenible (ODS) 3 y 12, que promueva la integración del medioambiente y fortalezca los sistemas de vigilancia y respuesta en los Planes Nacionales de Acción (PNAs). Este itinerario busca reforzar: las capacidades técnicas e institucionales de los países participantes a través de un programa formativo integral sobre RAM desde el enfoque One Health (OH) o de Una Sola Salud; el intercambio de experiencias y lecciones aprendidas en las áreas de medioambiente, salud humana, salud animal y comunicación para el cambio social y de comportamiento; y las redes de colaboración técnica en estos sectores, como paso inicial hacia la organización de Policy Labs que funcionarán como espacios dinámicos de experimentación e innovación. El objetivo final es transformar los conocimientos, experiencias y lecciones aprendidas a lo largo del programa formativo en acciones concretas y ajustadas a las realidades específicas de cada país mediante la actualización e implementación de los PNAs.

Para lograrlo se propone una serie de actividades:

1. Gobernanza, regulación y bases biológicas de la RAM – Aula Virtual Intercoonecta, en 2026.

2. La RAM en Salud Humana – Aula Virtual Intercoonecta, en 2027.

3. La RAM en Sanidad Animal – Aula Virtual Intercoonecta, en 2027.

4. LA RAM en Medio Ambiente – Aula Virtual Intercoonecta, en 2027.

5. Pasos para la creación de una estrategia para el cambio social y de comportamiento en materia de las RAM – Aula Virtual Intercoonecta, en 2027.

6. Taller regional sobre implementación de acciones para contener la RAM desde el enfoque Una Sola Salud – Presencial en el Centro de Formación de la Cooperación Española en Sta. Cruz de la Sierra, Bolivia en 2027.
...
El presente convenio no supone ningún compromiso de transferencia económica entre las entidades firmantes. La AECID, como entidad del Sector Público incluida en los Presupuestos Generales del Estado de España, financiará las obligaciones que asume en este convenio cargo a las aplicaciones presupuestarias 12.302.03.143A.226.15, 12.302.03.143A.227.15, 12.302.03.143A.233.

Cada una de las partes firmantes asumirá los costes derivados de la ejecución del presente convenio:

La AECID, financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, a través de sus Centros de Formación de la Cooperación Española en: Santa Cruz de la Sierra, Bolivia; Cartagena de Indias, Colombia; La Antigua, Guatemala y la Oficina de la Cooperacion Española en Uruguay, las obligaciones asumidas en la cláusula segunda por un importe de hasta 88.923,00 euros.

AEMPS, financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, las obligaciones asumidas en la cláusula tercera por un importe de hasta 48.000 euros.
