---
identificador: "BOE-A-2026-18494"
titulo: "Resolución de 29 de julio de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la Escala de Técnico Diplomado de Laboratorio y Talleres."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "216"
pagina_inicial: 118421
pagina_final: 118442
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-18494"
url_pdf: "https://www.boe.es/boe/dias/2026/09/02/pdfs/BOE-A-2026-18494.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-18494"
url_eli: ""
fetched_at: "2026-09-02T09:32:01Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 29 de julio de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la Escala de Técnico Diplomado de Laboratorio y Talleres.

De conformidad con lo establecido en la Resolución del Rector de la Universitat Politècnica de València de fecha 26 de abril de 2024 («Diari Oficial de la Generalitat Valenciana» número 9848, de fecha 14 de mayo de 2024) por el que se aprueba la oferta de empleo público para el año 2024 y con el fin de atender las necesidades de personal en esta Universitat, en ejercicio de las atribuciones previstas en el artículo 50 de la Ley Orgánica 2/2023, de 22 de marzo, del Sistema Universitario y en el artículo 152.3 del Decreto 122/2024, de 24 de septiembre, del Consell, por el que se aprueban los Estatutos de la Universitat Politècnica de València, el Rector resuelve:
...
1.1 Esta convocatoria tiene por objeto la selección de personal, mediante el sistema concurso-oposición por el turno libre, para cubrir en una (1) plaza del grupo A, subgrupo A2, sector de Administración Especial, técnico diplomado de laboratorio y talleres en el área de Ingeniería de Sistemas y Automática de la Universitat Politècnica de València.
...
5.3 Al objeto de evitar errores las personas aspirantes comprobarán que se encuentran recogidas en la relación provisional de personas admitidas, que sus nombres y datos constan correctamente.
...
6.3.2 Segundo ejercicio: consistirá en la realización de una prueba práctica, constando de dos partes a realizar con el equipamiento del laboratorio, sobre el temario del bloque de conocimientos específicos, así como las funciones del puesto. La duración máxima de esta prueba práctica será de 120 minutos y consistirá en la realización de alguna de las tareas que se llevan a cabo de manera habitual con los equipos de los laboratorios del departamento:

– Volcado de imagen y conexión al dominio de un ordenador.

– Configuración y puesta en marcha de un PLC.

– Identificación y reparación de alguna avería típica de los equipos empleados en las prácticas de laboratorio.

– Impresión 3D de una pieza o componente para equipos de laboratorio.
...
Si perdura dicho empate, se atenderá a la fase de concurso, se dirimirá a favor de quien tenga mayor puntuación en la fase de concurso, en el apartado de experiencia profesional. En última instancia, el orden se establecerá por el orden de actuación contemplado en la base 8.3 de esta convocatoria.
...
10.1 Hasta tanto en cuanto se determine el nivel de competencia lingüística en los conocimientos de valenciano de conformidad con lo dispuesto en el artículo 62 1.g) de la Ley 4/2021, de 16 de abril, de la Función Pública Valenciana, el nivel exigible de dichos conocimientos será el Grau Elemental o certificado equivalente.
...
13.7 En su caso, podrá presentarse una reclamación ante la Agencia Española de Protección de Datos (www.aepd.es).
...
El órgano técnico de selección en la sesión de constitución aprobará un cronograma orientativo de desarrollo del proceso, que se actualizará cuando varíe la programación prevista inicialmente. Esta previsión se publicará en la web www.upv.es/empleopublico.
...
## ANEXO I. Titulación exigida: título universitario de grado o diplomatura, ingeniería técnica o arquitectura técnica.
...
– Desarrollo de módulos específicos para apoyo a la docencia de prácticas de laboratorio, incluyendo la fabricación de circuitos impresos, diseño y programación de sistemas basados en microcontroladores, y realización de montaje de prototipos en impresión 3D.

– Instalación, configuración y administración de los sistemas operativos para funcionamiento básico de equipos informáticos: Windows Server, Windows 10, Windows 11, máquinas virtuales, Linux, y sus posibles actualizaciones a nuevas versiones.

– Puesta a punto y mantenimiento de los equipos informáticos existentes en los laboratorios y despachos del Departamento. Instalación de paquetes ofimáticos y software de cálculo de esta Universidad y propios del Departamento.
...
– Mantenimiento y supervisión de los equipos empleados en las prácticas realizadas en los laboratorios del Departamento: fuentes de alimentación, osciloscopios, generadores de señal, PLCs, motores, servomecanismos, accionamientos neumáticos, sensores, equipos audiovisuales, y otros.

– Mantenimiento y supervisión de los equipos audiovisuales empleados en las prácticas realizan en los laboratorios del Departamento: videoproyectores, cámaras, micrófonos, altavoces, y otros.
...
6. Manual de seguridad para operaciones en actividades electrónicas y para operaciones con riesgo de exposición a radiofrecuencias.

7. Componentes pasivos. Resistencias, condensadores e inductores.

8. Dispositivos semiconductores. Diodos. Transistores.

9. Fuentes de alimentación lineales y conmutadas.

10. Circuitos electrónicos analógicos.

11. Circuitos electrónicos digitales.

12. Circuitos impresos. Técnicas de elaboración manual clásicas y diseño asistido por ordenador.

13. Estación de soldadura. Soldadura de componentes SMD.

14. Instrumentos de laboratorio. Multímetros, generadores de señales, analizadores lógicos y osciloscopios.

15. Control electrónico de motores de corriente continua.

16. Control electrónico de motores de corriente alterna.

17. Control electrónico de motores paso a paso.

18. Variadores de frecuencia.

19. Convertidores DC/DC conmutados e inversores. Topologías, diseño y control.

20. Programación de microcontroladores y microprocesadores. Arduino, Raspberry, BeagleBone, STM.

21. Bus para conexión para microcontroladores. I2C, SPI.

22. Comunicaciones para sistemas industriales: RS-232, RS-485, CAN, Profibus, Modbus RTU, Modbus TCP, EthernetIP, Profinet, EtherCat.

23. Adquisición de datos por computador. Tarjetas y drivers.

24. Manejo y configuración de PLC. Omron, Siemens, Schneider, Phoenix Contact.

25. Diseño y mantenimiento de prototipos electrónicos para prácticas docentes.

26. Control neumático de sistemas.

27. Mantenimiento de prototipos neumáticos para prácticas docentes.

28. Conceptos informáticos básicos. Hardware/software.

29. Diseño asistido por ordenador e impresión 3D: Mantenimiento, selección de materiales y solución de problemas.

30. La seguridad en los equipos informáticos personales. Las reglas básicas de la navegación y correo seguros. Antivirus y cortafuegos.

31. Manejo y mantenimiento de células robotizadas: ABB, JAKA, UR.

32. Desarrollo aplicaciones en C, C++, MATLAB, LabVIEW, Python.

33. Ordenadores PC. Instalación y mantenimiento de hardware. Imágenes de particiones. Copias de seguridad.

34. Documentación técnica del PC, identificación y selección de equipamiento.

35. Conexión de equipos a red local y a UPVNET.

36. Instalación de aplicaciones y configuración de usuarios.

37. Gestión de redes, Direcciones IP, protocolo TCP/IP.

38. Instalación y mantenimiento de interfaces y periféricos.

39. Instalación y mantenimiento de equipamientos multimedia. Videoproyectores, pantallas táctiles, micrófonos, altavoces.
