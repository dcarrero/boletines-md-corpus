...
pagina_inicial: 5933
pagina_final: 5944
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-761"
url_pdf: "https://www.boe.es/boe/dias/2026/01/13/pdfs/BOE-A-2026-761.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-761"
url_eli: ""
fetched_at: "2026-04-08T09:16:21Z"
...
1. En el curso 2025-2026 en las Evaluaciones de diagnóstico se comprobará el grado de adquisición de las competencias específicas de las siguientes áreas de Educación Primaria:
...
f) La Subdirección General de la Inspección de Educación, por medio de la Inspección Central, en su ámbito de actuación, supervisará el proceso de evaluación e impulsará en los centros el análisis y la adopción de medidas en el plan de mejora por los centros. Además, coordinará dicha supervisión e impulso por parte de los servicios de inspección educativa en Ceuta y en Melilla, que actúan bajo la dependencia de la correspondiente Dirección Provincial.
...
– La fijación de las directrices en las que se concreten los aspectos que correspondan relativos a la organización y aplicación de las evaluaciones. Estas directrices se adaptarán a los distintos ámbitos (ciudades autónomas, centros de titularidad del Estado español en el exterior, centros privados españoles en el exterior y CIERD) atendiendo a su propia planificación y recursos.
...
– El cuestionario de contexto de familias se distribuirá el primer día de aplicación en cada unidad y se establecerá un periodo de recogida de este una vez cumplimentado.
...
Ceuta, Melilla y exterior entre el 5 y el 19 de mayo.

CIERD: la fecha se acordará con el equipo directivo.

| Horario | Actividad | Duración (minutos) |
| --- | --- | --- |
| 8:30 – 10:00 | Preparación de equipos. | 90 |
| 10:00 – 10:55 | Competencias específicas de Lengua Castellana y Literatura: comprensión oral y escrita. | 55 |
| 10:55 – 11:10 | Ampliación de tiempo para alumnado que así lo tenga autorizado. | 15 |
| 11:10 – 11:15 | Reparto de los cuestionarios de contexto. | 5 |
| 11:15 – 11:40 | Recreo. | 25 |
| 11:40 – 12:20 | Competencias específicas de Lengua Castellana y Literatura: expresión escrita. | 40 |
| 12:20 – 12:30 | Ampliación de tiempo para alumnado que así lo tenga autorizado. | 10 |
...
| 9:15 – 10:10 | Competencias específicas de Matemáticas. | 55 |
| 10:10 – 10:25 | Ampliación de tiempo para alumnado que así lo tenga autorizado. | 15 |
| 10:25 – 10:30 | Recogida de los cuestionarios de contexto. | 5 |
| 10:30 – 10:55 | Recreo. | 25 |
| 10:55 – 11:50 | Competencias específicas de Lengua Extranjera: comprensión oral y escrita. | 55 |
| 11:50 – 12:05 | Ampliación de tiempo para alumnado que así lo tenga autorizado. | 15 |
| 12:05 – 12:10 | Descanso. | 5 |
| 12:10 – 12:50 | Competencias específicas de Lengua extranjera: expresión escrita. | 40 |
| 12:50 – 13:00 | Ampliación de tiempo para alumnado que así lo tenga autorizado. | 10 |

b) En 2.º de Educación Secundaria Obligatoria:

Ceuta, Melilla, y exterior: 7 de mayo.
...
| 11:45 – 12:40 | Competencias específicas de Lengua Extranjera (inglés o francés). | 55 |
...
a) En Ceuta y Melilla, la aplicación de las pruebas en 4.º de Educación Primaria se realizará por la empresa que resulte adjudicataria del contrato correspondiente. Las pruebas de 2.º de Educación Secundaria Obligatoria serán responsabilidad del profesorado designado para ello. El profesorado encargado de aplicar estas pruebas será seleccionado, preferentemente, entre aquel que imparta docencia en un centro educativo diferente a aquel en el que aplique las pruebas y, en todo caso, entre aquel que no imparta docencia directa al grupo evaluado.
...
e) Con el fin de agilizar la devolución de los materiales de evaluación una vez realizada, se habilitará un espacio digital al que los aplicadores o aplicadores de la empresa o, en su caso, los coordinadores y coordinadoras del centro, tendrán que subir determinados materiales digitalizados.
...
Con la finalidad de que los centros educativos dispongan del informe individualizado del alumnado antes del final de curso y puedan entregarlo a las familias junto con el boletín de calificaciones, los equipos directivos de los centros educativos y los órganos de coordinación a nivel local se asegurarán de que las expresiones escritas, las hojas de seguimiento y otros materiales sean digitalizados y enviados a través de la plataforma destinada a tal fin el mismo día de su aplicación garantizando que el código de alumno o alumna se registra en cada una de las páginas y de que todo el material en papel sea enviado a la empresa el siguiente día lectivo a su realización. Asimismo, los cuestionarios de contexto de familias deben ser enviados a la empresa antes del día 29 de mayo de 2026.

## Decimoquinto. Informes.

1. El INEE elaborará un informe de resultados individualizado de cada alumno y alumna, que será entregado a finales del mes de junio y que incluirá los niveles alcanzados en las competencias específicas de cada área o materia con su descripción. Los resultados del alumnado evaluado tendrán carácter confidencial y se proporcionarán únicamente a su tutor o tutora y a sus representantes legales, utilizando para ello un formato que facilite su comprensión. Estos informes contendrán los resultados del alumno o alumna en relación con las medias globales del ámbito considerado, de su centro y de su grupo. En el CIERD el informe solo incluirá los resultados del alumno o alumna en relación con las medias del centro. Los resultados individuales no tendrán consecuencias académicas en ningún caso.
...
Madrid, 22 de diciembre de 2025.–El Secretario de Estado de Educación, Abelardo de la Rosa Díaz.
