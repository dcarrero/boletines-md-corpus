---
identificador: "BOE-A-2026-401"
titulo: "Resolución de 26 de diciembre de 2025, de la Subsecretaría, por la que se publica el Convenio entre la Agencia Estatal de Administración Digital y el Instituto de la Cinematografía y de las Artes Audiovisuales, O.A., para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 2221
pagina_final: 2235
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-401"
url_pdf: "https://www.boe.es/boe/dias/2026/01/07/pdfs/BOE-A-2026-401.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-401"
url_eli: ""
fetched_at: "2026-04-08T09:04:54Z"
...
La Presidenta de la Agencia Estatal de Administración Digital y el Director General del Instituto de la Cinematografía y de las Artes Audiovisuales, O.A., han suscrito, con fecha de 3 de diciembre de 2025, un convenio para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU.
...
Que son competencias del ICAA, de acuerdo con el artículo 3 de la Ley 55/2007, de 28 de diciembre, del Cine, el ejercicio de las funciones estatales que en dicha ley se determinan, que, conforme a su artículo 1, son la ordenación de los diversos aspectos sustantivos de la actividad cinematográfica y audiovisual desarrollada en España, la promoción y fomento de la producción, distribución y exhibición de obras cinematográficas y audiovisuales y el establecimiento de condiciones que favorezcan su creación y difusión. Por tanto, la mayor parte de las actuaciones del ICAA van dirigidas a las personas físicas y jurídicas del ámbito audiovisual, a las que se debe facilitar su relación electrónica con el mismo.
...
Que el ICAA ostenta un interés manifiesto en establecer un marco de colaboración con la AEAD para la utilización de los servicios compartidos mencionados y su implantación.

## Duodécimo.

Que es posible la aplicación del Fondo de Recuperación Next Generation EU, como instrumento destinado a hacer efectiva la Medida 7 «Servicio de infraestructuras cloud» para el fortalecimiento de la solución de nube híbrida NubeSARA. Mediante el presente convenio, se facilita al ICAA que pueda hacer uso del servicio NubeSARA.
...
1. Constituye el objeto del presente convenio el establecimiento de un marco de colaboración entre la Agencia Estatal de Administración Digital (en adelante, AEAD) y el ICAA para el desarrollo de actuaciones conjuntas que permitan el uso del servicio NubeSARA de acuerdo con los términos y condiciones generales expuestos a continuación y que conferirán al ICAA la condición de Centro Usuario de NubeSARA.
...
1.º Poner a disposición del ICAA el servicio NubeSARA en su modalidad Infraestructura como Servicio (IaaS, por sus siglas en inglés) y actuar como administrador de la infraestructura de sistemas, comunicaciones y almacenamiento necesaria para proporcionar dicho servicio.

2.º Adscribir los medios humanos y técnicos necesarios para la adecuada adaptación e implantación del servicio para su utilización por parte del ICAA.
...
5.º Notificar a los responsables del servicio en el ICAA cualquier intervención, actuación o problema que pudiera afectar al adecuado funcionamiento del servicio.

6.º Poner a disposición del ICAA las licencias relativas a los sistemas operativos Windows y Red Hat que precise la infraestructura acordada según lo descrito en el anexo I.

7.º Atender las incidencias y peticiones realizadas por parte del ICAA en relación con el funcionamiento del servicio, de acuerdo con lo señalado en los anexos I y II.
...
## Tercera. Obligaciones del ICAA.

El ICAA, a través de la unidad designada, se compromete a cumplir las siguientes obligaciones:
...
3. En caso de incumplimiento del presente convenio imputable al ICAA, se aplicarán las medidas incluidas en la normativa nacional y europea relativa al destino del Fondo de Recuperación Next Generation EU.
...
A partir del año 2026, la AEAD continuará aportando la infraestructura tecnológica, de la que se beneficiarán los usuarios, entre ellos el ICAA, que deberá ser actualizada y mejorada de forma continua para garantizar la renovación de la inversión, su correcta actualización y mejora tecnológica sin riesgo de obsolescencia.
...
## Séptima. Obligaciones Económicas del ICAA.

1. El ICAA contribuirá anualmente, con una contraprestación económica que se determina en base al uso del servicio, al mantenimiento de:
...
2. No obstante, hasta el fin del año 2025 la inversión en infraestructura de nube híbrida NubeSARA realizada por la AEAD está financiada con cargo al Fondo de Recuperación Next Generation EU, y en el cálculo de la contribución del ICAA no se incluirá la parte correspondiente de dicha inversión.

3. A partir del año 2026, la contribución del ICAA tendrá en cuenta tanto los recursos necesarios para la operación como la parte proporcional de la inversión necesaria para la renovación y ampliación de la infraestructura.

4. Al ser NubeSARA una infraestructura compartida y utilizada de forma simultánea por todos los órganos y organismos usuarios del servicio, la contribución del ICAA en cualquiera de los conceptos estará siempre asociada a los recursos que el ICAA utilice del total disponible en NubeSARA, basándose en los costes unitarios recogidos en el anexo I.
...
Y, en prueba de conformidad, las partes firman el presente convenio.–La Presidenta de la Agencia Estatal de Administración Digital, Consuelo Sánchez Naranjo.–El Director General del Instituto de la Cinematografía y de las Artes Audiovisuales, O.A., Ignacio Camós Victoria.
...
| GPU. | 2.084 euros/GPU | 20 | 2.064,03 |  |
...
| Disco. | 1.500 euros/TB | 250 | 1.250 |  |
| NubeSARA-Cómputo-POWER. | vCPU. | 1.500 euros/CPU | 250 | 1250 |
...
Con el objetivo de colaborar en la sostenibilidad funcional y técnica de los servicios compartidos, el ICAA contribuirá con una contraprestación económica que se determina en base al uso de dichos servicios.

De los servicios del catálogo de la AEAD, el ICAA ha mostrado interés en utilizar algunos de ellos con la siguiente estimación inicial de uso de recursos en el primer año:

– NubeSARA-Cómputo-x86 sin licencia.

● 24 vCPUs, 96 GB de RAM y 2,93 TB de disco.
...
● 2 TB en calidad NAS alto rendimiento.

– NubeSARA-Backup-Cómputo.

● 0,30 TB mediante snapshot.

● 0,30 TB mediante agente.

– NubeSARA-Backup-Ficheros.

● 0,50 TB sobre ficheros de NAS alto rendimiento.

– NubeSARA-Servicios complementarios.

● 1 Servicio de balanceo.

El importe unitario de los servicios comunes de la AEAD que utilizará el ICAA, incluyendo las modalidades, calidades y opciones deseadas se encuentra en las tablas correspondientes del anexo I.
