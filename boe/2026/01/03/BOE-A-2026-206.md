---
identificador: "BOE-A-2026-206"
titulo: "Resolución de 26 de diciembre de 2025, de la Subsecretaría, por la que se publica el Convenio entre la Agencia Estatal de Administración Digital y la Autoridad Independiente para la Igualdad de Trato y No Discriminación, para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_inicial: 995
pagina_final: 1010
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-206"
url_pdf: "https://www.boe.es/boe/dias/2026/01/03/pdfs/BOE-A-2026-206.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-206"
url_eli: ""
fetched_at: "2026-04-08T08:58:56Z"
...
La Presidenta de la Agencia Estatal de Administración Digital y el Subsecretario del Ministerio de Igualdad han suscrito, con fecha de 10 de diciembre de 2025, un convenio para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU.
...
## ANEJO. Convenio entre la Agencia Estatal de Administración Digital y la Autoridad Independiente para la Igualdad de Trato y No Discriminación (AINODI), a través del Ministerio de Igualdad, para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU
...
Que son competencias de la Subsecretaría de Igualdad, a través de la División TIC del Ministerio de Igualdad, establecidas en el Real Decreto 246/2024, de 8 de marzo, por el que se desarrolla la estructura orgánica básica del Ministerio de Igualdad:

La planificación, dirección y coordinación de los sistemas de información; la elaboración, preparación y propuesta de necesidades de los recursos tecnológicos, así como la prestación de servicios en materia de tecnologías de la información y la dirección y coordinación del portal web, sede electrónica e intranet.

La elaboración, desarrollo y ejecución de los planes de digitalización del departamento, así como la implantación y seguimiento de los planes de trasformación digital de la Administración General del Estado, en coordinación con la Agencia Estatal de Administración Digital del Ministerio para la Transformación Digital y de la Función Pública.

Prestará los servicios y el apoyo administrativo necesario para garantizar el inicio de la actividad de la Autoridad Independiente para la Igualdad de Trato y la No Discriminación (en adelante, AINODI) hasta la fecha que al efecto se determine por orden de la persona titular del Ministerio de Igualdad.

Hasta que la AINODI cuente con un presupuesto propio, la financiación de sus actuaciones se realizará con cargo a los créditos presupuestarios del Ministerio de Igualdad.
...
Que la AINODI ostenta un interés manifiesto en establecer un marco de colaboración con la AEAD para la utilización de los servicios compartidos mencionados y su implantación.

## Duodécimo.

Que es posible la aplicación del Fondo de Recuperación Next Generation EU, como instrumento destinado a hacer efectiva la Medida 7 «Servicio de infraestructuras cloud» para el fortalecimiento de la solución de nube híbrida NubeSARA. Mediante el presente convenio, se facilita a la AINODI que pueda hacer uso del servicio NubeSARA.
...
1. Constituye el objeto del presente convenio el establecimiento de un marco de colaboración entre la Agencia Estatal de Administración Digital (en adelante, AEAD) y la Autoridad Independiente para la Igualdad de Trato y la No Discriminación (en adelante, AINODI), a través del Ministerio de Igualdad, para el desarrollo de actuaciones conjuntas que permitan el uso del servicio NubeSARA de acuerdo con los términos y condiciones generales expuestos a continuación y que conferirán a la AINODI la condición de Centro Usuario de NubeSARA.
...
1.º Poner a disposición de la AINODI el servicio NubeSARA en su modalidad Infraestructura como Servicio (IaaS, por sus siglas en inglés) y actuar como administrador de la infraestructura de sistemas, comunicaciones y almacenamiento necesaria para proporcionar dicho servicio.

2.º Adscribir los medios humanos y técnicos necesarios para la adecuada adaptación e implantación del servicio para su utilización por parte de la AINODI.
...
5.º Notificar a los responsables del servicio en la AINODI cualquier intervención, actuación o problema que pudiera afectar al adecuado funcionamiento del servicio.

6.º Poner a disposición de la AINODI las licencias relativas a los sistemas operativos Windows y Red Hat que precise la infraestructura acordada según lo descrito en el anexo I.

7.º Atender las incidencias y peticiones realizadas por parte de la AINODI en relación con el funcionamiento del servicio, de acuerdo con lo señalado en los anexos I y II.
...
## Tercera. Obligaciones de la AINODI, a través del Ministerio de Igualdad.

El Ministerio de Igualdad, a través de la unidad designada, se compromete a cumplir las siguientes obligaciones:
...
3. En caso de incumplimiento del presente convenio imputable a Ministerio de Igualdad, se aplicarán las medidas incluidas en la normativa nacional y europea relativa al destino del Fondo de Recuperación Next Generation EU.
...
A partir del año 2026, la AEAD continuará aportando la infraestructura tecnológica, de la que se beneficiarán los usuarios, entre ellos el Ministerio de Igualdad, que deberá ser actualizada y mejorada de forma continua para garantizar la renovación de la inversión, su correcta actualización y mejora tecnológica sin riesgo de obsolescencia.
...
## Séptima. Obligaciones Económicas de Ministerio de Igualdad.

1. El Ministerio de Igualdad contribuirá anualmente, con una contraprestación económica que se determina en base al uso del servicio, al mantenimiento de:
...
2. No obstante, hasta el fin del año 2025 la inversión en infraestructura de nube híbrida NubeSARA realizada por la AEAD está financiada con cargo al Fondo de Recuperación Next Generation EU, y en el cálculo de la contribución de Ministerio de Igualdad no se incluirá la parte correspondiente de dicha inversión.

3. A partir del año 2026, la contribución de Ministerio de Igualdad tendrá en cuenta tanto los recursos necesarios para la operación como la parte proporcional de la inversión necesaria para la renovación y ampliación de la infraestructura.

4. Al ser NubeSARA una infraestructura compartida y utilizada de forma simultánea por todos los órganos y organismos usuarios del servicio, la contribución de Ministerio de Igualdad en cualquiera de los conceptos estará siempre asociada a los recursos que Ministerio de Igualdad utilice del total disponible en NubeSARA, basándose en los costes unitarios recogidos en el anexo I.
...
Y, en prueba de conformidad, las partes firman el presente convenio en la fecha de la última firma electrónica.–La Presidenta de la Agencia Estatal de Administración Digital, Consuelo Sánchez Naranjo.–El Subsecretario del Ministerio de Igualdad, Ignacio Sola Barleycorn.
...
Con el objetivo de colaborar en la sostenibilidad funcional y técnica de los servicios compartidos, el Ministerio de Igualdad contribuirá con una contraprestación económica que se determina en base al uso de dichos servicios.

De los servicios del catálogo de la AEAD, la AINODI, a través del Ministerio de Igualdad, ha mostrado interés en utilizar algunos de ellos con la siguiente estimación inicial de uso de recursos en el primer año:

– NubeSARA-Cómputo-x86 sin licencia:

10 vCPUs, 21 GB de RAM y 1 TB de disco.

– NubeSARA-Cómputo-x86 Windows:

170 CPUs, 450 GB de RAM y 7,60 TB de disco.

– NubeSARA-Cómputo-x86 Red Hat:

4 vCPUs, 16 GB de RAM y 0,20 TB de disco.

– NubeSARA-Ficheros:

3 TB en calidad NAS alto rendimiento.

– NubeSARA-Backup-Cómputo:

0,60 TB mediante snapshot.

0,90 TB mediante agente.

– NubeSARA-Servicios complementarios:

2 Servicio de balanceo.

El importe unitario de los servicios comunes de la AEAD que utilizará la AINODI, a través del Ministerio de Igualdad, incluyendo las modalidades, calidades y opciones deseadas se encuentra en las tablas correspondientes del anexo I.
