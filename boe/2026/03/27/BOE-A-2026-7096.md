---
identificador: "BOE-A-2026-7096"
titulo: "Resolución de 2 de marzo de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la categoría de Técnico Superior de Laboratorio."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 46135
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-7096"
url_pdf: "https://www.boe.es/boe/dias/2026/03/27/pdfs/BOE-A-2026-7096.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-7096"
url_eli: ""
fetched_at: "2026-04-08T14:26:33Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 2 de marzo de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la categoría de Técnico Superior de Laboratorio.
...
1.1 Esta convocatoria tiene por objeto la selección de personal, mediante el sistema concurso-oposición por el turno libre, para cubrir en una (1) plaza del grupo A, subgrupo A1, sector de Administración Especial, técnico superior de laboratorio en el área ingeniería mecánica y materiales de la Universitat Politècnica de València.
...
6.3.2 Segundo ejercicio: consistirá en la realización de tres pruebas prácticas de un máximo de 45 minutos cada una, utilizando el equipamiento del laboratorio sobre el temario especificado en el bloque de conocimientos específicos y sobre las funciones del puesto que figuran en el anexo I de la convocatoria.
...
Cada una de las pruebas prácticas se valorará de 0 a 10 puntos y será necesario alcanzar un mínimo de 15 puntos en cómputo total para superar el ejercicio.
...
– Manejo, mantenimiento y diagnóstico de fallos de las máquinas de taller relacionadas con la ingeniería de fabricación (tornos, fresadoras, taladros, rectificadoras, prensa, electroerosión).

– Manejo, programación, mantenimiento y diagnóstico de fallos en máquinas de corte por agua y láser.

– Manejo, programación, mantenimiento y diagnóstico de fallos en máquinas de control numérico.

– Manejo de extrusora e inyectora de polímeros.

– Preparación de moldes y ejecución de procesos de fabricación de materiales compuestos.

– Preparación y ajuste de parámetros de soldadura y uso de equipos de soldadura: SMAW, GTAW, GMAW, resistencia eléctrica y láser.

– Preparación de moldes y ejecución de procesos de fundición en arena verde y molde permanente.

– Uso de equipos de metrología y aparatos de medida: calibres, micrómetros, relojes comparadores, proyector de perfiles.
...
6. Fundamentos de Metrología Dimensional: Unidades, Patrones, Precisión, Trazabilidad y Plan de calibración.

7. Normalización: Tolerancias, Sistema ISO, Ajustes, Simbología y Calibres Pasa/No Pasa.

8. Técnicas de Medición I: Instrumentos de medida de longitudes, micrométricos y nonios.

9. Técnicas de Medición II: Medida de rugosidad superficial, MMC y tolerancias geométricas.

10. Calibración y Verificación de Instrumentos de Medición: Métodos, equipos y certificación de la calibración.

Módulo 2: Procesos de Moldeo y Fundición.

11. Fundamentos del Conformado por Moldeo: Características, Materiales y Diseño de sistemas.

12. Conformado por Moldeo en Arena: Tipos de arena, control y preparación.

13. Técnicas de Fundición Especiales: Fundición a presión, en coquilla y centrífuga.

14. Calidad en Piezas Fundidas: Clasificación de defectos y reglas de diseño.

Módulo 3: Conformado de Materiales.

15. Fundamentos del Conformado por Deformación Plástica: Fundamentos y Análisis de tensión y deformación.

16. Procesos de Deformación Volumétrica: Laminado, Forjado, Extrusión y Trefilado.

17. Conformado de Chapa: Procesos con y sin separación de material.

18. Procesos de Conformado de Materiales Poliméricos y Compuestos: Inyección, Extrusión, Termoconformado, Soplado, Moldeo rotacional, Laminado manual, Proyección simultánea, Moldeo centrífugo, Bobinado de hilos, Prepeg, SMC, Pultrusión, RTM, VARI, Moldeo por inyección de resina.

19. Tratamientos Térmicos y Superficiales: Temple, revenido, recocido, nitruración, anodizado, galvanizado.

Módulo 4: Procesos de Unión.

20. Fundamentos de la Soldadura: Procesos de unión, soldabilidad y simbología.

21. Técnicas de Soldadura eléctrica: SMAW, TIG, MIG/MAG, soldadura por plasma, soldadura por resistencia y soldadura láser.

22. Otros Procesos de Unión: Soldadura oxiacetilénica y adhesivos.

Módulo 5: Procesos de Mecanizado y Control Numérico.

23. Generalidades del Conformado por Arranque de Material: Conceptos básicos y herramientas de corte.

24. Máquinas Herramienta: Cepilladora, Limadora, Mortajadora, Brochadora, Torno, Fresadora, Taladradora y Rectificadora.

25. Programación y Control Numérico: Automatización, Programación CNC y Robots industriales.

26. Mecanizado de Alta Precisión: Electroerosión, rectificado, torneado y fresado de precisión.

Módulo 6: Fabricación Aditiva.

27. Introducción a la Fabricación Aditiva: Tecnologías y aplicaciones.

28. Tecnologías de Impresión 3D: FDM, SLA, SLS y Materiales empleados.

29. Procesado y Postprocesado de Piezas Aditivas: Parámetros, optimización y validación de piezas.

Módulo 7: Ingeniería Inversa.

30. Fundamentos de Ingeniería Inversa: Definición, aplicaciones y beneficios en la industria.

31. Digitalización 3D y Reconstrucción de Modelos: Escaneo 3D, técnicas de reconstrucción y software.

Módulo 8: Ofimática e Informática Aplicada.

32. Conocimientos Básicos de Ofimática: Windows, Word, Excel, PowerPoint.

33. Conocimientos Complementarios de Informática: Autocad, Mastercam, software de diseño y simulación.

Módulo 9: Seguridad y Salud.

34. Protección en Laboratorios y Talleres: Riesgos mecánicos, eléctricos y químicos.

35. Ergonomía del Puesto de Trabajo y Pantallas de Visualización: Riesgos posturales y visuales.

36. Planificación de la Actividad Preventiva de Riesgos: Implementación y control.
...
39. Control de calidad en procesos de fabricación: Inspección y análisis de defectos.

40. Gestión del Laboratorio: Inventario, mantenimiento y organización.

41. Gestión ambiental y de residuos en la Universitat Politècnica de València. Normativa aplicable. Información accesible en: http://www.upv.es/medioambiente.
