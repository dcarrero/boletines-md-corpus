---
identificador: "BOE-A-2026-18018"
titulo: "Resolución de 29 de julio de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la Escala de Técnico Superior de Laboratorio."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 116087
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-18018"
url_pdf: "https://www.boe.es/boe/dias/2026/08/22/pdfs/BOE-A-2026-18018.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-18018"
url_eli: ""
fetched_at: "2026-08-22T09:26:46Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 29 de julio de 2026, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la Escala de Técnico Superior de Laboratorio.
...
6.3.2 Segundo ejercicio: consistirá en la realización de máximo cuatro supuestos prácticos que versarán únicamente sobre las materias de los bloques 2 a 5 que figuran en el bloque específico, así como las funciones del puesto que figuran en el anexo I.
...
– Gestión de proveedores y pedidos de materiales y equipos.

– Ejercer como responsable de seguridad laboral N3 en los laboratorios.

– Coordinar, supervisar y realizar los montajes de dispositivos mecánicos, hidráulicos, eléctricos y electrónicos para las actividades docentes y de investigación.

– Desarrollo, mantenimiento y manejo de los sistemas de control de ensayos y de adquisición de datos de los ensayos de laboratorio (software y equipos).

– Gestión y mantenimiento de los equipos audiovisuales e informáticos y el software de los espacios docentes y de investigación.
...
6. Plan estratégico de la Universitat Politècnica de València (UPV_SIRVE | Plan Estratégico UPV_SIRVE | UPV).

7. La Ley de Prevención de Riesgos Laborales: (BOE-A-1995-24292 Ley 31/1995, de 8 de noviembre de Prevención de Riesgos Laborales).

8. Plan de Prevención de Riesgos Laborales de la Universitat Politècnica de València. (PPRL).

9. El Sistema de Gestión Ambiental de la Universitat Politècnica de València (Microsoft Word - UPV.MA-FOR.SGA-ALL-03).

10. Gestión de los residuos no peligrosos en la Universitat Politècnica de València (Microsoft Word - UPV.MA-FOR.RNP-ALL-04-Modif).

11. Gestión de residuos peligrosos en la Universitat Politécnica de València (https://riunet.upv.es/server/api/core/bitstreams/543caef9-30ea-49ce-ab1d-9291e87585e4/content).

12. Gestión económica: Sistema de gestión del presupuesto de ingresos y gastos en la UPV. Normativa aplicable.

Bloque 2. Laboratorio de ensayo de elementos estructurales.

13. Instrumentación en laboratorio estructural: fundamentos.

– Magnitudes físicas en ensayos estructurales (fuerza, desplazamiento, deformación, presión, aceleración).

– Conceptos de sensor, transductor y cadena de medida.

– Precisión, sensibilidad, resolución, histéresis, deriva.

– Calibración y trazabilidad metrológica.

14. Sensores de deformación: extensometría.

– Galgas extensométricas (principio resistivo).

– Puente de Wheatstone.

– Configuraciones en puente completo, ½ y ¼.

– Compensación térmica.

15. Sensores de desplazamiento y posición.

– Sensores potenciométricos.

– Sensores capacitivos.

– LVDT (transformadores diferenciales).

– Comparativa: precisión, rango y robustez.

– Aplicaciones típicas en ensayos de estructuras.

16. Sensores dinámicos y de fuerza.

– Sensores IEPE (acelerómetros y fuerza dinámica).

– Células de carga.

– Medida de vibraciones y cargas dinámicas.

17. Actuadores en laboratorio estructural.

– Actuadores hidráulicos: principios de funcionamiento.

– Componentes: servo-válvulas, bombas y acumuladores.

– Control de carga vs control de desplazamiento.

– Sistemas servo-hidráulicos en ensayos estructurales.

– Seguridad y mantenimiento.

18. Sistemas de adquisición de datos (DAQ).
...
19. Desarrollo de software para adquisición y control.

– Programación en LabView.

– Arquitectura de adquisición (loops, buffers).

– Interfaces de usuario (front panel).

– Registro y almacenamiento de datos.

– Integración de DAQ y control de actuadores.

Bloque 3. Laboratorio de Materiales de Construcción.

20. Métodos de ensayo normalizado para áridos.

– Granulometría y contenido de finos (UNE-EN 933-1:2012).

– Índice de lajas (UNE-EN 933-3:2012).

– Equivalente de arena (UNE-EN 933-8:2012).

– Azul de metileno (UNE-EN 933-9:2012).

– Resistencia a la fragmentación (UNE-EN 1097-2:2021).

– Determinación de la densidad aparente y la porosidad (UNE-EN 1097-3:1999).

– Determinación de la densidad de partículas y la absorción de agua (UNE-EN 1097-6:2025).

21. Métodos de ensayo normalizado para cementos.

– Fabricación de probeta de mortero (UNE-EN 196-1:2018).

– Determinación de las resistencias a flexotracción y compresión de morteros (UNE-EN 196-1:2018).

– Determinación de la pérdida por calcinación o pérdida al fuego (UNE-EN 196-2:2014).

– Obtención de pasta de consistencia normal (UNE-EN 196-3:2017).

– Determinación del tiempo de inicio y fin de fraguado (UNE-EN 196-3:2017).

– Determinación de la expansión de volumen (UNE-EN 196-3:2017).

– Determinación de la finura de molido por tamizado en seco (UNE-EN 196-6:2019).

22. Métodos de ensayo normalizado para hormigón fresco.

– Ensayo de asentamiento (UNE-EN 12350-2:2020).

– Medida del contenido de aire por el método de la presión (UNE-EN 12350-7:2020).

– Ensayo de escurrimiento (UNE-EN 12350-8:2020).

– Ensayo del embudo en V (UNE-EN 12350-9:2011).

– Ensayo del anillo japonés (UNE-EN 12350-12:2011).

23. Métodos de ensayo normalizado para hormigón endurecido.

– Forma, dimensiones y otras características de las probetas y moldes (UNE-EN12390-1:2022).

– Fabricación y curado de probetas para ensayos de resistencia (UNE-EN 12390-2:2020).

– Determinación de la resistencia a la compresión de probetas (UNE-EN 12350-3:2020).

– Resistencia a flexotracción (UNE-EN 12350-5:2020).

– Resistencia a tracción indirecta (UNE-EN 12350-6:2024).

– Profundidad de penetración de agua bajo presión (UNE-EN 12350-8:2020).

– Determinación del módulo secante de elasticidad en compresión (UNE-EN 12350-13:2022).

24. Métodos de ensayo no destructivos y semidestructivos para hormigón armado.

– Extracción de testigos (UNE-EN 12504-1:2020).

– Determinación del índice de rebote (esclerómetro) (UNE-EN 12504-2:2020).

– Determinación de la fuerza de arrancamiento (pull-out) (UNE-EN 12504-3:2006).

– Determinación de la velocidad de los impulsos ultrasónicos. (ultrasonidos) (UNE-EN 12504-4:2022).

– Medida de la adherencia por tracción directa (pull-off) (UNE-EN 1542:2000).

– Determinación de la profundidad de carbonatación en un hormigón endurecido por el método de la fenolftaleína (UNE-EN 14630:2007).

– Detección de la posición de las armaduras y los recubrimientos (pachómetro).

25. Métodos de ensayo normalizados de acero para perfiles laminados y armaduras de hormigón.

– Ensayo de dureza Rockwell. Método de ensayo (UNE-EN ISO 6508-1:2017).

– Barras corrugadas de acero soldable para uso estructural en armaduras de hormigón armado (UNE 36068:2011).

– Acero soldable para armaduras de hormigón armado (UNE-EN 10080:2006).

– Ensayo a tracción de una barra de acero (UNE-EN ISO 6892-1:2020).

26. Métodos de ensayo normalizados para productos bituminosos.

– Determinación del punto de reblandecimiento. Método del anillo y bola (UNE-EN 1427:2015).

– Determinación de la penetración con aguja (UNE-EN 1426:2025).

Bloque 4. Laboratorio de Química.

27. Química del agua y sus disoluciones:

– Valoraciones directas.

– Valoraciones por retroceso.

– Parámetros de reactividad química: pH, cloruros, sulfatos, ion amonio.

28. Química de los metales y sus aleaciones:

– Diagramas de fase binarios con solubilidad total.

– Diagramas de fase binarios con solubilidad restringida.

29. Corrosión metálica.

– Pilas con concentraciones. 1M.

– Pilas con concentraciones distintas a 1M. Aplicación de la ecuación de Nernst.

– Pilas de concentración.

– Corrosión en el hormigón armado. Aplicación del corrosímetro.

30. Determinación de parámetros en conglomerantes:

– Aplicación a cales. pH. Carbonatación.

– Aplicación a yesos. Determinación del tiempo de fraguado. Determinación del contenido en dihidrato en un yeso fraguado con el analizador de humedad.

– Aplicación a cementos: pH, tiempo de fraguado, carbonatación.

31. Métodos instrumentales para la caracterización de los materiales:

– Análisis por granulometría laser.
...
32. Métodos químicos para la caracterización de los materiales: Aplicación de normativas.
...
33. Durabilidad de materiales:

– Ensayos destructivos: ataque ácido.

– Ensayos no destructivos: vibración y ultrasonidos.

Bloque 5. Laboratorio Informático (aulas informáticas).

34. Arquitectura de sistemas informáticos en laboratorios docentes.

– Componentes hardware en aulas informáticas.

– Tipologías: aulas físicas vs laboratorios virtuales.

– Diseño de infraestructuras docentes escalables.

– Integración con redes universitarias.

35. Sistemas operativos: administración avanzada.

– Instalación desatendida (unattended).

– Gestión de usuarios y políticas (GPO en entornos Windows).

– Virtualización básica (Hyper-V y VMware).

– Gestión de actualizaciones y parches.

36. Despliegue y replicación de sistemas.

– Creación y gestión de imágenes de sistema.

– Herramientas (AOMEI Backupper).

– Clonado masivo en red.

37. Virtualización y laboratorios virtuales.

– Infraestructura VDI.

– Polilabs UPV. (https://wiki.upv.es/confluence/display/UVL/Manual+de+usuario).

– Gestión de recursos virtuales para docencia.

38. Redes y conectividad en aulas informáticas.

– Configuración de redes locales (LAN).

– VLANs en entornos docentes.

– Direccionamiento IP y DHCP.

– Seguridad en red.

39. Seguridad informática en laboratorios docentes.
...
40. Ofimática avanzada para gestión de datos de ensayos.

– Formatos habituales: CSV, TXT, XLSX,…

– Problemas típicos: ruido, datos incompletos, desalineación temporal,…
...
– Automatización y control de calidad de datos.
...
– Plan estratégico de la Universitat Politècnica de València:

UPV_SIRVE | Plan Estratégico UPV_SIRVE | UPV.

– La Ley de Prevención de Riesgos Laborales:

BOE-A-1995-24292 Ley 31/1995, de 8 de noviembre de Prevención de Riesgos Laborales.

– Plan de Prevención de Riesgos Laborales de la Universitat Politècnica de València:

PPRL.

– El Sistema de Gestión Ambiental de la Universitat Politècnica de València:

Microsoft Word - UPV.MA-FOR.SGA-ALL-03.

– Gestión de los residuos no peligrosos en la Universitat Politècnica de València:

Microsoft Word - UPV.MA-FOR.RNP-ALL-04-Modif.

– Gestión de residuos peligrosos en la Universitat Politécnica de València:

https://riunet.upv.es/server/api/core/bitstreams/543caef9-30ea-49ce-ab1d-9291e87585e4/content)

Bloque 5. Laboratorio Informático (aulas informáticas).

– Polilabs UPV.

https://wiki.upv.es/confluence/display/UVL/Manual+de+usuario
