---
identificador: "BOE-A-2026-17752"
titulo: "Orden APA/862/2026, de 3 de agosto, por la que se definen los bienes y los rendimientos asegurables, las condiciones técnicas mínimas de cultivo, el ámbito de aplicación, los periodos de garantía, las fechas de suscripción y los precios unitarios del seguro de explotaciones olivareras, comprendido en el correspondiente Plan de Seguros Agrarios Combinados."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 114534
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-17752"
url_pdf: "https://www.boe.es/boe/dias/2026/08/14/pdfs/BOE-A-2026-17752.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-17752"
url_eli: ""
fetched_at: "2026-08-14T09:40:33Z"
...
Así mismo, todos los aspectos regulados en esta orden serán igualmente de aplicación en el Cuadragésimo Octavo Plan de Seguros Agrarios Combinados en los términos y condiciones que al efecto sean aprobados en el mismo, por el correspondiente Acuerdo del Consejo de Ministros.
...
En el seguro principal se cubren las cosechas 2027/2028 y 2028/2029 para los asegurados que contraten en el Cuadragésimo Séptimo Plan de Seguros Agrarios Combinados y las cosechas 2028/2029 y 2029/2030, para los asegurados que contraten en el Cuadragésimo Octavo Plan de Seguros Agrarios Combinados.
...
En el seguro principal se cubre la cosecha 2027/2028 para los asegurados que contraten en el Cuadragésimo Séptimo Plan de Seguros Agrarios Combinados y la cosecha 2028/2029, para los asegurados que contraten en el Cuadragésimo Octavo Plan de Seguros Agrarios Combinados.
...
b) Módulos 1A y 2A. En el caso de los titulares de explotaciones de olivar que no estén incluidos en la base de datos o que el rendimiento asignado no les habilite para la contratación de todas sus parcelas, deberán formalizar la declaración del seguro a más tardar el 30 de septiembre del año en curso. El rendimiento a consignar en estas parcelas será de 100 Kilos por hectárea.

La formalización de la declaración del seguro, en estos casos, se considerará la solicitud de alta en la base de datos. Por lo tanto, aquellos agricultores que no estén incluidos en la misma y quieran ser incorporados, deberán contratar una póliza de los módulos 1A o 2A del 1 de septiembre al 30 de septiembre.

El procedimiento de alta en la base de datos implicará la realización de una visita a la explotación, por parte de un perito designado por la Agrupación Española de Entidades Aseguradoras de los Seguros Agrarios Combinados, S. A. (en adelante AGROSEGURO). Cuando la visita a la explotación no pueda realizarse por causas imputables al asegurado o ante la imposibilidad de acceso a la explotación por ocurrencia de fenómenos climáticos adversos, el rendimiento será fijado con base en la información disponible. En el caso de explotaciones con una superficie de tres hectáreas o menos, que no tengan parcelas de superintensivo, también podrá fijarse el rendimiento con la información disponible sin realizar visita a la explotación.

AGROSEGURO remitirá a ENESA la propuesta de rendimiento máximo a más tardar el 21 de noviembre. ENESA publicará en su página web las resoluciones de alta en la base de datos, a más tardar el 20 de diciembre, dando un plazo de 10 días hábiles, contados a partir del día siguiente al de publicación, para que, quien lo estimen oportuno, solicite la revisión del rendimiento con el que se le ha dado de alta.
...
Para los asegurados que han contratado el módulo P Otoñal, su complementario o el módulo P de primavera, si AGROSEGURO no estuviera de acuerdo con el rendimiento declarado en alguna/s parcela/s, se corregirá por acuerdo amistoso entre las partes. De no producirse dicho acuerdo, corresponderá al asegurado demostrar los rendimientos declarados.

En el caso de que esta disconformidad se refiera al rendimiento declarado en el seguro principal de los módulos 1A y 2A, corresponderá a ENESA mediante un procedimiento de revisión de oficio, determinar el rendimiento máximo asegurable.
...
Si durante la vigencia de la declaración de seguro se detectase que el rendimiento asignado a la explotación no se ajusta a la realidad productiva de la misma, ENESA iniciará el procedimiento de revisión de oficio.

2. Revisión a instancia del asegurado.

Los agricultores incluidos en la base de datos con una póliza en vigor de los módulos 1 o 2, que consideren que el rendimiento asignado a su explotación no se ajusta a la realidad productiva de la misma, podrán solicitar la revisión del rendimiento asignado en la base de datos, únicamente en el año de contratación del seguro.
...
1. Procedimientos iniciados de oficio.

En caso de que se compruebe la falta de adecuación del rendimiento asignado en la base de datos de rendimientos máximos asegurables para explotaciones olivareras, con la realidad productiva de la explotación, ENESA abrirá un expediente de revisión de oficio, que será comunicado al interesado para que en el plazo de 10 días hábiles presente las alegaciones que estime oportunas.

Cuando el conocimiento de la citada falta de adecuación tuviera su origen en una visita de comprobación en campo, la comunicación a ENESA del desacuerdo con el rendimiento asignado deberá efectuarse antes de los 10 días naturales previos a la finalización de las garantías, a las que hace referencia el anexo V.2.1, de los riesgos cubiertos sobre la producción asegurada.

El plazo para resolver las revisiones de oficio será de tres meses, contados desde el día siguiente al acuerdo de inicio del procedimiento. ENESA comunicará las resoluciones a los asegurados y a AGROSEGURO en este mismo plazo.

2. Procedimientos iniciados a instancia de los asegurados.
...
En la Sede electrónica del Ministerio se establecerá la documentación que será necesario aportar junto con las solicitudes. Para los cambios de titularidad se deberá presentar la documentación que acredite que ha habido un traspaso efectivo de la titularidad de la explotación del antiguo titular al nuevo y, además, que se cumplen las condiciones establecidas en el punto 2.3 del artículo 6 de esta orden.

c) Tramitación de las solicitudes:

1. Solicitudes de revisión de rendimientos para asegurados que están en la base de datos:

El procedimiento de revisión de rendimientos implicará la realización de una visita a la explotación, por parte de un perito designado por AGROSEGURO. Cuando la visita a la explotación no pueda realizarse por causas imputables al asegurado o ante la imposibilidad de acceso a la explotación por ocurrencia de fenómenos climáticos adversos, se mantendrá el rendimiento asignado en la base de datos.

AGROSEGURO remitirá a ENESA, los informes correspondientes a las visitas de campo, antes del 1 de noviembre del año en curso. ENESA publicará en el tablón de la sede electrónica las propuestas de resolución, a más tardar, el 20 de noviembre, dando un plazo de 10 días hábiles, contados desde el día siguiente al de comunicación, para formular alegaciones. ENESA emitirá la resolución a más tardar el 31 de diciembre del año de contratación.

2. Cambios de titularidad.

Si la solicitud no reúne los requisitos o la documentación necesaria para resolver, se requerirá al interesado para que, en un plazo de diez días hábiles, subsane la falta o acompañe los documentos preceptivos, con indicación de que, si así no lo hiciera, se le tendrá por desistido de su petición.

ENESA, efectuará la propuesta de resolución no más tarde del 20 de octubre, abriendo un plazo para presentar alegaciones de 10 días hábiles, contados desde el día siguiente al de comunicación. ENESA emitirá la resolución a más tardar el 20 de noviembre del año en curso.
...
– Para las plantaciones de primer año, las garantías se inician con la toma de efecto.

– Para las plantaciones de segundo año, las garantías se inician desde el final de garantías de las instalaciones de primer año.
...
a) Módulos 1A, 2A y P Otoñal.

Inicio de la suscripción: será el 1 de septiembre de 2026 para el Cuadragésimo Séptimo Plan Anual de seguros Agrarios Combinados y 1 de septiembre de 2027 para el Cuadragésimo Octavo Plan Anual de Seguros Agrarios Combinados.
...
Inicio de suscripción: será el 15 de marzo de 2027 para el Cuadragésimo Séptimo Plan Anual de seguros Agrarios Combinados y 15 de marzo de 2028 para el Cuadragésimo Octavo Plan Anual de Seguros Agrarios Combinados.
...
– El 15 de marzo de 2027 para el primer año y el 15 de marzo de 2028 para el segundo año en el seguro contratado en el Cuadragésimo Séptimo Plan Anual de Seguros Agrarios Combinados.

– El 15 de marzo de 2028 para el primer año y el 15 de marzo de 2029 para el segundo año en el seguro contratado en el Cuadragésimo Octavo Plan Anual de Seguros Agrarios Combinados.
...
El 15 de marzo de 2027 en el seguro contratado en el Cuadragésimo Séptimo Plan Anual de Seguros Agrarios Combinados y el 15 de marzo de 2028 en el seguro contratado en el Cuadragésimo Octavo Plan Anual de Seguros Agrarios Combinados.
...
Madrid, 3 de agosto de 2026.–El Ministro de Agricultura, Pesca y Alimentación, Luis Planas Puchades.
...
| Plantación en producción. | Producción. | Pedrisco.
 ...
 Resto de Adversidades climáticas. | Anual por Explotación. | Garantizado individualizado: 70% y 60% (sin límite de indemnización) y el 50% (con límite de indemnización del 40% o el 30%) (2). |
| Plantación en producción. | Plantación. | Todos los cubiertos en la garantía a la Producción (1). | Parcela. | -- |
...
I.3 Módulo 2A. Indemnización anual.
...
1.5 Complementario Módulo 1A, 2A y P Otoñal.

| Tipo de plantación | Garantía | Riesgos cubiertos | Cálculo de la
...
1. Información básica y criterios adoptados para la selección de explotaciones incluidas expresamente en la base de datos de rendimientos máximos a efectos de la contratación de los módulos 1A y 2A en el seguro de olivar 2026.

1.1 Información básica disponible.

La información que se ha utilizado para la asignación de rendimientos individualizados para cada explotación se ha obtenido de la contratación y siniestralidad de las cosechas 2020/2021 a 2025/2026, así como de los datos procedentes de las solicitudes de alta o revisión de rendimientos de los planes 2018 a 2025.
...
– Rendimiento expresado en Kg/hectárea.

– Año de alta o de la última revisión.

1.2 Agricultores titulares de explotaciones incluidas en la base de datos.

Los criterios adoptados para considerar que una explotación puede ser incluida expresamente en la base de datos son:

– Haber contratado los módulos 1 ó 2 en alguno de los 7 últimos planes (planes 2018 a 2024).

– Haber tenido alta o revisión de rendimientos en el plan 2024 o plan 2025.

1.3 Cálculo de los rendimientos máximos asegurables en los módulos 1A y 2A.
...
Para la asignación del rendimiento máximo asegurable se han establecido los siguientes criterios:

1.3.1 A los que han tenido alta o revisión del rendimiento en alguno de los planes 2024 ó 2025, se les mantiene el último rendimiento fijado en campo.

1.3.2 A los que han tenido alta o revisión en alguno de los planes 2018-2023 y tengan al menos 2 cosechas de información en los módulos 1 ó 2, se les asigna el rendimiento obtenido mediante la media aritmética de las cosechas con información de los módulos 1 ó 2.

1.3.3 A los que no han tenido alta o revisión en los referidos planes:

a. Y tengan al menos 4 cosechas de información de módulos 1 ó 2, se les asigna el rendimiento obtenido mediante la media aritmética de las cosechas con información de los módulos 1 ó 2.

b. Al resto se les asigna el rendimiento de la anterior base de datos.

2. Información básica y criterios adoptados para la selección de explotaciones incluidas expresamente en la base de datos de rendimientos máximos a efectos de la contratación de los módulos 1A y 2A en el seguro de olivar 2027.

La información que se ha utilizado para la asignación de rendimientos individualizados para cada explotación consiste en la base de datos de rendimientos máximos a efectos de la contratación de los módulos 1A y 2A en el seguro de olivar 2026 con la incorporación de las altas y revisiones del plan 2026.

## ANEXO IV. Rendimiento máximo asegurable en parcelas para los módulos 1A y 2A
...
| Regadío. | Todo el ámbito. | >200 y ≤1200 | No aseg. | 1.500** kg/ha | 3.000** kg/ha | 3.000** kg/ha | 7.000** kg/ha | (1) | (1) | (1) | (1) |
| Regadío. | Andalucía y Extremadura. | > 1200 | No aseg. | 1.500** kg/ha | (1) | (1) | (1) | (1) | (1) | (1) | (1) |
| Regadío. | Resto del ámbito. | >1200 | No aseg. | No aseg | 3.500** kg/ha | 6.000** kg/ha | (1) | (1) | (1) | (1) | (1) |
...
| Tipo de Plantación | Ámbito
 (Comunidad Autónoma) | Densidad
 (olivos/ha) | N.º años desde el siniestro |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Regadío. | Todo el ámbito. | >200 y ≤1200 | No asegurable | 1.500** kg/ha | 3.000** kg/ha | 3.000** kg/ha | 7.000** kg/ha | (1) |  |
| Regadío. | Andalucía y Extremadura. | > 1.200 | No asegurable | 1.500** kg/ha | (1) | (1) | (1) | (1) |  |
| Regadío. | Resto del ámbito. | > 1.200 | No asegurable | No asegurable | 3.500** Kg/Ha | 6.000** Kg/Ha | (1) | (1) |  |
| * Estos porcentajes se aplicarán sobre el rendimiento asignado a la explotación en la base de datos.
 ** Si el rendimiento asignado a la explotación es inferior a esta cantidad, se aplicará el rendimiento de la explotación.
...
| Regadío. | Todo el ámbito. | >200 y ≤1200 | No asegurable | 3.000** kg/ha | 7.000** kg/ha | (1) |
| Regadío. | Andalucía y Extremadura. | > 1.200 | No asegurable | (1) | (1) | (1) |
| Regadío. | Resto del ámbito. | > 1.200 | No asegurable | (1) | (1) | (1) |
| * Estos porcentajes se aplicarán sobre el rendimiento asignado a la explotación en la base de datos.
 ** Si el rendimiento asignado a la explotación es inferior a esta cantidad, se aplicará el rendimiento de la explotación.
 (1) Estas parcelas no tienen limitación de rendimiento. El rendimiento medio asegurado del conjunto de las parcelas no limitadas (calculado según lo indicado en el artículo 5) no podrá superar el rendimiento máximo establecido en la base de datos para la explotación. |  |  |  |  |  |  |
...
| Producción. | Riesgos excepcionales. | Fauna silvestre. | Estado fenológico «F». |
...
| Producción. | Resto de adversidades climáticas (1). | Toma de efecto. |  |
...
| Producción. | Cantidad. | Daños producidos a consecuencia de caída de frutos (1). | Todas. | Tarragona. | Bajo Ebro. | 15 octubre (2). |
| Teruel. | Bajo Aragón. |  |  |  |  |  |
...
| IV. Aceituna de Mesa. | Gordal, Caspolina (Gordal Sevillana tipo Caspe). | 79 | 50 |
| V. Aceituna de Mesa. | Manzanilla, Manzanilla Cacereña y Manzanilla Carrasqueña. | 72 | 46 |
| VI. Aceituna de Mesa. | Manzanilla Fina, Manzanilla Serrana, Morona y resto de variedades de Mesa. | 55 | 38 |
| VII. Aceituna de aprovechamiento mixto. | Empeltre. | 56 | 37 |
| Manzanilla Carrasqueña, Hojiblanca, Lechín de Granada (cuquillo) y resto de variedades de aprovechamiento mixto. | 52 | 36 |  |
...
| IV. Aceituna de Mesa. | Gordal, Caspolina (Gordal Sevillana tipo Caspe). | 87 | 56 |
| V. Aceituna de Mesa. | Manzanilla, Manzanilla Cacereña y Manzanilla Carrasqueña. | 80 | 47 |
| VI. Aceituna de Mesa. | Manzanilla Fina, Manzanilla Serrana, Morona y resto de variedades de Mesa. | 58 | 39 |
| VII. Aceituna de aprovechamiento mixto. | Empeltre. | 64 | 42 |
| Manzanilla Carrasqueña, Hojiblanca, Lechín de Granada (Cuquillo) y resto de variedades de aprovechamiento mixto. | 55 | 37 |  |
