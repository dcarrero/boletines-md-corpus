...
pagina_final: 113752
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-17678"
url_pdf: "https://www.boe.es/boe/dias/2026/08/13/pdfs/BOE-A-2026-17678.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-17678"
url_eli: ""
fetched_at: "2026-08-13T09:43:09Z"
...
El Director de la Agencia Estatal «Agencia Española de Cooperación Internacional para el Desarrollo» y la Directora de la Agencia Estatal de Meteorología han suscrito, con fecha de 19 de junio de 2026, un convenio para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta.
...
## ANEXO. Convenio entre la Agencia Española de Cooperación Internacional para el Desarrollo (AECID) y la Agencia Estatal de Meteorología (AEMET) para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta
...
Y de otra, Alicia López Rejas, Directora de la Agencia Estatal de Meteorología (en adelante, AEMET), nombrada por el Consejo Rector de AEMET en su reunión núm. 62 el 15 de abril de 2026 (BOE núm. 108, de 4 de mayo de 2026), actuando en nombre y representación de dicha agencia y en el ejercicio de las competencias atribuidas por el Real Decreto 299/2026 (BOE núm. 87, de 9 de abril de 2026), por el que se aprueba el Estatuto de la Agencia Estatal de Meteorología, con domicilio en la calle Leonardo Prieto Castro, 8, 28040, Madrid, España.
...
Que AEMET es una Agencia Estatal de las previstas en el artículo 84.1.a).3 de la Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público, adscrita al Ministerio para la Transición Ecológica y el Reto Demográfico a través de la Secretaría de Estado de Medio Ambiente, y tiene entre sus competencias la contribución a la planificación y ejecución de la política del Estado en materia de cooperación internacional al desarrollo en materia de meteorología y climatología, en coordinación con las organizaciones nacionales e internacionales que desarrollan estas actividades, de conformidad con el artículo 8 n) del Real Decreto 299/2026, de 8 de abril, por el que se aprueba el Estatuto de la Agencia Estatal de Meteorología.
...
El presente convenio tiene por objeto articular la colaboración entre la AECID y AEMET para la ejecución de la programación «Actualización en capacitación técnica en meteorología y climatología para reducción de riesgos de desastres y adaptación ante el cambio climático», seleccionada en el marco de la convocatoria Intercoonecta 2025, conforme a los términos establecidos en dicha convocatoria.
...
La programación tiene como finalidad reforzar y actualizar las capacidades técnicas de los profesionales de los Servicios Meteorológicos e Hidrológicos Nacionales de América Latina y el Caribe, con el objetivo de mejorar la calidad de la información y los servicios meteorológicos y climatológicos que prestan, y así contribuir a una mejor toma de decisiones frente a fenómenos extremos. A través de formación especializada y transferencia de conocimiento, la programación busca incrementar la resiliencia y la capacidad de adaptación al cambio climático, reducir el riesgo de desastres y mitigar sus impactos en la población y los territorios.

Actividades de la programación:

– Aplicaciones Hidrometeorológicas de los radares meteorológicos (4.ª edición): 2026, Centro de Formación de la Cooperación Española en Antigua (Guatemala).

– Generación de productos climatológicos a partir de bases de datos climáticos: fase *online* en 2026, Aula virtual Intercoonecta, fase presencial en 2026, Centro de Formación de la Cooperación Española en Antigua (Guatemala).

– Productos y aplicaciones de los satélites meteorológicos: fase *online* en 2026, Aula virtual Intercoonecta; fase presencial en 2026, Oficina de la Cooperación Española en Montevideo (Uruguay).

– Capacitación en servicios climáticos (4.ª edición): en 2027, Centro de Formación de la Cooperación Española en Antigua (Guatemala).

– Comunicación efectiva en meteorología e hidrología: en 2027, Aula virtual Intercoonecta.

– Uso e interpretación de productos del modelo numérico del CEPPM en el área tropical, (3.ª edición) fase *online* en 2027, Aula virtual Intercoonecta; fase presencial en 2027, Centro de Formación de la Cooperación Española en Antigua (Guatemala).
...
La AECID, financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, a través de sus Centros de Formación de la Cooperación Española en: Santa Cruz de la Sierra, Bolivia; Cartagena de Indias, Colombia; La Antigua, Guatemala y la Oficina de la Cooperación Española en Montevideo, Uruguay, las obligaciones asumidas en la cláusula segunda por un importe de hasta 179.533,57 euros.

AEMET, financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, las obligaciones asumidas en la cláusula tercera por un importe de hasta 174.950,00 euros.
...
Y en prueba de conformidad y, para la debida constancia de cuanto queda convenido, las partes firman digitalmente el presente convenio en la fecha indicada en la firma electrónica. El convenio se entiende suscrito en la fecha de firma de la última parte firmante.–El Director de la Agencia Estatal «Agencia Española de Cooperación Internacional para el Desarrollo», Antón Leis García.–La Directora de la Agencia Estatal de Meteorología, Alicia López Rejas.
