---
identificador: "BOE-A-2026-17684"
titulo: "Resolución de 5 de agosto de 2026, de la Subsecretaría, por la que se publica el Convenio entre la Agencia Estatal Agencia Española de Cooperación Internacional para el Desarrollo y el Instituto Nacional de Administración Pública, O.A., para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 113807
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-17684"
url_pdf: "https://www.boe.es/boe/dias/2026/08/13/pdfs/BOE-A-2026-17684.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-17684"
url_eli: ""
fetched_at: "2026-08-13T09:43:17Z"
...
El Director de la Agencia Estatal Agencia Española de Cooperación Internacional para el Desarrollo y el Director del Instituto Nacional de Administración Pública, O.A., han suscrito, con fecha de 12 de junio de 2026, un convenio para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta-Modelo Normalizado I.
...
## ANEXO. Convenio entre la Agencia Española de Cooperación Internacional para el Desarrollo (AECID) y el Instituto Nacional de Administración Pública (INAP) para la realización de las programaciones de capacitación técnica e innovación del programa Intercoonecta-Modelo Normalizado I
...
El presente convenio tiene por objeto articular la colaboración entre la AECID y EL Instituto Nacional de Administración Pública (INAP) para la ejecución de la programación «Capacitación e innovación pública para el fortalecimiento institucional en América Latina y el Caribe», seleccionada en el marco de la convocatoria Intercoonecta 2025, conforme a los términos establecidos en dicha convocatoria.
...
La programación «Capacitación e innovación pública para el fortalecimiento institucional en América Latina y el Caribe» tiene como finalidad reforzar las capacidades institucionales y técnicas de las administraciones públicas de la región, promoviendo la innovación, el aprendizaje colaborativo y el intercambio de conocimiento para afrontar la triple transición ecológica, digital y social. A través de acciones formativas y del impulso de redes de innovación pública, se busca mejorar la implementación de políticas públicas más inclusivas, participativas y sostenibles, contribuyendo a una gestión más eficaz y alineada con la Agenda 2030.

Actividades de la programación:

1. Diseño de procesos de aprendizaje en línea: Herramientas y estrategias (3.ª edición): 2026 Aula Virtual Intercoonecta.

2. Metodologías y herramientas activas enfocadas a la ejecución de acciones formativas en línea (1.ª edición): 2027 Aula Virtual Intercoonecta.

3. Taller de diseño de procesos de aprendizaje presenciales y uso de la inteligencia artificial (2.ª edición): 2027 Centro de Formación de la Cooperación Española en Cartagena de Indias.

4. Aprender con metodologías activas para mejorar las administraciones públicas locales (3.ª edición). Fase virtual: 2027 Aula Virtual Intercoonecta.

5. Aprender con metodologías activas para mejorar las administraciones públicas locales (3.ª edición) Fase presencial: 2027 Centro de Formación de la Cooperación Española en Cartagena de Indias.

6. Innovación pública, laboratorios de buenas prácticas: Conectando espacios de innovación Pública (Fase Virtual): 2027 Aula Virtual Intercoonecta.

7. Innovación pública, laboratorios de buenas prácticas: Grupo de trabajo para la realización de un análisis diagnóstico del estado de la cuestión. Modalidad Virtual: 2027 Aula Virtual Intercoonecta.

8. Innovación pública, laboratorios de buenas prácticas: Foro final de innovación pública (laboratorio de buenas prácticas). Modalidad Presencial: 2027 Centro de Formación de la Cooperación Española en Cartagena de Indias.
...
e) La AECID financiará la edición, maquetación y corrección de estilo de los productos de conocimiento y comunicación resultantes de la programación y/o de alguna de sus actividades.
...
c) La selección definitiva del equipo de diseñadores, expertos, profesores, docentes, tutores, coordinadores, gestores y todas las personas que participen en la ejecución de las actividades y en el desarrollo de los contenidos de los productos de conocimiento.
...
El presente convenio no supone ningún compromiso de transferencia económica entre las entidades firmantes. La AECID, como entidad del Sector Público incluida en los Presupuestos Generales del Estado de España, financiará las obligaciones que asume en este convenio con cargo a las aplicaciones presupuestarias 12.302.03.143A.226.15, 12.302.03.143A.227.15, 12.302.03.143A.233. El INAP financiará las obligaciones que asume en este convenio con cargo a las aplicaciones presupuestarias 33.101.921O.226.06 y 33.101.921O 233.

Cada una de las partes firmantes asumirá los costes derivados de la ejecución del presente convenio:

La AECID, financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, a través de sus Centros de Formación de la Cooperación Española en: Santa Cruz de la Sierra, Bolivia; Cartagena de Indias, Colombia; La Antigua, Guatemala las obligaciones asumidas en la cláusula segunda por un importe de hasta 109.260,65 euros.

El INAP financiará, siempre que para ello haya crédito adecuado y suficiente en el ejercicio 2026 y 2027, las obligaciones asumidas en la cláusula tercera por un importe de hasta 101.820,00 euros.
...
Las partes se comprometen a respetar el Código ético de la AECID, de 30 de octubre de 2019, disponible en la página web de la AECID (www.aecid.es). y el del INAP disponible en la página web del INAP (https://www.inap.es/documents/10136/1699464/Codigo-etico-2019.pdf/acf0f0b3-b676-0b35-f38c-31e029c40f3d).
