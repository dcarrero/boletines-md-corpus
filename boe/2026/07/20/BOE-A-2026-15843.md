---
identificador: "BOE-A-2026-15843"
titulo: "Resolución de 8 de julio de 2026, de la Agencia Española de Protección de Datos, por la que se aprueban las bases reguladoras y se convoca el Premio Comunicación de Protección de Datos Personales, para el año 2026."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "175"
pagina_inicial: 102484
pagina_final: 102492
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-15843"
url_pdf: "https://www.boe.es/boe/dias/2026/07/20/pdfs/BOE-A-2026-15843.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-15843"
url_eli: "https://www.boe.es/eli/es/res/2026/07/08/(5)"
fetched_at: "2026-07-20T10:23:09Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 8 de julio de 2026, de la Agencia Española de Protección de Datos, por la que se aprueban las bases reguladoras y se convoca el Premio Comunicación de Protección de Datos Personales, para el año 2026.
...
Se convoca el «Premio Comunicación de Protección de Datos Personales» para el año 2026.
...
El premio podrá otorgarse a uno o varios trabajos relativos al tema de la convocatoria, publicados o difundidos en un mismo medio de comunicación. En el caso de presentarse varios trabajos con la misma autoría estos se considerarán conjuntamente a efectos de valoración por parte del jurado.
...
No podrán obtener la condición de beneficiaria las personas o entidades en quienes concurra alguna de las circunstancias previstas en el artículo 13 de la Ley 38/2003, de 17 de noviembre, General de Subvenciones.
...
Las candidaturas que opten al premio deberán incluir, como mínimo, la siguiente documentación:

a) Trabajo objeto de participación (se deberá registrar con la denominación «Trabajo»):

a1) En el caso de que el trabajo presentado consista en piezas de audio o audiovisuales, los archivos deben ser incluidos en la candidatura para que puedan ser valorados.

a2) En el caso de que el trabajo presentado consista en artículos escritos, deberán presentarse en un documento que permita su lectura y análisis, con una extensión máxima de 80 páginas.

En el caso de presentar varios artículos publicados en prensa escrita, se agruparán todos los contenidos presentados en un único documento, haciéndose siempre visible la autoría de los mismos y el medio en el que han sido publicados. Para medios exclusivamente online, además de la URL donde están publicados los artículos, se incorporará el contenido de los mismos.

Todos los trabajos presentados (artículos escritos o piezas/reportajes/programas de audio o audiovisuales) deberán permitir su apertura en programas comúnmente usados con extensiones del tipo «DOCX, PDF, RTF, PPTX, JPG, TXT, XML, XSIG, XLSX, ODG, ODS, ODP, PNG, SVG, TIFF, MP3 o MP4»).
...
b) Resumen ejecutivo: Cada candidatura deberá incluir un resumen ejecutivo de acuerdo con el modelo del anexo 2, recogiendo los principales méritos y logros que la avalen. Este resumen tendrá una extensión máxima de cuatro páginas, en letra Arial 12 e interlineado sencillo.

El resumen ejecutivo deberá contener de forma obligatoria los apartados a los que se hace referencia en el anexo 2.

De cara a la evaluación recogida en la Base octava, se valorará haber incluido en el resumen ejecutivo la difusión o los impactos conseguidos por el trabajo presentado, así como el detalle de la metodología empleada para la cuantificación.
...
Pueden optar al premio aquellos trabajos individuales o proyectos periodísticos difundidos a través de cualquier medio de comunicación social (televisión, radio, prensa escrita, ya sea en papel o digital y agencias de noticias) entre el 16 de octubre de 2025 y el 15 de octubre de 2026.
...
Las personas premiadas contarán con mención honorífica, mediante diploma concedido al efecto. Asimismo, se otorgará por cada candidatura premiada un trofeo acreditativo del premio obtenido.
...
– Tipos de documentos permitidos: DOCX, PDF, RTF, PPTX, JPG, TXT, XML, XSIG, XLSX, ODG, ODS, ODP, PNG, SVG, TIFF, MP3 y MP4.
...
En caso de renuncia al premio, la persona adjudicataria deberá presentar la correspondiente solicitud fundamentada, dirigida al presidente de la AEPD, que resolverá si procede, la devolución de la cantidad percibida.
...
## ANEXO 1. Solicitud del Premio Comunicación de Protección de Datos Personales, de la Agencia Española de Protección de Datos (2026)
...
El resumen ejecutivo, con formato de texto, tendrá una extensión máxima de cuatro páginas con letra Arial 12 e interlineado sencillo.
...
– Adecuación al objeto del premio, con indicación expresa, en su caso, de las líneas prioritarias definidas en la Base 1.ª

– Contribución de la candidatura a la difusión del derecho fundamental a la protección de datos y cuantificación del impacto conseguido y las métricas empleadas, en su caso.

– Fechas en las que se ha desarrollado el trabajo.
