---
identificador: "BOE-A-2026-15846"
titulo: "Resolución de 8 de julio de 2026, de la Agencia Española de Protección de Datos, por la que se aprueban las bases reguladoras y se convoca el Premio a la difusión del derecho fundamental a la protección de datos personales en redes sociales, para el año 2026."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
Se convoca el «Premio a la difusión del derecho fundamental a la protección de datos personales en redes sociales» para el ejercicio 2026.
...
Entre los perfiles presentados se priorizarán aquellos que hayan contribuido a difundir en mayor medida la protección de datos desde un plano social ‒tanto entre la ciudadanía para que conozca sus derechos y cómo ejercerlos, como entre aquellos que tratan datos, de forma que conozcan cuáles son sus obligaciones y responsabilidades‒ y los que hayan contribuido a visibilizar las iniciativas y acciones lanzadas por la AEPD.

En el caso de un perfil activo en varias redes sociales, se deberá presentar una única candidatura conjunta de todos los perfiles activos. En todo caso, el jurado considerará dicho perfil con presencia en varias redes sociales de forma conjunta a efectos de su valoración única.
...
Corresponde a las personas solicitantes la prueba de la titularidad del perfil, para lo cual aportarán junto con la solicitud, mediante documentación adicional, la documentación que lo justifique.

No podrán participar miembros del jurado y personal destinado en la Agencia Española de Protección de Datos, Agencias autonómicas y autoridades extranjeras de protección de datos.
...
a) Memoria: Cada candidatura deberá incluir una memoria de acuerdo con el modelo del anexo 2, recogiendo los principales méritos y logros que la avalen. Esta memoria tendrá una extensión máxima de 10 páginas, en letra Arial 12 e interlineado sencillo y podrá presentarse en idioma original, si bien, en caso de ser diferente del castellano, deberá acompañarse de traducción a este último idioma. Al tratarse de un premio orientado a redes sociales, además del contenido susceptible de ser capturado o incrustado, deberán incluirse en la memoria los enlaces activos al contenido online que se considere debe ser valorado por el jurado, ya sea uno o varios perfiles en diversas redes sociales de forma completa o el proyecto y la difusión realizada de una acción concreta.

Esta Memoria deberá contener de forma obligatoria los apartados a los que se hace referencia en el anexo 2. El contenido enlazado en el resumen deberá permanecer visible en el momento de su valoración por parte del jurado, y deberá de presentarse en formato electrónico o digital, que permita su apertura en programas de uso común, con las siguientes extensiones admitidas: PPTX, JPG, TXT, XML, XSIG, XLSX, ODG, ODS, PDF, ODP, PNG, SVG, TIFF, MP3, MP4, DOCX o RTF.

Si la candidatura se presenta de forma telemática, toda la documentación deberá adjuntarse en formato electrónico conforme a los mismos requisitos técnicos.

b) En caso de presentación no telemática, se deberá incluir el anexo 1 recogido en la presente convocatoria, debidamente cumplimentado y firmado, y copia digital del proyecto presentado, en formato electrónico o digital, que permita su apertura en programas de uso común, con las extensiones admitidas (PPTX, JPG, TXT, XML, XSIG, XLSX, ODG, ODS, PDF, ODP, PNG, SVG, TIFF, MP3, MP4, DOCX o RTF).
...
Pueden optar al premio aquellos perfiles que hayan publicado contenidos relacionados con el objeto de estas bases entre el 16 de octubre de 2025 y el 15 de octubre de 2026.
...
Las candidaturas premiadas contarán con mención honorífica, diploma, y la difusión de los trabajos premiados a través de la página web y de las redes sociales de la AEPD, así como un trofeo acreditativo del premio obtenido.
...
Quienes deseen participar habrán de presentar su candidatura en el modelo de solicitud que figura en el anexo I), debidamente cumplimentado y firmado, acompañado de la documentación y el material que se estime oportuno en su apoyo.
...
– Grado de adecuación del contenido de la candidatura con las líneas temáticas propuestas para el premio en la base primera y rigor del mismo (puntuación hasta un máximo de 50 puntos).

– Difusión conseguida con la candidatura presentada. Contribución a la concienciación de la ciudadanía o de aquellos que tratan datos en relación con los principios del derecho fundamental a la protección de datos personales teniendo en cuenta las líneas prioritarias definidas en la base primera (puntuación hasta un máximo de 50 puntos).
...
## ANEXO 1. Solicitud del premio a la difusión del derecho fundamental a la protección de datos personales en redes sociales, de la Agencia Española de Protección de Datos (2026)
...
Puede ejercitar sus derechos de acceso, rectificación, supresión y portabilidad de sus datos, de limitación y oposición a su tratamiento, así como a no ser objeto de decisiones basadas únicamente en el tratamiento automatizado de sus datos, cuando procedan, ante la Agencia Española de Protección de Datos, paseo de la Castellana, núm. 141, planta novena, 28046 Madrid calle Jorge Juan, 6, 28001-Madrid.

## ANEXO 2. Memoria de la candidatura

La memoria que debe presentarse para la candidatura tendrá una extensión máxima de 10 páginas con letra Arial 12 e interlineado sencillo y tendrá los siguientes apartados:
