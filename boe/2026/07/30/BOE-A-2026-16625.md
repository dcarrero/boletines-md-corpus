---
identificador: "BOE-A-2026-16625"
titulo: "Resolución de 26 de mayo de 2026, de la Autoridad Portuaria de Marín y Ría de Pontevedra, por la que se publica el Pliego de prescripciones particulares del servicio portuario de manipulación de mercancías en el puerto de Marín y Ría de Pontevedra."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 107388
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-16625"
url_pdf: "https://www.boe.es/boe/dias/2026/07/30/pdfs/BOE-A-2026-16625.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-16625"
url_eli: "https://www.boe.es/eli/es/res/2026/05/26/(4)"
fetched_at: "2026-08-01T09:58:40Z"
...
El Consejo de Administración de la Autoridad Portuaria de Marín y Ría de Pontevedra, en la sesión celebrada el 30 de abril de 2026, de acuerdo con la propuesta elevada por la Dirección, acordó:

1.º Aprobar el Pliego de prescripciones particulares del servicio portuario de manipulación de mercancías que se adjunta a la presente resolución.
...
Marín, 26 de mayo de 2026.–El Presidente de la Autoridad Portuaria de Marín y Ría de Pontevedra, José Benito Suárez Costa.

## ANEXO. Pliego de prescripciones particulares de la Autoridad Portuaria de Marín y Ría de Pontevedra

PLIEGO DE PRESCRIPCIONES PARTICULARES DEL SERVICIO PORTUARIO DE MANIPULACIÓN DE MERCANCÍAS

Fecha de aprobación por el Consejo de Administración: 30 de abril de 2026
...
1. El ámbito geográfico de prestación de este servicio es el área portuaria delimitada por la zona de servicio del puerto de Marín y Ría de Pontevedra vigente en el momento de aprobación de este PPP, según figura en la «Orden TMA/690/2023, de 9 de junio, por la que se aprueba la delimitación de los espacios y usos portuarios del puerto de Marín y Ría de Pontevedra» o documento que le sustituya en lo sucesivo.
...
a. Licencias generales, que podrán obtener cualquier interesado que lo solicite y que cumpla las condiciones establecidas en este PPP y en el TRLPEMM. Estas licencias tendrán necesariamente como ámbito geográfico el indicado en la prescripción 3.ª
...
1. Cuando no exista limitación en el número de prestadores, el plazo de duración de las licencias generales será de:

a. Sin inversión significativa: seis años.

b. Con inversión significativa en equipos y material móvil:

i. Cuando el titular de la licencia tenga otorgada en concesión o autorización una terminal marítima de pasajeros o de mercancías, con atraque en concesión o autorización: veinte años.

ii. Cuando el titular de la licencia tenga otorgada en concesión o autorización una terminal marítima de pasajeros o de mercancías, sin atraque en concesión o autorización: quince años.
...
4. Los titulares de licencia pueden renunciar a la misma con un preaviso obligatorio de seis meses de antelación.
...
a. Inversión en equipos y material móvil:

1) Cuando el titular de la licencia tenga otorgada en concesión o autorización una terminal marítima de pasajeros o de mercancías, con atraque en concesión o autorización: 2.500.000 euros.

2) Cuando el titular de la licencia tenga otorgada en concesión o autorización una terminal marítima de pasajeros o de mercancías, sin atraque en concesión o autorización: 2.000.000 euros.

3) En otro caso: 1.500.000 euros.

b. Inversión en obras e instalaciones fijas:

1) Cuando las obras sean infraestructuras portuarias de abrigo, esclusas, obras de atraque, accesos marítimos y obras de relleno o de consolidación y mejora de terrenos en grandes superficies: 5.000.000 euros.

2) En otro caso: 3.000.000 euros.
...
7. A efectos del cómputo de la inversión significativa en equipos y material móvil, u obras e instalaciones fijas –que se valorará por la Autoridad Portuaria para concretar el plazo de duración de las licencias de prestación del servicio– se considera conveniente aclarar (respecto a las empresas que ya se encuentran prestando el servicio) que se tomarán en consideración las inversiones ya ejecutadas que se vinculen de manera directa a la prestación de este servicio.
...
1. La Autoridad Portuaria podrá modificar este Pliego de prescripciones particulares por razones objetivas motivadas de acuerdo con lo establecido en el artículo 113.2 del TRLPEMM.
...
1. El solicitante deberá contar para la obtención de la licencia, y durante toda la vigencia de esta, con unos fondos propios equivalentes, al menos, al mayor de los dos importes siguientes:
...
(que será debidamente justificado en la solicitud).
...
iii. Los Trabajadores portuarios necesarios para desarrollar las actividades integradas en el servicio portuario de manipulación de mercancías en condiciones de eficiencia, seguridad y protección del medio ambiente y que cumplan con las condiciones exigidas legalmente.
...
3. El Responsable de Operaciones Portuarias tendrá formación adecuada a las tareas a realizar y acreditará una experiencia en un puesto con responsabilidad en organización de operaciones portuarias o en terminales intermodales de mercancías de al menos dos años.
...
7. La persona o personas que desempeñen los cometidos de ‘Responsable de Operaciones portuarias’, y ‘Responsable de Seguridad y Coordinación’ formarán parte de la plantilla de la empresa, o de la plantilla de alguna otra empresa del Grupo de empresas al que pueda pertenecer la empresa prestadora (singularmente a la empresa matriz), poniéndose en tal supuesto a completa disposición de la empresa titular de la licencia –en el desarrollo de sus funciones– para el servicio de manipulación de mercancías en los términos exigidos por la Autoridad Portuaria.
...
12. Para el caso específico de licencias para la prestación del servicio de manipulación de mercancías circunscritas al tráfico de pesca congelada a granel/paletizada (no contenerizada, en las que las tareas específicas en bodega refrigerada requieren de una tareas especificadas y muy concretas y limitadas) se podrá utilizar personal con la formación suficiente para desarrollar esas concretas labores, de forma excepcional cuando por razones debidamente justificadas de puntas de alta actividad de buques y/u operaciones se requiera alto número de personal a disposición, siempre y cuando no se cuente con trabajadores en número suficiente con la certificación exigida en los puntos anteriores, y únicamente para tareas o puestos destinados al personal que desarrolle trabajos de manipulación en bodega. Dicho personal deberá disponer en todo caso de la correspondiente acreditación de un Curso de Prevención de Riesgos Laborales que acredite la disposición de los conocimientos necesarios para poder prevenir y evitar los riesgos más habituales en el desarrollo de dicha actividad profesional. Será la organización preventiva de la empresa la que se responsabilizará de la superación de dichos requisitos para cubrir la obligatoria formación del puesto de trabajo, previamente a permitir al trabajador realizar la actividad.

La empresa titular del servicio será la responsable de tener debidamente justificada y acreditada la falta de personal en número suficiente, la formación mínima necesaria del trabajador utilizado para el desempeño puntual y excepcional de dicha labor.

13. Los trabajadores portuarios formarán parte de la plantilla de la empresa o serán contratados de manera eventual, según lo establecido en la normativa laboral vigente y en los acuerdos o convenios laborales aplicables o de la plantilla de alguna otra empresa del Grupo de empresas al que pueda pertenecer la empresa prestadora (singularmente a la empresa matriz), poniéndose en tal supuesto a completa disposición de la empresa titular de la licencia –en el desarrollo de sus funciones– para el servicio de manipulación de mercancías en los términos exigidos por la Autoridad Portuaria. Las condiciones de estos contratos y de la actividad laboral que se realice se ajustarán a lo dispuesto en la regulación laboral y en los acuerdos o convenios laborales aplicables.

14. Será responsabilidad de la empresa titular de la licencia el control y coordinación de los medios humanos, verificando previamente que los medios humanos empleados en las operaciones cumplen los requisitos establecidos en el presente pliego. La Autoridad Portuaria no será responsable, en ningún caso, de los daños y perjuicios producidos por la falta de verificación de cumplimiento de los requisitos establecidos para los medios humanos.
...
| Tipo de Máquina | Características mínimas | Cantidad |
| --- | --- | --- |
| Graneles sólidos |  |  |
| Grúa. | Capacidad > 30 t | 1 |
| Grúa Móvil de Puerto (tipo MHC) (2). | Capacidad > 40 t | 1 |
| Carretilla/Pala Cargadora. | Capacidad > 6 t | 6 |
| Tolvas ecológicas (3). |  | 1 |
| Mercancía general no contenerizada ni rodada (*) |  |  |
| Grúa Móvil de Puerto (tipo MHC). | Potencia > 40 t | 1 |
| Carretilla/Reach stacker. | Capacidad > 25 t | 2 |
| Contenedores |  |  |
| Grúa Portacontenedores o Grúa Móvil de Puerto (tipo MHC). | Capacidad > 42 t | 1 |
| Spreaders. |  | 2 |
| Carretilla/Reach stacker. | Capacidad > 40 t | 2 |
| Carga rodada |  |  |
| Cabeza tractora (4). |  | 1 |
| (1) Para los tráficos de los que se obtiene la licencia. No es aplicable a operaciones de pequeño porte con mercancías de tipo diferente al de la licencia, que coexistan esporádicamente en buques con la carga principal, objeto de la licencia.
 (2) MHC= *Mobile Harbor Crane*, grúa móvil portuaria diseñada específicamente para operar en muelles y terminales marítimas, grúa autopropulsada, montada sobre un chasis con ruedas, capaz de desplazarse por el muelle y operar con alta flexibilidad.
 (3) Sistema de recepción con aspiración forzada y elementos de captación de polvo, con altura adecuada para facilitar la descarga de la cuchara en el interior, minimizando las emisiones. En caso de que la licencia habilite para los tráficos en que es necesaria.
 Se considera necesaria la tolva ecológica para las operaciones de descarga y transferencia de graneles pulverulentos tales como harinas (trigo/soja/maíz), salvados, tapioca, fosfato bicálcico y materiales de comportamiento equivalente. Se consideran de comportamiento equivalente: harina de pescado, harina de arroz, harina de cebada, DDGS (*Dried Distillers Grains with Solubles*, subproducto sólido obtenido en el proceso de producción de etanol o alcohol a partir de cereales(principalmente del maíz, trigo, sorgo), sémolas finas, almidones (maíz/trigo/tapioca), proteínas vegetales en polvo; arcillas (caolín, bentonita, sepiolita y similares), carbonato cálcico molido, cementos, cenizas, fertilizantes minerales finos y materiales equivalentes y cualesquiera otros graneles con fracción fina significativa y/o susceptibles de generar polvo secundario durante la descarga.
 (4) Sin incluir el tráfico de vehículos nuevos, que no precisa maquinaria.
 (*) Conforme a lo establecido en la prescripción 4.ª 2, en el caso de otorgamiento de licencia específica la manipulación de pesca congelada a granel/paletizada (no contenerizada), los medios mínimos a disposición serán los siguientes: 1 grúa (automóvil convencional autopropulsada de 30 t o similar apropiada para la operativa de que se trate), 1 carretilla (tipo Linde E16 o similar), y elementos auxiliares en número suficiente (planchetas, eslingas). |  |  |
...
9. La empresa prestadora del servicio deberá dotarse de los medios o servicios necesarios para dar respuesta a posibles episodios de contaminación marina que puedan derivar de su actividad. A estos efectos deberá elaborar, un protocolo o, en su caso, de un plan de actuación para posibles vertidos, tanto propios como para intervención, a solicitud de la administración competente, según lo dispuesto en la legislación vigente en la materia. Así mismo, participara en los ejercicios que la Autoridad Portuaria ejecute a fin de lograr la adecuada integración y coordinación de su Plan con el Plan Interior Marítimo de la Autoridad Portuaria, todo ello en el ámbito de su actividad.
...
4. Los titulares de licencias de autoprestación, otorgadas con arreglo a lo establecido en el artículo 135 del TRLPEMM, así como las restringidas a terminales de mercancías de uso particular, deberán cumplir las mismas condiciones establecidas en estas prescripciones particulares, para los prestadores del servicio abierto al uso general, con la excepción de las cláusulas referidas a cobertura universal, estructura tarifaria y tarifas máximas, niveles de rendimiento y obligaciones de servicio público relativas a la continuidad y regularidad del servicio en función de la demanda del puerto.
...
2. La prestación del servicio se realizará con la máxima diligencia evitando retrasos en la prestación el servicio.
...
3. De igual modo, la Autoridad Portuaria podrá establecer la adopción de medidas dirigidas a minimizar los aspectos ambientales de las operaciones, y/o en materia de coordinación y seguridad, cuando estas afecten significativamente a otras operaciones desarrolladas en el puerto, o al entorno urbano.
...
3. Durante el desarrollo de trabajos nocturnos o con visibilidad reducida, corresponde a la empresa prestadora del servicio como principal de la operación y titular del área de trabajo asignada, adoptar las medidas de iluminación complementarias a la iluminación de la Autoridad Portuaria necesarias para alcanzar los niveles de iluminación legalmente requeridos en caso de que así lo requiera la concreta operación a realizar.
...
1. La empresa prestadora deberá presentar un Plan de medidas de emergencia con el fin de que la Autoridad Portuaria lo integre en su correspondiente Plan de Autoprotección, conforme a lo establecido la normativa vigente en materia de Autoprotección de los centros, establecimientos y dependencias dedicados a actividades que puedan dar origen a situaciones de emergencia.
...
3. La empresa estibadora prestadora del servicio será responsable de que todo el personal que se encuentre en la instalación portuaria esté debidamente autorizado y disponga de las tarjetas identificativas facilitadas por la Autoridad Portuaria que les habilita para acceder a la misma, estando dicho personal obligado a mostrarlas siempre que se requiera a tal efecto por parte del personal de la Autoridad Portuaria. De la misma forma, corresponde a la empresa estibadora formar a cada trabajador integrante de sus plantillas o que opere bajo su responsabilidad, en relación con lo prescrito en el Código internacional para la protección de los buques y de las instalaciones portuarias (Código PBIP) para cada actividad.
...
3. La Autoridad Portuaria podrá consultar los manuales de servicio y de calidad, registros e informes de auditoría que certifiquen la implantación efectiva y mantenimiento de los sistemas de aseguramiento de calidad indicados anteriormente por causa justificada cuando se considere requisito necesario para la comprobación del cumplimiento de los requisitos normativos establecidos, tanto externos como la normativa propia emitida por la Autoridad Portuaria, que respetará el carácter confidencial de la información suministrada, siendo esta solicitada a los prestadores de forma transparente y no discriminatoria conforme a lo establecido en la Ley 19/2013, de 9 de diciembre, de transparencia, acceso a la información pública y buen gobierno, así como en la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos Personales y garantía de los derechos digitales.
...
Unidad de medida: % de servicios iniciados con retraso sobre el número de servicios prestados.

Cálculo: % de servicios iniciados pasados 15 ’ del momento en que debían de haber comenzado, sobre el número de servicios prestados.
...
Cálculo: % de servicios con accidentes o incidentes imputables al prestador, sobre el número de servicios prestados.

Valor por encima del cual el prestador puede ser penalizado: 5 %

d. Tiempo medio de respuesta a reclamaciones:

Definición: grado de capacidad de respuesta del prestador con respecto a las reclamaciones que pueda interponer el usuario en relación al servicio recibido.

Unidad de medida: Tiempo medio empleado en la respuesta de reclamaciones.

Cálculo: promedio entre la diferencia de la fecha de presentación de la reclamación y la fecha de respuesta a la misma.

Valor por debajo del cual el prestador puede ser penalizado: 95 %, se establecerá a tales efectos un tiempo medio de referencia de quince días hábiles.
...
c. Indicadores de productividad y rendimiento.
...
| Mercancía General | t/h |
| --- | --- |
| Bobinas laminadas. | 250 |
| Fruta. | 125 |
| Pasta de papel. | 400 |
| Eólicos. | 75 t/2 piezas |
| Granito en bloque. | 180 |
| Adoquín. | 200 |
| Palanquilla, varilla, planchas. | 175 |
| Chatarra. | 250 |
| Otra mercancía paletizada. | 80 |

| Mercancía contenedores | Mov./h |
| --- | --- |
| Contenedor. | 20 |

| Mercancía RO-RO | Rendimiento unitario |
| --- | --- |
| UTIs. | 5 Uds./h y tractora |
| Vehículos nuevos. | 7 Uds./h y hombre |

| Pesca congelada no contenedor. | 100 t/8h |
| --- | --- |

Dado que se trata de una lista no exhaustiva, en caso de ser necesario hallar rendimientos de mercancías no incluidas en la relación anterior, se hará por semejanza a las incluidas, quedando definidos los rendimientos mínimos para cada mercancía en la licencia correspondiente.

2. Respecto a los rendimientos mínimos antes indicados se deberá cumplir lo siguiente:

a. El 90 % de las operaciones realizadas durante el año natural deberán superar los anteriores niveles mínimos exigidos.
...
2. El prestador del servicio presentará cuando sea requerido un informe detallado sobre la prestación del servicio, que será presentado en el plazo de dos meses en soporte digital.
...
i) N.º de horas de maquinaria utilizada.
...
1. A fin de garantizar el cumplimiento de las obligaciones derivadas de estas Prescripciones Particulares, de las sanciones que pudieran imponerse y de los daños y perjuicios que pudieran producirse, así como el cumplimiento de la cláusula de preaviso definida en el punto 4 de la prescripción 5.ª en caso de renuncia a la licencia o en caso de abandono indebido del servicio, el prestador deberá constituir, antes de iniciar su actividad, una garantía a favor del Presidente de la Autoridad Portuaria, cuya cuantía será de al menos 100.000 euros para las licencias establecidas en la prescripción 4.ª 1. Para licencias de manipulación de mercancías para pesca congelada a granel/paletizada (no contenerizada), en razón de su notable menor volumen de actividad y requerimiento de medios, dicha garantía se establece en 22.500 euros.
...
8. Cuando, por aplicación de lo dispuesto en los párrafos anteriores, la Autoridad Portuaria tuviese que hacer uso de la garantía, total o parcialmente, el prestador vendrá obligado a reponerla o complementarla en el plazo de un mes, contado desde el acto de disposición. Si el interesado, previo requerimiento, no restituyese o completase la garantía en el referido plazo, la Autoridad Portuaria podrá extinguir la licencia, así como emprender las acciones legales que considere oportunas.
...
a. Por cada día de retraso injustificado en el inicio en la prestación del servicio una vez transcurrido al plazo indicado en este Pliego tras el otorgamiento de la licencia: hasta 100 euros/día.

b. Incumplimiento de la atención a la solicitud de un servicio solicitado, de forma no justificada ante la Autoridad Portuaria: hasta 2.500 euros/servicio.

c. Retraso de una hora en el inicio de las operaciones, de forma no justificada ante la Autoridad Portuaria: 1.000 euros/servicio.

d. Incumplimiento de los indicadores de calidad establecidos en la prescripción 17.b: 3.000 euros por incumplimiento del indicador en el periodo establecido.
...
4. Además, se establece una penalización de 500 euros anuales por no incorporar en la Memoria de las cuentas anuales la separación contable.
...
a. Valor de la tasa será de 0,025 euros/Tn de mercancía manipulada.
...
4. En el caso que la actividad se desarrolle en un espacio concesionado, no se devengará tasa de actividad adicional a la que se haya establecido en el pliego de condiciones de la concesión, siempre y cuando se haya previsto expresamente en el título concesional para la actividad correspondiente al servicio portuario de manipulación de mercancías.
...
Los titulares de licencias para la prestación del servicio deberán solicitar nueva licencia adaptada a las presentes prescripciones particulares en el plazo de dos meses desde que éstas entren en vigor, adaptándose a las prescripciones contenidas en el presente pliego.
...
3. Designación de un representante, con facultades suficientes y con oficina en la provincia de Pontevedra, a los efectos de establecer una comunicación regular con la Autoridad Portuaria.
...
3. Compromiso de contratar, antes del inicio de la actividad, un seguro de responsabilidad civil que cubra los riesgos propios de la prestación del servicio por la cantidad mínima establecida en la prescripción 17.ª y de presentar la documentación acreditativa una vez contratado.
...
7. Compromiso expreso de cumplimiento la normativa laboral vigente respecto de los trabajadores integrados en su plantilla para realizar las actividades que integran el servicio de manipulación de mercancías (estibadores portuarios de relación laboral común), particularmente respecto de la cualificación exigida, con relación de personal homologado conforme al artículo 3 del Real Decreto-ley 8/2017, de 12 de mayo.
...
Para lo cual, autorizo el tratamiento de los datos personales recogidos en la solicitud de licencia de prestación del servicio portuario de manipulación de mercancías, que son necesarios y serán utilizados por la Autoridad Portuaria de Marín y Ría de Pontevedra para el otorgamiento de la licencia solicitada, así como durante toda la duración de la misma.
