---
identificador: "BOE-A-2026-14623"
titulo: "Resolución de 30 de junio de 2026, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala Básica de Apoyo a la Docencia y a la Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 93188
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-14623"
url_pdf: "https://www.boe.es/boe/dias/2026/07/06/pdfs/BOE-A-2026-14623.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-14623"
url_eli: ""
fetched_at: "2026-07-06T10:56:41Z"
...
Se convoca proceso selectivo de acceso libre para la cobertura de una plaza de personal funcionario perteneciente a la Escala Básica de Apoyo a la Docencia y a la Investigación de la Universidad de Granada, Grupo C, Subgrupo C1 (Técnico/a de Laboratorio en el Departamento de Mecánica de Estructuras e Ingeniería Hidráulica).
...
1.4 La fase de oposición se desarrollará mediante los ejercicios y con las puntuaciones establecidos en el anexo II de la presente convocatoria, siendo el programa de materias en que se basarán aquellos el contenido en el anexo I. La fecha y el lugar de realización del primer ejercicio de la fase de oposición, que no podrá iniciarse antes del día 1 de noviembre de 2026, se fijarán en la forma establecida en la base 4.1 de la presente convocatoria.
...
1. Materiales estructurales y de experimentación. Materiales metálicos, hormigón, morteros, madera, materiales compuestos, polímeros reforzados con fibras, mampostería, fábrica y tapia. Propiedades físicas, mecánicas y de durabilidad. Comportamiento resistente, deformacional y dinámico. Aplicaciones, limitaciones y criterios de selección de materiales para la fabricación de especímenes, montajes experimentales, elementos auxiliares e instrumentación de ensayos estructurales.

2. Tecnología del hormigón y de otros materiales estructurales. Componentes, dosificación, amasado, transporte, vertido, compactación, vibrado, curado y control básico del hormigón. Preparación de morteros, fábricas, elementos de mampostería, tapia y otros geomateriales para investigación estructural. Ensayos de caracterización del material (resistencia y módulo de elasticidad). Armaduras pasivas: identificación, corte, doblado, montaje y disposición. Consideraciones básicas sobre adherencia, recubrimiento, juntas, curado, retracción y control de fabricación de especímenes.

3. Procesos de fabricación y preparación de especímenes estructurales. Operaciones de corte, conformado, perforado, mecanizado, ajuste, unión y montaje de elementos metálicos, de madera y auxiliares de ensayo. Preparación de encofrados, armados, zapatas, vigas, pilares, forjados, muros, paneles, nudos y especímenes a escala o de gran formato. Manejo de adhesivos epoxi para la elaboración de polímeros reforzados con fibras de carbono, vidrio o aramida. Requisitos de los materiales de partida, consideraciones operativas durante la fabricación y actuaciones posteriores al procesado.

4. Ensayos dinámicos con mesa sísmica de estructuras de hormigón, acero y mixtas, con y sistemas de control dinámico (disipadores pasivos histeréticos y/o viscosos, aislamiento de base, sistemas inerciales…): Lectura, interpretación y desglose de planos de los proyectos a realizar. Replanteo, acondicionamiento y aprovechamiento del espacio de trabajo, para optimización del mismo. Instrumentación general, fijadores bicomponentes, tornillos pasantes, estructuras auxiliares, soldaduras mixtas, etc.

5. Soldadura y uniones en montajes experimentales. Fundamentos, equipos y aplicaciones de soldadura. Uniones atornilladas, anclajes mecánicos, anclajes químicos, tornillería pasante, fijadores bicomponentes y sistemas mixtos de unión. Criterios básicos de ejecución, inspección visual, seguridad y adecuación al uso en montajes estructurales y bastidores auxiliares de ensayo.

6. Herramientas manuales y máquinas-herramienta convencionales. Sierras, taladros, taladro vertical, esmeriladoras, lijadoras, radiales, sierras de sable y circulares, dobladoras, hormigoneras, amasadoras, vibradores eléctricos y equipos auxiliares. Tipos, partes principales, útiles y accesorios. Operaciones básicas, condiciones de uso, mantenimiento preventivo y correctivo y seguridad asociada.

7. Fabricación y montaje de ensayos de grandes elementos estructurales. Lectura, interpretación y desglose de planos y documentación técnica. Replanteo, organización del espacio de trabajo y secuencia de montaje. Instalación de especímenes, marcos de carga, estructuras auxiliares, masas adicionales, planchas de sobrecarga, utillaje y sistemas de fijación. Nivelación, aplomado, anclaje y comprobaciones previas al ensayo.

8. Actuadores, pórticos de carga y sistemas hidráulicos. Principios de funcionamiento de actuadores estáticos y dinámicos. Pórticos de carga móviles. Centrales hidráulicas, acumuladores, aceite hidráulico, circuitos, conexiones y elementos auxiliares. Operaciones básicas de verificación, calentamiento, seguimiento del funcionamiento, detección de incidencias, mantenimiento preventivo y control de condiciones de seguridad.

9. Mesa sísmica y ensayos dinámicos. Fundamentos de la excitación dinámica y de la respuesta estructural. Operación básica de mesa sísmica biaxial. Preparación del espécimen, anclaje a bancada o mesa, sincronización con la adquisición de datos, comprobaciones previas, protocolos de seguridad, supervisión del ensayo, parada segura e inspección posterior. Campañas de caracterización dinámica y ensayos de resistencia sísmica.

10. Instrumentación de ensayos estructurales. Principios de funcionamiento, instalación, protección y verificación de sensores de desplazamiento, LVDTs, acelerómetros, células de carga, galgas extensométricas, láseres, telémetros y otros dispositivos de medida. Criterios de selección según el objetivo del ensayo. Preparación de cableado, conectores, acondicionamiento de señal, soldadura electrónica básica y comprobación de continuidad y funcionamiento. Calibración de sensores de fuerza, desplazamiento y aceleración mediante sensores de control.

11. Adquisición, registro y gestión de datos experimentales. Sistemas de adquisición de datos aplicados a ensayos estructurales estáticos y dinámicos. Configuración básica de canales, sincronización, verificación previa, almacenamiento, organización, respaldo y trazabilidad de los datos. Incidencias habituales de adquisición, ruido, pérdida de señal, saturación y comprobaciones elementales de calidad del dato experimental.

12. Metrología y verificación en laboratorio estructural. Conceptos de medida, unidades, errores, incertidumbre y trazabilidad. Instrumentos de medida directa e indirecta aplicados al montaje experimental. Verificación geométrica, nivelación, alineación, perpendicularidad, paralelismo, tolerancias de montaje y control dimensional básico de elementos, útiles, anclajes y dispositivos de ensayo. Verificación, calibración y mantenimiento básico de instrumentos y equipos de medida.

13. Mantenimiento de instalaciones experimentales. Tipología de averías en pórticos, actuadores, mesa sísmica, puentes grúa, máquinas de taller, sistemas hidráulicos y equipos de adquisición. Planificación del mantenimiento preventivo y correctivo. Control de repuestos, consumibles, accesorios y documentación técnica asociada. Revisión de anclajes, conexiones, cableado, niveles, engrase y estado general de los equipos e instalaciones.

14. Seguridad en el laboratorio de estructuras. Riesgos asociados al manejo de cargas suspendidas, puente grúa, elementos pesados, sistemas hidráulicos, máquinas-herramienta, soldadura, electricidad, polvo, ruido, vibraciones y demolición de especímenes. Evaluación básica de riesgos, medidas preventivas, señalización, delimitación de zonas de trabajo, maniobras críticas, procedimientos de trabajo seguro, actuaciones en caso de incidencia y equipos de protección individual.

15. Gestión técnica del laboratorio. Organización operativa del espacio de ensayo. Inventario de equipos activos e inactivos. Gestión de proveedores, compras, averías, control de existencias y material fungible. Preparación logística de campañas experimentales. Coordinación básica con personal docente e investigador. Conservación del orden operativo del laboratorio y apoyo a actividades docentes, de investigación, transferencia y divulgación.

16. Gestión de residuos y sostenibilidad en el entorno experimental. Residuos metálicos, inertes, envases, restos de hormigón, madera, componentes eléctricos, consumibles de soldadura, aceites y otros residuos asociados a la actividad del laboratorio. Segregación, almacenamiento temporal, retirada y gestión conforme a normativa aplicable. Uso eficiente de materiales, reutilización de utillaje y buenas prácticas de sostenibilidad en campañas experimentales.
