---
identificador: "BOE-A-2026-14292"
...
pagina_final: 90825
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-14292"
url_pdf: "https://www.boe.es/boe/dias/2026/07/01/pdfs/BOE-A-2026-14292.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-14292"
url_eli: ""
fetched_at: "2026-07-01T10:35:08Z"
...
Con fecha 1 de marzo de 2026, doña M. C. P. P. presentó telemáticamente en el Registro de la Propiedad de San Cristóbal de La Laguna número 1 y 3-Área Metropolitana de Santa Cruz de Tenerife solicitud de depósito de alquiler de corta duración, con número de entrada 2.919/2026.

II

Presentada dicha solicitud en el Registro de la Propiedad de San Cristóbal de La Laguna número 1 y 3-Área Metropolitana de Santa Cruz de Tenerife, fue objeto de la siguiente nota de calificación negativa:

«Datos Entrada.

N.º Entrada: 2919

Fecha: 01/03/2026 Hora: 20:49:26

Naturaleza: Documento Privado

N.º Protocolo: deposito NRUA/
...
Se deniega el asiento de presentación del precedente documento ya que no figura la finca sobre la que inscribir el depósito modelo informativo de arrendamiento de corta duración.

Contra la presente calificación (…)

Este documento incorpora un sello electrónico para garantizar su origen e integridad creado por el Registro Propiedad de San Cristóbal de La Laguna 1 a día dos de marzo del dos mil veintiséis.»

III

Contra la anterior nota de calificación, doña M. C. P. P. interpuso recurso alegando lo siguiente:

«Primero. Que con fecha 2 de marzo de 2026 se notificó la denegación de asiento de presentación relativo al depósito del modelo informativo de arrendamiento de corta duración, correspondiente a la finca registral n.º 92935 del término municipal de San Cristóbal de La Laguna, fundamentándose la denegación en que: “No figura la sobre la que inscribir el depósito modelo informativo de arrendamiento de duración.”

Es por ello que, al amparo del artículo 246.3 de la Ley Hipotecaria, se interpone en tiempo y forma el presente recurso.

Segundo. Que la finca registral N.º 92935 consta inscrita y vigente en ese Registro, tal como resulta de certificación registral expedida con fecha 071072025, en la que consta: Finca: 92935, CRU: 38010000410917 (…) Asimismo, figura extendida nota marginal relativa al Número de Registro de Alquiler de Corta Duración (NRA), en estado activo.

Tercero. Que en certificación de despacho relativa a la asignación del Número de Registro de Alquiler de fecha 07/07/2025 consta Finca 92935 CRU: 38010001360396 y finca 41725 4 CRU: 38010000410917 (…)

Ello evidenciaba una discordancia objetiva en la asignación del Código Registral Único, al aparecer la finca 92935 vinculada a dos CRU distintos según la documentación considerada.

Debe señalarse igualmente que, al iniciar el trámite telemático del depósito del NRUA (01/03/2026) en N2, al añadir el NRUA: (…) el sistema autocompletaba el CRU 38010001360396, lo que demuestra que la identificación procedía de la propia base de datos registral y no de una introducción manual por parte del interesado.

Cuarto. Que con fecha 07/07/2025, es decir, con anterioridad tanto a la presentación del depósito (01/03/2026) como a la posterior denegación, este Registro notificó expresamente que a la solicitud remitida le correspondía de forma definitiva el siguiente Número de Registro de Alquiler: (…), asociado al CRU: 38010000410917. En consecuencia, al tiempo de presentarse el depósito el 01/03/2026, la finca estaba perfectamente identificada y reconocida por el propio Registro. No obstante, como se ha mencionado, no se podía modificar en el programa N2 el CRU a dicho Número de Registro de Alquiler.

Quinto. Que no procede la denegación, debido a que, la afirmación de que “no figura la finca” carece de sustento fáctico y jurídico. Se trata de un error interno del Registro, ya que se ha vinculado la finca con dos CRU distintos, lo cual tiene que ser modificado, no pudiendo perjudicar al interesado en este acto, conforme al principio de seguridad jurídica.

Sexto. Que para el caso de apreciarse error material previo en la consignación del Código Registral Único en alguna certificación, se interesa expresamente la rectificación registral correspondiente, sin que ello afecta al derecho a la práctica del asiento de presentación solicitado.»
...
1. La presente Resolución tiene por objeto la negativa del registrador de la propiedad a practicar el asiento de presentación de una solicitud de depósito de arrendamiento de corta duración.

El registrador califica negativamente, señalando, resumidamente que «(…) no figura la finca sobre la que inscribir el depósito modelo informativo de arrendamiento de corta duración».

La recurrente manifiesta que de los datos del registro y de la solicitud resulta la finca registral a la que se hace referencia.
...
4. En el presente expediente, siendo el depósito de arrendamientos de corta duración un procedimiento telemático que se realiza mediante presentación electrónica, es el interesado el que rellena los diferentes campos mediante la sede electrónica, llegando al Registro dicha presentación sin posibilidad de modificación. Los datos consignados en el modelo N2 se codifican en formato XBLR y se comprimen en un archivo con extensión.ZIP en el que se presenta como dato adjunto en la plataforma.

Al realizar la presentación de dicho archivo se vuelve a solicitar que introduzca el número de finca registral para efectuar la correcta presentación del mismo sobre la finca sobre la que se pretende la inscripción, tal y como señala el artículo 251 de la Ley Hipotecaria. Parece ser que es este último paso el que no se ejecuta correctamente porque la presentación telemática que entra en el Registro no tiene finca asociada.

Siendo una entrada telemática que no permite modificación por parte de este Registro, tal y como se señala en el artículo 251 citado, y aun cuando de los archivos adjuntos se pueda inferir cuál es la finca, al no estar específicamente indicada por su presentante y no estar sujeta a posibles cambios ni modificaciones dicha presentación telemática, no cabe otro proceder que la denegación del asiento de presentación al no poder crear un asiento pendiente sobre finca alguna.
