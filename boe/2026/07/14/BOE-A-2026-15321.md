---
identificador: "BOE-A-2026-15321"
...
pagina_final: 98070
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-15321"
url_pdf: "https://www.boe.es/boe/dias/2026/07/14/pdfs/BOE-A-2026-15321.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-15321"
url_eli: ""
fetched_at: "2026-07-14T09:57:48Z"
...
Se incluye en este concurso un puesto de vigencia temporal, identificado en el anexo de puestos con la clave V.T. Este puesto ha sido creado al amparo de las previsiones contenidas en el Real Decreto-ley 36/2020, de 30 de diciembre, por el que se aprueban medidas urgentes para la modernización de la Administración Pública y para la ejecución del Plan de Recuperación, Transformación y Resiliencia.

Una vez que finalice la vigencia del mismo se adoptará, con respecto a la persona que lo ocupe, las medidas de provisión establecidas en el artículo 63 del Reglamento General de Ingreso del Personal al servicio de la Administración General del Estado y de Provisión de Puestos de Trabajo y Promoción Profesional de los Funcionarios Civiles de la Administración General del Estado, aprobado por Real Decreto de 365/1995, de 10 de marzo.
...
Únicamente se podrán valorar los cursos que previamente figuren incluidos en el listado anual de cursos publicado por el Departamento u Organismo convocante, y en el área de conocimiento al que pertenezca el puesto objeto de valoración, que aparecen publicados en la página web del Departamento:https://www.mites.gob.es/ficheros/ministerio/informacion/oposicion/funcionario/PERFILES-FORMATIVOS-Concursos-ESPECIFICOS-Departamento.
...
Madrid, 2 de julio de 2026.–El Subsecretario de Trabajo y Economía Social, José Ramón del Prado Cortés.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1 | 4985599 | JEFE / JEFA DE SECCION DE APOYO | - MADRID
 - MADRID | 22 | 5.215,28 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión del Portal de Transparencia, incluyendo el manejo de las aplicaciones Gesat2 y Acceda2, elaborando propuestas de resolución y tareas de coordinación.
 - Gestión técnica, a través de la aplicación Cortesía, de las iniciativas parlamentarias del Congreso y del Senado, relacionadas con la materia laboral.
 - Gestión de la coordinación de las consultas de Comunicación con la Ciudanía a través de FORMUGABADM, elaboración de las respuestas y coordinación técnica con las unidades dependientes.
 ...
 **Méritos específicos:**
 ...
 1. Experiencia en tares similares a las de la función 1 (máx: 10,00 pts.).
 2. Experiencia en tares similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tares similares a las de la función 3 (máx: 5,00 pts.). |  |

| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 CD | CE | GR/
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 1 | 5527005 | SECRETARIO / SECRETARIA DE SUBDIRECTOR GENERTAL | - MADRID
 - MADRID | 16 | 7.591,50 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tareas relacionadas con secretaria: recepción de llamadas, gestión del correo, agenda, calendario y registro de documentos.
 - Apoyo en las tareas administrativas, distribución y archivo de documentos.
 - Realización de comisiones de servicios y gestión de expedientes de anticipo de caja fija.
 - Manejo de aplicaciones informáticas de firma electrónica, Geiser, Sorolla, Word, Excel y Outlook.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3 | 1 | 1578814 | JEFE / JEFA DE SERVICIO | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación de contratos de servicios y suministros, encargos a medios propios, contratos menores, contratos basados en acuerdos marco y sistemas dinámicos de adquisición, y la preparación de la licitación en el perfil de órgano de contratación.
 - Secretaría de las Junta y Mesas de Contratación, incluyendo la configuración de las sesiones como órgano de asistencia y la preparación documentación para sesiones y actuaciones previas y posteriores a la apertura de sobres, e incidencias.
 - Elaboración de pliegos de cláusulas administrativas particulares, y gestión integral de las licitaciones, incidencias y redacción de documentos relativos a los expedientes de contratación, así como la gestión y distribución de los expedientes con el equipo.
 - Manejo de aplicaciones corporativas para la tramitación de expedientes de contratación, registro y notificación electrónica: Plataforma de Contratación, GEISER, SOROLLA2, SIC3, CORENET, DOCELWEB, AUNA, Cliente Ligero, ALMACÉN y NOTIFICA.
...
| 4 | 1 | 2781750 | JEFE / JEFA DE SERVICIO | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación de procedimientos de contratación pública, elaboración de pliegos y colaboración con las unidades proponentes en materia de contratación y tramitación de expedientes de contratación centralizada a través de la plataforma AUNA.
 - Tramitación de expedientes de contratación a través de la aplicación SOROLLA2, elaboración de documentos contables, remisión a la Intervención Delegada de la documentación administrativa y contable y subsanación de reparos.
 - Publicación en la Plataforma de Contratación del Sector Público, DOUE y BOE y remisión de contratos al Tribunal de Cuentas y al Registro de Contratos del Sector Público.
 - Revisión y control de las facturas correspondientes a cada contrato, elaboración y tramitación de los documentos contables y manejo de aplicaciones para el control de facturas de contratos centralizados (Mercurio) y COREnet.
 ...
 **Méritos específicos:**
 ...
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 5 | 1 | 2956197 | JEFE / JEFA DE SERVICIO DE ADMINISTRACION FINANCIERA | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Experiencia en la tramitación de expedientes de indemnización por razón del servicio del personal que se traslada desde el exterior.
 - Control, revisión y gestión de libramientos a favor de las cajas pagadoras en el exterior, mediante el procedimiento de pagos a justificar, anticipos de caja fija, pagos en firme y tramitación de las correspondientes cuentas justificativas, incluyendo su remisión al Tribunal de Cuentas.
 - Experiencia en la tramitación de expedientes de contratación en el exterior, gestión del presupuesto de las cajas pagadoras en el exterior y gestión de incrementos presupuestarios y de reintegros al Tesoro Público.
 - Revisión, seguimiento y control de la tesorería de las cajas pagadoras en el exterior (cuentas de gestión y estados de situación de tesorería), así como tramitación de apertura, renovación y cancelación de cuentas bancarias.
...
| 6 | 1 | 3301315 | JEFE / JEFA DE SERVICIO | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación y elaboración del presupuesto de gastos y de los presupuestos de gastos e ingresos de los Organismos Autónomos, resto de entidades de derecho público y fundaciones del sector público.
 - Tramitación y elaboración de los expedientes de modificaciones presupuestarias.
 - Seguimiento de ejecución presupuestaria.
 - Manejo de las aplicaciones informáticas relacionadas con la gestión presupuestaria (Adenda, Quanto, Quadro-Sigma, Atenea, Financia).
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 7 | 1 | 4727897 | JEFE / JEFA DE AREA DE PROYECTOS Y OBRAS | - MADRID
 - MADRID | 28 | 19.667,48 | A1 | A3 | EX11 | B001 |  |  | **Descripción del puesto de trabajo:**
 
 - Planificación, gestión y coordinación de contratos de redacción de proyectos, dirección facultativa, seguridad y salud, de obras en inmuebles, así como el seguimiento y supervisión de la ejecución material, presupuestaria y recepción de los mismos, incluyendo la supervisión de los proyectos.
 - Elaboración de pliegos para la contratación de obras, servicios de redacción de proyectos, dirección de obras, seguridad y salud y redacción de informes técnicos para la valoración de ofertas en licitaciones públicas y asistencia a Mesas y Juntas de Contratación.
 - Redacción de informes sobre el estado de los edificios, estudio de necesidades y determinación de las actuaciones necesarias para su conservación y mantenimiento.
 - Coordinación de equipos de trabajo y relación con otras Administraciones, Organismos, Ayuntamientos, Comunidades Autónomas y con las organizaciones usuarias de edificios del Patrimonio Sindical -sindicatos de trabajadores y organizaciones empresariales- en el marco de la gestión de los expedientes de obra y licencias.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 4,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 6,00 pts.). |  |
| 8 | 1 | 2454567 | JEFE / JEFA DE SERVICIO DE OFICINA DE SUPERVISION DE PROYECTOS | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Redacción de informes de supervisión de proyectos, seguimiento y supervisión de proyectos básicos y de ejecución de obras e instalaciones y de las liquidaciones de obras que afectan a los inmuebles.
 - Elaboración de memorias, pliegos de prescripciones técnicas y pliegos de cláusulas administrativas orientados a la contratación de expedientes de suministros, obras y servicios.
 - Información y asesoramiento al Órgano de Contratación sobre los criterios y orientaciones de carácter técnico en contratos de obras y emisión de informes técnicos sobre los proyectos y obras que se soliciten, valoración de ofertas y a la redacción de informes técnicos en las licitaciones.
 - Inspección de edificios y elaboración de informes técnicos el estado de inmuebles.
...
| 9 | 1 | 3995454 | JEFE / JEFA DE SERVICIO | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX21 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión presupuestaria, económica y financiera y redacción de documentación y tramitación de expedientes administrativos, de gasto y de formalización de documentos contables, relativos a suministros, obras y servicios asociados a obras a través de la Plataforma de Contratación del Sector Público, Sorolla, Docelweb, SIC3 y CORENET.
 - Apoyo y elaboración de documentación en todas las fases hasta su recepción y seguimiento posterior de los expedientes de gasto vinculados a encargos, servicios y obras financiados a cargo de fondos europeos, tanto FEDER como del Plan de Recuperación, Transformación y Resiliencia, en el ámbito de inmuebles integrados en el Patrimonio Sindical Acumulado.
 - Gestión y tramitación documental derivadas del seguimiento de los expedientes financiados a cargo de fondos europeos mediante el manejo de los softwares informáticos relativos a las ayudas de la unión europea: Tramita, CoFFEE, MINERVA.
 - Elaboración, gestión y tramitación de expedientes de gastos derivados de procesos de recursos, indemnizaciones y penalidades vinculados a expedientes de contratación de obras y servicios asociados a obras.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 10 | 1 | 2315415 | JEFE / JEFA DE SERVICIO DE COORDINACION INFORMATICA | - MADRID
 - MADRID | 26 | 17.092,74 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Administración y migración de servidores de aplicaciones JBOSS y administración de servicios Apache Web Server.
 - Administración y migración de Sistemas Gestores de Base de datos Oracle.
 - Administración y migración de Sistemas Gestores de Base de datos SQL Server y PostgreSQL.
 - Gestión de de herramientas de ticketing: SysAid y JIRA.
 ...
 **Méritos específicos:**
 ...
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 11 | 1 | 4605592 | JEFE / JEFA DE PROYECTO SISTEMAS INFORMATICOS | - MADRID
 - MADRID | 26 | 17.092,74 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Dirección, gestión de proyectos y coordinación de equipos de trabajo de desarrollo en las aplicaciones/entornos referentes a la Declaración de Partes de accidentes de Trabajo, así como de las aplicaciones para la gestión de datos estadísticos.
 - Dirección, gestión de proyectos y coordinación de equipos de trabajo de desarrollo en las aplicaciones/entornos referentes al Registro de Empresas Acreditadas y Servicios de Prevención Ajenos.
 - Dirección, gestión de proyectos y coordinación de equipos de trabajo de desarrollo en las aplicaciones/entornos referentes al Sistema Integral de Gestión para Empresas de Trabajo Temporal.
 - Planificación, dirección, coordinación y seguimiento de proyectos de desarrollo software haciendo uso de las tecnologías Angular SPA, Dintel, Java 11, servidor de aplicaciones JBoss 7.2, servidor web Apache HTTP server y base de datos Oracle; así como de las herramientas de desarrollo Maven, Jira, Artifactory y Jenkins.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 7,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 12 | 1 | 4236803 | JEFE / JEFA DE SERVICIO DE SISTEMAS INFORMATICOS | - MADRID
 - MADRID | 26 | 13.829,34 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión de EDR’s (Falcon Crowdstrike , MicroClaudia) para la correcta protección de los endpoints e identidades.
 - Manejo de soluciones BAS (Breach and Attack Simulation) automatizadas para la validación de la seguridad (BAS Keysight).
 - Manejo de soluciones PAM (Priviledge Access Management) para el control de acceso de cuentas privilegiadas (CyberArk PAM).
 - Interlocución con el COCs y gestión de los servicios ofrecidos por este para garantizar la protección de los sistemas (Prevención, Detección, Respuesta).
 ...
 **Méritos específicos:**
 ...
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 13 | 1 | 4686347 | JEFE / JEFA DE SERVICIO DE SISTEMAS INFORMATICOS | - MADRID
 - MADRID | 26 | 13.829,34 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Coordinación y supervisión de la tramitación de expedientes de contratación de bienes y servicios en materia TIC (Tecnologías de la Información y Comunicaciones), dirigiendo la elaboración de pliegos de prescripciones técnicas, memorias justificativas, documentos de licitación e invitación, informes de valoración y demás documentación integrante de los expedientes administrativos contractuales.
 - Coordinación del seguimiento y control de la ejecución de contratos en materia TIC: control de plazos, prórrogas, modificaciones e incidencias administrativas; planificación y seguimiento de la ejecución presupuestaria con cargo a presupuesto ordinario y fondos europeos de la contratación.
 - Gestión y coordinación de los procedimientos de contratación en materia TIC mediante el uso de herramientas de gestión y consulta administrativa (Sorolla2, CoFFEE, GECOTIC, CMADWeb, etc.), gestión de los procedimientos de licitación de contratación centralizada TIC, a través de la Plataforma de Contratación del Sector Público, ejerciendo la secretaría de los órganos de asistencia en dichos procedimientos.
 - Representación del centro gestor ante la Junta de Contratación y la Comisión Ministerial de Administración Digital.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 14 | 1 | 4686275 | TECNICO / TECNICA DE GESTION | - MADRID
 - MADRID | 22 | 5.215,28 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Mantenimiento y gestión de las aplicaciones de Planes de Formación, Gestión de Expedientes Normativos, Librería de Publicaciones, Gestión de Medallas al Mérito al Trabajo y Gestión de Relojes de Fichaje.
 - Gestión y mantenimiento de Cuadros de Mando estratégicos de CAU Externo, CAU Interno y Ciberseguridad mediante soluciones de Business Intelligence con MicroStrategy y Google Analytics para el seguimiento y análisis de KPIs.
 - Elaboración de planes de pruebas y definición de casos de uso utilizando TestLink, junto con la automatización y ejecución de pruebas mediante Selenium, así como análisis y estimación de requisitos con Puntos de Función para la planificación y dimensionamiento de proyectos.
 - Gestión de aplicaciones web en Java J2EE sobre servidores JBoss 7.2 y Apache con base de datos Oracle, incluyendo integración con soluciones horizontales de la AGE (Portafirmas, Candela, Notifica y Cl@ve), así como gestión de entornos de integración continua mediante SVN, Artifactory y Jenkins, con control de versiones y distribución de paquetes.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 15 | 1 | 1583969 | ANALISTA DE SISTEMAS | - MADRID
 - MADRID | 22 | 11.220,72 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Administración de almacenamiento (HP 3PAR, Windows System Storage Server, TrueNAS, NetApp FAS 8500 con NDMP, Pure Storage series /C y /X con Active Cluster/Active Workload/ActiveDR).
 - Configuración y Administración de red SAN (switches Broadcom Brocade 6510/6520 y Dell Connectrix DS-7720B/DS-7730B).
 - Administración, configuración y actualización de infraestructura VMware vSphere y consolidación de clústeres para optimización de carga y recursos.
 - Instalación y configuración de herramientas de monitorización (Nagios, Grafana, Cockpit, NABox, Secure Connect Gateway).
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 16 | 1 | 4718961 | ANALISTA DE SISTEMAS | - MADRID
 - MADRID | 22 | 11.220,72 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión de la Oficina virtual de Registro de Firma Electrónica, interlocución con la FNMT-RCM para gestión de usuarios registradores y acreditación de la identidad en la emisión de certificados electrónicos.
 - Tareas en materia de Recursos Humanos,gestión de autorizaciones de acceso y gestión de solicitudes de material.
 - Gestión y seguimiento de incidencias y peticiones de tecnologías de la información y comunicaciones, alta, seguimiento y resolución de incidencias a través de herramientas de ticketing (Jira, SysAid) e interlocución con los usuarios.
 - Participación en la redacción, corrección y maquetación de los manuales técnicos e instrucciones dirigidos tanto al personal interno como externo.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 17 | 1 | 3451153 | CONSEJERO TECNICO / CONSEJERA TECNICA | - MADRID
 - MADRID | 28 | 17.092,74 | A1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Elaboración de informes y respuestas oficiales, coordinación intra- e interministerial y seguimiento posterior de estas tareas, relativos a políticas públicas de empleo, transformaciones del mercado laboral, igualdad salarial y adaptación a la transición digital y verde, en el contexto internacional.
 - Participación en la Delegación española ante OCDE y seguimiento de los trabajos desarrollados en comités y grupos de trabajo de OCDE específicamente relacionados con el empleo, el mercado laboral y las políticas públicas en estos ámbitos.
 - Preparación de informes en la actividad de reporte sobre los asuntos de empleo y derechos humanos para el Comité de Derechos Humanos de Naciones Unidas, a través de la Oficina de Derechos Humanos.
 - Apoyo en las tareas de documentación para las relaciones internacionales a nivel bilateral y colaboración en las tareas de información y reporte a nivel multilateral.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 18 | 1 | 2561929 | JEFE / JEFA DE SERVICIO DE PUBLICACIONES | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Confección de pliegos para edición de publicaciones y relación con empresas de maquetación e impresión.
 - Maquetación y edición de publicaciones en formato PDF y EPUB, con ADOBE INDESIGN, ACROBAT PRO y SIGIL, y en formato web con OPEN CMS y diseño de creatividades con ADOBE PHOTOSHOP.
 - Gestión de proyectos de aplicaciones de librerías virtuales, con pasarela de pago preferentemente Redsys, a nivel de análisis y diseño de correctivos y evolutivos, gestión de incidencias de usuarios, generación de informes y difusión de publicaciones en redes sociales.
 - Programación y producción editorial: Seguimiento y control de la ejecución de Programas Editoriales, con la aplicación SICOPO, gestión y mantenimiento de identificadores digitales de objeto.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 19 | 1 | 4411631 | JEFE / JEFA DE AREA | - MADRID
 - MADRID | 28 | 17.092,74 | A1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Participación en la gestión de proyectos y equipos, utilizando como idioma de trabajo el inglés.
 - Seguimiento económico y presupuestario del gasto mediante Sorolla2.
 - Preparación de expedientes para contratos de asistencia técnica.
 - Seguimiento y control de la ejecución de contratos.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 20 | 1 | 2683708 | JEFE / JEFA DE SERVICIO | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tratamiento, depuración, validación, explotación y difusión de estadísticas en materia de economía social, mediante el uso de software estadístico y explotación de los datos procedentes del Sistema de Información del Registro de Cooperativas.
 - Tratamiento, depuración, validación, explotación y difusión de la Estadística de Empresas de Trabajo Temporal, mediante el uso de software estadístico y explotación de los datos procedentes del Sistema de Gestión de Empresas de Trabajo Temporal (SIGETT).
 - Gestión de peticiones a medida y resolución de consultas técnicas estadísticas en materia de economía social y de empresas de trabajo temporal.
 - Revisión y explotación de la información contenida en los ficheros procedentes de Seguridad Social, relativos a cuentas de cotización y a trabajadores del régimen especial de trabajadores autónomos, y de SEPE, relativos a contratos, demandantes de empleo y paro registrado.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 6,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 3,00 pts.). |  |
| 21 | 1 | 2540254 | JEFE / JEFA DE SECCION DE ESTADISTICA N24 | - MADRID
 - MADRID | 24 | 7.591,50 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tratamiento de información relacionada con áreas de seguridad social o empleo.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 22 | 1 | 3393663 | JEFE / JEFA DE AREA | - MADRID
 - MADRID | 28 | 17.092,74 | A1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación de expedientes y elaboración de informes y resoluciones en materia de regulación de empleo: despidos colectivos, ERTE, Mecanismo RED, etc.
 - Tramitación de expedientes y preparación de resoluciones en materia de gestión de ayudas previas a la jubilación ordinaria en el sistema de la Seguridad Social, así como de las ayudas extraordinarias a trabajadores afectados por procesos de reestructuración de empresas, o asimilables.
 - Tramitación de expedientes administrativos del área de relaciones laborales (procedimientos sancionadores, empresas de trabajo temporal, elecciones sindicales, etc.).
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 23 | 1 | 1026948 | JEFE / JEFA DE SECCION DE APOYO | - MADRID
 - MADRID | 24 | 5.720,82 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación de convenios colectivos: control previo de legalidad y registro de convenios y otros acuerdos colectivos de trabajo.
 - Tramitación de planes de igualdad: tramitación y registro en la aplicación REGCON.
 - Tramitación de otros expedientes de negociación colectiva (denuncias de convenios, protocolos contra el acoso, etc).
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 24 | 1 | 1825859 | JEFE / JEFA DE AREA | - MADRID
 - MADRID | 28 | 17.092,74 | A1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Elaboración de respuestas a consultas jurídicas en materia de derecho laboral y administrativo.
 - Redacción de informes jurídicos en materia de derecho administrativo y laboral.
 - Elaboración de notas y respuesta a preguntas parlamentarias en materia de derecho administrativo y laboral.
 - Resolución de consultas del portal de transparencia en materia de derecho administrativo y laboral.
 ...
 **Méritos específicos:**
 ...
 4. Experiencia en tareas similares a las de la función 4 (máx: 8,00 pts.). |  |
| 25 | 1 | 4663650 | CONSEJERO TECNICO / CONSEJERA TECNICA | - MADRID
 - MADRID | 28 | 17.092,74 | A1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Conocimientos en materia de derecho laboral y de prevención de riesgos laborales, especialmente sancionador y de inspección de trabajo.
 - Elaboración de respuestas a consultas técnico-jurídicas en materia de prevención de riesgos laborales y, en particular, en materia de seguridad en el trabajo y procedimiento sancionador.
 - Emisión de informes técnicos en relación con la vigilancia del cumplimiento de la normativa jurídico-técnica con incidencia en materia de prevención de riesgos laborales.
 - Funciones relacionadas con la seguridad y salud en el trabajo, inspección de trabajo, derecho administrativo y laboral.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 3,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 8,00 pts.). |  |
| 26 | 1 | 5592988 | JEFE / JEFA DE SERVICIO | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  | V.T | **Descripción del puesto de trabajo:**
 
 - Preparación y tramitación de proyectos normativos en materia de prevención de riesgos laborales, derecho administrativo y laboral.
 - Elaboración de respuestas a consultas jurídicas de organismos públicos, de organizaciones sindicales y empresariales y de otras entidades y particulares, en materia de prevención de riesgos laborales y, en particular, en materia de seguridad en el trabajo y de derecho administrativo laboral.
 - Participación en ponencias, foros y grupos de trabajo ministeriales e interministeriales, así como internacionales, relacionados en materia de prevención de riesgos laborales y de derecho administrativo laboral.
 - Emisión de informes técnicos en materia de seguridad y salud en el trabajo, inspección de trabajo, derecho administrativo y laboral.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 27 | 1 | 4679256 | JEFE / JEFA DE SERVICIO | - MADRID
 - MADRID | 26 | 13.234,76 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión del Registro Estatal de Asociaciones Profesionales de Personas Trabajadoras Autónomas.
 - Manejo de la aplicación de Gestión Integral de Subvenciones del Trabajo Autónomo (GESTA).
 - Definición, supervisión y seguimiento de proyectos de desarrollo de aplicaciones y páginas web desde la perspectiva de cliente.
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tares similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tares similares a las de la función 3 (máx: 5,00 pts.). |  |
| 28 | 1 | 3772395 | JEFE / JEFA DE SECCION DE GESTION | - MADRID
 - MADRID | 24 | 5.720,82 | A1
 A2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 ...
 - Tramitación de expedientes económicos en Sorolla2.
 ...
 **Méritos específicos:**
 ...
 1. Experiencia en tares similares a las de la función 1 (máx: 15,00 pts.).
 2. Experiencia en tares similares a las de la función 2 (máx: 5,00 pts.).
 3. Experiencia en tares similares a las de la función 3 (máx: 3,00 pts.).
 4. Experiencia en tares similares a las de la función 4 (máx: 2,00 pts.). |  |
| CUERPOS O ESCALAS:
...
| N.º Orden | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1840761 | JEFE / JEFA DE SERVICIO DE SISTEMAS INFORMATICOS | – MADRID
 – MADRID | 26 | 13.829,34 | A1
 A2 | AE | EX11 |  |  |  | Descripción del puesto de trabajo:
 – Manejo de aplicaciones informáticas (INDICADORES, INVAPP y VEGA), gestión de esquemas de base de datos (Oracle y PostgreSQL), despliegue y gestión de máquinas virtuales (Windows y Linux), certificados (sello y SSL), CyberArk e incidencias del Servicio de Innovación para el Desarrollo.
 – Gestión y administración de las herramientas Jira, Drupal, SVN, SonarQube, Artifactory, Jenkins, GitLab, Google Analytics y Strategy.
 – Análisis, diseño, desarrollo, implantación, pruebas y mantenimiento de aplicaciones web (Java J2EE, HTML5, CSS, Javascript y Angular) en servidores web (Apache) y servidores de aplicaciones (JBoss), modelado de datos y desarrollo (PL/SQL) de ETL (Extracción, Transformación y Carga) en base de datos (Oracle y PostgreSQL), gestión de cuadros de mando (Strategy) y automatización de herramientas (Groovy, Javascript y PowerShell).
 – Gestión de cambios tecnológicos, proyectos transversales, procedimientos y apoyo/colaboración a otros servicios de desarrollo.
 Perfil formativo/Cursos de formación:
 – INFORMÁTICA
 Méritos específicos:
 1. Experiencia en tareas similares a las de la función 1 (máx: 5,00 pts.).
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 6,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 2 | 3084396 | JEFE / JEFA DE SERVICIO DE SISTEMAS INFORMATICOS | – MADRID
 – MADRID | 26 | 13.829,34 | A1
 A2 | AE | EX11 |  |  |  | Descripción del puesto de trabajo:
 – Dirección, gestión de proyectos y coordinación de equipos de trabajo de desarrollo en las aplicaciones/entornos referentes a Memorias de Responsabilidad Social de las Empresas y del Registro Estatal de Asociaciones Profesionales de Personas Trabajadoras Autónomas.
 – Dirección, gestión de proyectos y coordinación de equipos de trabajo de desarrollo en las aplicaciones/entornos referentes al Depósito de Estatutos de Organizaciones Sindicales y Empresariales y de las Asistencias Técnicas Internacionales.
 – Dirección, gestión de proyectos y coordinación de equipos de trabajo de desarrollo en la aplicación de la Sede Electrónica.
 – Planificación, dirección, coordinación y seguimiento de proyectos de desarrollo software haciendo uso de las tecnologías Angular SPA, Dintel, Java 11, servidor de aplicaciones JBoss 7.2, servidor web Apache HTTP server y base de datos Oracle; así como de las herramientas de desarrollo Maven, Jira, Artifactory y Jenkins.
 Perfil formativo/Cursos de formación:
 – INFORMÁTICA
 Méritos específicos:
