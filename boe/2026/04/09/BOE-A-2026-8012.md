---
identificador: "BOE-A-2026-8012"
titulo: "Resolución de 26 de marzo de 2026, de la Presidencia de la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P., por la que se publica el Convenio con la Xunta de Galicia, para la realización del proyecto «Evaluación del estado de las poblaciones de zamburiña (\"Mimachlamys varia\") en la ría de Ferrol: un enfoque integral para su conservación y gestión sostenible (Zamfer)»."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 51541
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2026-8012"
url_pdf: "https://www.boe.es/boe/dias/2026/04/09/pdfs/BOE-A-2026-8012.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2026-8012"
url_eli: ""
fetched_at: "2026-04-09T17:58:10Z"
...
## ANEXO. Convenio entre la Consellería del Mar de la Xunta de Galicia y la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P. (CSIC), a través del Instituto de Investigaciones Marinas (IIM), para la realización del proyecto «Evaluación del estado de las poblaciones de zamburiña (*Mimachlamys varia*) en la ría de Ferrol: un enfoque integral para su conservación y gestión sostenible (Zamfer)»
...
Que de acuerdo a lo establecido en el Decreto 149/2024, de 20 de mayo, por el que se aprueba la estructura orgánica de la Consellería del Mar (que modifica el Decreto 50/2021, de 11 de marzo), corresponde a esta Consellería la investigación marina y la coordinación, programación y ejecución de actividades de divulgación y transferencia tecnológica en las comunidades pesqueras y litorales, así como la programación, supervisión, realización y difusión de publicaciones y otro material científico y didáctico.
...
Que la Xunta de Galicia, a través de la Consellería del Mar, así como el CSIC, a través del IIM, desean establecer una colaboración para elaborar un plan de manejo espacio-específico para la recuperación de las poblaciones de zamburiña en la ría de Ferrol.

El CSIC llevará a cabo las actividades recogidas en la propuesta presentada y aprobada «evaluación del estado de las poblaciones de zamburiña (*Mimachlamys varia*) en la ría de Ferrol: un enfoque integral para su conservación y gestión sostenible (Zamfer)» para alcanzar la finalidad del proyecto.

El 8 de abril de 2022 el Consello de la Xunta adoptó el acuerdo mediante el cual se aprobó la Estrategia de Especialización Inteligente (RIS3) de Galicia 2021-2027, que define el marco para las políticas de investigación e innovación en la comunidad autónoma para este período. Como instrumento de planificación operativa para su implementación entre 2025 y 2027, el Consello de la Xunta aprobó el 3 de febrero de 2025 el Plan gallego de investigación e innovación 2025-2027.

El presente convenio se alinea con el reto 1 de la RIS3 de Galicia 2021-2027, que consiste en desarrollar un modelo de gestión de recursos naturales y culturales basados en la innovación, y con la prioridad 1 (sostenibilidad), en concreto con el ámbito de priorización de mejora, preservación, gestión sostenible y puesta en valor de la biodiversidad. Asimismo, se adecúa al objetivo estratégico 1 (alcanzar un ecosistema más abierto e integrado), integrándose, por lo tanto, en el programa Integra de la RIS3 y en el programa Conocimiento del Plan gallego de investigación e innovación 2025-2027.
...
El presente convenio tiene por objeto establecer la colaboración entre la Xunta de Galicia, a través de la Consellería del Mar, así como la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P., a través del Instituto de Investigaciones Marinas (IIM), para la ejecución del proyecto denominado «evaluación del estado de las poblaciones de zamburiña (*Mimachlamys varia*) en la ría de Ferrol: un enfoque integral para su conservación y gestión sostenible (Zamfer)».

El objetivo principal del proyecto es elaborar un plan de manejo espacio-específico para la recuperación de las poblaciones de zamburiña en la ría de Ferrol, mediante la caracterización de su hábitat, el estudio de su ciclo fenológico, la evaluación de la captación de semilla local y la identificación de substratos preferenciales en los diferentes estadios de crecimiento.

Asimismo, los objetivos específicos del proyecto son los siguientes:

1. Caracterización espacial del hábitat del banco de zamburiña a lo largo de la ría, prestando especial atención a la composición del sustrato, y creación de modelos de hábitat para adultos y juveniles que permitan delimitar «nurseries» y zonas más favorables para el sembrado.

2. Caracterización del ciclo gonadal de las poblaciones adultas a lo largo de un gradiente longitudinal en la ría de Ferrol, para comprobar que la estrategia extractiva está en concordancia con el ciclo gametogénico actual, que puede haberse desplazado a lo largo de los últimos años a causa de las variaciones ambientales consecuencia del cambio global.

3. Caracterización de la capacidad de captación de semilla como posible suplemento de juveniles a la población, empleando colectores artificiales y restos de conchas, y evaluación de la sincronía entre captación y estado gonadal.

4. Estudio de los sustratos preferenciales de la especie en el laboratorio para evaluar la posibilidad de una restauración de los fondos en zonas con especial potencial para la especie y análisis del biso (incluyendo morfometría y funcionalidad) y de su capacidad de fijación.

5. Elaboración de un plan de manejo espacio-específico que integre la información recogida durante este proyecto y la información de la que disponen las propias cofradías.
...
Actividad 1: Caracterización espacial del hábitat del banco de zamburiña a lo largo de la ría de Ferrol y confección de mapas de hábitat para adultos y juveniles.

Actividad 2: Revisión de la fenología de la especie respecto a las condiciones ambientales actuales.

Actividad 3: Evaluación de la capacidad de obtención de semilla local de zamburiña para suplementar los bancos naturales en zonas de especial interés.

Actividad 4: Co-creación de un plan de gestión espacio-específico, transferencia y difusión de resultados. Formación de sinergias con el sector pesquero.

| Año | 2026 | 2027 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Actividad | M1 | M2 | M3 | M4 | M5 | M6 | M7 | M8 | M9 | M10 | M11 | M12 | M1 | M2 | M3 | M4 | M5 | M6 | M7 | M8 | M9 | M10 | M11 | M12 |
| Actividad 1. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Actividad 2. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Actividad 3. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| Actividad 4. |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
Entregable 1. Cartografía de las características físico-químicas y biológicas de la ría de Ferrol, así como del hábitat preferencial para juveniles y adultos de zamburiña en la ría de Ferrol con arreglo a los modelos construidos en el PT1. Esta cartografía irá acompañada de un informe científico-técnico que analizará los modelos de hábitat en relación con los datos ambientales, y las posibles diferencias entre juveniles y adultos.

Entregable 2. Informe científico-técnico donde se evalúe el ciclo reproductivo de la zamburiña en relación con las variables ambientales. Dicho informe presentará también una comparativa del ciclo actual con la información histórica sobre la biología de la especie y determinará se existen alteraciones fenológicas, que puedan hacer que el período extractivo actual (mes a mes) esté a interferir en el éxito reproductivo en la ría de Ferrol.

Entregable 3. Informe científico-técnico sobre la viabilidad de la obtención de semilla natural dentro de la propia ría, detallando estrategias para optimizar la captación larvaria (sustrato preferencial, zonas de la ría y periodos), su posterior preengorde en batea y su integración en los bancos naturales (sustrato preferencial para el sembrado) para el refuerzo de sus poblaciones. Por otro lado, se harán recomendaciones sobre posibles estrategias de restauración de fondos, para favorecer la expansión de los bancos, establecer «nurseries» y zonas de engorde en función de los sustratos preferenciales de cada etapa del crecimiento.

Entregable 4. Informe científico-técnico sobre las estrategias de gestión adaptativas resultantes de las sinergias entre el sector pesquero y el sector científico.

Entregable 5. Canales de comunicación estables entre sectores, que incluirán un espacio virtual de intercambio de documentación colaborativo (nube) donde estarán a disposición todos los resultados y materiales del proyecto.

Entregable 6. Informe sobre la repercusión social del proyecto, analizando la aceptación de los talleres, charlas o material divulgativo generados en el paquete de trabajo relativo a la cuarta actividad de las tareas a realizar recogidas en la cláusula segunda.
...
El importe total de las aportaciones previstas en el convenio por parte de la Consellería del Mar al CSIC asciende a un total de 167.653,63 euros (ciento sesenta y siete mil seiscientos cincuenta y tres euros con sesenta y tres céntimos), distribuidos en dos anualidades: 84.093,54 euros (ochenta y cuatro mil noventa y tres euros con cincuenta y cuatro céntimos) en el 2026 y 83.560,09 euros (ochenta y tres mil quinientos sesenta euros con nueve céntimos) en el 2027.
...
En dicha justificación se permite, en cada anualidad, un trasvase de fondos entre los conceptos recogidos en la solicitud de hasta un 20 %.
...
Y, en prueba de conformidad, las partes suscriben el presente convenio, el 24 de marzo de 2026.–La Conselleira del Mar de la Consellería del Mar de la Xunta de Galicia, Marta Villaverde Acuña.–El Vicepresidente de Organización y Relaciones Institucionales de la Agencia Estatal Consejo Superior de Investigaciones Científicas, M.P. (CSIC), Carlos Closa Montero.
