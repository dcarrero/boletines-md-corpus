---
identificador: "BOE-A-2021-17962"
...
pagina_final: 133716
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2021-17962"
url_pdf: "https://www.boe.es/boe/dias/2021/11/03/pdfs/BOE-A-2021-17962.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2021-17962"
url_eli: ""
fetched_at: "2026-04-15T05:16:11Z"
...
Madrid, 28 de octubre de 2021.–La Directora General de Desarrollo Rural, Innovación y Formación Agroalimentaria, Isabel Bombal Díaz.
...
|  | Medida/Submedida | Gasto público total | FEADER | AGE |
| --- | --- | --- | --- | --- |
| 1.1 | Formación digitalización. | 1.008.000 | 806.400 | 201.600 |
| 1.2 | Demostración digitalización. | 504.000 | 403.200 | 100.800 |
| 2.1 | Prestación asesoramiento digitalización. | 444.000 | 235.320 | 208.680 |
| 2.2 | Establecimiento asesoramiento digitalización. | 280.000 | 148.400 | 131.600 |
| 2.3 | Formación asesores digitalización. | 800.000 | 424.000 | 376.000 |
|  |  | 3.036.000 | 2.017.320 | 1.018.680 |
...
Además, la DGDRIFA es la Autoridad de Gestión del PNDR con las funciones preceptivas establecidas por el artículo 66 del Reglamento (UE) número 1305/2013 del Parlamento Europeo y el Consejo, de 17 de diciembre de 2013, relativo a la ayuda al desarrollo rural a través del FEADER.
...
La EOI actuará como entidad colaboradora, en nombre y por cuenta del órgano concedente (MAPA), participando en tareas de soporte a la gestión y control de los gastos con cargo al FEADER de las medidas que componen el Paquete de Digitalización del PNDR 2014-2020.
...
– Aprobación de los Manuales de procedimientos propuestos por la EOI para la gestión y control de las medidas incluidas en el Paquete de Digitalización.
...
– Elaborar y aprobar el manual para el seguimiento y evaluación de la ejecución de las actuaciones, así como dictar las instrucciones que sean necesarias.

– Aprobar los criterios de selección de las operaciones incluidas en el Paquete de Digitalización, que se realizarán en consonancia con el PNDR 2014-2020.

– Aprobación de las bases reguladoras para el cumplimiento de las operaciones incluidas en el Paquete de Digitalización del PNDR 2014-2020.

– Aprobación de las convocatorias, de acuerdo con las bases reguladoras aplicables y posterior tramitación de las mismas.

– Ordenación e instrucción del procedimiento de la concesión de las subvenciones.

– Supervisión y aprobación de las siguientes fases del procedimiento:

• Valoración de las solicitudes de ayuda recibidas en el marco de las convocatorias publicadas para la puesta en marcha de las submedidas del Paquete de Digitalización.

• Propuesta de resolución de concesión de las subvenciones para su posterior aprobación mediante resolución motivada.

– Comprobación de las justificaciones económicas y de ejecución de las operaciones objeto de cofinanciación FEADER, que determine la concesión o disfrute de la misma según la correspondiente convocatoria y sus bases reguladoras.
...
– Velar por que la EOI garantice que los beneficiarios conocen sus obligaciones en materia de información y publicidad, así como las obligaciones establecidas en el anexo III del Reglamento de Ejecución (UE) número 808/2014 y en la Instrucción número 3/2015 «Requisitos de información y publicidad relativos a operaciones declaradas FEADER en el periodo de programación 2014-2020», elaboradas por la Autoridad de Gestión y sus posibles modificaciones.
...
– Realizar las actuaciones de control de conformidad con el Reglamento (UE) 809/2014 de la Comisión.

• Aprobar el Plan Anual de Controles, que incluye que la EOI efectúe el control administrativo sobre el 100 % de las solicitudes de ayuda recibidas, así como de pagos, según establece el artículo 48 del Reglamento (UE) 809/2014 de la Comisión.

• Realizar los controles sobre el terreno, que, mediante un sistema de muestreo adecuado, se determine en el citado Plan Anual de Controles, antes de proceder al pago de la ayuda, de conformidad con el artículo 49.2 del Reglamento (UE) 809/2014 de la Comisión.
...
– Elaborar los borradores de los Manuales de procedimientos de gestión para las operaciones derivadas de la puesta en marcha de las medidas incluidas en el Paquete de Digitalización del PNDR 2014-2020.

– Elaborar la documentación preparatoria de acuerdo con los Manuales de procedimientos de gestión aprobados, de las bases reguladoras que apliquen a la ejecución de las medidas incluidas en el Paquete de Digitalización.

– Elaborar la documentación preparatoria de acuerdo con los Manuales de procedimientos de gestión aprobados de las convocatorias de subvenciones.

– Realizar las tareas auxiliares de ordenación documental del procedimiento y comprobar, en su caso, el cumplimiento y efectividad de las condiciones o requisitos determinantes para el otorgamiento de la subvención.

– Recepción, clasificación y análisis de las solicitudes de ayudas presentadas en el marco de las convocatorias previamente publicadas, conforme a los criterios establecidos en las mismas.

– Recepción de las solicitudes de ayuda y de pagos objeto de financiación FEADER; comprobación de los datos que figuran en las mismas y análisis técnico de la documentación presentada de acuerdo con las bases reguladoras y la convocatoria, según lo previsto en el artículo 48 del Reglamento de Ejecución (UE) número 809/2014 de la Comisión, de 17 de julio de 2014.

– Apoyo a la DGDRIFA en la comprobación de la documentación de la justificación de la subvención recibida, mediante su ordenación en soporte electrónico de acuerdo con los criterios establecidos en las bases reguladoras y en las respectivas convocatorias de subvenciones, para su posterior valoración y aprobación por la DGDRIFA.

– Realización de los trabajos técnicos necesarios para la elaboración de los planes anuales de control.
...
– Garantizar que los beneficiarios conocen sus obligaciones en materia de información y publicidad, así como las obligaciones establecidas en el anexo III del Reglamento de Ejecución (UE) número 808/2014 y en la instrucción número 3/2015 «Requisitos de información y publicidad relativos a operaciones declaradas a FEADER en el periodo de programación 2014-2020», elaboradas por la Autoridad de Gestión y sus posibles modificaciones.
...
La SGID aprobará el Plan Anual de Controles, que se basará en:

– Control administrativo de todas las solicitudes de ayudas y de pagos de la operaciones incluidas en el Paquete de Digitalización dentro de las medidas 1 y 2 del PNDR 2014-2020, aplicando lo establecido en el artículo 48 del Reglamento de Ejecución (UE) número 809/2014 de la Comisión de 17 de julio de 2014, por el que se establecen disposiciones de aplicación del Reglamento (UE) número 1306/2013 del Parlamento Europeo y del Consejo en lo que se refiere al sistema integrado de gestión y control, las medidas de desarrollo rural y la condicionalidad.
...
El MAPA basándose en dichos informes semestrales, pagará un máximo de 300.000 € a la EOI con cargo a la aplicación presupuestaria 21.08.414B.640, del presupuesto de gastos de la Dirección General de Desarrollo Rural, Innovación y Formación Agroalimentaria con la siguiente distribución de anualidades:
...
Se establece una Comisión de Seguimiento que estará constituida por un representante de cada parte, bajo la presidencia de la persona titular de la DGDRIFA. Esta Comisión se reunirá cuantas veces sea necesario, y a petición de cualquiera de las partes, para la coordinación de las actuaciones relacionadas con la finalidad perseguida en el presente Convenio.
...
De conformidad con lo establecido en el artículo 50.2.b) de la Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público, se acuerda resolver el Convenio anterior, suscrito por los firmantes en fecha de 25 de febrero de 2021, dando lugar a su extinción desde su inscripción en el registro electrónico estatal de órganos e instrumentos de cooperación.

Desde la fecha en que el presente Convenio adquiera eficacia jurídica, sustituirá en su totalidad al firmado por las partes en fecha 25 de febrero de 2021, Convenio que por consiguiente se declara resuelto y extinto.

No es necesario practicar la liquidación debido a que todos los compromisos y obligaciones anteriores se asumen en el marco del presente Convenio.
...
## Duodécima. Campañas de publicidad y difusión.

La EOI estará sujeta al cumplimiento de las medidas de información y publicidad previstas en el anexo III del Reglamento de Ejecución (UE) número 808/2014 de la Comisión, de 14 de julio de 2014, por el que se establecen disposiciones de aplicación del Reglamento (UE) número 1305/2013 del Parlamento Europeo y del Consejo, relativo a la ayuda al desarrollo rural a través del Fondo Europeo Agrícola de Desarrollo Rural (FEADER). Y del mismo modo, se seguirá la Instrucción número 3/2015 «Requisitos de información y publicidad relativos a operaciones declaradas FEADER en el periodo de programación 2014-2020».
...
Y para que así conste y en prueba de conformidad con lo expuesto, las partes firman el presente Convenio.–El Secretario General de Agricultura y Alimentación, Fernando Miranda Sotillos.–La Directora General de la Fundación EOI, FSP, Nieves Olivera Pérez-Frade.
