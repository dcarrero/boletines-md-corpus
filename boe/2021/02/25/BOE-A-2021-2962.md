---
identificador: "BOE-A-2021-2962"
titulo: "Resolución de 19 de febrero de 2021, de la Subsecretaría, por la que se publica el Convenio entre el Instituto Nacional de Administración Pública y la Agencia Estatal de Seguridad Ferroviaria, para la cesión de uso de los servicios de la plataforma de formación basada en Moodle del Instituto Nacional de Administración Pública."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 23201
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2021-2962"
url_pdf: "https://www.boe.es/boe/dias/2021/02/25/pdfs/BOE-A-2021-2962.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2021-2962"
url_eli: ""
fetched_at: "2026-04-14T14:21:29Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 19 de febrero de 2021, de la Subsecretaría, por la que se publica el Convenio entre el Instituto Nacional de Administración Pública y la Agencia Estatal de Seguridad Ferroviaria, para la cesión de uso de los servicios de la plataforma de formación basada en Moodle del Instituto Nacional de Administración Pública.

El Director del Instituto Nacional de Administración Pública y el Presidente de la Agencia Estatal de Seguridad Ferroviaria, han suscrito un Convenio para la cesión de uso de los servicios de la plataforma de formación basada en Moodle del INAP.
...
## ANEXO. Convenio entre el Instituto Nacional de Administración Pública y la Agencia Estatal de Seguridad Ferroviaria para la cesión de uso de los servicios de la plataforma de formación basada en Moodle del INAP
...
II. Que la Agencia Estatal de Seguridad Ferroviaria es un organismo público de los regulados en el artículo 84.1.a).3 de la Ley 40/2015, de 1 de octubre, de Régimen jurídico del Sector Público. De acuerdo con su Estatuto, la AESF tiene por objeto la detección, análisis y evaluación de los riesgos de seguridad en el transporte por ferrocarril, ejerciendo las funciones de autoridad responsable de la seguridad ferroviaria, en el ámbito de competencia estatal. En desarrollo de sus competencias, la formación del personal se configura como una de las principales herramientas de la política de recursos humanos de la AESF, ofreciendo a las personas que integran la organización un aprendizaje basado en los conceptos de calidad y de mejora continua.
...
VI. Que la AESF desea realizar formación en línea

VII. Que la AESF no dispone de una plataforma propia de formación, adecuada a sus necesidades y la utilización conjunta de esta herramienta del INAP da cumplimiento a lo previsto en el artículo 157.3 de la Ley 40/2015, de 1 de octubre, del Régimen Jurídico del Sector Público.
...
IX. Que es deseo de ambas instituciones, mediante el uso del instrumento del convenio, que el INAP ceda el uso de su plataforma de formación basada Moodle a la AESF.
...
El objeto de este convenio es la cesión de uso a la AESF de la plataforma de formación basada en Moodle del INAP.
...
b) La cesión del uso no supondrá, en ningún caso, la asunción de ninguna otra obligación para el INAP en el desarrollo y funcionamiento de las actividades formativas de la AESF.

No obstante, el INAP garantiza a la AESF el uso pacífico de la citada plataforma, de tal forma que el INAP protegerá a la AESF y asumirá toda responsabilidad en relación con cualquier reclamación de terceras personas, físicas o jurídicas, que pretendan tener derechos sobre una parte o sobre toda la plataforma.
...
g) El INAP establecerá un procedimiento para la eliminación de los cursos impartidos por la AESF a través de la plataforma Moodle. Dicha eliminación se realizará por la AESF una vez transcurridos tres meses desde su finalización del curso. Si no se ha eliminado un curso trascurrido este plazo, el INAP podrá proceder a su eliminación. La AESF será responsable de la gestión de las copias de respaldo de los contenidos de sus propios cursos con anterioridad a dicha eliminación, pudiendo solicitar apoyo al INAP a través del Centro de Atención a Usuarios (CAU).

h) El CAU de la plataforma será la unidad responsable de atender las consultas técnicas relativas a la plataforma, y exclusivamente las que tengan este carácter técnico. La AESF deberá disponer de un buzón electrónico al cual redirigir las consultas que se realicen al CAU en materia de trámites administrativos o de gestión, consultas específicas de los contenidos de los cursos, altas, bajas y modificaciones del alumnado, consultas dirigidas al profesorado o cualquier otra que no sea de índole técnica referida al funcionamiento de la plataforma, que deberá resolver la propia AESF.
...
Asimismo, la realización de actividades formativas en línea de la AESF a través de la citada plataforma no supone la renuncia de este a cualquiera de los derechos que pudieran corresponderle respecto a dichas actividades.
...
La Comisión de Seguimiento se reunirá siempre que lo solicite una de las partes y estará formada por el Gerente del INAP y por la Directora de la División de Administración de la AESF o persona en quien delegue.
