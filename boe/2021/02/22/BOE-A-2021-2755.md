...
Que dadas las circunstancias actuales de desarrollo científico y tecnológico y la necesidad de impulsar el I+D+i en el ámbito ATM, ENAIRE y CRIDA están interesadas en la colaboración con la UPM, con el objetivo de desarrollar de forma común las actividades de investigación que más adelante se dirán en el ámbito de eficiencia operativa y automatización en gestión del tráfico aéreo. De esta forma, el presente Convenio busca la participación activa de todas las partes, con el fin de obtener un resultado compartido que redunde en los objetivos y ámbito de actuación de cada una de las partes. No obstante, al tratarse de un Convenio centrado en actividades de I+D+i, no existen resultados garantizados. Los potenciales beneficios que se puedan obtener de los resultados de la investigación asociada al Convenio son comunes y no pertenecen exclusivamente a ninguno de los poderes adjudicadores que suscriben el presente Convenio; en este sentido, la UPM puede beneficiarse de la investigación realizada para su ámbito docente y de publicación científica en revistas, mientras que CRIDA y ENAIRE podrán desarrollar herramientas y soluciones derivadas.

## Quinto.

Por todo lo anterior, las partes consideran de gran interés y relevancia para el fomento del I+D+I en el ámbito del ATM en España, que constituye un fin común de todas ellas, establecer un mecanismo de colaboración de forma que las actividades científicas y tecnológicas que la UPM lleve a cabo cuenten con la evaluación científicotécnica de CRIDA y ENAIRE, asegurando con ello la aplicación de los principios de objetividad, independencia y eficiencia en la asignación de los recursos. De este modo, el Convenio permite tanto el desarrollo de investigación pura, mediante la participación de la UPM, como la investigación aplicada y el desarrollo práctico de los resultados, mediante la participación de CRIDA y ENAIRE.
...
El objeto del presente Convenio es establecer las bases de participación conjunta de la UPM, ENAIRE y CRIDA para la realización de actividades durante el periodo 2020-2022, en áreas de I+D+i en el ámbito de Gestión del Tráfico Aéreo, de interés común, centradas en la investigación de soluciones y desarrollo potencial de herramientas.

## Segunda. Actuaciones a realizar.

Las actividades a realizar a través del presente Convenio se encuadrarán en los siguientes tipos de colaboraciones:

a. Colaboración en el desarrollo de tareas de I+D+i, relacionados con la línea prioritaria identificada en el ámbito de eficiencia operativa y automatización en gestión del tráfico aéreo: la comparación y caracterización de flujos en sectores operativos.
...
• Por parte de la UPM, las actuaciones se desarrollarán por profesores del departamento de Sistemas Aeroespaciales, Transporte Aéreo y Aeropuertos (SATAA) de la Escuela Técnica Superior de Ingeniería Aeronáutica y del Espacio (ETSIAE), todos ellos integrantes del Grupo de Investigación de Navegación Aérea (GINA); así como por estudiantes de los títulos Grado en Ingeniería Aeroespacial, Grado en Gestión y Operaciones de Transporte Aéreo, Máster Universitario en Sistemas de Transporte Aéreo y Máster Universitario en Ingeniería Aeronáutica, en los que dichos profesores imparten docencia.
...
ENAIRE aportará los medios económicos necesarios para sufragar las actividades objeto del presente Convenio, siendo el presupuesto máximo de ejecución de 120.000 € a abonar en cuatro pagos:
...
El abono de dichas cantidades se hará efectivo en la c/c número ES36 2100-9194-1722-0060-0055 del Caixa Bank, paseo de la Castellana, 51, planta 3, 28046 Madrid, a nombre de Universidad Politécnica de Madrid-Investigación Transferencia Tecnológica.
...
La Comisión de Seguimiento se constituirá en el plazo de cuarenta y cinco días desde la publicación en BOE del presente Convenio y en cuanto a sus normas de funcionamiento se regirá por lo dispuesto en los artículos 15 y siguientes de la Ley 40/2015, de 1 de octubre, de Régimen Jurídico del Sector Público.
...
Habiendo leído el presente por sí mismos y hallándose conformes, lo firman por triplicado y a un solo efecto, en lugar y fecha arriba citados.–Por ENAIRE, el Director General, Ángel Luis Arias Serrano.–Por UPM, el Rector, Guillermo Cisneros Pérez.–Por CRIDA, el Director, José Miguel de Pablo Guerrero.

## ANEXO I. Actividades

| # | Nombre de la tarea | Descripción de la tarea asociada | Tipo de tarea | Responsable del paquete de trabajo | Horizonte temporal * |
| --- | --- | --- | --- | --- | --- |
| 1 | Revisión del trabajo inicial. | Revisar e incorporar los conceptos más prometedores de la primera fase del Convenio. | Data Science. | UPM. | T0 + T1 |
| 2 | Algoritmo de agrupación de flujos operacionales. | Incorporar técnicas de clusterización para agrupar e identificar flujos principales de manera autónoma. | Data Science. | CRIDA. | T0 + T2 |
| 3 | Modelos de la clasificación del impacto y estabilidad. | Investigar sobre los factores que afectan el impacto y la estabilidad de los flujos para mejorar la metodología de clasificación de los flujos desarrollada en la primera fase del Convenio. | Data Science. | UPM. | T0 + T3 |
| 4 | Desarrollar un modelo «mínimo viable» para obtener *feedback*operacional. | Aplicación del esquema de ponderaciones de complejidad e impacto de los flujos desarrollada en la primera fase del Convenio a un modelo «mínimo viable» muy reducido (un sector). Esto sirve para tomar el *feedback*directo de un controlador habilitado en dicho sector, que es quien conocerá realmente los detalles de complejidad de cada flujo particular. | Eficiencia operacional. | CRID-ENAIRE. | T0 + T4 |
| 5 | Aplicación a varios entornos de tráfico. | Investigar la aplicación de la metodología de complejidad e impacto a flujos de otros ACCs y sectores. | Data Science. | CRIDA. | T0 + T5 |
| 6 | Definición de un concepto para la sectorización dinámica basada en flujos. | Aplicar los modelos maduros en soporte de desarrollos de conceptos de sectorización dinámica. | Eficiencia operacional. | CRIDA-Enaire. | T0 + T6 |
| 7 | Desarrollo de modelos ML en soporte de sectorización dinámica. | Realizar el concepto de sectorización dinámica basada en flujos a través de modelos de aprendizaje automático. | Data Science. | UPM. | T0 + T7 |
| 8 | Validación del modelo de sectorización dinámica. | Validar los modelos en simulaciones y *workshops*con personal operativa de Enaire. | Eficiencia operacional. | CRIDA-Enaire. | T0 + T8 |

* Siendo T0 la fecha de inicio de las actividades, y T1, T2,…, T8 cada uno de los trimestres considerados para el desarrollo de las tareas incluidas en el Convenio.

Aparte de las tareas mencionadas arriba, se podrían considerar otras líneas potenciales listados abajo:

| # | Nombre de la tarea | Descripción de la tarea asociada | Tipo de tarea | Responsable del paquete de trabajo | Horizonte temporal * |
| --- | --- | --- | --- | --- | --- |
|  | Aplicación de los modelos a datos de 2019 y 2020. | Comparar los resultados de la aplicación de los modelos a los flujos de 2019 y de 2020 para identificar y cuantificar los cambios causados por la pandemia. | Data Science. | CRIDA. | TBD |
|  | Estudio de eficiencia de sectorización. | Estudiar la eficiencia de la sectorización según el origen/destino de los vuelos que cruzan el sector y los flujos a los que pertenecen. | Eficiencia Operacional. | CRIDA-Enaire. | TBD |
|  | Análisis de aplicabilidad de la metodología a TMA. | Extender la aplicación de flujos a otras fases de vuelo, con el objetivo de mejorar la eficiencia y predictibilidad de los procesos. | Eficiencia Operacional. | UPM. | TBD |
