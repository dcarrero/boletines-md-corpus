...
pagina_final: 116474
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2021-15436"
url_pdf: "https://www.boe.es/boe/dias/2021/09/23/pdfs/BOE-A-2021-15436.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2021-15436"
url_eli: "https://www.boe.es/eli/es/res/2021/09/16/(2)"
fetched_at: "2026-04-15T03:02:35Z"
...
## ANEXO. Propuesta de procedimiento para el envío y cálculo de la precisión de los programas de consumo de los consumidores electrointensivos
...
– Si no se dispone de Progh o no se dispone de P~h~ para la hora h:

Error_horario~h~ = 1

– Si Progh> 0 kWh:

• Si Progh > 5 % de la potencia contratada máxima o P~h~> 5 % de la potencia contratada máxima:

[imagen]

• Si Progh≤ 5 % de la potencia contratada máxima y P~h~< 5 % de la potencia contratada máxima:

Error_horario~h~ = 0

– Si Progh = 0 kWh:

Si P~h~ = 0 kWh → Error~horario~~h~ = 0

Si P~h~ > 0 kWh → Error~horario~~h~ = 1
...
– P~h~: Consumo horario de energía en la hora h (kWh) registrado en el concentrador principal, incluyendo la energía autoconsumida.

– Prog~h~: Último programa de consumo horario para la hora h (kWh) recibido.

– Error_previsión: Desviación mensual del consumo respecto a los programas (%).

– Error~horario~~h~: Desvío horario del consumo respecto a los programas en la hora h.
