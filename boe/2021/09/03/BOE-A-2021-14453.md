...
pagina_final: 107298
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2021-14453"
url_pdf: "https://www.boe.es/boe/dias/2021/09/03/pdfs/BOE-A-2021-14453.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2021-14453"
url_eli: "https://www.boe.es/eli/es/o/2021/09/01/hfp915"
fetched_at: "2026-04-15T01:58:09Z"
...
>  
>  
>  Fecha y hora de confirmación de la predeclaración/borrador.
>  Entrada.
>  Fecha y hora.
>  
>  
...
>  1-1
>  NUM.
>  TIPO DE REGISTRO 1 = CABECERA ENTIDAD TRANSMISORA.
>  
>  
>  2-5
>  NUM.
...
>  6-6
>  ALF.
>  TIPO DE PRESENTACIÓN ("I" = INGRESOS).
>  
>  
>  7-7
>  ALF.
...
>  16-17
>  NUM.
>  DELEGACION AEAT (PRESENTACION CENTRALIZADA = 57).
>  
>  
>  18-90
>  ALF.
...
>  1-1
>  NUM.
>  TIPO DE REGISTRO 2 = CABECERA ENTIDAD COLABORADORA.
>  
>  
>  2-5
>  NUM.
...
>  TIPO DE INGRESOS.
>  "A" = AUTOLIQUIDACIONES.
>  "E"= AUTOLIQDIDACIONES ESPECIALES.
>  "L" = LIQUIDACIONES.
>  "T" = TASAS DEL TESORO.
>  "Z"= TASAS DE ORGANISMOS AUTÓNOMOS.
>  
...
>  8-15
>  NUM.
>  NÚMERO DE QUINCENA (AAAAMMQQ): AAAAMM01 para las quincenas que finalicen el 5 del mes. AAAAMM02 para las quincenas que finalicen el 20.
>  
>  
>  16-17
>  NUM.
...
>  NUM.
>  
>  NÚMERO DE ORDEN DE LA TRANSMISION. - Será el número que identifique las transmisiones de una E.C. en una quincena. La primera transmisión de la quincena siempre tendrá NÚMERO = 01. Las transmisiones correspondientes a aquellas previamente rechazadas por error no incrementan este contador. Siempre llevarán el número de la transmisión original en que se detectaron los errores.
>  Si en una misma quincena hubiera transmisiones complementarias o sustitutivas de otras previamente aceptadas deberán ir incrementando este número.
>  
>  
>  
>  20-27
>  NUM.
>  FECHA DE INGRESO (AAAAMMDD). Esta fecha sólo será necesario cumplimentarla en los registros con TIPO INGRESO = A (Autoliquidaciones).
>  
>  
>  28-90
>  ALF.
...
>  
>  
>  IMPORTE TOTAL DECLARACIÓN (*).
>  13 posiciones numéricas(11 enteros y 2 decimales).
>  
>  
>  OPCIÓN FRACCIONAMIENTO (*).
...
>  
>  FORMA DE PAGO (**).
>  1 posición numérica (0=cargo CCC obligado tributario; 1=cargo CCC presentador/asesor).
>  
>  
>  IBAN.
>  4 posiciones alfanuméricas.
...
>  8 posiciones núm. (Registros tipos 3, 4 y 5).
>  
>  
>  TOTAL IMPORTES A PAGAR.
>  13 posiciones núm. (11 enteros y 2 decimales).
>  
>  
>  LIBRE.
>  274 posiciones alfanuméricas.
>  
>  
>  
...
>  
>  NIF PRESENTADOR/ASESOR.
>  9 posiciones numéricas (irá relleno a blancos).
>  
>  
>  NOMBRE/RAZÓN SOCIAL PRESENTADOR.
>  40 posiciones alfanuméricas (irá relleno a blancos).
...
>  
>  NÚMERO TOTAL REGISTROS.
>  6 posiciones núm. (Reg. Tipo 3, 4 y 5).
>  
>  
>  TOTAL IMPORTES A PAGAR.
>  13 posiciones núm. (11 enteros y 2 decimales).
...
>  
>  NÚMERO TOTAL REGISTROS.
>  6 posiciones núm.(Reg. Tipo 2, 3, 4, 5 y 6).
>  
>  
>  TOTAL IMPORTES A PAGAR.
>  13 posiciones núm. (11 enteros y 2 decimales).
