---
identificador: "BOE-A-2024-25627"
...
pagina_final: 167465
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-25627"
url_pdf: "https://www.boe.es/boe/dias/2024/12/09/pdfs/BOE-A-2024-25627.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-25627"
url_eli: ""
fetched_at: "2026-04-10T02:43:14Z"
...
1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala de Gestión de Apoyo a la Docencia y a la Investigación de la Universidad de Granada, Grupo A, Subgrupo A2, en el Área de Tratamiento de imagen del Centro de Instrumentación Científica.
...
1. Consolidación de la fotografía como instrumento científico.

– Inicios de la fotografía científica.

– Modalidades de fotografía científica.

– Usos y aplicaciones de la fotografía científica en las distintas áreas de conocimiento.

2. Tipos de cámaras fotográficas.
...
– Archivos de almacenamiento de fotografía digital.

3. Objetivos empleados en fotografía científica y microscopía.

– Tipos de objetivos.

– Materiales empleados en lentes fotográficas y de microscopio.

– Aberraciones ópticas.

4. Microscopía óptica.

– Componentes de la lupa y el microscopio.

– Clasificación de microscopios ópticos.

– Empleo de lupas y microscopios ópticos en fotografía científica.

5. Microscopía con luz polarizada.

– Componentes de un microscopio petrográfico.

– Tipos de prismas y polarizadores.

– Usos y aplicaciones.

6. Otros tipos de microscopía óptica.
...
– Sistemas de acercamiento.

– Cálculo de aumentos.

– Cálculo de profundidad de campo.

– Herramientas para el aumento de la profundidad de campo.

8. Fotomicrografía mediante focus stacking.

– Tipos de objetivos de microscopio usados en fotografía científica.

– Lentes convergentes y dioptrías.

– Sistemas de fotografía motorizados con micropasos de motor y sus utilidades.

9. Fotomicrografía mediante stack and stitch (SS) para obtención de imágenes de ultra-alta resolución.

– Sistemas de fotografía SS motorizados en 3 ejes (X, Y, Z).

– Cálculo de aumentos.

– Ajuste de la profundidad de campo de muestras irregulares.

10. Fotografía infrarroja.
...
– Usos y aplicación en diferentes campos de la fotografía científica.

11. Fotografía ultravioleta.

– Objetivos y filtros válidos para UV.

– Clasificación de la luz UV, usos y aplicaciones en diferentes campos de la fotografía científica.

– Restricción de la luz visible.

– Fotografía de la fluorescencia inducida por luz UV.

12. Iluminación en fotografía y microscopía.

– Tipos de focos y aplicaciones.

– Fuentes de luz para longitudes de onda fuera del espectro visible.

– Restricción de distintas longitudes de onda y de luz visible.

13. Fotografía con luz polarizad.

– Filtros polarizadores.

– Tipos de muestras y utilidades.

– Luz polarizada en digitalización.

– Gestión del color con luz polarizada.

14. Espacios, modelos y perfiles de color.

– Espacio CIELAB.

– Modelos aditivos y sustractivos, modelos basados en colores primarios y modelos basados en propiedades del color.

– Profundidad de color. Densidad y conversión entre modelos.

– Perfiles de color.

15. Software complementario a la adquisición de imágenes.

– Software para el apilado de imágenes en focus stacking.

– Montaje de una imagen mediante stack and stitch.

– Manejo de imágenes de ultra-alta resolución.

16. Edición de imágenes digitales con Photoshop y Camera Raw.

– Perfiles de color y gestión del color.

– Ajustes y herramientas, capas de ajuste, funciones.

– Formatos de imagen en Photoshop.

– Técnicas de edición de imágenes en fotografía científica: corrección de aberraciones ópticas, mejora de contraste y definición, mejora de enfoque, reducción de ruido, etc.

17. Coloreado de una imagen en escala de grises de manera manual.

– Imágenes de microscopía electrónica de barrido y de transmisión.

– Herramientas para la selección manual de áreas.

18. Usos de software para análisis de imágenes de microscopía electrónica.

– Software para análisis de imagen de microscopía y AFM. Digital Surf, Mountain y otros.

– Estudio de diferentes parámetros mediante análisis de imagen.

– Fotogrametría y creación de modelos 3D en fotografía.

– Adquisición y montaje de imágenes en programas de edición 3D b. Modelaje 3D.

– Detección y corrección de errores topológicos en modelos 3D.

19. Nuevas tecnologías y uso de herramientas de IA aplicadas a la FC.

– Creación de modelos de realidad virtual a partir de fotogrametría y de focus stacking.

– Creación y análisis de imagen mediante Inteligencia Artificial.

20. Principios generales de seguridad y salud en laboratorios. Principales grupos de sustancias químicas, manipulación, eliminación y control. Preparación de disoluciones. Símbolos químicos. Magnitudes y unidades básicas. Magnitudes y unidades derivadas (SI). Múltiplos y submúltiplos en factores de conversión.

21. Material de laboratorio de uso frecuente (material de vidrio, material auxiliar y aparataje). Funcionamiento, utilización y mantenimiento de equipos básicos de medida (temperatura, presión, masa, volumen, densidad, viscosidad, elasticidad, termostatos y criostatos, vacío, pH, tubos de sonido, conductímetros, voltímetros-amperímetros).

22. Tratamiento de residuos. El Manual de residuos de la UGR. Clasificación de residuos. Procedimiento de gestión.

23. Cuarteo, trituración y molienda. Morteros, molinos y su mantenimiento. Sierras y su mantenimiento. Pulidoras, desbastadoras y su mantenimiento. Preparación de láminas delgadas convencionales, para microsonda e inclusiones fluidas. Láminas delgadas de materiales no cohesivos.

24. Tinciones. Preparación de secciones pulidas, y levigados.
