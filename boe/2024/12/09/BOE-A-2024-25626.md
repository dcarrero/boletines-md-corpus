---
identificador: "BOE-A-2024-25626"
titulo: "Resolución de 26 de noviembre de 2024, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Gestión de Apoyo a la Docencia y a la Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 167450
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-25626"
url_pdf: "https://www.boe.es/boe/dias/2024/12/09/pdfs/BOE-A-2024-25626.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-25626"
url_eli: ""
fetched_at: "2026-04-10T02:43:13Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 26 de noviembre de 2024, de la Universidad de Granada, por la que se convoca proceso selectivo para ingreso, por el sistema general de acceso libre, en la Escala de Gestión de Apoyo a la Docencia y a la Investigación.
...
1.1 Se convoca proceso selectivo de acceso libre para cubrir una plaza de personal funcionario de la Escala de Gestión de Apoyo a la Docencia y a la Investigación de la Universidad de Granada, grupo A, subgrupo A2, en el Área de Análisis y determinación de estructuras del Centro de Instrumentación Científica.
...
1.4 La fase de oposición se desarrollará con los ejercicios y puntuaciones establecidas en el anexo II de esta convocatoria, y el programa de materias en que se basarán será el contenido en el anexo I. La fecha y lugar para la realización del primer ejercicio de la fase de oposición, que no podrá iniciarse antes del día 1 de abril de 2025, se fijará en la forma establecida en la base 4.1 de esta convocatoria.
...
Granada, 26 de noviembre de 2024.–El Rector, Pedro Mercado Pacheco.

## ANEXO I. Programa

Bloque específico

1. Principios fundamentales del análisis elemental CHNS-O.

– Conceptos básicos de carbono, oxígeno, hidrógeno, nitrógeno y azufre.

– Bases teóricas de la combustión y detección elemental.

2. Estructura y componentes del analizador elemental.

– Descripción del horno de combustión y horno de reducción.

– Sistema de detección (celdas de conductividad térmica y otros sensores).

– Configuración del inyector automático y consumibles.

3. Preparación de muestras y reactores para análisis elemental.

– Balanzas de precisión y pesaje de muestras sólidas y líquidas.

– Preparación de reactores en base los diferentes métodos de análisis.

– Uso de cápsulas y aditivos para mejorar la combustión.

– Precauciones para evitar contaminación cruzada.

– Criterios de homogeneidad y tamaño de muestra.

4. Procedimiento de análisis en el analizador elemental FLASH 2000.

– Automatización del muestreo: funcionamiento del autosampler MAS 200R.

– Circuitos neumáticos para los distintos tipos de análisis.

– Secuencia de combustión, oxidación y reducción.

– Control de gases portadores y flujo.

– Programación de métodos específicos según tipo de muestra.

5. Calibración, cuantificación y análisis de datos con el software Eager Xperience.

– Preparación de estándares de calibración.

– Curvas de calibración y cálculos de resultados.

– Corrección de factores instrumentales.

6. Mantenimiento del equipo FLASH2000 y resolución de problemas comunes.

– Limpieza de componentes.

– Reemplazo de consumibles (reactivos, columnas).

– Diagnóstico y solución de fallos operativos.

7. Aplicaciones del análisis elemental CHNS-O.

– Análisis en alimentos, polímeros, productos farmacéuticos, y combustibles.

– Ejemplos de estudios de combustión y caracterización de compuestos orgánicos.

– Aplicaciones en investigaciones ambientales.

8. Introducción a la fluorescencia.

– Fluorescencia y fosforescencia.

– Diagrama de Jablonski.

– Características de la emisión de fluorescencia.

– Anisotropía.

– Aplicaciones principales en espectrofluorimetría de luminiscencia.

9. Medidas en estado estacionario y resolución temporal.

– Absorbancia, emisión y excitación.

– Tiempos de vida y rendimientos cuánticos.

– TCSPC y MCS.

10. Rendimientos cuánticos.
...
11. Instrumentación en Espectrofotometría de Luminiscencia.

– Espectrofluorímetros.

– Distorsiones en los espectros de excitación y emisión.

– Fuentes de excitación.

– Monocromadores y redes de difracción.

– Sistemas de detección.

12. Fluoróforos orgánicos y complejos metálicos luminiscentes.

– Fluorescencia de proteínas.

– Complejos de Ru, Cr, Ir y Pt.

– Lantánidos.

13. Espectrofluorímetro PTI QuantaMaster-8000 (QM-8000).

– Descripción general del sistema y su diseño modular.

14. Componentes ópticos del QM-8000.

– Fuentes de excitación: Lámparas de Xenón continuas y pulsadas.

– NanoLEDS.

– Monocromadores de alta resolución.

– Redes de difracción.

– Resolución espectral.

15. Compartimento de muestras.

– P-Esfera de integración y rendimientos cuánticos.

– Polarizadores.

– Filtros: tipos y usos.

16. Detectores UV-Vis-NIR.

– PMT PPD850 y PMT R5509.

– Rango espectral y factores de corrección.

– Sistemas de enfriamiento de detectores y mantenimiento.

17. Medidas a baja temperatura.

– Criostato ARS CS-202PI: especificaciones técnicas y control de temperatura.

– Cold Finger Dewar.

– Revisión y mantenimiento.

18. Medidas de cinéticas rápidas de fluorescencia.

– Principios y tipos de medida.

– Stopped Flow SFA-20: especificaciones técnicas y mantenimiento.

19. Sistemas de control y tratamiento de datos de luminiscencia.

– Configuración de experimentos mediante el software Felix GX.

– Diseño de métodos y configuraciones de medida.

– Personalización de parámetros de escaneo, adquisición y análisis.

– Resolución de problemas.

20. Mantenimiento del equipo y calibración.

– Métodos de calibración espectral y de intensidad.

– Limpieza y cuidado de ópticas y lámparas.

– Revisión periódica de alineaciones y conexiones.

21. Introducción al magnetismo.

– Polarización de materiales en un campo magnético.

– Magnetización.

– Susceptibilidad magnética.

– Medidas en campo magnético estático y dinámico.

– Tipos de comportamiento magnético: diamagnetismo y paramagnetismo.

22. Diamagnetismo.

– Susceptibilidad diamagnética. Unidades.

– Signo, magnitud, dependencia con el campo magnético y origen.

– Correcciones diamagnéticas. Constantes de Pascal.
...
– Ley de Curie. Ley de Curie-Weiss.

– Paramagnetismo independiente de la temperatura.

24. Ecuación de Van Vleck.
...
– Ejemplos de aplicación de la ecuación de Van Vleck.

25. Manipulación y representación de datos magnéticos.

– Dependencia de la susceptibilidad magnética con la temperatura (χ~M~vs T).

– Dependencia de la magnetización con el campo magnético. Ciclo de histéresis (M vs H).

– Dependencia de la magnetización con la relación campo magnético/temperatura (M vs H/T).

– Medidas de histéresis térmica en compuestos de transición de spin.

– Medidas ZFC/FC.

26. Interacciones magnéticas.

– Sistemas polinucleares con interacciones magnéticas. Interacciones ferromagnéticas y antiferromagnéticas.

– Aplicación de la ecuación de Van Vleck a sistemas polinucleares.

– Ordenamiento magnético de largo alcance: ferroimanes, ferrimanes, antiferroimanes, y ferroimanes débiles.

– Imanes unimoleculares.

27. Medidas en campo alterno.

– Medidas de susceptibilidad AC en fase (χ~M~’) y fuera de fase (χ~M~’’).

– Tiempos de relajación: modelo de Debye y diagramas Cole-Cole.

– Aplicación a compuestos superparamagnéticos e imanes unimoleculares.

– Aplicación a ferro-, ferri- y antiferroimanes.

28. Instrumentación para medidas magnéticas: PPMS DynaCool.

– Aspectos generales y componentes del equipo.

– Inicialización del sistema y proceso de Cool Down.

– Instalación del sistema para medir las muestras: *Sample Pucks.*

29. Medidas en campo estático mediante la opción VSM.

– Instalación y desinstalación del hardware y el software.

– Preparación, montaje y centrado de las muestras.

– Diseño de secuencias para los distintos tipos de medidas magnéticas.

30. Medidas en campo alterno mediante la opción ACMS II.
...
31. Medidas de transporte eléctrico con la opción ETO.
...
32. Medidas de transporte eléctrico con la opción ETO.
...
33. Medidas fotomagnéticas con la opción VSM FOSH y con la fuente de luz TLS120Xe.

– Instalación y desinstalación del hardware y el software.

– Preparación, montaje y centrado de las muestras.

– Diseño de secuencias para los distintos tipos de medidas fotomagnéticas.

34. Resolución de problemas y mantenimiento.

– Cambio de la bala de He.
...
35. Verificación y calibración del equipo.

– Calibración con diferentes patrones (Pd,GGG) de los distintos módulos de medida: VSM, ACMS II y VSM Large Bore.
...
Primer ejercicio: Tendrá carácter eliminatorio y consistirá en contestar un cuestionario de 100 preguntas, más cinco preguntas adicionales de reserva, con cuatro respuestas alternativas, de las que solo una será correcta, basado en el contenido del programa que figura como anexo I de esta convocatoria. Para la realización de este ejercicio las personas aspirantes dispondrán de 120 minutos.
...
Por Acuerdo del Tribunal se publicará la relación provisional de aspirantes que han superado el ejercicio, con indicación de sus calificaciones y se abrirá un plazo de tres días hábiles para presentar reclamaciones sobre la misma. Finalizado el plazo anterior, y resueltas las reclamaciones que puedan presentarse, mediante Acuerdo del Tribunal se publicará la relación definitiva de aspirantes que han superado el ejercicio, así como la fase de oposición, con expresión de la calificación obtenida.
...
De las operaciones aritméticas se obtendrán tres cifras decimales.
...
1. Servicios prestados en la Universidad de Granada como personal funcionario en la misma escala que se convoca (grupo a, subgrupo A2) o como personal laboral en la categoría laboral equivalente: 0,40/30 puntos por día de servicios.

2. Servicios prestados en otras universidades públicas como personal funcionario en los cuerpos o escalas equivalentes a la que se convoca: 0,30/30 puntos por día de servicios.

3. Servicios prestados en otras Administraciones públicas como personal funcionario en los cuerpos o escalas equivalentes a la que se convoca: 0,20/30 puntos por día de servicios.

b) Superación de ejercicios obligatorios de cualquier convocatoria de acceso anterior en procesos de la misma escala que se convoca de la Universidad de Granada, o cuerpos o escalas equivalentes de otras universidades públicas, a razón de 0,50 puntos por ejercicio obligatorio superado con un máximo de cinco puntos.
