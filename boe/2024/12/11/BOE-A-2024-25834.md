---
identificador: "BOE-A-2024-25834"
titulo: "Resolución de 3 de diciembre de 2024, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la categoría de Técnico/a diplomado/a de laboratorio y talleres, área ingeniería aeroespacial y diseño."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
diario_numero: "298"
pagina_inicial: 168516
pagina_final: 168536
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-25834"
url_pdf: "https://www.boe.es/boe/dias/2024/12/11/pdfs/BOE-A-2024-25834.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-25834"
url_eli: ""
fetched_at: "2026-04-10T02:54:32Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 3 de diciembre de 2024, de la Universitat Politècnica de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la categoría de Técnico/a diplomado/a de laboratorio y talleres, área ingeniería aeroespacial y diseño.
...
1.1 La presente convocatoria tiene por objeto la selección de personal para cubrir una vacante de la categoría de técnico diplomado de laboratorio y talleres en el área ingeniería aeroespacial y diseño del grupo A, subgrupo A2, sector de Administración Especial, de la Universitat Politècnica de València, por turno libre.
...
6.3.2 Segundo ejercicio: prueba práctica que consistirá en dos supuestos prácticos propuestos por el órgano técnico de selección sobre el temario especificado en el anexo bloque de conocimientos específicos, así como las funciones de trabajo, objeto de esta convocatoria.
...
Cada uno de los supuestos prácticos se valorará de 0 a 15 puntos. En cada uno de los supuestos prácticos se deberá alcanzar un mínimo de 4 puntos para poder sumar en la puntuación total del ejercicio.
...
11.1 Una vez finalizado el proceso selectivo, se publicarán en el «Diari Oficial de la Generalitat Valenciana», la lista definitiva, con el nombre de las personas aprobadas con la puntuación obtenida. En el plazo de diez días hábiles, contados desde el día siguiente a esta publicación, las personas propuestas deberán remitir al Servicio de Gestión de Personal Técnico, de Gestión, y de Administración y Servicios a través del Registro General de esta Universitat Politècnica de València, sito en el edificio 3F, planta baja, junto a Rectorado, camino de Vera, s/n, CP 46071, de Valencia; del registro de la Escuela Politécnica Superior de Alcoy sito en la plaza Ferrándiz y Carbonell, s/n, de Alcoy; del registro de la Escuela Politécnica Superior de Gandia sito en la calle Paranimf, n.º 1, del Grao de Gandia o en cualquiera de las formas establecidas en el artículo 16.4 de la Ley 39/2015, de 1 de octubre, del Procedimiento Administrativo Común de las Administraciones Públicas, la siguiente documentación los siguientes documentos:
...
Valencia, 3 de diciembre de 2024.–El Rector, José Esteban Capilla Romá.
...
Área: ingeniería espacial y diseño.
...
Apoyo a los profesores y alumnos de proyecto fin de grado, fin de máster, doctorado, en el uso de las instalaciones de los laboratorios.
...
Instalación, configuración y administración de los sistemas operativos para funcionamiento básico de la máquina: Windows, máquinas virtuales, Linux, y sus posibles actualizaciones a nuevas versiones.

Puesta a punto y mantenimiento de los equipos informáticos existentes en los laboratorios y despachos de la ETSIADI. Instalación de paquetes ofimáticos estándar del momento en esta Universitat y del software propios de la ETSIADI.
...
Instalación, configuración, administración y mantenimiento de redes de área local y redes de comunicación industrial en instalaciones de la ETSIADI.

Mantenimiento y supervisión de los equipos empleados en las prácticas realizadas en los laboratorios de la ETSIADI: fuentes de alimentación, osciloscopios, generadores de señal, PLCs, motores, servomecanismos, accionamientos neumáticos, sensores, equipos audiovisuales, etc.
...
6. Hardware de un ordenador. Arquitectura y periféricos. Instalación, configuración y mantenimiento. Configuración y manejo de ordenadores PC. Sistemas operativos MS-DOS y Windows. Instalación y configuración del sistema.

7. Instalación de una pequeña red local. Gestión y administración mediante Windows de usuarios. Conexión a una red local y a dominios de la UPV. Métodos de protección antivirus en red.

8. Sistema LINUX. Conocimientos básicos.

9. Microsoft Office 2019 y posteriores. Conocimientos a nivel de usuario de Word, Access, Excel y PowerPoint. Comandos y atajos de teclado. El correo en la UPV. Gestión y configuración de cuentas.

10. Microsoft Teams. Manejo a nivel usuario. Conexión, configuración de dispositivos, creación y gestión de equipos. Administración y creación de reuniones.

11. Instalación, configuración, manejo y mantenimiento de recursos audiovisuales (videoproyectores, sistema videoapuntes UPV, cámaras digitales y fotografía digital.

12. Copias de seguridad. Planificación y soportes utilizables. Repositorios virtuales y en la nube.

13. Componentes pasivos, Resistencias lineales, no lineales. Condensadores. Bobinas.

14. Estudio, cálculo y montaje de circuitos RL, RC y RLC. Comportamiento transitorio y en resonancia.

15. Circuitos impresos. Técnicas de realización. Diseño asistido por ordenador. Proteus. Componentes ideales y reales de los circuitos eléctricos lineales. Métodos de análisis. Teoremas generales de los circuitos lineales; Análisis de circuitos: con componentes no lineales.

16. Circuitos eléctricos con cuadripolos. Parámetros y funciones de transferencia. Acoplamientos magnéticos.

17. Diodos semiconductores. Rectificación. Estabilización. Características y aplicaciones. Hojas de datos.

18. Transistores bipolares. Principio de funcionamiento. Polarización. Curvas características y ecuaciones básicas.

19. Transistores de efecto de campo FET y MOST. Principio de funcionamiento. Polarización. Curvas características y ecuaciones básicas.

20. Circuitos de rectificación.

21. Fuentes de alimentación lineales y conmutadas.

22. Amplificación. Monoetapa. Multietapa. Respuesta en frecuencia.

23. Funciones lógicas. Simplificación y representación. Aritmética binaria. Hojas características. Álgebra binaria. Puertas lógicas elementales.

24. El amplificador operacional ideal y el amplificador operacional real. Estudio y Funcionamiento. Características dinámicas y estáticas. Aplicaciones.

25. Convertidores de señal. Conversión Analógica/Digital y Digital/Analógica. Aplicaciones y características.

26. Amplificación con AO. Adaptaciones de impedancias. Tipos de amplificadores. Circuitos equivalentes.

27. Filtrado de señales. Filtrado de frecuencia. Filtros activos y pasivos. Características.

28. Transformadores y autotransformadores. Potencia y energía eléctricas. Potencia compleja. Mejora del factor de potencia. Aparatos de medida: Amperímetro, voltímetro, vatímetro, osciloscopio. Técnicas de medida.

29. Generadores de señal. Senoidales. De forma de onda. Programables.

30. Corriente alterna senoidal. Cálculo fasorial.

31. Instalaciones eléctricas. Circuitos de alumbrado y fuerza. Reglamentación. Tensiones de seguridad. Protecciones en las instalaciones eléctricas. Selectividad.

32. Respuesta de los sistemas. Temporal, en frecuencia, en el plano complejo.

33. Reguladores PID industriales. Acciones. Configuración y calibración. Sintonía y autosintonía.

34. Autómatas programables industriales. Arquitectura. Componentes. Aplicaciones. Diseño de automatismos. El Grafcet.

35. Organización y clasificación del trabajo de un laboratorio. Gestión de inventario. Adquisición de equipos, búsqueda de presupuestos y proveedores.

36. Conocimiento y manejo de instrumentación para prácticas de física aplicada, electromagnetismo y mecánica en el ámbito de la física. Cálculos y formulación.
