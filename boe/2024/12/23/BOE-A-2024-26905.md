...
pagina_final: 179097
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-26905"
url_pdf: "https://www.boe.es/boe/dias/2024/12/23/pdfs/BOE-A-2024-26905.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-26905"
url_eli: ""
fetched_at: "2026-04-10T03:42:13Z"
...
El Subdirector General de Planificación y Gobernanza de la Administración Digital y el Director General de Deportes, han suscrito un convenio para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación Next Generation EU.
...
Que las competencias del Consejo Superior de Deportes, establecidas en el artículo 14 de la Ley del Deporte (Ley 39/2022, de 30 de diciembre), están soportadas por servicios de Infraestructura de las Tecnologías de la Información y las Comunicaciones, entre los que se encuentran la computación y almacenamiento.
...
Que el Consejo Superior de Deportes ostenta un interés manifiesto en establecer un marco de colaboración con la SGAD para la utilización de los servicios compartidos mencionados y su implantación.

## Undécimo.

Que es posible la aplicación del Fondo de Recuperación Next Generation EU, como instrumento destinado a hacer efectiva la Medida 7 «Servicio de infraestructuras cloud» para el fortalecimiento de la solución de nube híbrida NubeSARA. Mediante el presente convenio, se facilita al Consejo Superior de Deportes que pueda hacer uso del servicio NubeSARA.
...
1. Constituye el objeto del presente convenio el establecimiento de un marco de colaboración entre la Secretaría General de Administración Digital (en adelante, SGAD) y el Consejo Superior de Deportes para el desarrollo de actuaciones conjuntas que permitan el uso del servicio NubeSARA de acuerdo con los términos y condiciones generales expuestos a continuación y que conferirán al Consejo Superior de Deportes la condición de Centro Usuario de NubeSARA.
...
1.º Poner a disposición del Consejo Superior de Deportes el servicio NubeSARA en su modalidad Infraestructura como Servicio (IaaS, por sus siglas en inglés) y actuar como administrador de la infraestructura de sistemas, comunicaciones y almacenamiento necesaria para proporcionar dicho servicio.

2.º Adscribir los medios humanos y técnicos necesarios para la adecuada adaptación e implantación del servicio para su utilización por parte del Consejo Superior de Deportes.
...
5.º Notificar a los responsables del servicio en el Consejo Superior de Deportes cualquier intervención, actuación o problema que pudiera afectar al adecuado funcionamiento del servicio.

6.º Poner a disposición del Consejo Superior de Deportes las licencias relativas a los sistemas operativos Windows y Red Hat que precise la infraestructura acordada según lo descrito en el anexo I.

7.º Atender las incidencias y peticiones realizadas por parte del Consejo Superior de Deportes en relación con el funcionamiento del servicio, de acuerdo con lo señalado en los anexos I y II.
...
El Consejo Superior de Deportes, a través de la unidad designada, se compromete a cumplir las siguientes obligaciones:
...
A partir del año 2026, la SGAD continuará aportando la infraestructura tecnológica, de la que se beneficiarán los usuarios, entre ellos el Consejo Superior de Deportes, que deberá ser actualizada y mejorada de forma continua para garantizar la renovación de la inversión, su correcta actualización y mejora tecnológica sin riesgo de obsolescencia.
...
## Séptima. Obligaciones económicas del Consejo Superior de Deportes.

1. El Consejo Superior de Deportes contribuirá anualmente, con una contraprestación económica que se determina en base al uso del servicio, al mantenimiento de:
...
2. No obstante, hasta el fin del año 2025 la inversión en infraestructura de nube híbrida NubeSARA realizada por la SGAD está financiada con cargo al Fondo de Recuperación Next Generation EU, y en el cálculo de la contribución del Consejo Superior de Deportes no se incluirá la parte correspondiente de dicha inversión.

3. A partir del año 2026, la contribución del Consejo Superior de Deportes tendrá en cuenta tanto los recursos necesarios para la operación como la parte proporcional de la inversión necesaria para la renovación y ampliación de la infraestructura.

4. Al ser NubeSARA una infraestructura compartida y utilizada de forma simultánea por todos los órganos y organismos usuarios del servicio, la contribución del Consejo Superior de Deportes en cualquiera de los conceptos estará siempre asociada a los recursos que el Consejo Superior de Deportes utilice del total disponible en NubeSARA, basándose en los costes unitarios recogidos en el anexo I.
...
Con el objetivo de colaborar en la sostenibilidad funcional y técnica de los servicios compartidos, el Consejo Superior de Deportes contribuirá con una contraprestación económica que se determina en base al uso de dichos servicios.

De los servicios del catálogo de la SGAD, el Consejo Superior de Deportes ha mostrado interés en utilizar algunos de ellos con la siguiente estimación inicial de uso de recursos en el primer año:

– NubeSARA-Cómputo-x86 sin licencia.

● 28 vCPUs, 50 GB de RAM y 2,40 TB de disco.

– NubeSARA-Cómputo-x86 Windows.

● 50 vCPUs, 96 GB de RAM y 4,10 TB de disco.

– NubeSARA-Backup-Cómputo.

● 4,2 TB mediante snapshot.

– NubeSARA-Servicios complementarios.

● 1 Servicio de balanceo.

El importe unitario de los servicios comunes de la SGAD que utilizará el Consejo Superior de Deportes, incluyendo las modalidades, calidades y opciones deseadas se encuentra en las tablas correspondientes del anexo I.
