---
identificador: "BOE-A-2024-26739"
...
diario_numero: "307"
pagina_inicial: 176326
pagina_final: 176339
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-26739"
url_pdf: "https://www.boe.es/boe/dias/2024/12/21/pdfs/BOE-A-2024-26739.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-26739"
url_eli: ""
fetched_at: "2026-04-10T03:34:29Z"
...
El Subdirector General de Planificación y Gobernanza de la Administración Digital y el Director General de Tráfico, han suscrito un convenio para la prestación de la solución de nube híbrida NubeSARA, financiado en parte por la Unión Europea, en el marco del Plan de Recuperación, Transformación y Resiliencia-Fondo de Recuperación *Next Generation EU.*
...
Que son competencias de la Dirección General de Tráfico, establecidas en Real Decreto 207/2024, de 27 de febrero, por el que se desarrolla la estructura orgánica básica del Ministerio del Interior, la creación de los registros informáticos y bases de datos necesarios para la ejecución de las competencias del organismo, la función de dar soporte en tecnologías de la información a las unidades del organismo, y el impulso, coordinación y puesta en marcha de los servicios de administración electrónica y la gestión de las tecnologías de la información y las comunicaciones del organismo.
...
Que la Dirección General de Tráfico ostenta un interés manifiesto en establecer un marco de colaboración con la SGAD para la utilización de los servicios compartidos mencionados y su implantación.

## Undécimo.

Que es posible la aplicación del Fondo de Recuperación *Next Generation EU,* como instrumento destinado a hacer efectiva la Medida 7 «Servicio de infraestructuras *cloud*» para el fortalecimiento de la solución de nube híbrida NubeSARA. Mediante el presente convenio, se facilita a la Dirección General de Tráfico que pueda hacer uso del servicio NubeSARA.
...
1. Constituye el objeto del presente convenio el establecimiento de un marco de colaboración entre la Secretaría General de Administración Digital (en adelante, SGAD) y la Dirección General de Tráfico para el desarrollo de actuaciones conjuntas que permitan el uso del servicio NubeSARA de acuerdo con los términos y condiciones generales expuestos a continuación y que conferirán a la Dirección General de Tráfico la condición de Centro Usuario de NubeSARA.
...
1.º Poner a disposición de la Dirección General de Tráfico el servicio NubeSARA en su modalidad Infraestructura como Servicio (IaaS, por sus siglas en inglés) y actuar como administrador de la infraestructura de sistemas, comunicaciones y almacenamiento necesaria para proporcionar dicho servicio.

2.º Adscribir los medios humanos y técnicos necesarios para la adecuada adaptación e implantación del servicio para su utilización por parte de la Dirección General de Tráfico.
...
5.º Notificar a los responsables del servicio en la Dirección General de Tráfico cualquier intervención, actuación o problema que pudiera afectar al adecuado funcionamiento del servicio.

6.º Poner a disposición de la Dirección General de Tráfico las licencias relativas a los sistemas operativos Windows y Red Hat que precise la infraestructura acordada según lo descrito en el anexo I.

7.º Atender las incidencias y peticiones realizadas por parte de la Dirección General de Tráfico en relación con el funcionamiento del servicio, de acuerdo con lo señalado en los anexos I y II.
...
## Tercera. Obligaciones de la Dirección General de Tráfico.

La Dirección General de Tráfico, a través de la unidad designada, se compromete a cumplir las siguientes obligaciones:
...
3. En caso de incumplimiento del presente convenio imputable a la Dirección General de Tráfico, se aplicarán las medidas incluidas en la normativa nacional y europea relativa al destino del Fondo de Recuperación Next Generation EU.
...
A partir del año 2026, la SGAD continuará aportando la infraestructura tecnológica, de la que se beneficiarán los usuarios, entre ellos la Dirección General de Tráfico, que deberá ser actualizada y mejorada de forma continua para garantizar la renovación de la inversión, su correcta actualización y mejora tecnológica sin riesgo de obsolescencia.
...
## Séptima. Obligaciones Económicas de la Dirección General de Tráfico.

1. La Dirección General de Tráfico contribuirá anualmente, con una contraprestación económica que se determina en base al uso del servicio, al mantenimiento de:
...
2. No obstante, hasta el fin del año 2025 la inversión en infraestructura de nube híbrida NubeSARA realizada por la SGAD está financiada con cargo al Fondo de Recuperación *Next Generation EU,* y en el cálculo de la contribución de la Dirección General de Tráfico no se incluirá la parte correspondiente de dicha inversión.

3. A partir del año 2026, la contribución de la Dirección General de Tráfico tendrá en cuenta tanto los recursos necesarios para la operación como la parte proporcional de la inversión necesaria para la renovación y ampliación de la infraestructura.

4. Al ser NubeSARA una infraestructura compartida y utilizada de forma simultánea por todos los órganos y organismos usuarios del servicio, la contribución de la Dirección General de Tráfico en cualquiera de los conceptos estará siempre asociada a los recursos que la Dirección General de Tráfico utilice del total disponible en NubeSARA, basándose en los costes unitarios recogidos en el anexo I.
...
| Servicios NubeSARA | Importe anual | Importe relativo a gasto | Importe relativo a inversión |  |
| --- | --- | --- | --- | --- |
...
De los servicios del catálogo de la SGAD, la Dirección General de Tráfico ha mostrado interés en utilizar algunos de ellos con la siguiente estimación inicial de uso de recursos en el primer año:

– NubeSARA-Objetos.

• 90 TB.

El importe unitario de los servicios comunes de la SGAD que utilizará la Dirección General de Tráfico, incluyendo las modalidades, calidades y opciones deseadas se encuentra en las tablas correspondientes del anexo I.
