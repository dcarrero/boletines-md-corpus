---
identificador: "BOE-A-2024-5634"
titulo: "Resolución de 18 de marzo de 2024, de la Secretaría General del Senado, por la que se convoca proceso selectivo para la provisión, en régimen de contratación laboral, de plaza de Arquitecto/a Técnico/a."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
pagina_final: 33091
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-5634"
url_pdf: "https://www.boe.es/boe/dias/2024/03/21/pdfs/BOE-A-2024-5634.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-5634"
url_eli: ""
...
Si el/la aspirante propuesto/a alegase grado de discapacidad deberá presentar, junto con la mencionada documentación, certificación de los órganos competentes del Ministerio de Derechos Sociales y Agenda 2030 o, en su caso, de la comunidad autónoma correspondiente, que acredite tanto su grado de discapacidad como su capacidad funcional para desempeñar las tareas propias de Arquitecto/a Técnico/a, si no lo hubiera aportado anteriormente.
...
16. Acciones en la edificación: generalidades, acciones permanentes, acciones variables, acciones accidentales y terminología, según Código Técnico de la Edificación CTE-DB SE-AE.

17. Código estructural (1). Principios generales. Bases para la contribución de la estructura a la sostenibilidad. Bases para el proyecto y criterios de seguridad. Criterios de ejecución de las estructuras. Gestión de la calidad de las estructuras. Principios generales de mantenimiento de las estructuras.

18. Código estructural (2). Estructuras de hormigón. Generalidades. Propiedades tecnológicas de los materiales. Clases de hormigones, composición y tipificación. Aceros para armaduras. Productos de inyección. Productos de protección del hormigón. Durabilidad de las estructuras de hormigón. Ejecución de estructuras de hormigón. Gestión de la calidad de los productos y de la ejecución de estructuras de hormigón.

19. Código estructural (3). Estructuras de acero. Clases de exposición. Tipos de acero y medios de unión. Durabilidad de las estructuras de acero. Fabricación y montaje de las estructuras de acero. Gestión de la calidad de los productos y de la ejecución de estructuras de acero.

20. Real Decreto 642/2002, de 5 de julio, por el que se aprueba la «Instrucción para el proyecto y la ejecución de forjados unidireccionales de hormigón estructural realizados con elementos prefabricados (EFHE)». Forjados de viguetas y losas alveolares: Consideraciones previas. Propiedades tecnológicas de los materiales. Disposiciones constructivas, ejecución y control.

21. Estructuras de madera: Propiedades de los materiales. Durabilidad. Materiales y uniones. Productos derivados. Ejecución, tolerancias y control. CTE-DB SE-M.

22. Carpintería de huecos. Normas UNE sobre colocación en obra, acristalamiento y sellados. Materiales de fabricación. Sistemas de apertura. Criterios de elección y mantenimiento. Ejecución de los trabajos, control y medición.

23. Fábricas de ladrillo y bloques. Generalidades. Capacidad portante. Juntas de movimiento y aptitud al servicio según CTE-DB SE-F. Materiales y soluciones constructivas. Ejecución de los trabajos, control y medición.

24. Muros, suelos, fachadas y cubiertas según CTE-DB HS-1: Criterios de diseño y ejecución para protegerlos frente a la humedad. Características exigibles a los productos de construcción. Ejecución de los trabajos. Control y medición. Mantenimiento y conservación.

25. Particiones interiores, fachadas, suelos y cubiertas según CTE-DB-HR: Exigencias de diseño y nivel de aislamiento acústico. Características exigibles a los productos de construcción. Ejecución y control. Mantenimiento y conservación.

26. Seguridad en caso de incendio. CTE-DB-SI. Instalaciones de protección contra incendios. Exigencias en edificios de uso administrativo y pública concurrencia. Reglamento de instalaciones de protección contra incendios, Real Decreto 513/2017. Instalación, puesta en servicio y mantenimiento de instalaciones de protección contra incendios.

27. Seguridad de utilización según CTE-DB-SUA. Seguridad frente al riesgo de caídas. Seguridad frente al riesgo de impacto o aprisionamiento. Seguridad frente al riesgo causado por iluminación inadecuada. Alta ocupación. Exigencias en edificios de uso administrativo y de pública concurrencia.

28. Calidad del aire interior. CTE-DB-HS3. Exigencias de diseño. Dimensionado. Ejecución. Productos de construcción. Mantenimiento y conservación.

29. Suministro y evacuación de aguas según CTE-DB-HS4 y HS5. Exigencias, dimensionado y ejecución. Productos de construcción. Mantenimiento y conservación.

30. Ahorro de energía según CTE-DB-HE. Limitación del consumo energético y condiciones para el control de la demanda energética. Condiciones de las instalaciones de iluminación. La certificación energética de los edificios y el informe de evaluación de los edificios en lo referente a eficiencia energética según el RD 390/2021.

31. Demoliciones: Sistemas. Procesos de demolición según el sistema utilizado: Riesgos más frecuentes y sus medios preventivos. Estudio de gestión de residuos de construcción y demolición. Gestión de residuos de construcción y demolición. Normativa de aplicación.

32. Patología de las edificaciones: Análisis del proceso patológico del edificio, deficiencias constructivas y sus causas.

33. Las humedades en la edificación. Definiciones y tipología. Análisis del fenómeno, causas y efectos: humedades por filtración, por absorción y por condensación. Medidas preventivas para su reparación y tratamiento.

34. Instalaciones eléctricas y de telecomunicaciones interiores. Normativa de aplicación. Condiciones de ejecución. Controles de calidad. Pruebas. Análisis de los riesgos y medidas de seguridad durante su ejecución. Criterios de medición y valoración. Conservación y mantenimiento.

35. Instalaciones térmicas y de fontanería y saneamiento en los edificios. Descripción y características de las diferentes tipologías. Normativa de aplicación. Condiciones de ejecución. Análisis de los riesgos y medidas de seguridad durante su ejecución. Controles de calidad. Criterios de medición y valoración. Conservación y mantenimiento.

36. Instalaciones sostenibles en la edificación: generación de energía solar fotovoltaica, reutilización de aguas pluviales y grises. Geotermia. Climatización por absorción y cogeneración.

37. Accesibilidad en la edificación según CTE-DB-SUA9. Normativa básica estatal y autonómica. Disposiciones reguladoras de las condiciones básicas de accesibilidad en la edificación. Adecuación efectiva de las condiciones de accesibilidad en edificios existentes.

38. Prevención de Riesgos Laborales. Ley 31/1995, de 8 de noviembre. Disposiciones generales. Evaluación de riesgos y planificación de la actividad preventiva.

39. Seguridad y salud en las obras de construcción. El estudio y estudio básico de seguridad y salud en las obras. RD 1627/1997, de 24 de octubre.

40. Planes de autoprotección. Concepto. Documentos que lo componen. La norma básica de autoprotección: Real Decreto 393/2007, de 23 de marzo.

41. Organización de obras. Planificación y programación de proyectos. Diagrama de GANTT. Método PERT, tiempos y probabilidad del cumplimiento de las previsiones. Relación plazos/costes. Control integrado de plazos y costes.

42. Sostenibilidad ambiental en la edificación. Conceptos generales. Análisis de ciclo de vida. Sistemas de gestión ambiental. Ecoetiquetas. Declaraciones ambientales de producto. Certificados de construcción sostenible: BREEAM, Verde.

43. Metodología BIM *(Building Information Modelling)* en el proyecto, construcción y mantenimiento de edificios. Fundamentos BIM para la contratación pública.

44. Plan Estratégico de Gestión Sostenible del Senado 2021-2024. Sostenibilidad de los edificios.

45. Mantenimiento integral en edificación (I). Tipos de mantenimiento. Planificación del mantenimiento. Herramientas de planificación. Obligaciones legales de mantener. Economía, eficiencia y vida útil de la edificación.

46. Mantenimiento integral en edificación (II). Contaminantes en la edificación. Radón. Calidad microbiológica. Limpieza y desinfección. Plan de uso. Plan de evacuación.
