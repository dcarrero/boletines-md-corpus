---
identificador: "BOE-A-2024-9551"
titulo: "Resolución de 26 de abril de 2024, de la Subsecretaría, por la que se convoca concurso general para la provisión de puestos de trabajo."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
Madrid, 26 de abril de 2024.–El Subsecretario de Trabajo y Economía Social, José Ramón del Prado Cortés.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1 | 4985541 | JEFE / JEFA DE SECCION N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Participación en la organización y ejecución de actos protocolarios e institucionales.
 - Elaboración de proyectos de actos: escaleta de intervinientes y relaciones de invitados, diseño de invitaciones, elaboración de carteles de mesa, recepción de visitas, etc.
 - Planificación y preparación de programas de actos protocolarios e institucionales, con aplicación del RD de Precedencias.
 - Conocimiento y manejo de aplicaciones informáticas de tratamiento de texto, bases de datos y presentaciones.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | 1 | 3537443 | JEFE / JEFA DE SECCION N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión administrativa del almacén en relación con el material de oficina no inventariable, consumibles de informática, material impreso, suministro de papel y otro tipo de material.
 ...
 - Atención a proveedores y usuarios.
...
| 3 | 1 | 3696693 | JEFE / JEFA DE SECCION N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Elaboración y tramitación de nóminas para el personal funcionario y laboral en el exterior, así como la elaboración de las cuentas justificativas de nóminas ordinarias y de incidencias.
 - Manejo de la aplicación informática de Nedaes (Nómina Estándar Descentralizada de la Administración del Estado), aplicación SOROLLA2 y aplicación IRIS de la Intervención General de la Administración del Estado.
 - Elaboración de ficheros de transferencias y cheques SEPA a través de banca electrónica y aplicación NOMO para divisa del Banco de España.
 - Confección, tramitación y remisión de documentación a Muface Cotiza, Tesorería General de la Seguridad Social, Balanza de Pagos e INE.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 4 | 1 | 4263348 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Preparación y remisión de expedientes administrativos a los Juzgados, Tribunales Superiores de Justicia, Audiencia Nacional y otras instancias judiciales a través de la plataforma INSIDE, así como tramitación de expedientes en ejecución de sentencias.
 - Clasificación, registro y arhivo de documentos.
 - Redacción de oficios, certificados y correos electrónicos relacionados con procedimientos administrativos.
 - Manejo de las aplicaciones informáticas: Geiser, Notifica y Portafirmas.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 5 | 1 | 4985562 | PUESTO DE TRABAJO N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tareas de apoyo en materia de personal y seguimiento de bases de datos.
 - Tramitación de los servicios y suministros del área, mediante contratos menores y anticipos de caja fija, en todas sus fases.
 - Uso, aplicación y seguimiento de aplicaciones informáticas, entre otras las de reserva de salas.
 - Gestión del servicio de notificaciones electrónicas de la Dirección Electrónica Habilitada Ünica (DEHú).
...
| 6 | 1 | 3537590 | JEFE / JEFA DE NEGOCIADO | - MADRID
 - MADRID | 16 | 8.216,18 | C1
 C2 | AE | EX11 |  |  | APC1 | **Descripción del puesto de trabajo:**
 
 - Atención e información al público en unidades de información administrativa, tanto presencial como telefónica.
 - Conocimiento actualizado de la estructura organizativa de la Administración Pública.
 - Conocimiento actualizado de la normativa sociolaboral.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 7 | 1 | 1624608 | JEFE / JEFA DE NEGOCIADO DE ATENCION AL PUBLICO N16 | - MADRID
 - MADRID | 16 | 8.520,40 | C1
 C2 | AE | EX11 |  |  | APC1 | **Descripción del puesto de trabajo:**
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 8 | 1 | 4152635 | AYUDANTE DE OFICINA N14 | - MADRID
 - MADRID | 14 | 8.204,42 | C2 | AE | EX11 |  |  | APC1 | **Descripción del puesto de trabajo:**
 
 - Registro General: registro de personas y de documentación.
 - Uso y manejo de aplicaciones informáticas relacionadas con la identificación y firma electrónica.
 - Tareas de apoyo administrativo y manejo de aplicaciones informáticas, Portafirmas, DocelWeb y Geiser.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 9 | 1 | 2953226 | ANALISTA DE SISTEMAS | - MADRID
 - MADRID | 22 | 10.522,26 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión, manejo y mantenimiento de la infraestructura de backup (Copias de seguridad) formada por la solución de VERITAS NETBACKUP y robots de cintas Oracle.
 - Mantenimiento de las infraestructuras del CPD (Centro de Proceso de Datos).
 - Redacción de documentación preparatoria de contratos de carácter informático tramitados a través de las diferentes modalidades de contratación: Contrato menor, caja fija, contratación centralizada, concursos abiertos, etc.
 - Manejo de la PLACSP (Plataforma de Contratación del Sector Público) en la parametrización de licitación (construcción) y posterior apertura pública.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 6,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 10 | 1 | 2223650 | ANALISTA FUNCIONAL | - MADRID
 - MADRID | 20 | 9.031,68 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Administración de almacenamiento (HP 3PAR 8440 y 7440, NetApp FAS 8300, Windows System Storage Server/TrueNAS).
 - Instalación, Configuración y Administración de VMWare 7, Linux (Oracle Linux, RHEL y Debian).
 - Soporte de Sistemas para la entidad de certificación (CA) y el SGBD Oracle.
 - Instalación y configuración de herramientas de monitorización (Nagios, Grafana y CockpiT).
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 6,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 5,00 pts.). |  |
| 11 | 1 | 2255463 | ANALISTA PROGRAMADOR | - MADRID
 - MADRID | 20 | 6.476,26 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Administración de la plataforma @firma: gestión usuarios, gestión aplicaciones, carga de políticas de certificación, reinicio servidores, detección de incidentes y revisión de logs.
 - Administración de aplicaciones de firma electrónica: portafirmas AGE federado (gestión de usuarios, gestión de aplicaciones, detección de incidencias, reinicio servidores, actualización de versiones Servidor de Aplicaciones...) y Firmas XL (gestión de usuarios, integración de aplicaciones, detección y gestión de incidencias).
 - Gestión Geiser y REGECO: gestión de usuarios, gestión de aplicaciones integradas con REGECO, gestión de incidencias y ayuda a los usuarios en la utilización de la herramienta.
 - Administración CA interna con herramienta EJBCA, gestión de usuarios y certificados y gestión de servidor de aplicaciones y frontal Apache.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 12 | 1 | 2058799 | PUESTO DE TRABAJO N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo administrativo en las relaciones internacionales con otros países y organizaciones internacionales.
 - Recopilación de información periódica, actualización de listados y maquetación de informes en el ámbito de las relaciones internacionales o las políticas sociales.
 - Realización, seguimiento y liquidación de las comisiones de servicio mediante el manejo del programa SOROLLA2, entre otros, en el ámbito nacional e internacional.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 4,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 13 | 1 | 3521415 | JEFE / JEFA DE SECCION N22 | - MADRID
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 4,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 14 | 1 | 4364155 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tareas administrativas en el seguimiento de las relaciones internacionales con terceros países y organizaciones internacionales.
 - Gestión de bienes materiales, servicios comunes y suministros.
 - Gestión de documentos y archivo, especialmente los informatizados y utilización de Geiser.
 - Manejo de aplicaciones informáticas.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 4,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 15 | 1 | 1380203 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 3.961,16 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tareas administrativas en el seguimiento de las relaciones internacionales con terceros países y organizaciones internacionales en materia de cooperación internacional y seguimiento de acuerdos bilaterales.
 - Gestión de documentos y archivo, especialmente los informatizados y utilización de Geiser.
 - Realización, seguimiento y liquidación de las comisiones de servicio mediante el manejo del programa SOROLLA2, entre otros, en el ámbito nacional e internacional.
 - Manejo de aplicaciones informáticas.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 16 | 1 | 1627201 | JEFE / JEFA DE SECCION N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Manejo de la aplicación de recursos VMEXPINTRA 2:8080.
 - Apoyo administrativo, registro, clasificación y archivo de documentos.
 - Remisión de expedientes a los juzgados y tribunales de justicia.
 - Manejo de las aplicaciones Geiser, Notifica, Inside, Portafirmas y paquete Office.
...
| 17 | 1 | 2454750 | JEFE / JEFA DE SECCION DE APOYO | - MADRID
 - MADRID | 22 | 4.589,76 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo en tareas de proceso técnico del Archivo Central: ingreso, proceso técnico, transferencias y eliminaciones de documentación.
 - Apoyo administrativo al Archivo Central (paquete Office, herramientas de Administración electrónica Geiser, sede electrónica, Notifica, etc.).
 - Apoyo en las tareas de descripción y catalogación de documentos.
 - Apoyo en la gestión de usuarios internos y externos del Archivo Central.
...
| 18 | 1 | 3998798 | JEFE / JEFA DE SECCION N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión de la difusión institucional y distribución comercial de publicaciones y suscripciones a la Revista (Albaranes y facturas).
 - Control y seguimiento de envíos de las publicaciones.
 - Organización y control de los almacenes del Centro de Publicaciones.
 - Manejo de programas informáticos, archivo y gestión de documentos electrónicos.
 ...
 **Méritos específicos:**
 ...
 4. Experiencia en tareas similares a las de la función 4 (máx: 15,00 pts.). |  |
| 19 | 1 | 2200688 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Cotejo, proceso técnico y signaturado de documentación ingresada por transferencia sobre la aplicación "Archivo Central".
 - Descripción básica de documentos de archivo.
 - Atención a usuarios del procedimiento 203447 y acceso y consulta de documentos custodiados en el Archivo Central.
 - Asistencia en el control de instalación y condiciones ambientales de depósito de archivos, altas y bajas de documentación.
 ...
 **Méritos específicos:**
 ...
 4. Experiencia en tareas similares a las de la función 4 (máx: 4,00 pts.). |  |
| 20 | 1 | 3699015 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo a las tareas de gestión de la colección bibliográfica en bibliotecas.
 - Manejo de aplicaciones informáticas de gestión de bibliotecas (AbsysNet, Symphony, Kobli, Millenium).
 ...
 **Méritos específicos:**
 ...
 1. Experiencia en tareas similares a las de la función 1 (máx: 15,00 pts.).
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.). |  |
| 21 | 1 | 4283108 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo en la gestión de la difusión institucional y distribución comercial de publicaciones (albaranes y facturas) y apoyo a la Unidad económica de Publicaciones.
 - Tramitación de solicitudes de publicaciones e información de estas a través de correo electrónico.
 - Control del stock en almacenes.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 2,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 15,00 pts.). |  |
| 22 | 1 | 750072 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo a las tareas de gestión de la colección bibliográfica en bibliotecas.
 - Manejo de aplicaciones informáticas de gestión de bibliotecas (AbsyNet, Symphony, Kobli, Millenium).
 ...
 **Méritos específicos:**
 ...
 1. Experiencia en tareas similares a las de la función 1 (máx: 15,00 pts.).
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.). |  |
| 23 | 1 | 1073736 | PROGRAMADOR / PROGRAMADORA DE PRIMERA | - MADRID
 - MADRID | 17 | 6.049,40 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo administrativo, registro, clasificación y archivo de documentos.
 - Manejo de herramientas ofimáticas, correo electrónio y paquete Office.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 24 | 1 | 2363138 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Asistencia en la atención telefónica y la derivación de las consultas que se reciben de las CCAA, los organismos de la Administración General del Estado y las entidades de acción social.
 - Preparación y realización de envíos de documentación, convocatorias y comunicaciones y mantenimiento y actualización del buzón de correo electrónico.
 - Asistencia en la preparación y justificación de las comisiones de servicio mediante uso de la aplicación Sorolla.
 - Asistencia en la organización de reuniones y actos públicos, tanto nacionales como internacionales.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 25 | 1 | 3548188 | JEFE / JEFA DE NEGOCIADO DE ESTADISTICA N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Manejo de hojas de cálculo en Excel.
 - Organización y gestión del correo electrónico y atención de peticiones de información.
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 8,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 7,00 pts.). |  |
| 26 | 1 | 899767 | JEFE / JEFA DE NEGOCIADO DE ESTADISTICA N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 27 | 1 | 4718164 | JEFE / JEFA DE SECCION N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Gestión de expedientes de regulación de empleo.
 - Gestión del registro de convenios colectivos, acuerdos colectivos de trabajo y planes de igualdad.
 - Comunicaciones con otros organismos administrativos y judiciales.
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 10,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 5,00 pts.). |  |
| 28 | 1 | 1847168 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tramitación administrativa de expedientes de regulación de empleo y manejo de aplicación SERENA.
 - Apoyo en tareas administrativas.
 - Gestión de registros de entrada y salida de documentos y manejo de la Aplicación Geiser.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 29 | 1 | 4190025 | JEFE / JEFA DE SECCION N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Apoyo a secretaría.
 - Registro, clasificación y archivo de documentos, catalogación de registros bibliográficos y gestión, seguimiento y actualización de bases de datos e informes.
 - Elaboración de comisiones de servicio y liquidaciones de viajes.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 30 | 1 | 1345265 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tareas de secretaría, gestión de correspondencia, registro y control de documentación.
 - Información, atención y orientación telefónica.
 - Gestión informática de tareas administrativas.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 31 | 1 | 4713840 | PUESTO DE TRABAJO N22 | - MADRID
 - MADRID | 22 | 4.890,62 | A2
 C1 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Colaboración en la gestión de las convocatorias de subvenciones relativas al fomento del trabajo autónomo.
 - Revisión de documentación y análisis del cumplimiento de los requisitos de las solicitudes de la convocatoria de subvenciones, utilizando las aplicaciones informáticas; Excel, Access, sede electrónica y BDNS.
 - Gestión y análisis de las justificaciones de las subvenciones concedidas y gestión de procedimientos de reintegro.
 - Gestión, seguimiento y control del expediente de gasto de subvenciones a través de SOROLLA2 y del SIC 3 y confección de documentos contables.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 8,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 6,00 pts.). |  |
| 32 | 1 | 1403040 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 3.961,16 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Colaboración en la gestión de las convocatorias de subvenciones relativas al fomento del trabajo autónomo.
 - Revisión de documentación y análisis del cumplimiento de los requisitos de las solicitudes de la convocatoria de subvenciones.
 - Gestión y análisis de las justificaciones de las subvenciones concedidas.
 - Gestión, seguimiento y control del expediente de gasto de subvenciones a través de SOROLLA2 y SIC 3 y confección de documentos contables.
 ...
 **Méritos específicos:**
 ...
 3. Experiencia en tareas similares a las de la función 3 (máx: 6,00 pts.).
 4. Experiencia en tareas similares a las de la función 4 (máx: 6,00 pts.). |  |
| 33 | 1 | 2922106 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 3.961,16 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Colaboración en la gestión de las convocatorias de subvenciones relativas al fomento del trabajo autónomo.
 - Revisión de documentación y análisis del cuplimiento de los requisitos de las solicitudes de la convocatoria de subvenciones.
 - Gestión y análisis de las justificaciones de las subvenciones concedidas.
 - Gestión, seguimiento y control del expediente de gasto de subvenciones a través de SOROLLA2 y SIC 3 y confección de documentos contables.
...
| N.º Orden | N.º Plazas | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 34 | 1 | 957316 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
 
 - Tareas de apoyo administrativo en la tramitación de expedientes soporte papel y telemático en Registro Administrativo.
 - Gestión y almacenamiento de documentos administrativos en soporte papel y telemático.
 - Atención telefónica.
 - Utilización de aplicaciones informáticas como Geiser o Portafirmas, así como procesadores de textos, hojas de cálculo y correo electrónico.
 ...
 **Méritos específicos:**
 ...
 2. Experiencia en tareas similares a las de la función 2 (máx: 7,00 pts.).
 3. Experiencia en tareas similares a las de la función 3 (máx: 4,00 pts.).
 4. Experiencia en tareas similares a las de la función 1 (máx: 7,00 pts.). |  |
| 35 | 1 | 1894132 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 4.589,76 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
...
| N.º Orden | Código puesto | Denominación del puesto de trabajo | Provincia/Localidad | Nv/
 ...
 SB | ADM | Cuerpo | Tit. req. | Form. req. | Observ. | Información relacionada con el puesto de trabajo | M/E |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 2206393 | JEFE / JEFA DE NEGOCIADO N18 | - MADRID
 - MADRID | 18 | 3.961,16 | C1
 C2 | AE | EX11 |  |  |  | **Descripción del puesto de trabajo:**
...
## ANEXO IV. A. Consentimiento para cuidado de hijo e hija
