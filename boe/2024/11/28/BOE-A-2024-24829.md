...
diario_numero: "287"
pagina_inicial: 160369
pagina_final: 160384
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-24829"
url_pdf: "https://www.boe.es/boe/dias/2024/11/28/pdfs/BOE-A-2024-24829.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-24829"
url_eli: ""
fetched_at: "2026-04-10T02:05:28Z"
...
Madrid, 19 de noviembre de 2024.–La Directora General del Instituto de Mayores y Servicios Sociales, María Teresa Sancho Castiello.
...
Y de otra, la Hble. Sra. Susana Camarero Benítez, como Vicepresidenta y Consellera de Servicios Sociales, Igualdad y Vivienda de la Administración de la Generalitat Valenciana, en nombre y representación de la Generalitat Valenciana, en virtud de lo dispuesto en la Ley 5/1983, de 26 de diciembre del Consell, y de conformidad con el Decreto 18/2024, de 12 de julio, del President de la Generalitat, por el que se nombra a la persona titular de la vicepresidencia i conselleria de Servicios Sociales, Igualdad y Vivienda y con el acuerdo del Consell de la Generalitat Valenciana.
...
Que, por su parte, la Administración de la Generalitat Valenciana ha dispuesto, en sus presupuestos correspondientes al año 2024, créditos para la atención a las personas en situación de dependencia en aplicación de lo previsto en el artículo 32 de la Ley 39/2006, de 14 de diciembre.
...
La Administración de la Generalitat Valenciana aportará, para la financiación del presente convenio, con cargo a sus propios presupuestos, un crédito inicial de sesenta y ocho millones ciento once mil cincuenta y cuatro euros con cuatro céntimos (68.111.054,04 euros), con cargo a la aplicación presupuestaria G01160301313G00.4, línea S0391.
...
| Descripción de la medida. | Creación de una unidad de gestión de los trámites necesarios para la comprobación de la justificación del objeto de las Prestaciones Vinculadas al Servicio y de Asistente Personal, revisando la documentación presentada por las personas dependientes (contrato, facturas, etc…) y requiriendo, en su caso, la documentación necesaria a las empresas prestadoras de los correspondientes servicios. |
| --- | --- |
| Línea de base a 1 de enero de 2024. | N.º personas atendidas a 1-1-24: 147.779 (dato Vicepresidencia y Conselleria de Servicios Sociales, Igualdad y Vivienda) 146.290 (dato IMSERSO). |
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | N.º personas atendidas a 31-12-24: 152.212 (dato Vicepresidencia y Conselleria de Servicios Sociales, Igualdad y Vivienda) 150.679 (dato IMSERSO). |
| Indicadores de verificación de cumplimiento. | Aumento de un 3 % del número de personas atendidas. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 66.577.894,04 |
| Observaciones. |  |

| Descripción de la medida. | Las mejoras en la aplicación informática ADA3 se extienden en el año 2024 a la realización de la resolución de la prestación o servicio de dependencia, lo que lleva consigo el cálculo del importe de la prestación y el cálculo del importe de la tasa en el caso de los servicios de atención residencial, así como la emisión de la resolución que se notificará a la persona dependiente.
 Esta medida agilizará los procesos de resolución y notificación de prestaciones y servicios. |
| --- | --- |
| Línea de base a 1 de enero de 2024. | N.º personas atendidas a 1-1-24: 147.779 (dato Vicepresidencia y Conselleria de Servicios Sociales, Igualdad y Vivienda) 146.290 (dato IMSERSO). |
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | N.º personas atendidas a 31-12-24: 152.212 (dato Vicepresidencia y Conselleria de Servicios Sociales, Igualdad y Vivienda) 150.679 (dato IMSERSO). |
| Indicadores de verificación de cumplimiento. | Aumento de un 3 % del número de personas atendidas. |
...
| Descripción de la medida. | Aumento del número de entidades locales (municipios/mancomunidades) que prestan el Servicio de Ayuda a Domicilio, lo que permitirá ofrecer este servicio en más localidades. |
| --- | --- |
| Situación a 1 de enero de 2024. | N.º de entidades locales que prestan el SAD financiado por la GV a 31-12-2023: 139. |
| Impacto esperado para 2024 (hasta 31 de diciembre de 2024). | N.º de entidades locales que prestan el SAD financiado por la GV a 31-12-2024: 143. Se incorporan Vila-real, Vila Joiosa, L’Olleria i Sant Vicent del Raspeig. |
| Indicadores de verificación de cumplimiento. | Aumento de un 2,88 % de entidades locales que ofrecen el SAD público de dependencia. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 914.000 euros. |
| Observaciones. |  |
...
| Descripción de la medida. | Aumento destinado a Entidades Locales para la contratación de personal destinado a tareas de gestión de expedientes de dependencia. |
| --- | --- |
| Situación a 1 de enero de 2024. | Propuesta de contratación de 872 trabajadores, 20 más que en 2023. |
| Impacto esperado para 2024 (hasta 31 de diciembre de 2024). | Contratación de 872 trabajadores, 20 más que en 2023. |
| Indicadores de verificación de cumplimiento. | Aumento de 2,35 % en el número de trabajadores contratados. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 619.160 euros. |
| Observaciones. |  |

## ANEXO II. Certificado justificativo de las aportaciones recogidas en el Convenio entre la Administración General del Estado y la Administración de la Comunidad Autónoma para el desarrollo del Marco de cooperación interadministrativa previsto en la Ley 39/2006, de 14 de diciembre, de Promoción de la Autonomía Personal y Atención a las personas en situación de dependencia y para el establecimiento y financiación del nivel de protección acordado para el ejercicio 2024
