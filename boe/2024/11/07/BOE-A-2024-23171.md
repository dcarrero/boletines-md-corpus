...
diario_numero: "269"
pagina_inicial: 142460
pagina_final: 142476
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-23171"
url_pdf: "https://www.boe.es/boe/dias/2024/11/07/pdfs/BOE-A-2024-23171.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-23171"
url_eli: ""
fetched_at: "2026-04-10T00:38:10Z"
...
Madrid, 25 de octubre de 2024.–La Directora General del Instituto de Mayores y Servicios Sociales, María Teresa Sancho Castiello.
...
Que, por su parte, la Comunidad Autónoma de Castilla-La Mancha ha dispuesto, en sus presupuestos correspondientes al año 2024, créditos para la atención a las personas en situación de dependencia en aplicación de lo previsto en el artículo 32 de la Ley 39/2006, de 14 de diciembre.
...
La Comunidad Autónoma de Castilla-La Mancha aportará, para la financiación del presente convenio, con cargo a sus propios presupuestos, un crédito inicial de cuarenta y un millones quinientos diez mil cuatrocientos once euros con cincuenta y ocho céntimos (41.510.411,58 euros) con cargo a las aplicaciones presupuestarias 27.03.313H.4811G y 27.04.313D.24502.
...
d) Actuaciones en coherencia con los criterios de acreditación y calidad en los centros y servicios del SAAD aprobados por el Acuerdo del Consejo Territorial de Servicios Sociales y del Sistema para la Autonomía y Atención a la Dependencia sobre criterios comunes de acreditación y calidad de los centros y servicios del SAAD del 28 de junio de 2022.
...
g) Cualesquiera otras que vayan dirigidas al cumplimiento de las actuaciones contenidas y de los acuerdos, y que deberán constar en el anexo I de este convenio.
...
Y en prueba de conformidad, y para la debida constancia de todo lo convenido, las partes firman el presente convenio digitalmente, tomándose como fecha de formalización y eficacia del presente documento la fecha del último firmante (24 de octubre de 2024).–Por el Instituto de Mayores y Servicios Sociales, la Directora General, María Teresa Sancho Castiello.–Por la Comunidad Autónoma de Castilla-La Mancha, la Consejera de Bienestar Social, Bárbara García Torijano.
...
Acción núm. 1: Desarrollo del sistema de gestión informática del Sistema de Atención a la Dependencia

| Descripción de la medida. | Se continuará con la mejora del Sistema de gestión informática del SAAD mediante el desarrollo de las siguientes líneas de actuación:
 – Captura y traslado automático de datos contenidos en documentos pdf a la herramienta informática de dependencia SAAD.
 – Análisis y rediseño de los sistemas SAAD y GND mediante minería de procesos.
 – Generación de modelos de resoluciones e implantación de firma electrónica. |
| --- | --- |
| Línea de base a 1 de enero de 2024. | Expedientes ptes. de PIA en relación con las solicitudes recibidas en el año. 2.478/ 30.547.
 Expedientes ptes. de PIA efectivo: 2.022. |
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | Reducción de expedientes pendientes de PIA en relación con solicitudes recibidas en el año.
 Reducción expedientes ptes. de PIA efectivo. |
| Indicadores de verificación de cumplimiento. | Actuaciones informáticas realizadas. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 367.597,48 euros. |
...
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | Reducción de expedientes pendientes de PIA en relación con solicitudes recibidas en el año.
 Reducción expedientes ptes. de PIA efectivo. |
| Indicadores de verificación de cumplimiento. | Prórroga del programa temporal y continuidad de la contratación del personal asociado. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 897.980,00 euros. |
| Observaciones. |  |

Acción núm. 3: Revisión de protocolos para la mejora de la gestión de los servicios del SAAD

| Descripción de la medida. | Continuidad en el ejercicio 2024 de las actuaciones de revisión y adaptación de los protocolos de gestión de servicios del SAAD con la finalidad de reducir tiempos de valoración y de tramitación del PIA. |
| --- | --- |
| Línea de base a 1 de enero de 2024. | Expedientes ptes. de PIA en relación con las solicitudes recibidas en el año. 2.478/ 30.547.
 Expedientes ptes. de PIA efectivo: 2.022. |
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | Reducción de expedientes pendientes de PIA en relación con solicitudes recibidas en el año.
 Reducción expedientes ptes. de PIA efectivo. |
| Indicadores de verificación de cumplimiento. | Protocolos de gestión de servicios del SAAD, en especial de servicios de atención a mayores y servicio de ayuda a domicilio. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | Medida a realizar con personal público. |
| Observaciones. |  |

Acción núm. 4: Mejora de la gestión de la información entre los distintos profesionales que intervienen en el procedimiento de dependencia

| Descripción de la medida. | Continuar potenciando en el ejercicio 2024 la accesibilidad de la información para los profesionales de las distintas áreas que intervienen en la atención de las personas en situación de dependencia del módulo de recursos compartidos (historia social profesional) para poner a disposición de los profesionales información de servicios y prestaciones que recibe la persona como información relevante para la tramitación del procedimiento.
 Colaboración en el desarrollo de la Tarjeta Social Digital. |
| --- | --- |
| Línea de base a 1 de enero de 2024. | Expedientes ptes. de PIA en relación con las solicitudes recibidas en el año. 2.478/ 30.547.
 Expedientes ptes. de PIA efectivo: 2.022. |
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | Reducción de expedientes pendientes de PIA en relación con solicitudes recibidas en el año.
 Reducción expedientes ptes. de PIA efectivo. |
| Indicadores de verificación de cumplimiento. | Actuaciones de accesibilidad de la información. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | Medida a realizar con personal público. |
| Observaciones. |  |
...
Acción núm. 5: Implementación del Real Decreto 675/2023, de 18 de Julio en el SAAD de Castilla-La Mancha

| Descripción de la medida. | Implementación de las medidas previstas en el Real Decreto 675/2023, de 18 de julio en el Sistema de Atención a la Dependencia en Castilla-La Mancha. |
| --- | --- |
| Situación a 1 de enero de 2024. | Implementación de la nueva intensidad horaria al servicio de ayuda a domicilio, así como la adaptación de los sistemas informáticos.
 Continuidad en el establecimiento del servicio de teleasistencia como derecho subjetivo. |
| Impacto esperado para 2024 (hasta 31 de diciembre). | Adaptación de la normativa autonómica e implementación en prestaciones del SAAD:
 – Medidas de flexibilización de requisitos para el acceso a las PECEF.
 – Mejoras en cuantías máximas y mínimas de las prestaciones económicas.
 – Adecuación de la normativa de acreditación de empresas, entidades y profesionales que prestan el servicio de asistencia personal.
 – Revisión de compatibilidades entre servicios y prestaciones económicas.
 – Medidas de mejora del servicio de teleasistencia (desarrollada en la acción 3.ª). |
| Indicadores de verificación de cumplimiento. | Tramitación del Decreto de modificación de la normativa autonómica en materia de dependencia. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 8.296.420 euros. |
| Observaciones. | Costes estimativos. |

Acción núm. 6: Mejora de la prestación del servicio de ayuda a domicilio

| Descripción de la medida. | Mejora de la prestación del servicio de ayuda a domicilio mediante el incremento de las horas de atención, así como del kilometraje de los desplazamientos de los profesionales a los núcleos de población separados del municipio, cuando el servicio se preste en poblaciones inferiores a 2.000 habitantes. |
| --- | --- |
| Situación a 1 de enero de 2024. | 5.309.838 horas. |
| Impacto esperado para 2024 (hasta 31 de diciembre de 2024). | 37.558 horas adicionales. |
| Indicadores de verificación de cumplimiento. | Número de horas.
 Kilometraje en desplazamientos a poblaciones inferiores a 2.000 habitantes. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 539.037,12 euros. |
| Observaciones. | Costes estimativos. |

Acción núm. 7: Avance en el reconocimiento del servicio de teleasistencia avanzada como derecho subjetivo y ampliación de su cobertura
...
| Descripción de la medida. | Avance en el servicio de teleasistencia avanzada con el fin de facilitar la permanencia de la persona en su entorno mediante apoyos tecnológicos, incremento de la cobertura de este servicio para personas en situación de dependencia que residan en su domicilio:
 ...
 – Ampliación de las prestaciones mediante protocolos o proyectos piloto (ej. Protocolo prevención maltrato en personas mayores o proyectos piloto de geolocalización). |
| --- | --- |
| Situación a 1 de enero de 2024. | Prestaciones de teleasistencia 28.921. |
| Impacto esperado para 2023 (hasta 31 de diciembre). | Durante 2024 se incrementarán un 3 % el número de prestaciones de teleasistencia. |
| Indicadores de verificación de cumplimiento. | Adjudicación en el ejercicio 2024 del nuevo contrato de teleasistencia. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 15.883.765,40 euros (anualidad contrato de teleasistencia). |
| Observaciones. |  |
...
Acción núm. 8: Avance y consolidación del modelo de concierto social en Castilla-La Mancha

| Descripción de la medida. | Se continúa con la ejecución del concierto social en Castilla-La Mancha. |
| --- | --- |
| Situación a 1 de enero de 2024. | 315 acuerdos de acción concertada formalizados. |
| Impacto esperado para 2024 (hasta 31 de diciembre). | Crecimiento de plazas concertadas. |
| Indicadores de verificación de cumplimiento. | Número de plazas concertadas. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 2024: 113.585.120,60 euros. |
| Observaciones. | Costes estimativos. |
...
Que, según consta en los archivos de esta Comunidad Autónoma, se ha recibido de los Presupuestos Generales del Estado del año 2024 del Imserso, una aportación por importe total de cuarenta y un millones quinientos diez mil cuatrocientos once euros con cincuenta y ocho céntimos (41.510.411,58 euros), con cargo a la aplicación económica 31.34.451.2, siendo el estado de ejecución del ejercicio 2024 el que se especifica a continuación:

Aportaciones del Instituto de Mayores y Servicios Sociales en concepto de nivel acordado: 41.510.411,58 euros.

| Aplicación
 económica
 del PGE | Asignación
 (euros) (1) | Compromiso
 de crédito (2) | Obligaciones
 reconocidas (3) | Pagos
 realizados (4) | Remanentes
 (1-2) | Obligaciones
 pendientes
 de pago (3-4) |
| --- | --- | --- | --- | --- | --- | --- |
