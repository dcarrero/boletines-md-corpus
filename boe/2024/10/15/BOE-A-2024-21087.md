---
identificador: "BOE-A-2024-21087"
titulo: "Resolución de 1 de octubre de 2024, de la Universitat de València, por la que se convocan pruebas selectivas de acceso, por el sistema general de acceso libre, a la Escala Técnica Media de Investigación."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
Las copias o fotocopias de estos documentos no serán válidas en ningún caso. Ni tampoco las fotos, PDF o capturas de pantalla guardadas en dispositivos electrónicos de cualquier tipo.
...
2. Cloud Computing. IaaS, PaaS, SaaS. Nubes privadas, públicas e híbridas. Computación en el borde. Computing Continuum.
...
4. Sistemas de altas prestaciones: supercomputación. Arquitectura y elementos básicos. Aplicación en entornos de investigación. La Red Española de Supercomputación (RES). La Universitat de València como nodo del RES.

5. Centro de Procesamiento de Datos (CPD). Clasificación TIER. Suministro y distribución de energía. Climatización. Fuentes de energía ininterrumpida. Protección contra incendios y seguridad. Monitorización del CPD.

6. Eficiencia energética e infraestructura de cableado y comunicaciones en el Data Center. Data Center Definido por Software (SDDC). Red definida por software (SDN). Openflow.

7. Esquema Nacional de Seguridad (Real Decreto 311/2022, de 3 de mayo). Política de seguridad de la información en la utilización de medios electrónicos de la Universitat de València.

8. Reglamento de seguridad de la información en la utilización de medios electrónicos de la Universitat de Valencia. Reglamento de uso de los recursos relacionados con las tecnologías de la información y las comunicaciones de la Universitat de València.

9. Seguridad física y lógica de los sistemas de información. Medidas de protección y aseguramientos ante amenazas y vulnerabilidades. Auditoría de seguridad. Análisis forense de sistemas. Riesgos, amenazas y vulnerabilidades.

10. Seguridad a nivel de enlace y a nivel de red. Ataques por saturación de la tabla CAM. Ataques de DHCP. ARP spoofing y IP spoofing. Protección de los niveles 2 y 3. Red privada virtual (VPN). Cortafuegos. Sistemas de detección/prevención de intrusiones (IDS/IPS/SIEM).

11. Seguridad a nivel de transporte: conexiones seguras (SSL/TLS, SSH y HTTPS). Seguridad a nivel de aplicación. Tecnología WAF. El correo electrónico seguro y seguridad en navegadores.

12. Identificación y firma electrónica. Marco europeo y nacional. Certificados digitales. Claves privadas, públicas y concertadas. Formatos de firma electrónica.

13. Gestión de identidades. Single Sign-On (SSO). Identidad federada. El servicio SIR de RedIRIS.
...
16. Tipos de sistemas de información multiusuario. Sistemas grandes, medianos y pequeños. Servidores de datos y de aplicaciones.

17. Docker y Kubernetes: construcción y ejecución de aplicaciones en contenedores y orquestación de contenedores. Function as a Service (FaaS).

18. Virtualización de sistemas y de centros de datos. Virtualización de puestos de trabajo. Maquetas de terminales Windows y de servidores Linux.

19. Herramientas y técnicas utilizables para la evaluación del rendimiento. Planificación de la capacidad. Análisis de la carga. Prácticas de mantenimiento de equipos e instalaciones. Mantenimiento preventivo, correctivo y perfectivo. Monitorización y gestión de capacidad.

20. Administración y gestión del almacenamiento: disco local, SAN (FC, FCoE, iSCSI, NVMeOF) y NAS (NFS, SMB). Familias SCSI, SATA y SSD. RAID. Gestión de Volúmenes.

21. Virtualización del almacenamiento y copias de seguridad: clasificación y opciones. Almacenamiento Definido por Software (SDS): CEPH.

22. Tecnologías Fibre Chanel (FC): Topologías. Dirección. El login de puertos. El zonnig. Construcción de Fabric extendido.

23. Redes de área local. Arquitectura. Tipología. Medios de transmisión. Métodos de acceso. Dispositivos de interconexión. Gestión de dispositivos.

24. Administración de redes LAN. Gestión de usuarios en redes locales. Monitorización y control de tráfico. Gestión SNMP. Configuración y gestión de redes virtuales (VLAN). Redes de área extensa.

25. Redes inalámbricas: el estándar IEEE 802.11. Características funcionales y técnicas. Sistemas de expansión del espectro. Sistemas de acceso. Autenticación. Maneras de operación. Seguridad, normativa reguladora.

26. Redes académicas y de investigación: NREN, RedIRIS, GÉANT. Redes para la administración pública: Red SARA, pasarela IRIS-SARA.

27. Diseño de bases de datos relacionales. Sentencias DML y DDL en SQL Oracle. Optimización del código SQL en bases de datos Oracle. Proceso de sentencias SQL: análisis, ejecución y obtención.

28. Seguridad y alta disponibilidad de bases de datos. Herramientas de protección y recuperación de SGBD. Backup físico y lógico. Auditoria de base de datos. Técnicas de ajuste y optimización de bases de datos.

29. Gestión de los datos corporativos. Almacén de datos (Data-Warehouse). Arquitectura OLAP. Compartimentos. Minería de datos. Generación de informes para la dirección. Gestión del conocimiento.

30. Soluciones de Business Intelligence. Big-Data y Analytics. Gestión de Big data: datos y usos. Tecnologías. Bases de datos NoSQL.

31. Datos abiertos (Open Data). Fuentes de datos. Reutilizadores de datos. Tecnologías.

32. Procesos de pruebas y garantía de calidad en el desarrollo de software. Planificación, estrategia de pruebas y estándares. Métricas y evaluación de la calidad del software. La implantación de la función de calidad.

33. Metodología de gestión de proyectos y desarrollo de aplicaciones. Metodologías ágiles de desarrollo. SCRUM, LEAN, KANBAN, XP, Clean Code. La estimación del esfuerzo en el desarrollo de sistemas de información.

34. Arquitectura de sistemas cliente/servidor y multicapas: componentes y operación. Arquitecturas de servicios web y protocolos asociados. Arquitectura Serverless.

35. Programas para control de versiones: Git, Bitbucket. Metodologías de desarrollo. Pruebas. Construcción de software: Maven.

36. Arquitectura orientada a servicios (SOA). Servicios web SOAP. Descripción y descubrimiento de servicios. XML y JSON.

37. Modelo de desarrollo de aplicaciones basado en microservicios. Arquitectura y soluciones. Despliegue, monitorización y escalado. Servicios REST.

38. Arquitectura de desarrollo en la web. Desarrollo web micro/frontend. Script de cliente. Frameworks. Desarrollo web en servidor. Conexión a bases de datos e interconexión con sistemas y servicios.

39. Sistemas CRM (Customer Relationship Management) y ERP (Enterprise Resource Planning) universitarios.

40. Open Science. Conceptos. Publicación en acceso abierto de resultados y datos científicos. Elementos tecnológicos para Open Science.
