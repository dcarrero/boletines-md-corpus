---
identificador: "BOE-A-2024-20830"
...
diario_numero: "246"
pagina_inicial: 130272
pagina_final: 130287
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-20830"
url_pdf: "https://www.boe.es/boe/dias/2024/10/11/pdfs/BOE-A-2024-20830.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-20830"
url_eli: ""
fetched_at: "2026-04-09T22:47:39Z"
parser_version: "boletines-md/0.1"
---

# Resolución de 2 de octubre de 2024, del Instituto de Mayores y Servicios Sociales, por la que se publica el Convenio con la Comunidad Autónoma de Aragón, para el desarrollo del marco de cooperación interadministrativa previsto en la Ley 39/2006, de 14 de diciembre, de Promoción de la Autonomía Personal y Atención a las personas en situación de dependencia, y para el establecimiento y financiación del nivel de protección acordado para el ejercicio 2024.

Con fecha 1 de octubre de 2024 se ha suscrito el Convenio entre el Instituto de Mayores y Servicios Sociales y la Comunidad Autónoma de Aragón para el desarrollo del Marco de Cooperación Interadministrativa previsto en la Ley 39/2006, de 14 de diciembre, de Promoción de la Autonomía Personal y Atención a las personas en situación de dependencia, y para el establecimiento y financiación del nivel de protección acordado para el ejercicio 2024.
...
Madrid, 2 de octubre de 2024.–La Directora General del Instituto de Mayores y Servicios Sociales, María Teresa Sancho Castiello.
...
Que, por su parte, la Comunidad Autónoma de Aragón ha dispuesto, en sus presupuestos correspondientes al año 2024, créditos para la atención a las personas en situación de dependencia en aplicación de lo previsto en el artículo 32 de la Ley 39/2006, de 14 de diciembre.
...
La Comunidad Autónoma de Aragón aportará, para la financiación del presente convenio, con cargo a sus propios presupuestos, un crédito inicial de treinta y nueve millones novecientos cuarenta y un mil ciento sesenta euros con sesenta y tres céntimos (39.941.160,63 €), con cargo a la aplicación presupuestaria G/3132/480271/91002.
...
Y, en prueba de conformidad y para la debida constancia de todo lo convenido, las partes firman el presente convenio digitalmente, tomándose como fecha de formalización y eficacia del presente documento la fecha del último firmante (1 de octubre de 2024).–Por el Instituto de Mayores y Servicios Sociales, la Directora General, María Teresa Sancho Castiello.–Por la Comunidad Autónoma de Aragón, la Consejera de Bienestar Social y Familia, Carmen María Susín Gabarre.
...
| Descripción de la medida. | En Aragón el volumen de solicitudes está aumentando de forma muy importante, existiendo la previsión de que en el ejercicio 2024 se haya aumentado en casi 5.000 expedientes.
 Pese a que se ha reforzado la plantilla de funcionarios adscritos al proceso, el objetivo es el mantenimiento de los tiempos de gestión que en Aragón se sitúan en el mes de julio en 210 días, 121 días menos que la media nacional. |
| --- | --- |
| Línea de base a 1 de enero de 2024. | Expedientes ptes de valoración: 4.154.
 Expedientes ptes. de PIA: 186.
 Expedientes ptes. de PIA efectivo: 659. |
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | Expedientes ptes de valoración: 4.500.
 Expedientes ptes. de PIA: 75.
 Expedientes ptes. de PIA efectivo: 750. |
| Indicadores de verificación de cumplimiento. | SISAAD a 31 de diciembre de 2024. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | 2.000.000 de euros. |
| Observaciones. |  |

| Descripción de la medida. | Aragón, siguiendo las recomendaciones del Plan de Choque aprobó e implantó de forma efectiva la resolución única de grado y PIA en mayo de 2023.
 Ello ha supuesto una reducción progresiva del denominado «limbo». El objetivo es terminar el ejercicio 2024 con su supresión total. |
| --- | --- |
| Línea de base a 1 de enero de 2024. | Expedientes ptes. de PIA: 186. |
| Impacto esperado sobre la lista de espera para 2024 (desde 1 de enero hasta 31 de diciembre). | Expedientes ptes. de PIA: 75. |
| Indicadores de verificación de cumplimiento. | SISAAD a 31 de diciembre de 2024. |
| Determinación de costes previstos en 2023 derivados directamente de la medida/actuación. | Se incluyen los costes directos de la medida de evolución del programa informático: 150.000 euros. |
| Observaciones. |  |
...
| Descripción de la medida. | Aragón está ultimando la norma que desarrolla la previsión contenida la DF primera del Real Decreto 675/2023, de 18 de julio, que modifica el Real Decreto 1050/2013, de 27 de diciembre, por la que se posibilita a las CC AA la mejora de la cuantía de la PECEF cuando exista un contrato laboral con un tercero, al objeto de colaborar con el cuidador no profesional en las tareas del hogar.
 En estos momentos está en fase final de tramitación, debiendo estar en vigor antes de acabar el ejercicio 2024. |
| --- | --- |
| Situación a 1 de enero de 2024. | No existe esa prestación en la modalidad mejorada. |
| Impacto esperado para 2024 (hasta 31 de diciembre de 2024). | Aprobación de la norma e implantación efectiva. |
| Indicadores de verificación de cumplimiento. | Remisión datos al SISAAD. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. |  |
| Observaciones. |  |

| Descripción de la medida. | La lista de espera en Aragón para recibir el servicio de teleasistencia a 1 de enero de 2024 era de 6.883 personas, siendo el servicio más demandado.
 Se propone la mejora de los convenios de colaboración con las entidades locales que prestan el servicio de teleasistencia de dependencia durante el año 2024 para que presten. |
| --- | --- |
| Situación a 1 de enero de 2024. | Personas en lista de espera: 6.883. |
| Impacto esperado para 2024 (hasta 31 de diciembre de 2024). | Incorporación al servicio de 3.735 terminales más durante 2024 y 2025. |
| Indicadores de verificación de cumplimiento. | Remisión datos al SISAAD. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. |  |
| Observaciones. | 900.000 euros. |

| Descripción de la medida. | Incremento de un 4,3 % de los precios de las plazas concertadas o contratadas por el IASS con efectos desde el 1 de enero de 2024. |
| --- | --- |
| Situación a 1 de enero de 2024. | Precios no actualizados. |
| Impacto esperado para 2024 (hasta 31 de diciembre de 2024). | Actualización con efectos 1 enero de 2024. |
| Indicadores de verificación de cumplimiento. | Publicación orden actualización. Orden BSF/622/2024, de 31 de mayo, por la que se establecen los precios de las plazas contratadas o concertadas por el Instituto Aragonés de Servicios Sociales, en ejercicio de sus competencias en materia de acción concertada. |
| Determinación de costes previstos en 2024 derivados directamente de la medida/actuación. | 3.000.000 de euros. |
| Observaciones. |  |
...
| Descripción de la medida. | – Planes específicos de formación del personal que trabaja en el SAAD, tanto de las entidades locales como del Instituto Aragonés de Servicios Sociales. Asimismo, por primer año se extenderá la formación en dependencia al personal adscrito a los centros de salud y hospitales de la Comunidad Autónoma de Aragón para una adecuada gestión de la información de dependencia con el paciente y coordinación entre profesionales de los sistemas de servicios sociales y sanitarios.
 – Inicio del proceso de transformación de las plazas adscritas a los contratos programa de refuerzo del personal contratado, a consecuencia de los objetivos del Plan de Choque de Dependencia y de la implementación del programa de atención centrada en la persona en los centros residenciales, en personal de estructura. Ante la imposibilidad de absorber la carga de trabajo derivada de la implantación del Plan de Choque y del Programa de Atención Centrada en la Persona, se recurrió a programas de ejecución temporal de refuerzo a la plantilla estructural del instituto. Debe señalarse que la carga de trabajo no es puntual sino estructural derivada del aumento significativo de las solicitudes y de la estrategia de reducción de tiempos. |
| --- | --- |
| Situación a 1 de enero de 2024. |  |
| Impacto esperado para 2024 (hasta 31 de diciembre de 2024). | Mejora de la capacitación y agilidad en la gestión del SAAD en el ámbito de los Servicios Sociales y del Servicio Aragonés de Salud.
 Inicio de la transformación en puestos de estructura de plazas de refuerzo para el Plan de Choque de Dependencia. |
...
Que, según consta en los archivos de esta Comunidad Autónoma, se ha recibido de los Presupuestos Generales del Estado del año 2024 del Imserso, una aportación por importe total de treinta y nueve millones novecientos cuarenta y un mil ciento sesenta euros con sesenta y tres céntimos (39.941.160,63 €), con cargo a la aplicación económica 31.34.451.2, siendo el estado de ejecución del ejercicio 2024 el que se especifica a continuación:

Aportaciones del Instituto de Mayores y Servicios Sociales en concepto de nivel acordado: 39.941.160,63 euros
