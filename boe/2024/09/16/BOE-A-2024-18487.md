---
identificador: "BOE-A-2024-18487"
titulo: "Resolución de 27 de agosto de 2024, de la Presidencia del Tribunal Constitucional, por la que se convoca concurso para la provisión de puestos de trabajo."
pais: "es"
fuente: "BOE"
fuente_tipo: "estatal"
...
Madrid, 27 de agosto de 2024.–El Presidente del Tribunal Constitucional, Cándido Conde-Pumpido Tourón.

ANEXO I

| N.º orden | Puesto de trabajo | Número de puestos | Adscripción | C. Destino anual
 –
 Euros | Descripción | Méritos específicos |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Jefe de Área. | 1 | Cuerpos o Escalas subgrupo A2. | 37.363,90 | Bajo la autoridad del jefe del Servicio o, en su caso, de la Unidad de Informática, colabora en la organización y gestión del sistema informático del Tribunal Constitucional, la tramitación y seguimiento de expedientes de contratación TIC, la planificación y desarrollo de proyectos informáticos, la creación y mantenimiento de los sistemas y aplicaciones, el aseguramiento de los entornos tecnológicos, y la prestación del apoyo técnico y formación básica a los usuarios. | Titulación universitaria de grado o master, o equivalente, relacionada con Informática, Matemáticas o Ingeniería.
 ...
 Conocimientos y experiencia en el desarrollo de sitios y páginas web sobre el gestor de contenidos Microsoft SharePoint 2013-2019.
 Conocimientos y experiencia en HTML5,CSS3, Javacript así como en framewoks de desarrollo web: Angular, React o Bootstrap.
 ...
 Conocimientos de infraestructuras en la nube y o365.
...
| 2 | Analista. | 2 | Cuerpos o Escalas Subgrupo C1. | 28.158,34 | Participación, bajo la autoridad del jefe del Servicio o, en su caso, de la Unidad de Informática, en las áreas de desarrollo y mantenimiento del sistema informático del Tribunal Constitucional, su aseguramiento funcional y técnico, así como en la formación básica y prestación del apoyo a los usuarios del sistema | Titulación de formación profesional relacionadas con Informática, o superior.
 ...
 Experiencia en el desarrollo de sitios y páginas web sobre el gestor de contenidos Microsoft SharePoint 2013-2019.
 Experiencia en HTML5, CSS3, Javacript así como en framewoks de desarrollo web: Angular, React o Bootstrap.
 Experiencia con tecnologías IA, RPA, LowCode y Apps móviles, para su aplicación en la digitalización de servicios.
