---
identificador: "BOE-A-2024-18486"
...
pagina_final: 113967
url_html: "https://www.boe.es/diario_boe/txt.php?id=BOE-A-2024-18486"
url_pdf: "https://www.boe.es/boe/dias/2024/09/16/pdfs/BOE-A-2024-18486.pdf"
url_xml: "https://www.boe.es/diario_boe/xml.php?id=BOE-A-2024-18486"
url_eli: ""
fetched_at: "2026-04-09T20:57:02Z"
...
Presidente: La jefa de personal y asuntos generales.
...
| N.º orden | Puesto trabajo | Número de puestos | Adscripción | C. Destino anual
 –
 ...
 *Unidad de Asuntos Económicos y Contabilidad*
 ...
 Administrativo/a. | 1 | Cuerpos o Escalas Subgrupo C1 | 25.738,30 | Participación, bajo la dirección del jefe/a de la Unidad, en la tramitación de expedientes y gestión de asuntos propios del área económica y de contabilidad. | Conocimientos en materia de Contratación del sector público.
 Conocimientos de la Plataforma de Contratación del Sector Público PLACE.
 Conocimientos del Registro contable de facturas FACe.
 Conocimientos de anticipo de caja fija ACF.
 Conocimientos de contabilidad del Estado (SIC 3 y Sorolla).
 Conocimientos de paquete Office 365. |
| 2 | **Gerencia**
 
 
 *Unidad de Archivo (Formación Archivística y Gestión Documental)*
 
 Técnico/a auxiliar de gestión documental y archivo. | 1 | Cuerpos o Escalas Subgrupo C1 | 25.738,30 | Participación, bajo la dirección del jefe/a de la Unidad, en tareas de organización de la documentación física y electrónica del Archivo general y en la aplicación del cuadro de clasificación.
 Descripción archivística utilizando la aplicación informática de gestión documental.
 Aplicación de calendarios de conservación/eliminación.
 Gestión y control de transferencias, préstamos y solicitudes de reproducción. Control de calidad.
 Atención al usuario. | Experiencia en archivos públicos realizando tareas supervisadas de apoyo en el tratamiento archivístico.
 Conocimientos y experiencia en archivística y gestión documental: clasificación, descripción, conservación y normalización.
 Conocimientos y experiencia en el uso de herramientas informáticas: aplicaciones ofimáticas, bases de datos relacionales y documentales. Aplicaciones de gestión documental. Digitalización de documentos y tratamiento de imágenes.
 Pertenencia a cuerpos o escalas de archivos de las Administraciones Públicas. |
| 3 | **Gerencia**
 
 
 *Unidad de Personal y Asuntos Generales*
 
 Auxiliar. | 1 | Cuerpos o Escalas
 Subgrupo C2 | 24.149,30 | Participación, bajo la dirección del jefe/a de la Unidad, en la tramitación de expedientes y gestión de asuntos propios de RR. HH y asuntos generales. | Experiencia en tramitación de expedientes y gestión de personal de la Administraciones Públicas.
 Experiencia en control horario y en formación.
 Conocimientos y experiencia, como usuario, en bases de datos aplicadas a la gestión de personal.
 Conocimientos y experiencia de paquete Office 365. |

El régimen retributivo de los funcionarios al servicio del Tribunal Constitucional es el previsto en el artículo 96 de su Reglamento de Organización y Personal, aprobado por Acuerdo del Pleno de 5 de julio de 1990 (BOE de 3 de agosto), y en el Acuerdo del Pleno del Tribunal de 19 de diciembre de 2002 (BOE de 24 de diciembre) por el que se regula el régimen de retribuciones del personal al servicio del Tribunal Constitucional. Con arreglo a dicho régimen retributivo, los funcionarios de las Administraciones Públicas que resulten adscritos al Tribunal Constitucional tendrán asignado un complemento de adecuación de sueldo, que, para el Grupo C, subgrupo C1, está establecido en 7.168,20 euros y para el grupo C, subgrupo C2 está establecido en 5.528,28 euros anuales, para el 2024.
